...
function Admin1() {
 ...
 useEffect(
  ...
  .then((data) => {
    ...
    setValuea1t1(data[0].af2t1);
    setValuea1t2(data[0].af2t2);
    setValuea1t3(data[0].af2t3);
    setValuea1t4(data[0].af2t4);
    setValuea1t5(data[0].af12t5);
    setValuea1t6(data[0].af2t6);
    setValuea1t7(data[0].af2t7);
    setValuea1t81(data[0].af2t81);
    setValuea1t82(data[0].af2t82);
    setValuea1t83(data[0].af2t83);
    setValuea1t11(data[0].af2t11);
    setValuea1t12(data[0].af2t12);
    setValuea1t13(data[0].af2t13);
    setValuea1t14(data[0].af2t14);
  ...
  //   };
  //   fetch(
  //     "http://localhost:8080/api/v1/admissionEnquiry",
  //     filesFetchMethod
  //   ).then((response) => {
