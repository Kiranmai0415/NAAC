...
function Admin2() {
  ...
  const [pathValuea2t15, setPathValuea2t15] = useState("");
    ...
    useEffect(
      ...
      .then((data) => {
        ...
        setValuea2t1(data[0].af1t1);
        setValuea2t2(data[0].af1t2);
        setValuea2t3(data[0].af1t3);
        setValuea2t4(data[0].af1t4);
        setValuea2t5(data[0].af1t5);
        setValuea2t6(data[0].af1t6);
        setValuea2t7(data[0].af1t7);
        setValuea2t8(data[0].af1t8);
        setValuea2t9(data[0].af1t9);
        setValuea2t10(data[0].af1t10);
        setValuea2t11(data[0].af1t11);
        setValuea2t12(data[0].af1t12);
        setValuea2t13(data[0].af1t13);
        setValuea2t14(data[0].af1t14);
        setValuea2t15(data[0].af1t15);  
        setPathValuea2t15(data[0].uploadfileadmin[0].uploadfileadmin);       
        })
  ...
  //     body: admin2Data,
  //   };
  //   fetch("http://localhost:8080/api/v1/adminupload", filesFetchMethod).then(
  //     (response) => {
