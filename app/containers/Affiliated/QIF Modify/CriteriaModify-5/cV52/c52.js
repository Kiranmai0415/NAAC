...
function Criteria52() {
      ...
      (response) => response
        ...
        .then((data) => {
          console.log(JSON.stringify(data));
            ...
            setValue5221t1(data[0].affiliatedYearTable5221[0]?data[0].affiliatedYearTable5221[0].input5221y:"");
            setValue5221t2(data[0].affiliatedYearTable5221[1]?data[0].affiliatedYearTable5221[1].input5221y:"");
            setValue5221t3(data[0].affiliatedYearTable5221[2]?data[0].affiliatedYearTable5221[2].input5221y:"");
            setValue5221t4(data[0].affiliatedYearTable5221[3]?data[0].affiliatedYearTable5221[3].input5221y:"");
            setValue5221t5(data[0].affiliatedYearTable5221[4]?data[0].affiliatedYearTable5221[4].input5221y:"");
            setValue5221t6(data[0].affiliatedYearTable5221[0]?data[0].affiliatedYearTable5221[0].input5221v:"");
            setValue5221t7(data[0].affiliatedYearTable5221[1]?data[0].affiliatedYearTable5221[1].input5221v:"");
            setValue5221t8(data[0].affiliatedYearTable5221[2]?data[0].affiliatedYearTable5221[2].input5221v:"");
            setValue5221t9(data[0].affiliatedYearTable5221[3]?data[0].affiliatedYearTable5221[3].input5221v:"");
            setValue5221t10(data[0].affiliatedYearTable5221[4]?data[0].affiliatedYearTable5221[4].input5221v:"");

            setValue5222t1(data[0].yearTable5232[0]?data[0].yearTable5232[0].input5232y:"");
            setValue5222t2(data[0].yearTable5232[1]?data[0].yearTable5232[1].input5232y:"");
            setValue5222t3(data[0].yearTable5232[2]?data[0].yearTable5232[2].input5232y:"");
            setValue5222t4(data[0].yearTable5232[3]?data[0].yearTable5232[3].input5232y:"");
            setValue5222t5(data[0].yearTable5232[4]?data[0].yearTable5232[4].input5232y:"");
            setValue5222t6(data[0].yearTable5232[0]?data[0].yearTable5232[0].input5232v:"");
            setValue5222t7(data[0].yearTable5232[1]?data[0].yearTable5232[1].input5232v:"");
            setValue5222t8(data[0].yearTable5232[2]?data[0].yearTable5232[2].input5232v:"");
            setValue5222t9(data[0].yearTable5232[3]?data[0].yearTable5232[3].input5232v:"");
            setValue5222t10(data[0].yearTable5232[4]?data[0].yearTable5232[4].input5232v:"");
  ...
  criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType},          
    ...
    //   {
    //     criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType},          
    //     uniqueKey1: 101, input5231y: value5221t1, input5231v: value5221t6
    //   },
    //   {
    //     criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType},          
    //     uniqueKey1: 102, input5231y: value5221t2, input5231v: value5221t7
    //   },
    //   {
    //     criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType},          
    //     uniqueKey1: 103, input5231y: value5221t3, input5231v: value5221t8
    //   },
    //   {
    //     criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType},          
    //     uniqueKey1: 104, input5231y: value5221t4, input5231v: value5221t9
    //   },
    //   {
    //     criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType},          
    //     uniqueKey1: 105, input5231y: value5221t5, input5231v: value5221t10
    //   },
    // ],
    // yearTable5232: [
    //   {
        ...
        <form>
          <div className="c52x-container">
            <div className="c52x-heading_Help-container">
              ...
              <HelpButton
                ...
                title='percentage'
                > <h1>(Total number of outgoing students placed and / or progressed to higher education during the last five years / Total number of outgoing students during the last five years) * 100</h1></HelpButton>
            </div>
          ...
          <div className="c52xx-container">
            <h1 className="c52x-heading-style">
              ...
              Number of outgoing students placed and / or progressed to higher education
          ...
          <div className="c52x-container">
            <div className="c52x-heading_Help-container">
              ...
              <HelpButton
                ...
                title='percentage'
                ><h1>(Total number of students qualified in such examinations during the last five years) / (Total number of outgoing students (5.2.1.2)−Total number of outgoing students placed,progressed to higher education during the last five years (5.2.1.1)) * 100</h1></HelpButton>
            </div>
            <div className="c52x-response-container">
              <button
                onClick={(e) => {
