  ...
  return (
    <div className="c62-inputFields-mainContainer">
          ...
          <div className="c62x-Ql-label-textarea-container">
            <div className="c62x-heading_Help-container">
              <h1 className="c62x-heading-style">
                ...
                The functioning of the institutional bodies is effective and efficient as visible from policies, administrative setup, appointment and service rules, procedures, deployment of institutional
          ...
          <table className="c62x-Ql-table-style">
            ...
            <tr>
              ...
              <input
                  ...
                  {/* <a href={downloadFile(value621f3)} target="_blank">View File</a> */}
          ...
          <table className="c62x-table-style">
            ...
            <tr>
              ...
              <input
                  ...
                  {/* <a href={downloadFile(value622f4)} target="_blank">View File</a> */}
      ...
      <div className="c62x-button-container">
        <button className="c62x-button-style" onClick={onClickingSave}>Modify</button>
      </div>
    </div>
  );
}
