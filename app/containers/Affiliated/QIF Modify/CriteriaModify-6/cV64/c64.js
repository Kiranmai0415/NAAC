  ...
  return (
    <div className="c64-inputFields-mainContainer">
          ...
          <div className="c64x-Ql-label-textarea-container">
            <div className="c64x-heading_Help-container">
              <h1 className="c64x-heading-style">
                ...
                Institution has strategies for mobilization and optimal utilization of resources and funds from various sources (government/ non-government organizations) and it
      ...
      <div className="c64x-button-container">
        <button className="c64x-button-style" onClick={onClickingSave}>Modify</button>
      </div>
    </div>
  );
}
