  ...
  return (
    <div className="c44-inputFields-mainContainer">
          ...
          <div className="c44x-container">
            <div className="c44x-heading_Help-container">
              ...
              <HelpButton
                ...
                title='percentage'
                ><h1>(Total expenditure incurred on maintenance of infrastructure excluding salary during the last five years / Total expenditure excluding salary
                   during the last five years) * 100</h1></HelpButton>
            </div>
      ...
      <div className="c44x-button-container">
        <button className="c44x-button-style" onClick={onClickingSave}>Modify</button>
      </div>
    </div>
  );
}
