    ...
    () => fetch(resources.APPLICATION_URL+'criteria2getallfiles?collegeId='+collegeId+'&financialYear='+fYear+'&typeofInstitution='+instituteType,).then(
      (response) => response
        ...
        .then((data) => {
          ...
          // setValue2112t11(data[0].criteria2FieldInfoQn[0].input2112t11);
          ...
          setValue2112f1(data[0].criteria2FileUpload[0]?data[0].criteria2FileUpload[0].criteria2FileName:"");
          setValue2112f2(data[0].criteria2FileUpload[0]?data[0].criteria2FileUpload[0].criteria2FileName:"");
          setValue2121f1(data[0].criteria2FileUpload[0]?data[0].criteria2FileUpload[0].criteria2FileName:"");
          setValue2121f2(data[0].criteria2FileUpload[0]?data[0].criteria2FileUpload[0].criteria2FileName:"");
        })
        .catch((error) => {
  ...
  const inputDataList = {
    ...
    yearTable2111: [
      {         criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType},
       ...
       uniqueKey1: 101, input2111y: value2111t1, input2111v: value2111t6 },
      { 
        criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType},

       uniqueKey1: 102,input2111y: value2111t2, input2111v: value2111t7 },
      { 
        criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType},
        uniqueKey1: 103, input2111y: value2111t3, input2111v: value2111t8 },
      { 
        criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType},
        uniqueKey1: 104, input2111y: value2111t4, input2111v: value2111t9 },
      { 
        criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType},
        uniqueKey1: 105, input2111y: value2111t5, input2111v: value2111t10 },
    ],
    yearTable2112: [
      { 
        criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType},
        uniqueKey1: 101,input2112y: value2112t1, input2112v: value2112t6 
      },
      {
        criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType},
        uniqueKey1: 102, input2112y: value2112t2, input2112v: value2112t7 
      },
      {
        criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType},
        uniqueKey1: 103, input2112y: value2112t3, input2112v: value2112t8 
      },
      { 
        criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType},
        uniqueKey1: 104, input2112y: value2112t4, input2112v: value2112t9 
      },
      { 
        criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType},
        uniqueKey1: 105, input2112y: value2112t5, input2112v: value2112t10 
      },
    ],
    yearTable2121: [
      { 
        criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType},
        uniqueKey1: 101, input2121y: value2121t1, input2121v: value2121t6 },
      { 
        criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType},
        uniqueKey1: 102, input2121y: value2121t2, input2121v: value2121t7 },
      { 
        criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType},
        uniqueKey1: 103, input2121y: value2121t3, input2121v: value2121t8 },
      { 
        criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType},
        uniqueKey1: 104, input2121y: value2121t4, input2121v: value2121t9 },
      { 
        criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType},
        uniqueKey1: 105, input2121y: value2121t5, input2121v: value2121t10 },
    ],
    yearTable21212: [
      { 
        criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType},
        uniqueKey1: 101, input21212y: value2121t11, input21212v: value2121t16 },
      { 
        criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType},
        uniqueKey1: 102, input21212y: value2121t12, input21212v: value2121t17 },
      { 
        criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType},
        uniqueKey1: 103, input21212y: value2121t13, input21212v: value2121t18 },
      { 
        criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType},
        uniqueKey1: 104, input21212y: value2121t14, input21212v: value2121t19 },
      {  
        criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType},
        uniqueKey1: 105,input21212y: value2121t15, input21212v: value2121t20 },
    ],
    ...
    <div className="c21-inputFields-mainContainer">
      ...
      <div className="c21x-eachInputField-container">
        <div className="c21x-weightage-container">
          <h1 className="c21x-weightage-heading-style">Weightage: 20</h1>
        </div>
        <form>
          ...
          <div className="c21xx-container">
            ...
            <table className="c21x-table-style">
              ...
              <tr>
                <td>
                Institutional data in the prescribed format (template merged with 2.1.2)
                </td>
                <td> <a href={downloadFile("af2.1.1.xlsx")} target="_blank">View Template</a></td>
                <td>
                <input
                  onChange={(e) => {
              ...
              {/* <a href={downloadFile(value2112f1)} target="_blank">View File</a>
                 */}
                </td>
              ...
              {/* <a href={downloadFile(value2112f2)} target="_blank">View File</a> */}
        ...
        <form>
          <div className="c21x-container">
            <div className="c21x-heading_Help-container">
              <h1 className="c21x-heading-style">
                ...
                policy ) during the last five years ( exclusive of supernumerary
                seats)
              </h1>
              <button
              ...
              <HelpButton
                ...
                title='percentage'
                >
                  <h1>(Total number of students admitted during last five years/Total number of sanctioned seatsduring last five years) * 100</h1>
                </HelpButton>
            </div>
            <div className="c21x-response-container">
              <button
          ...
          <div className="c21xx-container">
            <h1 className="c21xx-Heading-style">
              ...
              Number of actual students admitted from the reserved categories
            ...
            <table className="c21x-table-style">
              ...
              {/* <a href={downloadFile(value2121f1)} target="_blank">View File</a> */}
              ...
              <tr>
                ...
                <td> <a href={downloadFile("af2.1.2.xlsx")} target="_blank">View Template</a></td>
                <td>
                <input
                  onChange={(e) => {
              ...
              {/* <a href={downloadFile(value2121f2)} target="_blank">View File</a> */}
