          ...
          <div className="c24x-container">
            <div className="c24x-heading_Help-container">
              ...
              <HelpButton
                ...
                title='percentage'
                >
                  <h1>((Total number of full time teachers year wise during the last five yearsTotal number of Sanctioned posts/required positions for full time teachers)) * 100</h1>
                </HelpButton>
            </div>
          ...
          <div className="c24x-container">
            <div className="c24x-heading_Help-container">
              ...
              <HelpButton
                ...
                title='percentage'
                >
                  <h1>(Total number of full time teachers with such qualifications during last five yearsTotal number of full time teachers year wise during last five years) * 100</h1>
                </HelpButton>
            </div>
            <div className="c24x-response-container">
              <button
