  ...
  () => fetch(resources.APPLICATION_URL+'criteria7getallfiles?collegeId='+collegeId+'&financialYear='+fYear+'&typeofInstitution='+instituteType,).then(
    (response) => response
      ...
      .then((data) => {
        ...
        setValue721t1(data[0].criteria72Ql[0]?data[0].criteria72Ql[0].input721t1:"");

        setValue721f1(data[0].criteria7FileUpload[0]?data[0].criteria7FileUpload[0].criteria7FileName:"");
        setValue721f2(data[0].criteria7FileUpload[1]?data[0].criteria7FileUpload[1].criteria7FileName:"");
      })
      .catch((error) => {
  ...
  return (
    <div className="c72-inputFields-mainContainer">
        ...
        <form>
          <div className="c72x-Ql-label-textarea-container">
            <div className="c72x-heading_Help-container">
              ...
              className="c73x-helpButton-style"
                >
                Help
              </button>
              <HelpButton
          ...
          <table className="c72x-Ql-table-style">
            ...
            <tr>
              ...
              <input
                  ...
                  {/* <a href={downloadFile(value721f2)} target="_blank">View File</a> */}
      ...
      <div className="c72x-button-container">
        <button className="c72x-button-style" onClick={onClickingSave}>Modify</button>
      </div>
    </div>
  );
}
