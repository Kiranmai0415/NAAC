...
//   useEffect(
//     () => fetch('http://localhost:8080/api/v1/criteria7getallfiles?collegeId='+collegeId+'&financialYear='+fYear+'&typeofInstitution='+instituteType,).then(
//       (response) => response
//         .json()
//         .then((data) => {
...
//         <button className="c73x-button-style" onClick={onClickingSave}>Modify</button>
//       </div>
//     </div>
//   );
// }
