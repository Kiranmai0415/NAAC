      ...
      fetch(resources.APPLICATION_URL+'criteria1getallfiles?collegeId='+collegeId+'&financialYear='+fYear+'&typeofInstitution='+instituteType,).then(
        (response) =>
          response
            ...
            setValue132t1(data[0].criteria13Qn[0]?data[0].criteria13Qn[0].input1321t11:"");
            setValue1321t1(data[0].criteria13Qn[0]?data[0].criteria13Qn[0].input1321t12:"");
           
            setValue1321f1(data[0].criteria1FileUpload[0]?data[0].criteria1FileUpload[0].criteria1FileName:"");
            setValue1321f2(data[0].criteria1FileUpload[1]?data[0].criteria1FileUpload[1].criteria1FileName:"");
            setValue131f1(data[0].criteria1FileUpload[2]?data[0].criteria1FileUpload[2].criteria1FileName:"");
            setValue131f2(data[0].criteria1FileUpload[3]?data[0].criteria1FileUpload[3].criteria1FileName:"");
            })
            .catch((error) => {
