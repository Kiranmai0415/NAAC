...
function Criteria35() {
  ...
  const inputDataList = {
    ...
    yearTable3511: [
      {
        criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType},        
         uniqueKey1: 101, input3511y: value3511t1, input3511v: value3511t6
      },
      {
        criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType},        
         uniqueKey1: 102, input3511y: value3511t2, input3511v: value3511t7
      },
      {
        criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType},        
         uniqueKey1: 103, input3511y: value3511t3, input3511v: value3511t8
      },
      {
        criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType},        
         uniqueKey1: 104, input3511y: value3511t4, input3511v: value3511t9
      },
      {
        criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType},        
         uniqueKey1: 105, input3511y: value3511t5, input3511v: value3511t10
      },
    ],
        ...
        <form>
          <div className="c35x-container">
            <div className="c35x-heading_Help-container">
              <h1 className="c35x-heading-style">
                ...
                The number of MoUs, collaborations/linkages for Faculty exchange, Student exchange, Internship, Field project, On-the- job training, research and other
          ...
          <div className="c35xx-container">
            <h1 className="c35xx-Heading-style">
             ...
             Number of MoUs, collaborations/linkages for Faculty 
            exchange, Student exchange, Internship, Field project, On-the- job 
            training, research and other academic activities during the last five 
             years:
            </h1>
            ...
            <table className="c35x-table-style">
              ...
              <tr>
                ...
                <td>
                <a href={downloadFile("af3.5.1.xlsx")} target="_blank">View Template</a>
                </td>
                <td>
                <input
                    onChange={(e) => {
