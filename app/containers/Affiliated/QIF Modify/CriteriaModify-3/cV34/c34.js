    ...
    () => fetch(resources.APPLICATION_URL+'criteria3getallfiles?collegeId='+collegeId+'&financialYear='+fYear+'&typeofInstitution='+instituteType,).then(
      (response) => response
        ...
        .then((data) => {
          ...
          setValue342t1(data[0].criteria34Qn[0]?data[0].criteria34Ql[0].input342t1:"");
          ...
          setValue3431t1(data[0].yearTable3431[0]?data[0].yearTable3431[0].input3431y:"");
            ...
            setValue3431f3(data[0].criteria3FileUpload[6]?data[0].criteria3FileUpload[6].criteria3FileName:"");
        })
        .catch((error) => {
        ...
        <form>
          <div className="c34x-container">
            <div className="c34x-heading_Help-container">
              <h1 className="c34x-heading-style">
                ...
                Number of extension and outreach programs conducted by the institution through NSS/NCC etc., (including the programmes such as Swachh Bharat, AIDS awareness, Gender issues etc. and/or those organised in collaboration with industry, community and NGOs)
          ...
          <div className="c34xx-container">
            <h1 className="c34xx-Heading-style">
              <span className="c34xx-span-style">3.6.3.1: </span>
            ...
            <table className="c34x-table-style">
              ...
              <tr>
                ...
                <input
                  ...
                  {/* <a href={downloadFile(value3431f3)} target="_blank">View File</a> */}
