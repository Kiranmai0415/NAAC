...
import Criteria1 from "./Authoze principalc1";
import Criteria2 from "./Authoze principalc2";
import Criteria3 from "./Authoze principalc3";
import Criteria4 from "./Authoze principalc4";
import Criteria5 from "./Authoze principalc5";
import Criteria6 from "./Authoze principalc6";
import Criteria7 from "./Authoze principalc7";
...
function AuthorizePrincipalScreen() {
  ...
  function onConfirmingReject() {
    ...
    fetch(
      resources.APPLICATION_URL + "principalRejectRecord",
      rejectAPImethod
    ).then((response) => {
      console.log(response);
      if (response.ok) {
