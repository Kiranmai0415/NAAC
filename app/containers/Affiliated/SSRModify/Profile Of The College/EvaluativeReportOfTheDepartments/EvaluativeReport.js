...
function EvaluativeReport() {
  ...
  const [pathValuef4, setPathValuef4] = useState("");
   ...
   useEffect(
    () => fetch('http://localhost:8080/api/v1/evaluativedata?collegeId=collegeId&financialYear='+fYear+'&typeofInstitution=instituteType').then(
      (response) => response
        .json()
        .then((data) => {
          console.log(JSON.stringify(data));
          setValuet1(data[0].evaluativeReport[0]?data[0].evaluativeReport[0].valuet1:"");
          setValuet2(data[1].evaluativeReport[1]?data[1].evaluativeReport[1].valuet2:"");
          setValuet3(data[2].evaluativeReport[2]?data[2].evaluativeReport[2].valuet3:"");
          setValuet4(data[3].evaluativeReport[3]?data[3].evaluativeReport[3].valuet4:"");
        })
        .catch((error) => {
