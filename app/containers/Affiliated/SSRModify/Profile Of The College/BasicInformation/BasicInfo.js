    ...
    () => fetch('http://localhost:8080/api/v1/getallacademicdata?collegeId='+collegeId+'&financialYear='+fYear+'&typeofInstitution='+instituteType,).then(
      (response) => response
        ...
        .then((data) => {
          ...
          //
          setValuebt1(data[0].basicProfile?data[0].basicProfile[0].inputbt1:"");
          setValuebt2(data[0].basicProfile?data[0].basicProfile[0].inputbt2:"");
          setValuebt3(data[0].basicProfile?data[0].basicProfile[0].inputbt3:"");
          setValuebt4(data[0].basicProfile?data[0].basicProfile[0].inputbt4:"");
          setValuebt5(data[0].basicProfile?data[0].basicProfile[0].inputbt5:"");
          setValuebt6(data[0].basicProfile?data[0].basicProfile[0].inputbt6:"");
    ...
    <div className="main-container">
      ...
      <div className="eachTable-container">
        <form>
          ...
          <input
            type="text"
            style={{ width: "20%", marginLeft: "180px" }}
            id="bti1"
            value={valuebti1}
         ...
         <FormControl>
          <p> 5.It is a recognized minority institution?</p>
           <RadioGroup name="radio-buttons-group">
              <FormControlLabel id="btr11" value="Yes" 
              onChange={(e) => setValuebtr11(e.target.value)}
               control={<Radio />} label="Yes" />

               <FormControlLabel  id="btr11" value="No"  
               onChange={(e) => setValuebtr11(e.target.value)} 
      ...
      <div className="eachTable-container">
        <form>
          ...
          <input
            type="text"
            style={{ width: "20%", marginLeft: "255px" }}
            id="btr12"
            value={valuebtr12}
      ...
      <div className="eachTable-container">
        <form>
          ...
          <input
            type="date"
            style={{ width: "20%", marginLeft: "358px" }}
            id="btr13"
            value={valuebtr13}
          ...
          <br></br>
          <label htmlFor="basicInfo-t4">c. Details of UGC recognition:</label> <br/>
          <table>
            <tr>
              <th>Under Section</th>
      ...
      <div className="eachTable-container">
       ...
       <label>If yes, Name of the agency.....
       <input
         type="text"
         style={{ width: "20%" ,  marginLeft:"405px" }}
         id="btc15"
         value={valuebtc15}
         onChange={(e) => setValuebtc15(e.target.value)}
       />
       </label> <br/>
       <label>Date of recognition.....(dd/mm/yyyy)
       <input
         type="date"
         style={{ width: "20%" ,  marginLeft:"355px" }}
         id="btc16"
         value={valuebtc16}
      ...
      <div className="eachTable-container">
        ...
        <br></br>
        <div>
          <label htmlFor="academicInfo-t1">Cycle 3:  &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;
          <input
            type="date"
            style={{ width: "30%" }}
            id="btda5"
      ...
      <div className="eachTable-container">
        ...
        <div>
          ...
          <input
            type="date"
            style={{ width: "30%" , marginLeft:"26px"}}
            id="btda9"
            value={valuebtda9}
