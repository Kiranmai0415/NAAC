...
export default function EvaluationReportModify() {
  ...
  useEffect(
    () => fetch('http://localhost:8080/api/v1/getallevaluativedata?collegeId='+collegeId+'&financialYear='+fYear+'&typeofInstitution='+instituteType,).then(
      (response) => response
        .json()
        .then((data) => {
  ...
  const inputDataList = {
    ...
    evaluativereportofthedepartment11: [
      ...
      },
      {
        ...
        uniqueKey1: 1093, 
        english: department93, zoology: zoology93, bioTechnology: bioTech93
      },
      ...
      },
      {
        ...
        uniqueKey1: 1095, 
        english: department95, zoology: zoology95, bioTechnology: bioTech95
      },

      {
        ...
        uniqueKey1: 1096, 
        english: department96, zoology: zoology96, bioTechnology: bioTech96
      },

      {
        ...
        uniqueKey1: 1010, 
        english: department10, zoology: zoology10, bioTechnology: bioTech10
      },
