  ...
  () => fetch('http://localhost:8080/api/v1/getallexecutivedata?collegeId='+collegeId+'&financialYear='+fYear+'&typeofInstitution='+instituteType,).then(
    (response) => response
      ...
      .then((data) => {
        ...
        setValuees2(data[0].inputes2?data[0].inputes2:"");
        setValuees3(data[0].inputes3?data[0].inputes3:"");
        setValuees4(data[0].inputes4?data[0].inputes4:"");
        setValuees5(data[0].inputes5?data[0].inputes5:"");
        setValuees7(data[0].inputes7?data[0].inputes7:"");
        setValuees8(data[0].inputes8?data[0].inputes8:"");
        setValuees9(data[0].inputes9?data[0].inputes9:"");
        setValuees10(data[0].inputes10?data[0].inputes10:"");
      })
      .catch((error) => {
