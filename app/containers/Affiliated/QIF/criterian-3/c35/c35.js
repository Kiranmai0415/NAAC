    ...
    if (
      ...
      setResponseValue351(
       (parseInt((value3511t6, 10)+
          ...
          parseInt(value3511t10, 10))/ viewResponseValue)*100
      );
    }
  }
          ...
          <div className="c35x-container">
            <div className="c35x-heading_Help-container">
              <h1 className="c35x-heading-style">
                ...
                The number of MoUs, collaborations/linkages for Faculty exchange, Student exchange, Internship, Field trip, On-the- job training,
