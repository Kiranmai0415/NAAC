...
function Criteria33() {
  ...
  function onClickingViewResponse331() {
    if (
      ...
      setResponseValue331(
        ...
        parseInt(value3311t10, 10))/ viewResponseValue)*100
        // (value3311t11, 10)/ viewResponseValue)*100
      );
    }
  }
    ...
    if (
     ...
     // && value3321t11 !== ''
      ...
      setResponseValue332(
       ...
       parseInt  (value3321t10, 10))/ viewResponseValue)*100
        //  (value3321t11, 10)/ viewResponseValue)*100
      );
    }
  }
 ...
 const financialYear="2021-2022";
  ...
  function onClickingSave() {
    ...
    console.log(JSON.stringify("inputDataList",inputDataList));
  ...
  useEffect(
    () => fetch(resources.APPLICATION_URL+'viewResponseValueAffiliated331?collegeId='+collegeId+'&financialYear='+fYear+'&typeofInstitution='+instituteType).then(
      (response) => response
        .json()
        .then((data) => {
  ...
  useEffect(
    () => fetch(resources.APPLICATION_URL+'viewResponseValueAffiliated332?collegeId='+collegeId+'&financialYear='+fYear+'&typeofInstitution='+instituteType).then(
      (response) => response
        .json()
        .then((data) => {
          console.log("response value is from backend==>"+JSON.stringify(data));
        ...
        <form>
          <div className="c33x-container">
            <div className="c33x-heading_Help-container">
              ...
              title='percentage'><h1>(Total number of research papers in the Journals notified on UGC CARE )/(Number of full time teachers during the last five years (without repeat count))</h1>
              </HelpButton>
            </div>
        ...
        <form>
          <div className="c33x-container">
            <div className="c33x-heading_Help-container">
              ...
              title='percentage'><h1>(Total number of books and chapters in edited volumes/books published and papers in national/international conference proceedingsNumber of full time teachers during the last five years (without repeat count))</h1>
              </HelpButton>
            </div>
            <div className="c33x-response-container">
              <button
