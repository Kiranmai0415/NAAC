...
function Criteria31() {
  ...
  function onClickingViewResponse311() {
    if (
      ...
      parseInt (value3111t10, 10))/ viewResponseValue)*100
      );
    }
  }
  ...
  function onClickingSaveSendingTexts() {
    ...
    if (pathValue3111f1 !== '') {
      form31Data.append('uploadfile3', value3111f1, '3111-f1-' + value3111f1.name);
    }
    if (pathValue3111f2 !== '') {
      form31Data.append('uploadfile3', value3111f2, 'f3111-f2-' + value3111f2.name);
    }
    // if (pathValue311f3 !== '') {
