...
const [isOpen2,setIsopen2] = useState(false)
  ...
  // response button functionality
   ...
   function onClickingViewResponse121() {
    if ( value1211t1 === "" || viewResponseValue === "") {
    ...
    } else if ( value1211t1 !== "" && viewResponseValue !== "") {
      setResponseValue121(
        (parseInt( value1211t1, 10) / parseInt(viewResponseValue, 10)) * 100
      );
    }
  }
  function onClickingViewResponse122() {
    console.log("onClickingViewResponse122"+viewResponseValue);
    if ( value1221t1 === "" || value1221t2 === "" || value1221t3 === "" || value1221t4 === "" ||
    value1221t5 === "" || value1221t6 === "" || value1221t7 ==="" || value1221t8 === "" || value1221t9 ==="" || value1221t10 ==="" ) {
      setResponseValue122("Please fill the required fields");
    } else if (
      Number.isInteger(parseInt( value1221t1, 10)) === false ||
      Number.isInteger(parseInt(value1221t2, 10)) === false ||
      Number.isInteger(parseInt(value1221t3, 10)) === false ||
      Number.isInteger(parseInt(value1221t4, 10)) === false ||
      Number.isInteger(parseInt(value1221t5, 10)) === false ||
      ...
      setResponseValue122(
       ( ((parseInt( value1221t6, 10) )  +
        ...
        (parseInt( value1221t10, 10)  ) )/viewResponseValue)*100
      );
    }
  }
  ...
  useEffect(
    () => fetch(resources.APPLICATION_URL+'viewResponseValueAffiliated122?collegeId='+collegeId+'&financialYear='+fYear+'&typeofInstitution='+instituteType).then(
      (response) => response
        .json()
        .then((data) => {
          ...
          <div className="c12x-container">
            <div className="c12x-heading_Help-container">
              <h1 className="c12x-heading-style">
                ...
                Average percentage of students enrolled in Certificate/ Add-on/ Value added programs as
              ...
              <HelpButton
                ...
                title='percentage'
                ><h1>((Total number of students enrolled in such programs/during the 
                  last five years/during the last five years)/Total number of students during the last five years) * 100</h1></HelpButton>
            </div>
            <div className="c12x-response-container">
              <button
                onClick={(e) => {
 ...
 Add-on/Value added programs year wise during last five years
            ...
            <table className="c12x-table-style">
              ...
              <td>Institutional data in prescribed format</td>
                <td>
                <a href={downloadFile("af1.2.1.xlsx")} target="_blank">
                    View Template
                  </a>
                </td>
                <td>
