          ...
          <div className="c71x-Ql-label-textarea-container">
            <div className="c71x-heading_Help-container">
              <h1 className="c71x-heading-style">
                ...
                GMeasures initiated by the Institution for the promotion of gender 
          ...
          <div className="c71x-container">
            <div className="c71x-heading_Help-container">
              <div>
                ...
                <div className="c71x-radio-container" style={{width:"108%"}}>
          ...
          <div className="c71x-Ql-label-textarea-container">
            <div className="c71x-heading_Help-container">
              <h1 className="c71x-heading-style">
                ...
                Describe the Institutional efforts/initiatives in providing an inclusive environment i.e., tolerance and harmony towards 
                cultural, regional, linguistic, communal socioeconomic and Sensitization of students and employees to the constitutional 
                obligations: values, rights, duties and responsibilities of citizens (Within 500 words)
              </h1>
              <button
