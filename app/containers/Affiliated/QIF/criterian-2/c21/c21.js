          ...
          <div className="c21x-container">
            <div className="c21x-heading_Help-container">
              ...
              <HelpButton
                ...
                title='percentage'
                ><h1>((Total number of students admitted during last five years)/
                  Total number of sanctioned seatsduring last five years) * 100</h1></HelpButton>
            </div>
          ...
          <div className="c21x-container">
            <div className="c21x-heading_Help-container">
              <h1 className="c21x-heading-style">
                ...
                Percentage of seats filled against seats reserved for various categories (SC, ST, OBC, Divyangjan, etc. as per applicable reservation policy during the last 
                five years ( exclusive of supernumerary seats)
              </h1>
              <button
              ...
              title='percentage'>
                <h1>((Total number of actual students admitted from the reserved categories during last five years)/Total number of seats earmarked for reserved category as 
                  per GOI/State Govt ruleduring last five years) * 100</h1></HelpButton>
            </div>
            <div className="c21x-response-container">
              <button
                onClick={(e) => {
