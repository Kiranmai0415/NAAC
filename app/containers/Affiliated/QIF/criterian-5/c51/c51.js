...
function Criteria51() {
        ...
        parseInt (value5111t7 ,10)+
          parseInt (value5111t8 ,10)+ 
            parseInt (value5111t9 ,10)+ 
              parseInt (value5111t10 ,10))/ viewResponseValue)*100
  ...
  function onClickingViewResponse513() {
    if (
      ...
      setResponseValue513(
        ((parseInt(value5131t6 ,10)+
         parseInt (value5131t7 ,10)+
         parseInt(value5131t8 ,10)+
         parseInt (value5131t9 ,10)+
         parseInt (value5131t10 ,10)) / viewResponseValue)*100
...
useEffect(
  () => fetch(resources.APPLICATION_URL+'viewResponseValueAffiliated511?collegeId='+collegeId+'&financialYear='+fYear+'&typeofInstitution='+instituteType).then(
    (response) => response
      .json()
      .then((data) => {
        console.log("response value is from backend511==>"+JSON.stringify(data));
...
useEffect(
  () => fetch(resources.APPLICATION_URL+'viewResponseValueAffiliated513?collegeId='+collegeId+'&financialYear='+fYear+'&typeofInstitution='+instituteType).then(
    (response) => response
      .json()
      .then((data) => {
        console.log("response value is from backend513==>"+JSON.stringify(data));
        setViewResponseValue(data);
      })
      .catch((error) => {
        console.error('Error:', error);
          ...
          <div className="c51x-container">
            <div className="c51x-heading_Help-container">
              ...
              <HelpButton
                ...
                title='percentage'
                ><h1>(Total number of students benefited by scholarships and freeships provided by Government and Non Government agencies and philanthropistsTotal number of students during the last five years) * 100</h1></HelpButton>
            </div>
          ...
          <div className="c51x-container">
            <div className="c51x-heading_Help-container">
              <h1 className="c51x-heading-style">
                ...
                Percentage of students benefitted by guidance for competitive examinations and career counselling 
                offered by the Institution duringthe last five years
              </h1>
              <button
              ...
              <HelpButton
                ...
                title='percentage'
                ><h1>Total number of students benefited by guidance for competitive examinations and career counselingduring the last five yearsTotal number of students during the last five years * 100</h1></HelpButton>
            </div>
            <div className="c51x-response-container">
              <button
                onClick={(e) => {
          ...
          <div className="c51x-container">
            <div className="c51x-heading_Help-container">
              ...
              <HelpButton
                isOpen={isOpen2}
                handleClose={handleHelpClose2}
                title='file discription'></HelpButton>
            </div>
          </div>
          <table className="c51x-table-style">
            <tr>
