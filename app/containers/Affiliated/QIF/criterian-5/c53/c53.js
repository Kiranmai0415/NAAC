  ...
  function onClickingViewResponse531() {
    if (
      ...
      setResponseValue531(
        ...
        ((parseInt(value5311t6 ,10)+
        parseInt (value5311t7 ,10)+
        parseInt(value5311t8 ,10)+
        parseInt (value5311t9 ,10)+
        parseInt (value5311t10 ,10)) / viewResponseValue)*100
  ...
  function onClickingViewResponse532() {
    if (
      ...
      setResponseValue532(
        ...
        ((parseInt(value5321t6 ,10)+
        parseInt (value5321t7 ,10)+
        parseInt(value5321t8 ,10)+
        parseInt (value5321t9 ,10)+
        parseInt (value5311t10 ,10)) / viewResponseValue)*100
          ...
          <div className="c53x-container">
            <div className="c53x-heading_Help-container">
              <h1 className="c53x-heading-style">
                ...
                Average number of sports and cultural events/competitions in which students of the Institution participated during last five years(organised by
                 the institution/other institutions)
              </h1>
              <button
