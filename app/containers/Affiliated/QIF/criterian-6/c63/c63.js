...
function Criteria63() {
  ...
  const inputDataList = {
    ...
    //   {
    //     criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType},          
    //     uniqueKey1: 101, input6332y: value6331t1, input6332v: value6331t6
    //   },
    //   {
    //     criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType},          
    //     uniqueKey1: 102, input6332y: value6331t2, input6331v: value6331t7
    //   },
    //   {
    //     criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType},          
    //     uniqueKey1: 103, input6332y: value6331t3, input6331v: value6331t8
    //   },
    //   {
    //     criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType},          
    //     uniqueKey1: 104, input6332y: value6331t4, input6331v: value6331t9
    //   },
    //   {
    //     criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType},          
    //     uniqueKey1: 105, input6332y: value6331t5, input6331v: value6331t10
    //   },
    // ],
    affiliated_YearTable6332: [
      {
  ...
  useEffect(
    () => fetch(resources.APPLICATION_URL+'viewResponseValueAffiliated632?collegeId='+collegeId+'&financialYear='+fYear+'&typeofInstitution='+instituteType).then(
      (response) => response
        .json()
        .then((data) => {
      ...
      setResponseValue632(
       ( (parseInt(value6321t6, 10)+
          ...
          parseInt(value6321t9, 10)+
           parseInt(value6321t10, 10))/ viewResponseValue)*100
  ...
  function onClickingViewResponse633() {
    if (
      ...
      || value6331t16 === undefined
      || value6331t17 === undefined
      || value6331t18 === undefined
      || value6331t19 === undefined
      || value6331t20 === undefined
    ) {
      ...
      || Number.isInteger(parseInt(value6331t16, 10)) === false
      || Number.isInteger(parseInt(value6331t17, 10)) === false
      || Number.isInteger(parseInt(value6331t18, 10)) === false
      || Number.isInteger(parseInt(value6331t19, 10)) === false
      || Number.isInteger(parseInt(value6331t20, 10)) === false
    ) {
      ...
      setResponseValue633(
        (parseInt(value6331t6, 10)
          ...
          + parseInt(value6331t10, 10))/
           (parseInt(value6331t16, 10)
          + parseInt(value6331t17, 10)
          + parseInt(value6331t18, 10)
          + parseInt(value6331t19, 10)
          + parseInt(value6331t20, 10))*100
      );
    }
  }
  // function onClickingViewResponse633() {
  ...
  return (
    <div className="c63-inputFields-mainContainer">
      ...
      <div className="c63x-eachInputField-container">
        <div className="c63x-weightage-container">
          <h1 className="c63x-weightage-heading-style">Weightage: 12</h1>
        </div>
        <form>
          <div className="c63x-container">
            <div className="c63x-heading_Help-container">
              <h1 className="c63x-heading-style">
                ...
                Percentage of teachers provided with financial support to attend conferences/workshops and towards membership fee of professional 
              ...
              title='percentage'>
                <h1> (Total number of teachers provided with financial support during the last five yearsTotal number of full time teachers year wise during the last five years ) * 100</h1>
              </HelpButton>
            </div>
        ...
        <form>
          <div className="c63x-container">
            <div className="c63x-heading_Help-container">
              <h1 className="c63x-heading-style">
               ...
               Percentage of teaching and non teaching staff participating in Faculty Development Programmes (FDP), professional
               development/administrative trainning programmes during the last five years
              </h1>
              <button
                onClick={handleHelpOpen2}
                className="c14x-helpButton-style"
          ...
          <div className="c63xx-container">
            <h1 className="c63xx-Heading-style">
             ...
             Total Number of teaching and non teaching staff participating in Faculty Development Programmes (FDP), professional
               development/administrative trainning programmes during the last five years
            </h1>
            ...
            <h1 className="c63xx-Heading-style">
             ...
             Number of non teaching staff year-wise During the last five years
            </h1>
            <table className="c63x-Qt-table-style">
              <tr>
                <th className="c63x-horizontalTable-heading-style">Year</th>
