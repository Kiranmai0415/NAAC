...
function Criteria41() {
  ...
  function onClickingViewResponse412() {
    ...
    //   && value4121t20 !== ''
      ...
      setResponseValue412(
       ( (parseInt(value4121t6 ,10)+
        parseInt (value4121t7 ,10)+
        parseInt (value4121t8 ,10) +
        parseInt(value4121t9  ,10)+
        parseInt (value4121t10 ,10))/ viewResponseValue)*100
 ...
 const financialYear="2021-2022";
  ...
  criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType},          
    ...
    affiliatedYearTable4121: [
      {
        criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType},          
        uniqueKey1: 101, input4121y: value4121t1, input4121v: value4121t6
      },
      {
        criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType},          
        uniqueKey1: 102, input4121y: value4121t2, input4121v: value4121t7
      },
      {
        criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType},          
        uniqueKey1: 103, input4121y: value4121t3, input4121v: value4121t8
      },
      {
        criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType},          
        uniqueKey1: 104, input4121y: value4121t4, input4121v: value4121t9
      },
      {
        criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType},          
        uniqueKey1: 105, input4121y: value4121t5, input4121v: value4121t10
      },
    ],
    // affiliatedYearTable41212: [
    //   {
    //     criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType},          
    //     uniqueKey1: 101, input41212y: value4121t11, input41212v: value4121t16
    //   },
    //   {
    //     criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType},          
    //     uniqueKey1: 102, input41212y: value4121t12, input41212v: value4121t17
    //   },
    //   {
    //     criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType},          
    //     uniqueKey1: 103, input41212y: value4121t13, input41212v: value4121t18
    //   },
    //   {
    //     criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType},          
    //     uniqueKey1: 104, input41212y: value4121t14, input41212v: value4121t19
    //   },
    //   {
    //     criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType},          
    //     uniqueKey1: 105, input41212y: value4121t15, input41212v: value4121t20
    //   },
    // ],
  };
  ...
  useEffect(
    () => fetch(resources.APPLICATION_URL+'viewResponseValueAffiliated412?collegeId='+collegeId+'&financialYear='+fYear+'&typeofInstitution='+instituteType).then(
      (response) => response
        .json()
        .then((data) => {
          ...
          <div className="c41x-Ql-label-textarea-container">
            <div className="c41x-heading_Help-container">
              <h1 className="c41x-heading-style">
                ...
                classrooms, laboratories, ICT facilities, cultural activities, gymnasium, 
                yoga centre etc. in the institution
              </h1>
              <button
          ...
          <div className="c41x-container">
            <div className="c41x-heading_Help-container">
              ...
              <HelpButton
                ...
                augmentation, excluding salary)/Total Expenditure excluding salary) * 100</h1></HelpButton>
            </div>
          ...
          <div className="c41xx-container">
            ...
            <table className="c41x-table-style">
              ...
              <tr>
                ...
                <td><a href={downloadFile("af4.1.2.xlsx")} target="_blank">View Template</a></td>
                <td>
                  <input
                    onChange={(e) => {
