...
function BasicInfo() {
  ...
  useEffect(
    () => fetch(
      resources.APPLICATION_URL+'getallacademicdata?collegeId='+collegeId+'&financialYear='+fYear+'&typeofInstitution='+instituteType,
  ...
  const authorize = {
    ...
    assignedTo: "deeepk@adiversetech.com",
    assignedBy: email,
