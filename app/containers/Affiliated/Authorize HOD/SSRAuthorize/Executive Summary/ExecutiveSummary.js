...
function ExecutiveSummary() {
  ...
  useEffect(
    () => fetch(
      resources.APPLICATION_URL+'getallexecutivedata?collegeId='+collegeId+'&financialYear='+fYear+'&typeofInstitution='+instituteType,
  ...
  function getRejectExecutive() {
    ...
    fetch(
      resources.APPLICATION_URL
        + 'evaluativeDeanRejectRecord?collegeId='+collegeId+'&financialYear='+fYear+'&typeofInstitution='+instituteType,
      rejectAPImethod
    ).then((response) => {
      console.log(response);
      if (response.ok) {
