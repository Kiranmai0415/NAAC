...
import Criteria61 from './ViewHOD/CriteriaView-6/cV61/c61';
import Criteria62 from './ViewHOD/CriteriaView-6/cV62/c62';
import Criteria63 from './ViewHOD/CriteriaView-6/cV63/c63';
import Criteria64 from './ViewHOD/CriteriaView-6/cV64/c64';
import Criteria65 from './ViewHOD/CriteriaView-6/cV65/c65';
import {
  AssignPopup6,
  AssignPopup61,
  AssignPopup62,
...
function Criteria6() {
  ...
  function onClickingSaveSendingTexts() {
    ...
    fetch(
      resources.APPLICATION_URL + 'criteria6submittoprincipal?collegeId='+collegeId+'&financialYear='+fYear+'&typeofInstitution='+instituteType,
      authorizeAPImethod
    ).then((response) => {
      console.log(response);
      if (response.ok) {
