...
function onClickingAssign6() {
  ...
  fetch(resources.APPLICATION_URL+'AssignC1Email', methodAssign6).then(
...
function onClickingAssign61() {
  ...
  fetch(resources.APPLICATION_URL+'AssignC1Email', methodAssign61).then(
    (response) => console.log(response)
  );
}
function onClickingAssign62() {
  ...
  fetch(resources.APPLICATION_URL+'AssignC1Email', methodAssign62).then(
    (response) => console.log(response)
  );
}
function onClickingAssign63() {
  ...
  fetch(resources.APPLICATION_URL+'AssignC1Email', methodAssign63).then(
    (response) => console.log(response)
  );
}
function onClickingAssign64() {
  ...
  fetch(resources.APPLICATION_URL+'AssignC1Email', methodAssign64).then(
    (response) => console.log(response)
  );
}
function onClickingAssign65() {
  ...
  fetch(resources.APPLICATION_URL+'AssignC1Email', methodAssign65).then(
    (response) => console.log(response)
  );
}
