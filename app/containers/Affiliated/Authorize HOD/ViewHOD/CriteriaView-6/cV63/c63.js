      ...
      fetch(
        ...
        response
          ...
          .then((data) => {
            ...
            setValue6321t16(data[0].yearTable63212[0]?data[0].yearTable63212[0].input6321v:"");
            setValue6321t17(data[0].yearTable63212[1]?data[0].yearTable63212[1].input6321v:"");
            setValue6321t18(data[0].yearTable63212[2]?data[0].yearTable63212[2].input6321v:"");
            setValue6321t19(data[0].yearTable63212[3]?data[0].yearTable63212[3].input6321v:"");
            setValue6321t20(data[0].yearTable63212[4]?data[0].yearTable63212[4].input6321v:"");

            setValue6331t1(data[0].yearTable6331[0]?data[0].yearTable6331[0].input6331y:"");
            setValue6331t2(data[0].yearTable6331[1]?data[0].yearTable6331[0].input6331y:"");
            setValue6331t3(data[0].yearTable6331[2]?data[0].yearTable6331[0].input6331y:"");
            setValue6331t4(data[0].yearTable6331[3]?data[0].yearTable6331[0].input6331y:"");
            setValue6331t5(data[0].yearTable6331[4]?data[0].yearTable6331[0].input6331y:"");
            setValue6331t6(data[0].yearTable6331[0]?data[0].yearTable6331[0].input6331v:"");
            setValue6331t7(data[0].yearTable6331[1]?data[0].yearTable6331[0].input6331v:"");
            setValue6331t8(data[0].yearTable6331[2]?data[0].yearTable6331[0].input6331v:"");
            setValue6331t9(data[0].yearTable6331[3]?data[0].yearTable6331[0].input6331v:"");
            setValue6331t10(data[0].yearTable6331[4]?data[0].yearTable6331[0].input6331v:"");

            setValue6331t11(data[0].affiliated_YearTable6332[0]?data[0].affiliated_YearTable6332[0].input6332y:"");
            setValue6331t12(data[0].affiliated_YearTable6332[1]?data[0].affiliated_YearTable6332[0].input6332y:"");
            setValue6331t13(data[0].affiliated_YearTable6332[2]?data[0].affiliated_YearTable6332[0].input6332y:"");
            setValue6331t14(data[0].affiliated_YearTable6332[3]?data[0].affiliated_YearTable6332[0].input6332y:"");
            setValue6331t15(data[0].affiliated_YearTable6332[4]?data[0].affiliated_YearTable6332[0].input6332y:"");
            setValue6331t16(data[0].affiliated_YearTable6332[0]?data[0].affiliated_YearTable6332[0].input6332v:"");
            setValue6331t17(data[0].affiliated_YearTable6332[1]?data[0].affiliated_YearTable6332[0].input6332v:"");
            setValue6331t18(data[0].affiliated_YearTable6332[2]?data[0].affiliated_YearTable6332[0].input6332v:"");
            setValue6331t19(data[0].affiliated_YearTable6332[3]?data[0].affiliated_YearTable6332[0].input6332v:"");
            setValue6331t20(data[0].affiliated_YearTable6332[4]?data[0].affiliated_YearTable6332[0].input6332v:"");
    ...
    affiliated_YearTable6332: [
      {
        ...
        uniqueKey1: 101,
        input6332y: value6331t11,
        input6332v: value6331t16,
      },
      {
        criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType},

        uniqueKey1: 102,
        input6332y: value6331t12,
        input6332v: value6331t17,
      },
      {
        criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType},

        uniqueKey1: 103,
        input6332y: value6331t13,
        input6332v: value6331t18,
      },
      {
        criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType},

        uniqueKey1: 104,
        input6332y: value6331t14,
        input6332v: value6331t19,
      },
      {
        criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType},

        uniqueKey1: 105,
        input6332y: value6331t15,
        input6332v: value6331t20,
      },
    ],
  };
          ...
          <div className="c63x-Ql-label-textarea-container">
            <div className="c63x-heading_Help-container">
              <h1 className="c63x-heading-style">
                ...
                The institution has effective welfare measures and Performance Appraisal System
      ...
      bodies year wise during the last five years
            ...
            <table className="c63x-table-style">
              ...
              <tr>
                ...
                <td><a href={downloadFile("af6.3.2.xlsx")} target="_blank">view template</a></td>
                <td>
                  <input
                    readOnly
                    onChange={(e) => {
          ...
          <div className="c63x-container">
            <div className="c63x-heading_Help-container">
              <h1 className="c63x-heading-style">
                ...
                Percentage of teaching and non-teaching staff participating in Faculty development Programmes (FDP), professional development /administrative 
              ...
              <HelpButton
                ...
                title='percentage'
               ><h1>(Total number of teaching and non teaching staff participating in FDPs,professional development Programmes during the last five years)/(Total number of full time teachers year wise during the last five years+total number of non teaching staff during the last five years) * 100</h1></HelpButton>
            </div>
            <div className="c63x-response-container">
              <button
                onClick={(e) => {
          ...
          <div className="c63xx-container">
            ...
            <table className="c63x-table-style">
              ...
              <tr>
                ...
                <td>
                <a href={downloadFile("af6.3.3.xlsx")} target="_blank">
                    View Template
                  </a>
                </td>
                <td>
