    ...
    affiliatedYearTable1221: [
      {
        ...
        uniqueKey1: 101,
        input1221y: value1221t1,
        input1221v: value1221t6,
      },
      {
        criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType},

        uniqueKey1: 102,
        input1221y: value1221t2,
        input1221v: value1221t7,
      },
      {
        criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType},

        uniqueKey1: 103,
        input1221y: value1221t3,
        input1221v: value1221t8,
      },
      {
        criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType},

        uniqueKey1: 104,
        input1221y: value1221t4,
        input1221v: value1221t9,
      },
      {
        criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType},

        uniqueKey1: 105,
        input1221y: value1221t5,
        input1221v: value1221t10,
      },
    ],
  };
      ...
      <div className="c12x-eachInputField-container">
        ...
        <form>
          <div className="c12x-container">
            <div className="c12x-heading_Help-container">
              <h1 className="c12x-heading-style">
                ...
                Number of Add on /Certificate/Value added programs offered and 
             online MOOC programs like SWAYAM, NPTEL etc. where the 
             students of the institution have benefitted during the last five years
              </h1>
              <button
          ...
          <div className="c12xx-container">
            ...
            {/* <h1 className="c12xx-Heading-style">
              <span className="c12xx-span-style">
                1.2.1.2: Number of Add on /Certificate /Value added programs
            ...
            <table className="c12x-table-style">
              ...
              <tr>
                ...
                <td><a href={downloadFile("af1.2.1.xlsx")} target="_blank">view Template</a></td>
                <td>
                   <input readOnly
                    onChange={(e) => {
          ...
          <div className="c12xx-container">
            <h1 className="c12xx-Heading-style">
              ...
              Number of students enrolled in subject related Certificate/
                 Add-on/Value added programs and also completed online 
              MOOC programs like SWAYAM, NPTEL etc. year wise during last five 
                 years
            </h1>
