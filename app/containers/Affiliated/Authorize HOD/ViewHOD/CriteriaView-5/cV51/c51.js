    ...
    affiliatedYearTable5131: [
      {
        ...
        uniqueKey1: 101,
        input5131y: value5131t1,
        input5131v: value5131t6,
      },
      {
        criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType},

        uniqueKey1: 102,
        input5131y: value5131t2,
        input5131v: value5131t7,
      },
      {
        criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType},

        uniqueKey1: 103,
        input5131y: value5131t3,
        input5131v: value5131t8,
      },
      {
        criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType},

        uniqueKey1: 104,
        input5131y: value5131t4,
        input5131v: value5131t9,
      },
      {    criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType},

        uniqueKey1: 105,
        input5131y: value5131t5,
        input5131v: value5131t10,
      },
    ],
    ...
    yearTable51312: [
      {
        ...
        uniqueKey1: 101,
        input51312y: value5131t11,
        input51312v: value5131t16,
      },
      {
        criteriaId: {
          collegeId: "1",
        ...
        uniqueKey1: 102,
        input51312y: value5131t12,
        input51312v: value5131t17,
      },
      {
        criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType},

        uniqueKey1: 103,
        input51312y: value5131t13,
        input51312v: value5131t18,
      },
      {
        criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType},

        uniqueKey1: 104,
        input51312y: value5131t14,
        input51312v: value5131t19,
      },
      {
        criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType},

        uniqueKey1: 105,
        input51312y: value5131t15,
        input51312v: value5131t20,
      },
    ],
  };
        ...
        <form>
          <div className="c51x-container">
            <div className="c51x-heading_Help-container">
              <h1 className="c51x-heading-style">
                ...
                by the Government and Non-Government agencies and philanthropists
              ...
              <HelpButton
                ...
                title='formula'
                ><h1>((Total number of students benefited by scholarships and freeships provided by Government and Non−Government agencies and philanthropists)/(Total number of students during the last five years)) * 100
                  </h1></HelpButton>
            </div>
          ...
          <div className="c51xx-container">
            <h1 className="c51x-heading-style">
              ...
              Number of students benefited by scholarships and freeships provided
            by the Government and Non-Government agencies and philanthropists year
            ...
            <table className="c51x-table-style">
              ...
              <tr>
                ...
                <td>
                <a href={downloadFile("af5.1.1.xlsx")} target="_blank">
                    View Template
                  </a>
                </td>
                <td>
        ...
        <form>
          ...
          <table className="c51x-table-style">
            ...
            <tr>
              ...
              <td>
              <a href={downloadFile("af5.1.2.xlsx")} target="_blank">
                  View Template
                </a>
              </td>
              <td>
            ...
            <div className="c51x-heading_Help-container">
             ...
             the last five years
              ...
              <HelpButton
                ...
                handleClose={handleHelpClose}
                title='formula'
                >(Total number of students benefited by guidance for competitive examinations and career counselingduring the last five years) / (Total number of students during the last five years) * 100</HelpButton>
            </div>
            <div className="c51x-response-container">
              <button
                onClick={(e) => {
          ...
          <div className="c51xx-container">
            ...
            <table className="c51x-table-style">
              ...
              <tr>
                ...
                <td>
                <a href={downloadFile("af5.1.3.xlsx")} target="_blank">View Template</a>
                </td>
                <td>
                  <input
                    readOnly
