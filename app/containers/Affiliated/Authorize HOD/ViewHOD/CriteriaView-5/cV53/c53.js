    ...
    affiliatedYearTable5321: [
      {
        ...
        uniqueKey1: 101,
        input5321y: value5321t1,
        input5321v: value5321t6,
      },
      {
        criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType},

        uniqueKey1: 102,
        input5321y: value5321t2,
        input5321v: value5321t7,
      },
      {
        criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType},

        uniqueKey1: 103,
        input5321y: value5321t3,
        input5321v: value5321t8,
      },
      {
        criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType},

        uniqueKey1: 104,
        input5321y: value5321t4,
        input5321v: value5321t9,
      },
      {
        criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType},

        uniqueKey1: 105,
        input5321y: value5321t5,
        input5321v: value5321t10,
      },
    ],
  };
          ...
          <div className="c53xx-container">
            ...
            <table className="c53x-table-style">
              ...
              <tr>
                ...
                <td>
                <a href={downloadFile("af5.3.1.xlsx")} target="_blank">
                    View Template
                  </a>
                </td>
                <td>
          ...
          <div className="c53x-container">
            <div className="c53x-heading_Help-container">
              ...
              <HelpButton
                ...
                handleClose={handleHelpClose}
                title='percentage'
                ><h1>Total number of sports and cultural events/ competitions in which students of the Institution participated during the last five yearsNumber of years in the assessment period</h1></HelpButton>
            </div>
            <div className="c53x-response-container">
              <button
                onClick={(e) => {
                  e.preventDefault();
                  setResponseButtonStatus532(!responseButtonStatus532);
                  onClickingViewResponse532();
                }}
                className="c53x-responseButton-style"
              >
                View Response
          ...
          <div className="c53xx-container">
                ...
                <td>
                  ...
                  >
                    <input
                      readOnly
                      onChange={(e) => {
                        setValue5321t10(e.target.value);
                        onClickingViewResponse532();
                      }}
                      id="5321-t10"
                      className="c52x-input-style"
            ...
            <table className="c53x-table-style">
              ...
              <tr>
                ...
                <td>
                <a href={downloadFile("af5.3.2.xlsx")} target="_blank">
                    View Template
                  </a>
                </td>
                <td>
