      ...
      fetch(
        ...
        response
          ...
          .then((data) => {
            ...
            setValue221t1(data[0].criteria22Qn[1]?data[0].criteria22Qn[1].input221t1:"");
            setValue221t2(data[0].criteria22Qn[1]?data[0].criteria22Qn[1].input221t2:"");
        ...
        <form>
          <div className="c22x-container">
            <div className="c22x-heading_Help-container">
              ...
              <HelpButton
                ...
                title='Formula:'
                ><h1> Students: Full time teacher</h1></HelpButton>
            </div>
          ...
          <div className="c22xx-container">
            <h1 className="c22xx-Heading-style">
              <span className="c22xx-span-style">
