...
function Criteria26() {
  ...
  return (
    <div className="c26-inputFields-mainContainer">
      ...
      <div className="c26x-eachInputField-container">
        <div className="c26x-weightage-container">
          <h1 className="c26x-weightage-heading-style">Weightage: 45</h1>
        </div>
        <form>
          <div className="c26x-container">
            <div className="c26x-heading_Help-container">
              ...
              <HelpButton
                ...
                handleClose={handleHelpClose}
                title='percentage'
                ><h1>(Total number of final year students who passed the university examination / Total number of final year students who appeared for the university examination) * 100</h1></HelpButton>
            </div>
          ...
          <div className="c26xx-container">
            ...
            <table className="c26x-table-style">
              ...
              <tr>
                ...
                <td>
                <a href={downloadFile("af2.6.2.xlsx")} target="_blank">
                    View Template
                  </a>
                </td>
                <td>
                ...
                <td>
                  <input
                    ...
                    onChange={(e) => {
                      ...
                      setPathValue2622f3(e.target.value);
                      showFilePreview(e);
                    }}
                    id="2622-f3"
                    className="c26-fileButton-style"
