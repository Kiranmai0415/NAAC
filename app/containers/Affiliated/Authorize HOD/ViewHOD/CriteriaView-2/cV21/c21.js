...
function Criteria21() {
 ...
 const handleHelpClose = () => {
  ...
  useEffect(
    () =>
      fetch(
        resources.APPLICATION_URL+'criteria2getallfiles?collegeId='+collegeId+'&financialYear='+fYear+'&typeofInstitution='+instituteType,
      ).then((response) =>
        response
          .json()
          .then((data) => {
        ...
        <form>
          <div className="c21x-container">
            <div className="c21x-heading_Help-container">
              ...
              <HelpButton
                ...
                title='percentage'
                ><h1>(Total number of students admitted during last five years / Total number of sanctioned seatsduring last five years) * 100</h1></HelpButton>
            </div>
          ...
          <div className="c21xx-container">
            ...
            <table className="c21x-table-style">
              ...
              <tr>
                <td>
                  Institutional data in the prescribed format (template merged
                  with 2.1.2)
                </td>
                <td>
                <a href={downloadFile("af2.1.1.xlsx")} target="_blank">
                    View Template
                  </a>
                </td>
                <td>
          ...
          <div className="c21x-container">
            <div className="c21x-heading_Help-container">
              ...
              <HelpButton
                ...
                handleClose={handleHelpClose}
                title='percentage'
                > <h1>(Total number of actual students admitted from the reserved categories during last five years / Total number of seats earmarked for reserved category as per GOI/State Govt ruleduring last five years) * 100</h1></HelpButton>
            </div>
            <div className="c21x-response-container">
              <button
                onClick={(e) => {
          ...
          <div className="c21xx-container">
            ...
            <table className="c21x-table-style">
              ...
              <tr>
                ...
                <td>
                <a href={downloadFile("af2.1.2.xlsx")} target="_blank">
                    View Template
                  </a>
                </td>
                <td>
