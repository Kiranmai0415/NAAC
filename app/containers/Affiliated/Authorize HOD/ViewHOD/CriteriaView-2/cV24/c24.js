      ...
      fetch(
        ...
        response
          ...
          .then((data) => {
            ...
            // setValue241t21(data[0].criteria24Qn[0].input241t21);
    ...
    yearTable24112: [
      {
        ...
        uniqueKey1: 101,
        input24112y: value241t1,
        input24112v: value241t6,
      },
      {
        criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType},

        uniqueKey1: 102,
        input24112y: value241t2,
        input24112v: value241t7,
      },
      {
        criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType},

        uniqueKey1: 103,
        input24112y: value241t3,
        input24112v: value241t8,
      },
      {
        criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType},

        uniqueKey1: 104,
        input24112y: value241t4,
        input24112v: value241t9,
      },
      {
        criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType},

        uniqueKey1: 105,
        input24112y: value241t5,
        input24112v: value241t10,
      },
    ],
    yearTable2421: [
      {
          ...
          <div className="c24x-container">
            <div className="c24x-heading_Help-container">
              <h1 className="c24x-heading-style">
                ...
                Percentage of full-time teachers against sanctioned posts during
                the last five years
              </h1>
              <button
              ...
              <HelpButton
                ...
                title='percentage'
                ><h1>(Total number of full time teachers year wise during the last five yearsTotal number of Sanctioned posts/required positions for full time teachers) * 100</h1></HelpButton>
            </div>
          ...
          <div className="c24xx-container">
            ...
            <table className="c24x-table-style">
              ...
              <tr>
                ...
                <td>
                  {/* <a href="http://localhost:8080/api/v1/download/criteria2.4.1.-2.4.3.xlsx">
                    View Template
                  </a> */}
                </td>
                <td>
        ...
        <form>
          <div className="c24x-container">
            <div className="c24x-heading_Help-container">
              <h1 className="c24x-heading-style">
                ...
                D.M. / M.Ch. / D.N.B Superspeciality / D.Sc. / D.Litt. during
                the last five years (consider only highest degree for count)
              </h1>
              <button
                onClick={handleHelpOpen}
              ...
              <HelpButton
                ...
                handleClose={handleHelpClose}
                title='percentage'
                ><h1>(Total number of full time teachers with such qualifications during last five years / Total number of full time teachers year wise during last five years) * 100</h1></HelpButton>
            </div>
            <div className="c24x-response-container">
              <button
                onClick={(e) => {
          ...
          <div className="c24xx-container">
            <h1 className="c24xx-Heading-style">
              ...
              Number of full time teachers with NET/SET/SLET/Ph. D. / D.M. /
              M.Ch. / D.N.B Superspeciality / D.Sc. / D.Litt. year wise during
              the last five years
            </h1>
            <h1 className="c24xx-Heading-style">
              <span className="c24xx-span-style">A: </span>
              Total number of full time teachers with such qualifications during
              last five years
            </h1>
            <table className="c24x-Qt-table-style">
              <tr>
            ...
            <h1 className="c24xx-Heading-style">
              ...
              Total number of full time teachers year wise during last five
              years
            </h1>
            <table className="c24x-Qt-table-style">
              <tr>
