    ...
    affiliatedYearTable3111: [
      {
        ...
        uniqueKey1: 101,
        input3111y: value3111t1,
        input3111v: value3111t6,
      },
      {    criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType},

        uniqueKey1: 102,
        input3111y: value3111t2,
        input3111v: value3111t7,
      },
      {
        criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType},

        uniqueKey1: 103,
        input3111y: value3111t3,
        input3111v: value3111t8,
      },
      {
        criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType},

        uniqueKey1: 104,
        input3111y: value3111t4,
        input3111v: value3111t9,
      },
      {
        criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType},

        uniqueKey1: 105,
        input3111y: value3111t5,
        input3111v: value3111t10,
      },
    ],
  };
          ...
          <div className="c32xx-container">
            ...
            <table className="c32x-Qt-table-style">
              ...
              <tr>
                ...
                <td>
                  <a href={downloadFile("criteria3.2.1.xlsx")}>
                    View Template
                  </a>
                </td>
                <td className="c32x-Qt-tableBorders-style">
