      ...
      fetch(
        ...
        response
          ...
          .then((data) => {
            ...
            setValue3321t11(data[0].criteria33Qn[0]?data[0].criteria33Qn[0].input3321t11:"");
            ...
            setValue3311t7(data[0].affiliatedYearTable3311[1]?ata[0].affiliatedYearTable3311[1].input3311v:"");
    ...
    affiliatedYearTable3311: [
      {
        ...
        uniqueKey1: 101,
        input3311y: value3311t1,
        input3311v: value3311t6,
      },
      {
        criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType},

        uniqueKey1: 102,
        input3311y: value3311t2,
        input3311v: value3311t7,
      },
      {
        criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType},

        uniqueKey1: 103,
        input3311y: value3311t3,
        input3311v: value3311t8,
      },
      {
        criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType},

        uniqueKey1: 104,
        input3311y: value3311t4,
        input3311v: value3311t9,
      },
      {
        criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType},

        uniqueKey1: 105,
        input3311y: value3311t5,
        input3311v: value3311t10,
      },
    ],
    yearTable3321: [
      {
          ...
          <div className="c33x-container">
            <div className="c33x-heading_Help-container">
              ...
              <HelpButton
                ...
                title='formula'
                ><h1>(Total number of research papers in the Journals notified on UGC CARE )/(Number of full time teachers during the last five years (without repeat count))
                  </h1></HelpButton>
            </div>
          ...
          <div className="c33xx-container">
            ...
            <table className="c33x-table-style">
              ...
              <tr>
                ...
                <td>
                <a href={downloadFile("af3.3.1.xlsx")} target="_blank">
                    View Template
                  </a>
                </td>
                <td>
          ...
          <div className="c33x-container">
            <div className="c33x-heading_Help-container">
              ...
              <HelpButton
                ...
                handleClose={handleHelpClose}
                title='formula'
                ><h1>(Total number of books and chapters in edited volumes/books published and papers in national/international conference proceedings)/(Number of full time teachers during the last five years (without repeat count))</h1></HelpButton>
            </div>
            <div className="c33x-response-container">
              <button
                onClick={(e) => {
          ...
          <div className="c33xx-container">
            ...
            <table className="c33x-table-style">
              ...
              <tr>
                ...
                <td>
                <a href={downloadFile("af3.3.2.xlsx")} target="_blank">
                    View Template
                  </a>
                </td>
                <td>
