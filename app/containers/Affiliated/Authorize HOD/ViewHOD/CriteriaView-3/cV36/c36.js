...
function Criteria36() {
  ...
  const [gradePointsClickStatus361, setGradePointsClickStatus361] =
    useState(false);

  const [gradeScale362, setGradeScale362] = useState("");
  const [gradePoints362, setGradePoints362] = useState();
  const [gradeScaleClickStatus362, setGradeScaleClickStatus362] =
    useState(false);
  const [gradePointsClickStatus362, setGradePointsClickStatus362] =
    useState(false);

  const [gradeScale363, setGradeScale363] = useState("");
  const [gradePoints363, setGradePoints363] = useState();
  const [gradeScaleClickStatus363, setGradeScaleClickStatus363] =
    useState(false);
  const [gradePointsClickStatus363, setGradePointsClickStatus363] =
    useState(false);

  const [gradeScale364, setGradeScale364] = useState("");
  const [gradePoints364, setGradePoints364] = useState();
  const [gradeScaleClickStatus364, setGradeScaleClickStatus364] =
    useState(false);
  const [gradePointsClickStatus364, setGradePointsClickStatus364] =
    useState(false);
        ...
        (response) =>
          response
            ...
            .then((data) => {
              ...
              setValue3641t1(data[0].yearTable36412[0]?data[0].yearTable36412[0].input36412y:"");
          ...
          <table className="c36x-Ql-table-style">
            ...
            <tr>
              ...
              <td className="c36x-Ql-tableBorders-style">
                ...
                {/* <a href={downloadFile(value361f1)} target="_blank">View File</a> */}
              </td>
            ...
            <tr>
              ...
              <td>
                ...
                {/* <a href={downloadFile(value361f2)} target="_blank">View File</a> */}
              </td>
            ...
            <table className="c36x-table-style">
              ...
              <tr>
                ...
                <td>
                  ...
                  {/* <a href={downloadFile(value3621f1)} target="_blank">View File</a> */}
                </td>
                <td className="c36x-Qt-tableBorders-style">pdf</td>
              </tr>
              <tr>
                ...
                <td>
                  <a href={downloadFile("criteria3.6.2.xlsx")}>
                    View Template
                  </a>
                </td>
                <td>
                  ...
                  {/* <a href={downloadFile(value3621f2)} target="_blank">View File</a>
                   */}
                </td>
                <td className="c36x-Qt-tableBorders-style">pdf</td>
              </tr>
              <tr>
                ...
                <td>
                  ...
                  {/* <a href={downloadFile(value3621f3)} target="_blank">View File</a> */}
                </td>
                <td className="c36x-Qt-tableBorders-style">pdf</td>
              </tr>
            </table>
            ...
            <table className="c36x-table-style">
              ...
              <tr>
                ...
                <td>
                  ...
                  {/* <a href={downloadFile(value3631f1)} target="_blank">View File</a> */}
                </td>
                <td className="c36x-Qt-tableBorders-style">pdf</td>
              </tr>
              <tr>
                ...
                <td>
                  ...
                  {/* <a href={downloadFile(value3631f2)} target="_blank">View File</a> */}
                </td>
                <td className="c36x-Qt-tableBorders-style">pdf</td>
              </tr>
              <tr>
                ...
                <td>
                  ...
                  {/* <a href={downloadFile(value3631f3)} target="_blank">View File</a> */}
                </td>
                <td className="c36x-Qt-tableBorders-style">pdf</td>
              </tr>
            </table>
            ...
            <table className="c36x-table-style">
              ...
              <tr>
                ...
                <td>
                  ...
                  {/* <a href={downloadFile(value3641f1)} target="_blank">View File</a> */}
                </td>
                <td className="c36x-Qt-tableBorders-style">pdf</td>
              </tr>
              <tr>
                ...
                <td>
                  ...
                  {/* <a href={downloadFile(value3641f2)} target="_blank">View File</a>
                   */}
                </td>
                <td className="c36x-Qt-tableBorders-style">pdf</td>
              </tr>
              <tr>
                ...
                <td>
                  <a href={downloadFile("criteria3.6.4.xlsx")}>
                    View Template
                  </a>
                </td>
                <td>
                  ...
                  {/* <a href={downloadFile(value3641f3)} target="_blank">View File</a> */}
                </td>
                <td className="c36x-Qt-tableBorders-style">pdf</td>
              </tr>
            </table>
