...
import Criteria11 from "./ViewHOD/CriteriaView-1/cV11/c11";
import Criteria12 from "./ViewHOD/CriteriaView-1/cV12/c12";
import Criteria13 from "./ViewHOD/CriteriaView-1/cV13/c13";
import Criteria14 from "./ViewHOD/CriteriaView-1/cV14/c14";
import {
  AssignPopup1,
  AssignPopup11,
  AssignPopup12,
  ...
  function onClickingSaveSendingTexts() {
    ...
    fetch(
      resources.APPLICATION_URL
        + 'criteria1submittoprincipal?collegeId='+collegeId+'&financialYear='+fYear+'&typeofInstitution='+instituteType,
      authorizeAPImethod
    ).then((response) => {
      console.log(response);
      if (response.ok) {
