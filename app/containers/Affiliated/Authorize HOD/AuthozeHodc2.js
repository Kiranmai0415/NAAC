...
import Criteria21 from "./ViewHOD/CriteriaView-2/cV21/c21";
import Criteria22 from "./ViewHOD/CriteriaView-2/cV22/c22";
import Criteria23 from "./ViewHOD/CriteriaView-2/cV23/c23";
import Criteria24 from "./ViewHOD/CriteriaView-2/cV24/c24";
import Criteria25 from "./ViewHOD/CriteriaView-2/cV25/c25";
import Criteria26 from "./ViewHOD/CriteriaView-2/cV26/c26";
import Criteria27 from "./ViewHOD/CriteriaView-2/cV27/c27";
import {
  AssignPopup2,
  AssignPopup21,
  AssignPopup22,
  ...
  function onClickingSaveSendingTexts() {
    ...
    fetch(
      resources.APPLICATION_URL
        + 'criteria2submittoprincipal?collegeId='+collegeId+'&financialYear='+fYear+'&typeofInstitution='+instituteType,
      authorizeAPImethod
    ).then((response) => {
      console.log(response);
      if (response.ok) {
  ...
  return (
    <div className="c2-container">
      ...
      <div className="c2-heading-container">
        <h1 className="c2-heading-style">Teaching Learning and Evaluation (350)</h1>
        {/* <button
