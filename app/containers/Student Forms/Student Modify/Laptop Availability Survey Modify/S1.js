...
useEffect(
  ()=> 
  fetch(resources.APPLICATION_URL+"getalllaptopdata"
  ).then((response) => response.json()
  .then((data) => {
    console.log(JSON.stringify(data));
    setValues1t1(data[0].sf2t1);
    setValues1t2(data[0].sf2t2);
    setValues1t3(data[0].sf2t3);
    setValues1t4(data[0].sf2t4);
    setValues1t5(data[0].sf2t5);
    setValues1t6(data[0].sf2t6);
    setValues1t7(data[0].sf2t7);
    setValues1t8(data[0].sf2t8);
    setValues1t9(data[0].sf2t9);
    setValues1t10(data[0].sf2t10);
