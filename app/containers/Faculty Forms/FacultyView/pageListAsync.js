...
/* Faculty Modify*/
export const documentSubmission = loadable(() => import("./Faculty Forms/FacultyModify/Document Submission/F4"), {
  fallback: <Loading />,
});

export const eventDetails = loadable(() => import("./Faculty Forms/FacultyModify/Event Details/F5"), {
  fallback: <Loading />,
});

export const facultyDailyReport = loadable(() => import("./Faculty Forms/FacultyModify/Faculty Daily Report/F3"), {
  fallback: <Loading />,
});

export const facultyReport = loadable(() => import("./Faculty Forms/FacultyModify/Faculty Report/F2"), {
  fallback: <Loading />,
});

export const researchPublications = loadable(() => import("./Faculty Forms/FacultyModify/Research Publications/F6"), {
  fallback: <Loading />,
});

export const teachingAndLearningActivities = loadable(() => import("./Faculty Forms/FacultyModify/Teaching and learning activities/F1"), {
  fallback: <Loading />,
});
...
//   () => import("./Universities/Authorize HOD/IIQAView"),
//   {
//     fallback: <Loading />,
//   }
// );
...
//   () => import("./Universities/Authorize HOD/SSRView/Executive Summary/ExecutiveSummary"),
//   {
//     fallback: <Loading />,
//   }
// );
...
export const AdminFormEnquiry = loadable(
  () => import("./Admin Forms/Admission Enquiry Form/A1"),
  {
    fallback: <Loading />,
  }
);
export const Admin1 = loadable(
  () => import("./Admin Forms/Admission Form/A2"),
  {
    fallback: <Loading />,
  }
);
