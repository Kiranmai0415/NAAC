...
const years=[
  ...
  useEffect(
    ()=> 
    fetch("http://localhost:8080/api/v1/getallresearchfiles"
    ).then((response) => response.json()
    .then((data) => {
      console.log(JSON.stringify(data));
      setValuef3t1(data[0].ff3t1);
      setValuef3t2(data[0].ff3t2);
      setValuef3t3(data[0].ff3t3);
      setValuef3t4(data[0].ff3t4);
      setValuef3t5(data[0].ff3t5);
      setValuef3t6(data[0].ff3t6);
      setValuef3t7(data[0].ff3t7);
      setValuef3t8(data[0].ff3t8);
      setValuef3t9(data[0].ff3t9);
      setValuef3t10(data[0].ff3t10);
      setValuef3t11(data[0].ff3t11);
      setValuef3t12(data[0].ff3t12);
      setValuef3t13(data[0].ff3t13);
      setValuef3t14(data[0].ff3t14);
      setValuef3t15(data[0].ff3t15);
      setValuef3t16(data[0].ff3t16);
      setValuef3t17(data[0].ff3t17);
      setValuef3f1(data[0].facultyFileupload[0].facultyFileupload);
      })
