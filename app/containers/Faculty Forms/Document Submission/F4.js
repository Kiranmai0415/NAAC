...
const  items=[
  ...
  function onClickingSave() {
    ...
    fetch("http://localhost:8080/api/v1/documentupload", filesFetchMethod).then(
      (response) => {
        ...
        >
          <form className="outer">
            ...
            <div className="main">
              ...
              <div className="col-2">
                {/* {valuef4f1==="" ? (<p style={{color:"red"}}>This is a required question</p>):null} */}
                ...
                {pathValuef4f1 === "" ? null : (
                  <div className="c11-fileButtons-container">
                    ...
                    <button className="c11-removeFileButton-style" 
                      ...
                      document.getElementById("f4-f1").value="" }} >
                       Reset                     
                     </button>
                  </div>
                )} */}
