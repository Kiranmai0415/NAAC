...
import "./FinancialSupportAuthorize.css";
...
function FinancialSupportAuthorize() {
  ...
  function onConfirmingReject() {
    ...
    fetch(
      "http://localhost:8080/api/v1/hodDashBoardRejectRecord?screenType=FinancialSupport",
      rejectAPImethod
    ).then((response) => {
  ...
  function onConfirmingAuthorize(e) {
    ...
    fetch(
      "http://localhost:8080/api/v1/hodDashBoardAuthorizedEmail?screenType=FinancialSupport",
      authAPImethod
    ).then((response) => {
      console.log(response);
      if (response.ok) {
...
export default FinancialSupportAuthorize;
