...
import "./PassPercentageAuthorize.css";
...
function PassPercentageAuthorize() {
  ...
  function onConfirmingReject() {
    ...
    fetch(
      "http://localhost:8080/api/v1/hodDashBoardRejectRecord?screenType=passPercentage",
      rejectAPImethod
    ).then((response) => {
  ...
  function onConfirmingAuthorize(e) {
    ...
    fetch(
      "http://localhost:8080/api/v1/hodDashBoardAuthorizedEmail?screenType=passPercentage",
      authAPImethod
    ).then((response) => {
      console.log(response);
      if (response.ok) {
...
export default PassPercentageAuthorize;
