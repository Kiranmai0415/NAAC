...
import "./CentricMethodAuthorize.css";
...
function CentricMethodAuthorize() {
  ...
  function onConfirmingReject() {
    ...
    fetch(
      "http://localhost:8080/api/v1/hodDashBoardRejectRecord?screenType=CenticAuthorize",
      rejectAPImethod
    ).then((response) => {
  ...
  function onConfirmingAuthorize(e) {
    ...
    fetch(
      "http://localhost:8080/api/v1/hodDashBoardAuthorizedEmail?screenType=CenticAuthorize",
      authAPImethod
    ).then((response) => {
      console.log(response);
      if (response.ok) {
...
export default CentricMethodAuthorize;
