...
import "./TeachingPedagologyAuthorize.css";
...
function TeachingPedagologyAuthorize() {
  ...
  const rejectContent = {
    ...
    programmerId: "TeachingPedagology",
    deanStatus: "R",
  ...
  function onConfirmingReject() {
    ...
    fetch(
      "http://localhost:8080/api/v1/hodDashBoardRejectRecord?screenType=TeachingPedagology",
      rejectAPImethod
    ).then((response) => {
  ...
  function onConfirmingAuthorize(e) {
    ...
    fetch(
      "http://localhost:8080/api/v1/hodDashBoardAuthorizedEmail?screenType=TeachingPedagology",
      authAPImethod
    ).then((response) => {
      console.log(response);
      if (response.ok) {
...
export default TeachingPedagologyAuthorize;
