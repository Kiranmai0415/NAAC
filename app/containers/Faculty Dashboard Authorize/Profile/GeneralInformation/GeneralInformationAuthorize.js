...
import "./GeneralInformationAuthorize.css";
...
function GeneralInformationAuthorize() {
  ...
  const rejectContent = {
    ...
    programmerId: "GeneralInformation",
    deanStatus: "R",
  ...
  function onConfirmingReject() {
    ...
    fetch(
      "http://localhost:8080/api/v1/hodDashBoardRejectRecord?screenType=GeneralInformation",
      rejectAPImethod
    ).then((response) => {
  ...
  function onConfirmingAuthorize(e) {
    ...
    fetch(
      "http://localhost:8080/api/v1/hodDashBoardAuthorizedEmail?screenType=GeneralInformation",
      authAPImethod
    ).then((response) => {
      console.log(response);
      if (response.ok) {
...
export default GeneralInformationAuthorize;
