...
import "./FacultyAwardsAuthorize.css";
...
function FacultyAwardsAuthorize() {
  ...
  function onConfirmingReject() {
    ...
    fetch(
      "http://localhost:8080/api/v1/hodDashBoardRejectRecord?screenType=FacultyAward",
      rejectAPImethod
    ).then((response) => {
  ...
  function onConfirmingAuthorize(e) {
    ...
    fetch(
      "http://localhost:8080/api/v1/hodDashBoardAuthorizedEmail?screenType=FacultyAward",
      authAPImethod
    ).then((response) => {
      console.log(response);
      if (response.ok) {
...
export default FacultyAwardsAuthorize;
