...
import "./ProfessionalAuthorize.css";
...
function ProfessionalAuthorize() {
  ...
  function onConfirmingReject() {
    ...
    fetch(
      "http://localhost:8080/api/v1/hodDashBoardRejectRecord?screenType=Professional",
      rejectAPImethod
    ).then((response) => {
  ...
  function onConfirmingAuthorize(e) {
    ...
    fetch(
      "http://localhost:8080/api/v1/hodDashBoardAuthorizedEmail?screenType=Professional",
      authAPImethod
    ).then((response) => {
      console.log(response);
      if (response.ok) {
...
export default ProfessionalAuthorize;
