...
function PercentageFullTimeTeacherAuthorize() {
  ...
  const rejectContent = {
    ...
    programmerId: "PercentageFullTimeTeacher",
    deanStatus: "R",
  ...
  function onConfirmingReject() {
    ...
    fetch(
      "http://localhost:8080/api/v1/hodDashBoardRejectRecord?screenType=PercentageFullTimeTeacher",
      rejectAPImethod
    ).then((response) => {
  ...
  function onConfirmingAuthorize(e) {
    ...
    fetch(
      "http://localhost:8080/api/v1/hodDashBoardAuthorizedEmail?screenType=PercentageFullTimeTeacher",
      authAPImethod
    ).then((response) => {
      console.log(response);
      if (response.ok) {
...
export default PercentageFullTimeTeacherAuthorize;
