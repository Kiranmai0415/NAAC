...
import "./CounsellingAuthorize.css";
...
function CounsellingAuthorize() {
  ...
  function onConfirmingReject() {
    ...
    fetch(
      "http://localhost:8080/api/v1/hodDashBoardRejectRecord?screenType=counselling",
      rejectAPImethod
    ).then((response) => {
  ...
  function onConfirmingAuthorize(e) {
    ...
    fetch(
      "http://localhost:8080/api/v1/hodDashBoardAuthorizedEmail?screenType=counselling",
      authAPImethod
    ).then((response) => {
      console.log(response);
      if (response.ok) {
...
export default CounsellingAuthorize;
