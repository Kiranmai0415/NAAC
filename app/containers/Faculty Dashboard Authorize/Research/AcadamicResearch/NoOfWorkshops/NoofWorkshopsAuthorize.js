...
import "./NoofWorkshopsAuthorize.css";
...
function NoofWorkshopsAuthorize() {
  ...
  function onConfirmingReject() {
    ...
    fetch(
      "http://localhost:8080/api/v1/hodDashBoardRejectRecord?screenType=nOOFwORKsHOP",
      rejectAPImethod
    ).then((response) => {
  ...
  function onConfirmingAuthorize(e) {
    ...
    fetch(
      "http://localhost:8080/api/v1/hodDashBoardAuthorizedEmail?screenType=nOOFwORKsHOP",
      authAPImethod
    ).then((response) => {
      console.log(response);
      if (response.ok) {
...
export default NoofWorkshopsAuthorize;
