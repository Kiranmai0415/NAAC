...
import "./ResearchGuidesAuthorize.css";
...
function ResearchGuidesAuthorize() {
  ...
  function onConfirmingReject() {
    ...
    fetch(
      "http://localhost:8080/api/v1/hodDashBoardRejectRecord?screenType=ResearchGuides",
      rejectAPImethod
    ).then((response) => {
  ...
  function onConfirmingAuthorize(e) {
    ...
    fetch(
      "http://localhost:8080/api/v1/hodDashBoardAuthorizedEmail?screenType=ResearchGuides",
      authAPImethod
    ).then((response) => {
      console.log(response);
      if (response.ok) {
...
export default ResearchGuidesAuthorize;
