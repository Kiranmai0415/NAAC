...
import "./CollaborationsLinkagesAuthorize.css";
...
function CollaborationsLinkagesAuthorize() {
  ...
  const rejectContent = {
    ...
    programmerId: "collaborationLinkages",
    deanStatus: "R",
  ...
  function onConfirmingReject() {
    ...
    fetch(
      "http://localhost:8080/api/v1/hodDashBoardRejectRecord?screenType=collaborationLinkages",
      rejectAPImethod
    ).then((response) => {
  ...
  function onConfirmingAuthorize(e) {
    ...
    fetch(
      "http://localhost:8080/api/v1/hodDashBoardAuthorizedEmail?screenType=collaborationLinkages",
      authAPImethod
    ).then((response) => {
      console.log(response);
      if (response.ok) {
...
export default CollaborationsLinkagesAuthorize;
