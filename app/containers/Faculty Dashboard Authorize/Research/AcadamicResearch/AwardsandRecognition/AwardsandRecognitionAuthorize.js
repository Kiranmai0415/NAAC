...
import "./AwardsandRecognitionAuthorize.css";
...
function AwardsandRecognitionAuthorize() {
  ...
  const rejectContent = {
    ...
    programmerId: "AwardsRecognition",
    deanStatus: "R",
  ...
  function onConfirmingReject() {
    ...
    fetch(
      "http://localhost:8080/api/v1/hodDashBoardRejectRecord?screenType=AwardsRecognition",
      rejectAPImethod
    ).then((response) => {
  ...
  function onConfirmingAuthorize(e) {
    ...
    fetch(
      "http://localhost:8080/api/v1/hodDashBoardAuthorizedEmail?screenType=AwardsRecognition",
      authAPImethod
    ).then((response) => {
      console.log(response);
      if (response.ok) {
...
export default AwardsandRecognitionAuthorize;
