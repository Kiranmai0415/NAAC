...
import "./ConsultancyAuthorize.css";
...
function ConsultancyAuthorize() {
  ...
  function onConfirmingReject() {
    ...
    fetch(
      "http://localhost:8080/api/v1/hodDashBoardRejectRecord?screenType=Consultancy",
      rejectAPImethod
    ).then((response) => {
  ...
  function onConfirmingAuthorize(e) {
    ...
    fetch(
      "http://localhost:8080/api/v1/hodDashBoardAuthorizedEmail?screenType=Consultancy",
      authAPImethod
    ).then((response) => {
      console.log(response);
      if (response.ok) {
...
export default ConsultancyAuthorize;
