...
import "./RevenueCorporateAuthorize.css";
...
function RevenueCorporateAuthorize() {
  ...
  function onConfirmingReject() {
    ...
    fetch(
      "http://localhost:8080/api/v1/hodDashBoardRejectRecord?screenType=RevenueCorporate",
      rejectAPImethod
    ).then((response) => {
  ...
  function onConfirmingAuthorize(e) {
    ...
    fetch(
      "http://localhost:8080/api/v1/hodDashBoardAuthorizedEmail?screenType=RevenueCorporate",
      authAPImethod
    ).then((response) => {
      console.log(response);
      if (response.ok) {
...
export default RevenueCorporateAuthorize;
