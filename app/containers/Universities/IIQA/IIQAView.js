...
function IIQAView() {
  ...
  useEffect(
    () => fetch(resources.APPLICATION_URL+'getallqiafiles?collegeId='+collegeId+'&financialYear='+fYear+'&typeofInstitution='+instituteType).then((response) => response
        .json()
        .then((data) => {
