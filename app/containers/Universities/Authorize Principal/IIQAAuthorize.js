...
function IIQAAuthorize() {
    ...
    () => fetch(resources.APPLICATION_URL + 'getallqiafiles?collegeId='+collegeId+'&financialYear='+fYear+'&typeofInstitution='+instituteType).then(
      (response) => response
        ...
        .then((data) => {
          ...
          // qiaIndicator4
          setIiqa18t2(data[0].qiaIndicator4[0] ? data[0].qiaIndicator3[0].inputiiqa18t2 : "");
          setIiqa18t3(data[0].qiaIndicator4[0] ? data[0].qiaIndicator3[0].inputiiqa18t3 : "");
          ...
          setIiqa20t9(data[0].qiaIndicator5[4] ? data[0].qiaIndicator5[4].inputiiqa20t1 : "");
          setIiqa20t10(data[0].qiaIndicator5[4] ? data[0].qiaIndicator5[4].inputiiqa20t2 : "");

          setIiqa20t11(data[0].qiaIndicator5[5] ? data[0].qiaIndicator5[5].inputiiqa20t1 : "");
          setIiqa20t12(data[0].qiaIndicator5[5] ? data[0].qiaIndicator5[4].inputiiqa20t2 : "");
          ...
          setIiqa21t16(data[0].qiaIndicator6[3] ? data[0].qiaIndicator6[2].inputiiqa21t1 : "");
          setIiqa21t17(data[0].qiaIndicator6[3] ? data[0].qiaIndicator6[2].inputiiqa21t2 : "");
          setIiqa21t18(data[0].qiaIndicator6[3] ? data[0].qiaIndicator6[2].inputiiqa21t3 : "");
          setIiqa21t19(data[0].qiaIndicator6[3] ? data[0].qiaIndicator6[2].inputiiqa21t4 : "");
          setIiqa21t20(data[0].qiaIndicator6[3] ? data[0].qiaIndicator6[2].inputiiqa21t5 : "");
          ...
          setIiqa21t66(data[0].qiaIndicator6[11] ? data[0].qiaIndicator6[10].inputiiqa21t1 : "");
          setIiqa21t67(data[0].qiaIndicator6[11] ? data[0].qiaIndicator6[10].inputiiqa21t2 : "");
          setIiqa21t68(data[0].qiaIndicator6[11] ? data[0].qiaIndicator6[10].inputiiqa21t3 : "");
          setIiqa21t69(data[0].qiaIndicator6[11] ? data[0].qiaIndicator6[10].inputiiqa21t4 : "");
          setIiqa21t70(data[0].qiaIndicator6[11] ? data[0].qiaIndicator6[10].inputiiqa21t5 : "");
  ...
  function getRejectIIQA() {
    ...
    fetch(
      resources.APPLICATION_URL + 'principalRejectEmail',
      rejectAPImethod
    ).then((response) => {
      console.log(response);
      if (response.ok) {
