...
function Criteria71() {
 ...
 //help buttom
  ...
  //   }
  // }
  function onClickingViewResponse712() {
    if (value712t1 === "" || value712t1 === undefined || value712t1 === null) {
      setResponseValue712("Please select any option");
    } else {
  ...
  function onClickingViewResponse714() {
  ...
  function onClickingViewResponse715() {
  ...
  function onClickingViewResponse716() {
  ...
  function onClickingViewResponse717() {
  ...
  function onClickingViewResponse7110() {
          ...
          <div className="c71x-Ql-label-textarea-container">
            <div className="c71x-heading_Help-container">
              <h1 className="c71x-heading-style">
                ...
                <li> E-waste management</li><li> Waste recycling system </li>
      ...
      <div className="c71x-eachInputField-container" >
        ...
        <form>
          <div className="c71x-container">
            ...
            <label htmlFor="715-t1" className="c33x-label-style">
              Response:
            </label>
            <div className="c71x-response-container">
              <textarea
          ...
          <div className="c71x-container">
            <div className="c71x-heading_Help-container">
              ...
              institution
                ...
                <div className="c71x-radio-container" style={{width:"115%"}}>
                  <div className="c71x-radio-subContainer" style={{width:"45%"}}>
                    <div className="c71x-eachRadio-container">
                      <input
                        name="716options"
          ...
          <div className="c71x-container">
            <div className="c71x-heading_Help-container">
              <div>
                ...
                <div className="c71x-radio-container" style={{width:"100%"}}>
                  <div className="c71x-radio-subContainer" style={{width:"45%"}}>
                    <div className="c71x-eachRadio-container">
                      <input
                        name="717options"
