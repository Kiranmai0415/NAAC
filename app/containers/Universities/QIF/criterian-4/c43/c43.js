...
const handleHelpClose3 = (e)=>{
  ...
  function onClickingViewResponse434() {
    if (value434t1 === "" || value434t1 === undefined || value434t1 === null) {
  ...
  function onClickingViewResponse435(e) {
    if (value435t1 === '' || value435t1 === undefined || value435t1 === null) {
      setResponseValue435('Please select any option');
    } else {
      setResponseValue435(value435t1);
    }
  }
      ...
      <div className="c43x-eachInputField-container">
        ...
        <form>
          ...
          {/* <div className="c43xx-container">
           ...
           <span> Number of classrooms and seminar halls with ICT facilities
              Data Requirements:
              <input
          ...
          {/* <table className="c43x-table-style">
            ...
            <tr>
              <td>Upload Number of classroom</td>
              <td></td>
              <td>
                <input
                  onChange={(e) => {
                ...
                {pathValue431f3 === '' ? null : (
                  <div className="c43-fileButtons-container">
                    ...
                    <button className="c11-removeFileButton-style" 
                      onClick={(e)=>{setPathValue431f3("");
                      document.getElementById("431-f3").value="" }} >
                       Reset                     
                     </button>
                  </div>
                )}
              ...
              <td>
                ...
                {pathValue432f2 === '' ? null : (
                  <div className="c43-fileButtons-container">
                    ...
                    <button className="c11-removeFileButton-style" 
                      onClick={(e)=>{setPathValue432f2("");
                      document.getElementById("432-f2").value="" }} >
                       Reset                     
                     </button>
                  </div>
                )}
          ...
          <div className="c43x-container">
            <div className="c43x-heading_Help-container">
              ...
              <HelpButton
                ...
                title='Formula:  '
                >Total number of computers available for student use
                1.2: Number of students on rolls (latest compleated academic year)</HelpButton>
            </div>
            <div className="c43x-response-container">
              <button
                onClick={(e) => {
          ...
          <div className="c43xx-container">
            {/* <h1 className="c43xx-Heading-style">
              ...
              <input
                ...
                id="433-t1"
                style={{ marginLeft: '44.1%' }}
                type="number"
              /></h1> */}
            <h1 className="c43xx-Heading-style">
              Number of Computers available to students foracademic purposes:
              <input
                onChange={(e) => setValue433t2(e.target.value)}
                id="433-t2"
                style={{ marginLeft: '4%' }}
                type="number"
              /></h1>
          ...
          <div className="c43x-container">
            <div className="c43x-heading_Help-container">
              <div>
                ...
                <div className="c43x-radio-container" style={{width:"160%"}}>
