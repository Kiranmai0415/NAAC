    ...
    <div className="c63-inputFields-mainContainer">
      ...
      <div className="c63x-eachInputField-container">
        <div className="c63x-weightage-container">
          <h1 className="c63x-weightage-heading-style">Weightage: </h1>
        </div>
        <form>
        ...
        <form>
          ...
          <div className="c63xx-container">
            ...
            <table className="c63x-table-style">
              ...
              <tr>
                <td>Policy document on providing financial support to teachers</td>
                <td><a href={downloadFile("un6.3.2.xlsx")} target="_blank">view temoplate</a></td>
                <td>
                  <input
                    onChange={(e) => {
              ...
              <tr>
                <td>
                E-copy of letter/s indicating financial assistance to teachers and list
...
teachers to attend conferences/workshops and towards
