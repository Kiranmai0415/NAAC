...
function Criteria3() {
  ...
  function onClickingSave() {
   ...
   // criteria3upload.append("uploadfile3", jsonBlob(inputDataList));
    ...
    fetch("http://localhost:8080/api/v1/criteria3submit?collegeId="+collegeId+"&financialYear="+fYear+"&typeofInstitution="+instituteType, filesFetchMethod).then(
      (response) => {
      ...
      <div className="c3x-container">
        <div className="c3x-subContainer">
          <h1
            ...
            className="c3x-heading-style"
          >
            3.2: 3.2 Resource Mobilization for Research (40)
          </h1>
          {/* <button
      ...
      <div className="c3x-container">
        <div className="c3x-subContainer">
          <h1
            ...
            className="c3x-heading-style"
          >
            3.4: 3.4 Research Publications and Awards (120)
          </h1>
          {/* <button
