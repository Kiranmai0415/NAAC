...
function ExtendedProfile() {
  ...
  useEffect(
    () => fetch(resources.APPLICATION_URL + 'getallextendeddata?collegeId=' + collegeId + '&financialYear=' + fYear + '&typeofInstitution=' + instituteType).then(
      (response) => response
        .json()
        .then((data) => {
        ...
        <form>
          ...
          <p htmlFor="43" style={{ margin: "1%" }}>
            ...
            <input readOnly
              ...
              style={{ width: "30%", marginLeft: "18.2%" }}
              className="input-43"
              value={value43}
            />
          </p>
