...
function BasicInfo() {
  ...
  useEffect(
    () => fetch(resources.APPLICATION_URL + 'getallacademicdata?collegeId=' + collegeId + '&financialYear=' + fYear + '&typeofInstitution=' + instituteType).then(
      (response) => response
        .json()
        .then((data) => {
          ...
          //
          setValuebtip1(data[0].basicprofile2[0] ? data[0].recognizationDetails[0].inputbtip11 : "");
