    ...
    () => fetch('http://localhost:8080/api/v1/getallevaluation?collegeId='+collegeId+'&financialYear='+fYear+'&typeofInstitution='+instituteType,).then(
      (response) => response
        ...
        .then((data) => {
          ...
          setInputValuet1(data[0].evaluativeReport[0].valuet1);
          setInputValuet2(data[0].evaluativeReport[0].valuet2);
          setInputValuet3(data[0].evaluativeReport[0].valuet3);
          setInputValuet4(data[0].evaluativeReport[0].valuet4);
        })
        .catch((error) => {
  ...
  function getAuthorizeEvaluativereport(e) {
    ...
    fetch(
      resources.APPLICATION_URL
        + 'evaluationDatasubmittoprincipal?collegeId='+collegeId+'&financialYear='+fYear+'&typeofInstitution='+instituteType,
      authAPIMethod
    ).then((response) => {
