...
import Criteria51 from './ViewHOD/CriteriaView-5/cV51/c51';
import Criteria52 from './ViewHOD/CriteriaView-5/cV52/c52';
import Criteria53 from './ViewHOD/CriteriaView-5/cV53/c53';
import Criteria54 from './ViewHOD/CriteriaView-5/cV54/c54';
...
function Criteria5() {
  ...
  function onClickingSaveSendingTexts() {
    ...
    fetch(
      resources.APPLICATION_URL + 'criteria5submittoprincipal?collegeId='+collegeId+'&financialYear='+fYear+'&typeofInstitution='+instituteType,
      authorizeAPImethod
    ).then((response) => {
      console.log(response);
      if (response.ok) {
