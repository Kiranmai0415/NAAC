...
const financialYear="2021-2022";
  ...
  useEffect(
    () => fetch(resources.APPLICATION_URL+'criteria6getallfiles?collegeId='+collegeId+'&financialYear='+fYear+'&typeofInstitution='+instituteType).then((response) => response
        .json()
        .then((data) => {
          ...
          setValue644t1(data[0].criteria64Ql[0] ? data[0].criteria64Ql[0].input644t1 : "");
          ...
          <div className="c64x-container">
            <div className="c64x-heading_Help-container">
              <h1 className="c64x-heading-style">
                ...
                Funds / Grants received from government bodies/non government and
            philanthropists during the last five years for development and maintenance of
        ...
        <form>
          ...
          <table className="c64x-Ql-table-style">
            ...
            <tr>
              ...
              <td className="c64x-Ql-tableBorders-style"></td>
              <td className="c64x-Ql-tableBorders-style">
              <a href={downloadFile(value644f1)} target="_blank">view</a>
              </td>
              <td className="c64x-Ql-tableBorders-style">pdf</td>
            </tr>
            <tr>
              ...
              <td className="c64x-Ql-tableBorders-style"></td>
              <td className="c64x-Ql-tableBorders-style">
              <a href={downloadFile(value644f2)} target="_blank">view</a>
              </td>
              <td className="c64x-Ql-tableBorders-style">pdf</td>
            </tr>
            <tr>
              ...
              <td className="c64x-Ql-tableBorders-style">
              <a href={downloadFile(value644f3)} target="_blank">view</a>
              </td>
              <td className="c64x-Ql-tableBorders-style">pdf</td>
            </tr>
          </table>
