    ...
    <div className="c32x-help-mainContainer">
      <div className="c32x-help-subContainer">
        ...
        <p className="c32x-help-para-style">
          Data for the last five years:(As per Data Template) 1.Name of the
          Project/ Endowments, Chairs
          <br />
          2.Name of the Principal Investigator
          <br />
          3.Department of Principal Investigator
          <br />
          4.Year of Award
          <br />
          5.Funds provided
  ...
  return props.isHelp323Clicked ? (
    <div className="c32x-help-mainContainer">
      <div className="c32x-help-subContainer">
        ...
        <p className="c32x-help-para-style">
          Number of research projects funded by government and non-government
          agencies during the last five years
          <span style={{ fontWeight: "bold" }}> / </span>Number of full time
          teachers with research projectsworking in the institution during the
          last 5 years
        </p>
        <button
          className="c32x-help-closeButton-style"
 ...
 //help buttom
      ...
      fetch(
        ...
        response
          ...
          .then((data) => {
            ...
            setValue3211t1(data[0].yearTable3211[0].input3211y);
            setValue3211t2(data[0].yearTable3211[0].input3211y);
            setValue3211t3(data[0].yearTable3211[2].input3211y);
            setValue3211t4(data[0].yearTable3211[3].input3211y);
            setValue3211t5(data[0].yearTable3211[4].input3211y);
            setValue3211t6(data[0].yearTable3211[0].input3211v);
            setValue3211t7(data[0].yearTable3211[1].input3211v);
            setValue3211t8(data[0].yearTable3211[2].input3211v);
            setValue3211t9(data[0].yearTable3211[3].input3211v);
            setValue3211t10(data[0].yearTable3211[4].input3211v);

            setValue3221t1(data[0].yearTable3221[0].input3221y);
            setValue3221t2(data[0].yearTable3221[1].input3221y);
            setValue3221t3(data[0].yearTable3221[2].input3221y);
            setValue3221t4(data[0].yearTable3221[3].input3221y);
            setValue3221t5(data[0].yearTable3221[4].input3221y);
            setValue3221t6(data[0].yearTable3221[0].input3221v);
            setValue3221t7(data[0].yearTable3221[1].input3221v);
            setValue3221t8(data[0].yearTable3221[2].input3221v);
            setValue3221t9(data[0].yearTable3221[3].input3221v);
            setValue3221t10(data[0].yearTable3221[4].input3221v);

            setValue3231t1(data[0].universityYearTable3231[0].input3231y);
            setValue3231t2(data[0].universityYearTable3231[1].input3231y);
            setValue3231t3(data[0].universityYearTable3231[2].input3231y);
            setValue3231t4(data[0].universityYearTable3231[3].input3231y);
            setValue3231t5(data[0].universityYearTable3231[4].input3231y);
            setValue3231t6(data[0].universityYearTable3231[0].input3231v);
            setValue3231t7(data[0].universityYearTable3231[1].input3231v);
            setValue3231t8(data[0].universityYearTable3231[2].input3231v);
            setValue3231t9(data[0].universityYearTable3231[3].input3231v);
            setValue3231t10(data[0].universityYearTable3231[4].input3231v);

            setValue3231t11(data[0].universityYearTable3232[0].input3232y);
            setValue3231t12(data[0].universityYearTable3232[1].input3232y);
            setValue3231t13(data[0].universityYearTable3232[2].input3232y);
            setValue3231t14(data[0].universityYearTable3232[3].input3232y);
            setValue3231t15(data[0].universityYearTable3232[4].input3232y);
            setValue3231t16(data[0].universityYearTable3232[0].input3232v);
            setValue3231t17(data[0].universityYearTable3232[1].input3232v);
            setValue3231t18(data[0].universityYearTable3232[2].input3232v);
            setValue3231t19(data[0].universityYearTable3232[3].input3232v);
            setValue3231t20(data[0].universityYearTable3232[4].input3232v);

            setValue3211f1(data[0].criteria2FileUpload[0].criteria2FileName);
            setValue3211f2(data[0].criteria2FileUpload[1].criteria2FileName);
            setValue3211f3(data[0].criteria2FileUpload[1].criteria2FileName);
            setValue3211f1(data[0].criteria2FileUpload[3].criteria2FileName);
            setValue3211f2(data[0].criteria2FileUpload[4].criteria2FileName);
            setValue3211f3(data[0].criteria2FileUpload[4].criteria2FileName);
            setValue3231f1(data[0].criteria2FileUpload[4].criteria2FileName);
            setValue3231f2(data[0].criteria2FileUpload[5].criteria2FileName);
            setValue3231f3(data[0].criteria2FileUpload[6].criteria2FileName);
            setValue3231f4(data[0].criteria2FileUpload[6].criteria2FileName);
          })
          .catch((error) => {
  ...
  function onClickingViewResponse323() {
    if (
      ...
      setResponseValue323(
        (value3231t6 + value3231t7 + value3231t8 + value3231t9 + value3231t10) /
          (value3231t16 +
            value3231t17 +
            value3231t18 +
            value3231t19 +
    ...
    yearTable3211: [
      {
        ...
        uniqueKey1: 201,
        input3211y: value3211t1,
        input3211v: value3211t6,
      },
      {
        criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType },

        uniqueKey1: 202,
        input3211y: value3211t2,
        input3211v: value3211t7,
      },
      {
        criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType },

        uniqueKey1: 203,
        input3211y: value3211t3,
        input3211v: value3211t8,
      },
      {
        criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType },

        uniqueKey1: 204,
        input3211y: value3211t4,
        input3211v: value3211t9,
      },
      {
        criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType },

        uniqueKey1: 205,
        input3211y: value3211t5,
        input3211v: value3211t10,
      },
    ],
    yearTable3221: [
      {
        ...
        uniqueKey1: 201,
        input3221y: value3221t1,
        input3221v: value3221t6,
      },
      {
        criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType },

        uniqueKey1: 202,
        input3221y: value3221t2,
        input3221v: value3221t7,
      },
      {
        criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType },

        uniqueKey1: 203,
        input3221y: value3221t3,
        input3221v: value3221t8,
      },
      {
        criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType },

        uniqueKey1: 204,
        input3221y: value3221t4,
        input3221v: value3221t9,
      },
      {
        criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType },

        uniqueKey1: 205,
        input3221y: value3221t5,
        input3221v: value3221t10,
      },
    ],
    universityYearTable3231: [
      {
        ...
        uniqueKey1: 201,
        input3231y: value3231t1,
        input3231v: value3231t6,
      },
      {
        criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType },

        uniqueKey1: 202,
        input3231y: value3231t2,
        input3231v: value3231t7,
      },
      {
        criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType },

        uniqueKey1: 203,
        input3231y: value3231t3,
        input3231v: value3231t8,
      },
      {
        criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType },

        uniqueKey1: 204,
        input3231y: value3231t4,
        input3231v: value3231t9,
      },
      {
        criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType },

        uniqueKey1: 205,
        input3231y: value3231t5,
        input3231v: value3231t10,
      },
    ],
    universityYearTable3232: [
      {
        ...
        uniqueKey1: 201,
        input3232y: value3231t11,
        input3232v: value3231t16,
      },
      {
        criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType },

        uniqueKey1: 202,
        input3232y: value3231t12,
        input3232v: value3231t17,
      },
      {
        criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType },

        uniqueKey1: 203,
        input3232y: value3231t13,
        input3232v: value3231t18,
      },
      {
        criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType },

        uniqueKey1: 204,
        input3232y: value3231t14,
        input3232v: value3231t19,
      },
      {
        criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType },

        uniqueKey1: 205,
        input3232y: value3231t15,
        input3232v: value3231t20,
      },
    ],
  };
    ...
    <div className="c32-inputFields-mainContainer">
      ...
      <div className="c32x-eachInputField-container">
        <div className="c32x-weightage-container">
          <h1 className="c32x-weightage-heading-style">Weightage: 25</h1>
        </div>
        <form>
      ...
      <div className="c32x-eachInputField-container">
        <div className="c32x-weightage-container">
          <h1 className="c32x-weightage-heading-style">Weightage: 15</h1>
        </div>
        <form>
          <div className="c32x-container">
            <div className="c32x-heading_Help-container">
              ...
              <HelpButton
                ...
                title='formula'
                >(Total numberofresearchprojects funded by government and non-government ???????????????? h??????????,?????????????????????????? ???????????? during the last five years)/((2.2 Number of full time terachers (without repeat count) during the last five years))</HelpButton>
            </div>
            <div className="c32x-response-container">
              <button
                onClick={(e) => {
...
<input></input>
            ...
            <table className="c32x-table-style">
              ...
              <tr>
                <td>
                E-copies of the grant award letters for research projects sponsored by government agencies. .                </td>
                <td>
        ...
        <form>
          ...
          <div className="c32xx-container">
            <h1 className="c32xx-Heading-style">
              ...
              Number of research projects funded by government and
              non-government agencies during the last five years
            </h1>
            ...
            <table className="c32x-Qt-table-style">
              ...
              <h1 className="c32xx-Heading-style">
                ...
                Number of full time teachers with research projectsworking in
            ...
            <table className="c32x-Qt-table-style">
              ...
              <tr>
                <th className="c32x-horizontalTable-heading-style">Number</th>
                <td>
                  <div
                    style={{
                      display: "flex",
            ...
            <table className="c32x-table-style">
              ...
              <tr>
                <td>
                  Provide the List of research projects and funding details
                  (Data Templateas of 3.1.6)
                </td>
                <td></td>
                <td>
                  <input
