  ...
  return props.isHelp254Clicked ? (
    <div className="c25x-help-mainContainer">
      <div className="c25x-help-subContainer">
        ...
        <p className="c25x-help-para-style">(Opt any one)</p>
        <button
          className="c25x-help-closeButton-style"
          onClick={(e) => {
            e.preventDefault();
    ...
    yearTable2511: [
      {
        ...
        uniqueKey1: 201,
        input2511y: value2511t1,
        input2511v: value2511t6,
      },
      {
        criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType },

        uniqueKey1: 202,
        input2511y: value2511t2,
        input2511v: value2511t7,
      },
      {
        criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType },

        uniqueKey1: 203,
        input2511y: value2511t3,
        input2511v: value2511t8,
      },
      {
        criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType },

        uniqueKey1: 204,
        input2511y: value2511t4,
        input2511v: value2511t9,
      },
      {
        criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType },

        uniqueKey1: 205,
        input2511y: value2511t5,
        input2511v: value2511t10,
      },
    ],
    yearTable2521: [
      {
        ...
        uniqueKey1: 201,
        input2521y: value2521t1,
        input2521v: value2521t6,
      },
      {
        criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType },

        uniqueKey1: 202,
        input2521y: value2521t2,
        input2521v: value2521t7,
      },
      {
        criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType },

        uniqueKey1: 203,
        input2521y: value2521t3,
        input2521v: value2521t8,
      },
      {
        criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType },

        uniqueKey1: 204,
        input2521y: value2521t4,
        input2521v: value2521t9,
      },
      {
        criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType },

        uniqueKey1: 205,
        input2521y: value2521t5,
        input2521v: value2521t10,
      },
    ],
    yearTable25212: [
      {
        ...
        uniqueKey1: 201,
        input25212y: value2521t1,
        input25212v: value2521t6,
      },
      {
        criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType },

        uniqueKey1: 202,
        input25212y: value2521t2,
        input25212v: value2521t7,
      },
      {
        criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType },

        uniqueKey1: 203,
        input25212y: value2521t3,
        input25212v: value2521t8,
      },
      {
        criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType },

        uniqueKey1: 204,
        input25212y: value2521t4,
        input25212v: value2521t9,
      },
      {
        criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType },

        uniqueKey1: 205,
        input25212y: value2521t5,
        input25212v: value2521t10,
      },
    ],
  };
...
the last five years
              ...
              <HelpButton
                ...
                title='formula'
                ><h1>(Total Number of days from the date of last semester−end/ year− end examination till the last date declaration of results)/5</h1></HelpButton>
            </div>
...
years
            ...
            <table className="c25x-table-style">
              ...
              <tr>
                ...
                <td></td>
                <td>
                  <a href={downloadFile(value2511f1)} target="_blank">
                    view
                  </a>
                </td>
              ...
              <tr>
                ...
                <td>
                <a href={downloadFile("un2.5.1.xlsx")} target="_blank">
                    View Template
                  </a>
                </td>
                <td>
                  <a href={downloadFile(value2511f2)} target="_blank">
                    view
                  </a>
                </td>
                <td className="c25x-Qt-tableBorders-style">pdf</td>
...
examinations
            ...
            <table className="c25x-table-style">
              ...
              <tr>
                ...
                <td></td>
                <td>
                  <a href={downloadFile(value2521f1)} target="_blank">
                    view
                  </a>
                </td>
              ...
              <tr>
                ...
                <td>
                <a href={downloadFile("un2.5.2.xlsx")} target="_blank">view twmplate</a>
                </td>
                <td>
                  <a href={downloadFile(value2521f2)} target="_blank">
                    view
                  </a>
                </td>
                <td className="c21x-Qt-tableBorders-style">pdf</td>
...
E. Only manual methodology
          ...
          <table className="c25x-table-style">
            ...
            <tr>
              ...
              <td></td>
              <td>
                <a href={downloadFile(value253f1)} target="_blank">
                  view
                </a>
              </td>
              <td className="c25x-Qt-tableBorders-style">pdf</td>
            ...
            <tr>
              ...
              <td>
                <a href={downloadFile(value253f2)} target="_blank">
                  view
                </a>
              </td>
              <td className="c25x-Qt-tableBorders-style">pdf</td>
        ...
        <form>
            ...
            <div className="c25x-heading_Help-container">
              <div>
                <h1 className="c25x-heading-style">
                  ...
                  Status of automation of Examination division along with
                  ...
                  <div className="c25x-radio-subContainer">
                    <div className="c25x-eachRadio-container">
                      ...
                      <label className="c25x-radioLabel-style" for="254-t1">
                        A. 100% automation of entire division & implementation
          ...
          <table className="c25x-table-style">
            ...
            <tr>
              ...
              <td></td>
              <td>
                <a href={downloadFile(value254f1)} target="_blank">
                  view
                </a>
              </td>
              <td className="c25x-Qt-tableBorders-style">pdf</td>
            ...
            <tr>
              ...
              <td></td>
              <td>
                <a href={downloadFile(value254f2)} target="_blank">
                  view
                </a>
              </td>
              <td className="c25x-Qt-tableBorders-style">pdf</td>
            ...
            <tr>
              ...
              <td></td>
              <td>
                <a href={downloadFile(value254f3)} target="_blank">
                  view
                </a>
              </td>
              <td className="c25x-Qt-tableBorders-style">pdf</td>
            ...
            <tr>
              ...
              <td></td>
              <td>
                <a href={downloadFile(value254f4)} target="_blank">
                  view
                </a>
              </td>
              <td className="c25x-Qt-tableBorders-style">pdf</td>
