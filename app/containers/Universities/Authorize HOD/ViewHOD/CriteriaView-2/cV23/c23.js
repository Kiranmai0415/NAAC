      ...
      fetch(
        ...
        response
          ...
          .then((data) => {
            ...
            setValue2331f1(data[0].criteria2FileUpload[3] ? data[0].criteria2FileUpload[0].criteria2FileName : "");
            setValue2331f2(data[0].criteria2FileUpload[4] ? data[0].criteria2FileUpload[1].criteria2FileName : "");
            setValue2331f3(data[0].criteria2FileUpload[5] ? data[0].criteria2FileUpload[2].criteria2FileName : "");
          })
          .catch((error) => {
