    ...
    <div className="c43x-help-mainContainer">
      <div className="c43x-help-subContainer">
        ...
        <p className="c43x-help-para-style">
          ...
          <br />* Upload the names of the e-content development facilities
        </p>
        <button
          className="c43x-help-closeButton-style"
          onClick={(e) => {
...
console.log("current year==" + fYear);
  ...
  function onClickingViewResponse431() {
    if (
      value431t1 === "" ||
      value431t2 === "" ||
      value431t1 === undefined ||
      value431t2 === undefined
    ) {
      ...
      setResponseValue431(
        parseInt(value431t1, 10) / parseInt(value431t2, 10) / 100
      );
    }
  }
  ...
  function onClickingViewResponse433() {
    if (
      value433t1 === "" ||
      value433t2 === "" ||
      value433t1 === undefined ||
      value433t2 === undefined
    ) {
        ...
        <form>
          <div className="c43x-container">
            <div className="c43x-heading_Help-container">
              <h1 className="c43x-heading-style">
                ...
                recording facilities.(Data to be provided only for the latest
                completed academic year)
              </h1>
              <button
                onClick={(e) => {
                  e.preventDefault();
                  setHelp431Status(true);
                }}
              ...
              <Help431
                isHelp431Clicked={help431Status}
                setIsHelp431Clicked={setHelp431Status}
              />
            </div>
          ...
          <div className="c43xx-container">
            <h1 className="c43xx-Heading-style">
              Number of classrooms and seminar halls with ICT facilities Data
              Requirements:
              <input
                readOnly
      ...
      <div className="c43x-eachInputField-container">
        ...
        <form>
          ...
          {/* <div className="c43xx-container">
            ...
            <h1 className="c43xx-Heading-style">
              Number of Computers available to students for academic purposes:
              <input
                readOnly
          ...
          <table className="c43x-table-style">
            ...
            <tr>
              <td>Upload any additional information</td>
              <td><a href={downloadFile("un4.3.3.xlsx")} target="_blank">view Template</a></td>
              <td>
                <input
                  readOnly
                  onChange={(e) => {
          ...
          <div className="c43x-container">
            <div className="c43x-heading_Help-container">
              <div>
                ...
                <div className="c43x-radio-container">
          ...
          <table className="c43x-table-style">
            ...
            <tr>
              <td>
                ...
                Recording facility, LCS etc (Data Templates as in 3.4.7)
              </td>
              <td></td>
              <td>
                <input
