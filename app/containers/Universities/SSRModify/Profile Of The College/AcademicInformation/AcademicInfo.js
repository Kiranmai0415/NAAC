    ...
    () => fetch('http://localhost:8080/api/v1/getallacademicdata?collegeId='+collegeId+'&financialYear='+fYear+'&typeofInstitution='+instituteType).then(
      (response) => response
        ...
        .then((data) => {
          ...
          setValuead21(data[0].auniversityAffiliated1[0]?data[0].auniversityAffiliated1[0].inputa2t1:"");
          setValuead22(data[0].auniversityAffiliated1[0]?data[0].auniversityAffiliated1[0].inputa2t2:"");
          setValuead23(data[0].auniversityAffiliated1[0]?data[0].auniversityAffiliated1[0].inputa2t3:"");
          ...
          setValueatg31(data[0].academiciansAppointed[2]?data[0].academiciansAppointed[2].inputaa1t1:"");
          setValueatg32(data[0].academiciansAppointed[2]?data[0].academiciansAppointed[2].inputaa1t2:"");
          setValueatg33(data[0].academiciansAppointed[2]?data[0].academiciansAppointed[2].inputaa1t2:"");
          setValueatg34(data[0].academiciansAppointed[2]?data[0].academiciansAppointed[2].inputaa1t2:"");
