    ...
    () => fetch(resources.APPLICATION_URL+'criteria1getallfiles?collegeId='+collegeId+'&financialYear='+fYear+'&typeofInstitution='+instituteType).then(
      (response) => response
        ...
        .then((data) => {
          ...
          setResponseValue111(data[0].criteria11Ql[0] ? data[0].criteria11Ql[0].response111 : "");
          ...
          setValue1131t11(data[0].yearTable11312[0] ? data[0].yearTable11312[0].input11312y : "");
          setValue1131t12(data[0].yearTable11312[1] ? data[0].yearTable11312[1].input11312y : "");
          setValue1131t13(data[0].yearTable11312[2] ? data[0].yearTable11312[2].input11312y : "");
          setValue1131t14(data[0].yearTable11312[3] ? data[0].yearTable11312[3].input11312y : "");
          setValue1131t15(data[0].yearTable11312[4] ? data[0].yearTable11312[4].input11312y : "");
          setValue1131t16(data[0].yearTable11312[0] ? data[0].yearTable11312[0].input11312v : "");
          setValue1131t17(data[0].yearTable11312[1] ? data[0].yearTable11312[1].input11312v : "");
          setValue1131t18(data[0].yearTable11312[2] ? data[0].yearTable11312[2].input11312v : "");
          setValue1131t19(data[0].yearTable11312[3] ? data[0].yearTable11312[3].input11312v : "");
          setValue1131t20(data[0].yearTable11312[4] ? data[0].yearTable11312[4].input11312v : "");
          ...
          setValue1121f1(data[0].criteria1FileUpload[2] ? data[0].criteria1FileUpload[2].criteria1FileName : "");
          setValue1121f2(data[0].criteria1FileUpload[3] ? data[0].criteria1FileUpload[3].criteria1FileName : "");
          setValue1131f1(data[0].criteria1FileUpload[4] ? data[0].criteria1FileUpload[4].criteria1FileName : "");
          setValue1131f2(data[0].criteria1FileUpload[5] ? data[0].criteria1FileUpload[5].criteria1FileName : "");
          setValue1131f3(data[0].criteria1FileUpload[6] ? data[0].criteria1FileUpload[6].criteria1FileName : "");
          setValue1131f4(data[0].criteria1FileUpload[7] ? data[0].criteria1FileUpload[7].criteria1FileName : "");
          setValue1131f5(data[0].criteria1FileUpload[8] ? data[0].criteria1FileUpload[8].criteria1FileName : "");
        })
        .catch((error) => {
      ...
      <div className="c11x-eachInputField-container">
        ...
        <form>
          <div className="c11x-Ql-label-textarea-container">
            ...
            ></textarea>
            {value111t1 === "" ? (
              <p style={{ color: "red", borderColor:"red" }}>Required*</p>
            ) : null}
          </div>
          ...
          <table className="c11x-Ql-table-style">
            ...
            <tr>
              ...
              <td className="c11x-Ql-tableBorders-style">
                {/* <a href={downloadFile(value111f1)} target="_blank">view</a> */}
            ...
            <tr>
              ...
              <td></td>
              <td className="c11x-Ql-tableBorders-style">
                {/* <a href={downloadFile(value111f2)} target="_blank">view</a> */}
                <Button variant="contained" component="label">
                File Upload
                <input
                  className="input-text"
              ...
              {pathValue111f2 === "" ? null : (
                <div className="c21-fileButtons-container">
                  <button
                    ...
                    style={{ height: "37px", width: "70px" }}
                  >
                    <a target="_openfile" href={filePreviewSrc111f2}>
                      {" "}
                      View File
                    </a>
                  </button>
          ...
          <div className="c11xx-container">
            ...
            <table className="c11x-table-style">
              ...
              <tr>
                ...
                <td></td>
                <td>
                  {/* <a href={downloadFile(value1121f1)} target="_blank">view</a> */}
                  <Button variant="contained" component="label">
                File Upload
                <input
                  className="input-text"
              ...
              {pathValue1121f1 === "" ? null : (
                <div className="c21-fileButtons-container">
                  <button
                    ...
                    style={{ height: "37px", width: "70px" }}
                  >
                    <a target="_openfile" href={filePreviewSrc112f1}>
                      {" "}
                      View File
                    </a>
                  </button>
              ...
              <tr>
                ...
                <td></td>
                <td>
                  {/* <a href={downloadFile(value1121f2)} target="_blank">view</a> */}
                  <Button variant="contained" component="label">
                File Upload
                <input
                  className="input-text"
              ...
              {pathValue1121f2 === "" ? null : (
                <div className="c21-fileButtons-container">
                  <button
                    ...
                    style={{ height: "37px", width: "70px" }}
                  >
                    <a target="_openfile" href={filePreviewSrc112f2}>
                      {" "}
                      View File
                    </a>
                  </button>
              ...
              {/* <tr>
                ...
                <td>
                  <a href=resources.APPLICATION_URL+"download/criteria1.1.2-1.2.2.xlsx">
                    View Template
                  </a>
                </td>
                <td>
                  <a href={downloadFile(value1121f3)} target="_blank">view</a>
                </td>
                <td className="c11x-Qt-tableBorders-style">pdf</td>
              </tr> */}
            </table>
