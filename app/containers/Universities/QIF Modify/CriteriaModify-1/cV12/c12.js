    ...
    () => fetch(resources.APPLICATION_URL+'criteria1getallfiles?collegeId='+collegeId+'&financialYear='+fYear+'&typeofInstitution='+instituteType).then(
      (response) => response
        ...
        .then((data) => {
          ...
          setValue1212f3(data[0].criteria1FileUpload[2] ? data[0].criteria1FileUpload[2].criteria1FileName : "");
          setValue1221f1(data[0].criteria1FileUpload[3] ? data[0].criteria1FileUpload[3].criteria1FileName : "");
          setValue1221f2(data[0].criteria1FileUpload[4] ? data[0].criteria1FileUpload[4].criteria1FileName : "");
          setValue1221f3(data[0].criteria1FileUpload[5] ? data[0].criteria1FileUpload[5].criteria1FileName : "");
        })
        .catch((error) => {
            ...
            <table className="c12x-table-style">
              ...
              {pathValue1212f1 === "" ? null : (
                <div className="c21-fileButtons-container">
                  ...
                  >
                    <a target="_openfile" href={filePreviewSrc121f1}>
                      {" "}
                      View File
                    </a>
                  </button>
              ...
              {pathValue1212f2 === "" ? null : (
                <div className="c21-fileButtons-container">
                  <button
                    ...
                    style={{ height: "37px", width: "70px" }}
                  >
                    <a target="_openfile" href={filePreviewSrc121f2}>
                      {" "}
                      View File
                    </a>
                  </button>
