...
function Criteria62() {
 ...
 //help buttom
  ...
  const [value622t4, setValue622t4] = useState();
  const [value622t5, setValue622t5] = useState();
...
// const financialYear="2021-2022";
  ...
  const inputDataList = {
    ...
    criteria62Ql: [
      ...
      input622t2: value622t2,
      input622t3: value622t3,
      input622t4: value622t4,
      input622t5: value622t5,
        ...
        <form>
          ...
          <table className="c62x-Ql-table-style">
            ...
            <tr>
              ...
              <td className="c62x-Ql-tableBorders-style">
              {/* <a href={downloadFile(value621f1)} target="_blank">view</a> */}
            ...
            <tr>
              ...
              <td className="c62x-Ql-tableBorders-style"></td>
              <td className="c62x-Ql-tableBorders-style">
              {/* <a href={downloadFile(value621f2)} target="_blank">view</a> */}
              <Button variant="contained" component="label">
                File Upload
                <input
                  className="input-text"
            ...
            <tr>
              ...
              <td className="c62x-Ql-tableBorders-style">
              {/* <a href={downloadFile(value621f3)} target="_blank">view</a> */}
              <Button variant="contained" component="label">
                File Upload
                <input
                  className="input-text"
          ...
          <div className="c62x-Ql-label-textarea-container">
            <div className="c62x-heading_Help-container">
              <h1 className="c62x-heading-style">
                ...
                Institution Implements e-governance in its operations <br></br>
       6.2.2.1 e-governance is implemented covering the following areas of operations:
              ...
              1. Administration including complaint management
                ...
                <div className="c65x-radio-container" style={{width:"100%"}}>
                  <div className="c65x-radio-subContainer" style={{width:"45%"}}>
                    ...
                    <input name="653options" id="622-t1" type="radio" 
                      onChange={(e) => { setValue622t1(e.target.value); }} 
                       value="Any 5 or All of the above"/>

                      <label className="c65x-radioLabel-style" for="622-t1">
                      Any 5 or All of the above
                      </label>
                    </div>

                    <div className="c65x-eachRadio-container">
                    <input name="653options" id="622-t2" type="radio" 
                      onChange={(e) => { setValue622t2(e.target.value); }} 
                      value="Any 4 or All of the above"/>

                      <label className="c65x-radioLabel-style" for="622-t2">
                      Any 4 or All of the above
                      </label>
                    </div>

                    <div className="c65x-eachRadio-container">
                    <input name="653options" id="622-t3" type="radio" 
                      onChange={(e) => { setValue622t3(e.target.value); }}
                       value="Any 3 or All of the above"/>

                      <label className="c65x-radioLabel-style" for="622-t3">
                  ...
                  <div className="c65x-radio-subContainer">
                    <div className="c65x-eachRadio-container">
                    <input name="653options" id="622-t4" type="radio" 
                      onChange={(e) => { setValue622t4(e.target.value); }} 
                      value="Any 2 or All of the above"/>

                      <label className="c65x-radioLabel-style" for="622-t4">
                      Any 2 or All of the above
                      </label>
                    </div>

                    <div className="c65x-eachRadio-container">
                      <input name="653options" id="622-t5" type="radio" 
                      onChange={(e) => { setValue622t5(e.target.value); }}
                       value="Any 1 or All of the above"/>
                      <label className="c65x-radioLabel-style" for="622-t5">
          ...
          <table className="c62x-Ql-table-style">
            ...
            <tr>
              ...
              <td className="c62x-Ql-tableBorders-style"></td>
              <td className="c62x-Ql-tableBorders-style">
              {/* <a href={downloadFile(value622f1)} target="_blank">view</a> */}
              <Button variant="contained" component="label">
                File Upload
                <input
                  className="input-text"
            ...
            <tr>
              ...
              <td className="c62x-Ql-tableBorders-style">
              <a href={downloadFile("un6.2.2.xlsx")} target="_blank">View Template</a>
              </td>
              <td className="c62x-Ql-tableBorders-style">
              {/* <a href={downloadFile(value622f2)} target="_blank">view</a> */}
              <Button variant="contained" component="label">
                File Upload
                <input
                  className="input-text"
            ...
            <tr>
              ...
              <td className="c62x-Ql-tableBorders-style">
              {/* <a href={downloadFile(value622f3)} target="_blank">view</a> */}
              <Button variant="contained" component="label">
                File Upload
                <input
                  className="input-text"
        ...
        <form>
            ...
            <div className="c62x-heading_Help-container">
              <div>
                <h1 className="c62x-heading-style">
                  ...
                  Institution Implementation of e-governance in areas of operations
                </h1>
                ...
                <div className="c62x-radio-container"  style={{width:"150%"}}>
                  <div className="c62x-radio-subContainer" style={{width:"45%"}}>
                    <div className="c62x-eachRadio-container">
                      <input name="623options" id="623-t1" type="radio" onChange={(e) => { setValue623t1(e.target.value); }} value="All of the above"/>
                    ...
                    <div className="c62x-eachRadio-container">
                      <input name="623options" id="623-t2" type="radio" onChange={(e) => { setValue623t1(e.target.value); }} value="Any three of the above"/>
                    ...
                    <div className="c62x-eachRadio-container">
                      <input name="623options" id="623-t3" type="radio" onChange={(e) => { setValue623t1(e.target.value); }} value="Any two of the above"/>
                  ...
                  <div className="c62x-radio-subContainer">
                    <div className="c62x-eachRadio-container">
                      <input name="623options" id="623-t4" type="radio" onChange={(e) => { setValue623t1(e.target.value); }} value="Any one of the above"/>
                    ...
                    <div className="c62x-eachRadio-container">
                      <input name="623options" id="623-t5" type="radio" onChange={(e) => { setValue623t1(e.target.value); }} value="None of the above"/>
          ...
          <table className="c62x-table-style">
            ...
            <tr>
              ...
              <td></td>
              <td>
              <a href={downloadFile(value623f1)} target="_blank">view</a>
              </td>
            ...
            <tr>
              ...
              <td></td>
              <td>
              <a href={downloadFile(value623f2)} target="_blank">view</a>
              </td>
              <td className="c62x-Qt-tableBorders-style">pdf</td>
            </tr>
            <tr>
              ...
              <td></td>
              <td>
              <a href={downloadFile(value623f3)} target="_blank">view</a>
              </td>
              <td className="c62x-Qt-tableBorders-style">pdf</td>
            </tr>
            <tr>
              ...
              <td>
                <a href=resources.APPLICATION_URL+"download/criteria6.2.3.xlsx">View Template</a>
              </td>
              <td>
              <a href={downloadFile(value623f4)} target="_blank">view</a>
              </td>
              <td className="c62x-Qt-tableBorders-style">pdf</td>
            </tr>
          </table>
