...
function Help644(props) {
  return props.isHelp644Clicked ? (
    <div className="c64x-help-mainContainer">
      <div className="c64x-help-subContainer">
        <h1 className="c64x-help-heading-style">
        ...
        <button
          ...
          onClick={(e) => {
            e.preventDefault();
            props.setIsHelp644Clicked(false);
          }}
        >
          Close
        </button>
...
function Criteria64() {
 ...
 //help buttom
  ...
  const [value644t1, setValue644t1] = useState();

  const [value644f1, setValue644f1] = useState();
  const [pathValue644f1, setPathValue644f1] = useState('');
  const [value644f2, setValue644f2] = useState();
  const [pathValue644f2, setPathValue644f2] = useState('');
  const [value644f3, setValue644f3] = useState();
  const [pathValue644f3, setPathValue644f3] = useState('');
  const [responseValue644, setResponseValue644] = useState('');
  ...
  const [help644Status, setHelp644Status] = useState(false);
  const [filePreviewSrc641f1, setFilePreviewSrc641f1] = useState();
...
const financialYear="2021-2022";
    ...
    () => fetch(resources.APPLICATION_URL+'criteria6getallfiles?collegeId='+collegeId+'&financialYear='+fYear+'&typeofInstitution='+instituteType).then(
      (response) => response
        ...
        .then((data) => {
          ...
          setValue643t1(data[0].criteria64Ql[0] ? data[0].criteria64Ql[0].input641t1:"");
          setValue644t1(data[0].criteria64Ql[0] ? data[0].criteria64Ql[0].input641t1:"");
          ...
          setValue6421t6(data[0].yearTable6421[0] ? data[0].yearTable6421[0].input6421y:"");
          setValue6421t7(data[0].yearTable6421[1] ? data[0].yearTable6421[1].input6421y:"");
          setValue6421t8(data[0].yearTable6421[2] ? data[0].yearTable6421[2].input6421y:"");
          setValue6421t9(data[0].yearTable6421[3] ? data[0].yearTable6421[3].input6421y:"");
          setValue6421t10(data[0].yearTable6421[4] ? data[0].yearTable6421[4].input6421y:"");
          ...
          setValue6421f1(data[0].criteria6FileUpload[2] ? data[0].criteria6FileUpload[2].criteria6FileName:"");
          setValue6421f2(data[0].criteria6FileUpload[3] ? data[0].criteria6FileUpload[3].criteria6FileName:"");
          setValue6421f3(data[0].criteria6FileUpload[4] ? data[0].criteria6FileUpload[4].criteria6FileName:"");
          setValue643f1(data[0].criteria6FileUpload[5] ? data[0].criteria6FileUpload[5].criteria6FileName:"");
          setValue643f2(data[0].criteria6FileUpload[6] ? data[0].criteria6FileUpload[6].criteria6FileName:"");
          setValue643f3(data[0].criteria6FileUpload[7] ? data[0].criteria6FileUpload[7].criteria6FileName:"");
          setValue644f1(data[0].criteria6FileUpload[0] ? data[0].criteria6FileUpload[0].criteria6FileName:"");
          setValue644f2(data[0].criteria6FileUpload[1] ? data[0].criteria6FileUpload[1].criteria6FileName:"");
          setValue644f3(data[0].criteria6FileUpload[2] ? data[0].criteria6FileUpload[2].criteria6FileName:"");
        })
        .catch((error) => {
  ...
  const inputDataList = {
    ...
    input644t1: value644t1,
    response644: responseValue644,
    ...
    yearTable6421: [
      {criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType },
      uniqueKey1: 201,input6421y: value6421t1, input6421v: value6421t6 },
      {criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType },
      uniqueKey1: 202,input6421y: value6421t2, input6421v: value6421t7 },
      {criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType },
       uniqueKey1: 203,input6421y: value6421t3, input6421v: value6421t8 },
       {criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType },
       uniqueKey1: 204,input6421y: value6421t4, input6421v: value6421t9 },
       {criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType },
       uniqueKey1: 205,input6421y: value6421t5, input6421v: value6421t10 },
    ],
  };
  ...
  function onClickingSave() {
    ...
    if (pathValue644f1 !== '') {
      form64Data.append('uploadfile6', value644f1, 'f644f1-' + value644f1.name);
    }
    if (pathValue644f2 !== '') {
      form64Data.append('uploadfile6', value644f2, 'f644f2-' + value644f2.name);
    }
    if (pathValue644f3 !== '') {
      form64Data.append('uploadfile6', value644f3, 'f644f3-' + value644f3.name);
    }
    ...
    <div className="c64-inputFields-mainContainer">
      ...
      <div className="c64x-eachInputField-container">
        <div className="c64x-weightage-container">
          <h1 className="c64x-weightage-heading-style">Weightage: 4</h1>
        </div>
        <form>
          <div className="c64x-Ql-label-textarea-container">
            <div className="c64x-heading_Help-container">
              <h1 className="c64x-heading-style">
                ...
                Institutional strategies for mobilisation of funds other than salary and fees
      ...
      <div className="c64x-eachInputField-container">
        <div className="c64x-weightage-container">
          <h1 className="c64x-weightage-heading-style">Weightage: 12</h1>
        </div>
        <form>
          ...
          <div className="c64xx-container">
            <h1 className="c64xx-Heading-style">
              <span className="c64xx-span-style">6.4.2.1: </span>
              Total Grants received from government and non-government bodies
and philanthropists for development and maintenance of infrastructure (not
covered under Criteria III and V) year-wise during the last five years (INR in Lakhs)
            </h1>
            ...
            <table className="c64x-table-style">
              ...
              <tr>
                ...
                <td>
                <a href={downloadFile("UN6.4.2.xlsx")} target="_blank">View Template</a>
                </td>
                <td>
                  {/* <input
                    onChange={(e) => {
              ...
              {pathValue6421f3 === "" ? null : (
                <div className="c64-fileButtons-container">
                  <button
                    ...
                    style={{ height: "37px", width: "70px" }}
                  >
                    <a target="_openfile" href={filePreviewSrc6421f3}>
                      {" "}
                      View File
                    </a>
                  </button>
              ...
              <td className="c64x-Ql-tableBorders-style">
                {/* <input
                  onChange={(e) => {
                    ...
                    setPathValue644f1(e.target.value);
                  }}
                  id="643-f1"
                  type="file"
                  className="c64-fileButton-style"
              ...
              <td className="c64x-Ql-tableBorders-style">
                {/* <input
                  onChange={(e) => {
                    ...
                    setPathValue644f2(e.target.value);
                  }}
                  id="643-f1"
                  type="file"
                  className="c64-fileButton-style"
              ...
              <td className="c64x-Ql-tableBorders-style">
                {/* <input
                  onChange={(e) => {
                    ...
                    setPathValue644f3(e.target.value);
                  }}
                  id="643-f3"
                  type="file"
                  className="c64-fileButton-style"
      ...
      {/* <div className="c64x-eachInputField-container">
        <div className="c64x-weightage-container">
          <h1 className="c64x-weightage-heading-style">Weightage: 2</h1>
        </div>
        <form>
          <div className="c64x-Ql-label-textarea-container">
            <div className="c64x-heading_Help-container">
              <h1 className="c64x-heading-style">
                <span className="c64x-span-style">6.4.4: </span>
              ...
              <Help644
                isHelp644Clicked={help644Status}
                setIsHelp644Clicked={setHelp644Status}
              />
            </div>
            <label htmlFor="644-t1" className="c31x-label-style">
              Response:
            </label>
            <textarea
              placeholder="Write description in maximum of 500 words"
              onChange={(e) => {
                setValue644t1(e.target.value);
                setResponseValue644(e.target.value);
              }}
              value={value644t1}
              rows={10}
              className="c64x-textarea-style"
          ...
          <table className="c64x-Ql-table-style">
            ...
            <tr>
              ...
              <td className="c64x-Ql-tableBorders-style"></td>
              <td className="c64x-Ql-tableBorders-style">
              <a href={downloadFile(pathValue644f1)} target="_blank">view</a>
              </td>
              <td className="c64x-Ql-tableBorders-style">pdf</td>
            </tr>
            <tr>
              ...
              <td className="c64x-Ql-tableBorders-style"></td>
              <td className="c64x-Ql-tableBorders-style">
              <a href={downloadFile(pathValue644f2)} target="_blank">view</a>
              </td>
              <td className="c64x-Ql-tableBorders-style">pdf</td>
            </tr>
            <tr>
              ...
              <td className="c64x-Ql-tableBorders-style">
              <a href={downloadFile(pathValue644f3)} target="_blank">view</a>
              </td>
              <td className="c64x-Ql-tableBorders-style">pdf</td>
            </tr>
          </table>
