...
function Criteria65() {
 ...
 //help buttom
  ...
  const [filePreviewSrc111f1, setFilePreviewSrc111f1] = useState('null')
    ...
    () => fetch(resources.APPLICATION_URL+'criteria6getallfiles?collegeId='+collegeId+'&financialYear='+fYear+'&typeofInstitution='+instituteType).then(
      (response) => response
        ...
        .then((data) => {
          ...
          setValue652t2(data[0].criteria65Ql[1] ? data[0].criteria65Ql[1].input651t1:"");
          setValue653t3(data[0].criteria65Qn[2] ? data[0].criteria65Ql[2].input651t1:"");
          setValue654t4(data[0].criteria65Qn[3] ? data[0].criteria65Ql[3].input651t1:"");
        })
        .catch((error) => {
        ...
        <form>
          ...
          <table className="c65x-Ql-table-style">
            ...
            <tr>
              ...
              <td className="c65x-Ql-tableBorders-style">
              {/* <a href={downloadFile(value651f1)} target="_blank">view</a> */}
            ...
            <tr>
              ...
              <td className="c65x-Ql-tableBorders-style"></td>
              <td className="c65x-Ql-tableBorders-style">
              {/* <a href={downloadFile(value651f2)} target="_blank">view</a> */}
              <Button variant="contained" component="label">
                File Upload
                <input
                  className="input-text"
        ...
        <form>
              ...
              1. Academic and Administrative Audit (AAA) and follow up action taken
                ...
                <div className="c65x-radio-container" style={{width:"100%"}}>
                  <div className="c65x-radio-subContainer" style={{width:"45%"}}>
                    ...
                    <input name="653options" id="652-t1" type="radio" 
                    ...
                    <div className="c65x-eachRadio-container">
                    <input name="653options" id="652-t2" type="radio" 
                      onChange={(e) => { setValue652t2(e.target.value); }} 
                    ...
                    <input name="653options" id="653-t3" type="radio" 
                      onChange={(e) => { setValue652t3(e.target.value); }}
                  ...
                  <div className="c65x-radio-subContainer">
                    <div className="c65x-eachRadio-container">
                    <input name="653options" id="653-t3" type="radio" 
                      onChange={(e) => { setValue652t4(e.target.value); }} 
                    ...
                    <div className="c65x-eachRadio-container">
                      <input name="653options" id="653-t3" type="radio" 
                      onChange={(e) => { setValue652t5(e.target.value); }}
          ...
          <table className="c65x-Ql-table-style">
            ...
            <tr>
              ...
              <td className="c65x-Ql-tableBorders-style">
              {/* <a href={downloadFile(value652f1)} target="_blank">view</a> */}
              <Button variant="contained" component="label">
                File Upload
                <input
                  className="input-text"
            ...
            <tr>
              ...
              <td className="c65x-Ql-tableBorders-style">
              <a href={downloadFile("unxlsx")} target="_blank">view Template</a>
              </td>
              <td className="c65x-Ql-tableBorders-style">
              <a href={downloadFile(value652f2)} target="_blank">view</a>
              <Button variant="contained" component="label">
                File Upload
                <input
                  className="input-text"
...
Post accreditation quality initiatives (second and subsequent cycles of NAAC A/A)
          ...
          <table className="c65x-table-style">
            ...
            <tr>
              ...
              <td></td>
              <td>
              {/* <a href={downloadFile(value653f1)} target="_blank">view</a> */}
              <Button variant="contained" component="label">
                File Upload
                <input
                  className="input-text"
            ...
            <tr>
              ...
              <td></td>
              <td>
              {/* <a href={downloadFile(value653f2)} target="_blank">view</a> */}
              <Button variant="contained" component="label">
                File Upload
                <input
                  className="input-text"
              ...
              {pathValue653f2 === "" ? null : (
                <div className="c65-fileButtons-container">
                  ...
                  <button
                    ...
                    onClick={(e) => {
                      setPathValue653f2("");
                      document.getElementById("653f2").value = "";
                    }}
                    style={{ height: "37px", width: "70px" }}
                  >
                    Reset
            ...
            <tr>
              ...
              <td></td>
              <td>
              {/* <a href={downloadFile(value653f3)} target="_blank">view</a> */}
              <Button variant="contained" component="label">
                File Upload
                <input
                  className="input-text"
            ...
            <tr>
              ...
              <td></td>
              <td>
              {/* <a href={downloadFile(value653f4)} target="_blank">view</a> */}
              <Button variant="contained" component="label">
                File Upload
                <input
                  className="input-text"
