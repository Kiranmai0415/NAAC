...
console.log("current year==" + fYear);
  ...
  useEffect(
    () => fetch(resources.APPLICATION_URL+'criteria6getallfiles?collegeId='+collegeId+'&financialYear='+fYear+'&typeofInstitution='+instituteType).then(
      (response) => response
        ...
        .then((data) => {
          ...
          setValue6341t1(data[0].yearTable6341[0] ? data[0].yearTable6341[0].input6341y:"");
          setValue6341t2(data[0].yearTable6341[1] ? data[0].yearTable6341[1].input6341y:"");
          setValue6341t3(data[0].yearTable6341[2] ? data[0].yearTable6341[2].input6341y:"");
          setValue6341t4(data[0].yearTable6341[3] ? data[0].yearTable6341[3].input6341y:"");
          setValue6341t5(data[0].yearTable6341[4] ? data[0].yearTable6341[4].input6341y:"");
          setValue6341t6(data[0].yearTable6341[0] ? data[0].yearTable6341[0].input6341v:"");
          setValue6341t7(data[0].yearTable6341[1] ? data[0].yearTable6341[1].input6341v:"");
          setValue6341t8(data[0].yearTable6341[2] ? data[0].yearTable6341[2].input6341v:"");
          setValue6341t9(data[0].yearTable6341[3] ? data[0].yearTable6341[3].input6341v:"");
          setValue6341t10(data[0].yearTable6341[4] ? data[0].yearTable6341[4].input6341v:"");

          setValue6341t11(data[0].yearTable63412[0] ? data[0].yearTable63412[0].input63412y:"");
          setValue6341t12(data[0].yearTable63412[1] ? data[0].yearTable63412[1].input63412y:"");
          setValue6341t13(data[0].yearTable63412[2] ? data[0].yearTable63412[2].input63412y:"");
          setValue6341t14(data[0].yearTable63412[3] ? data[0].yearTable63412[3].input63412y:"");
          setValue6341t15(data[0].yearTable63412[4] ? data[0].yearTable63412[4].input63412y:"");
          setValue6341t16(data[0].yearTable63412[0] ? data[0].yearTable63412[0].input63412v:"");
          setValue6341t17(data[0].yearTable63412[1] ? data[0].yearTable63412[1].input63412v:"");
          setValue6341t18(data[0].yearTable63412[2] ? data[0].yearTable63412[2].input63412v:"");
          setValue6341t19(data[0].yearTable63412[3] ? data[0].yearTable63412[3].input63412v:"");
          setValue6341t20(data[0].yearTable63412[4] ? data[0].yearTable63412[4].input63412v:"");

          setValue631f1(data[0].criteria6FileUpload[0] ? data[0].criteria6FileUpload[0].criteria6FileName:"");
          setValue631f2(data[0].criteria6FileUpload[1] ? data[0].criteria6FileUpload[1].criteria6FileName:"");
          setValue631f3(data[0].criteria6FileUpload[2] ? data[0].criteria6FileUpload[2].criteria6FileName:"");
          setValue6321f1(data[0].criteria6FileUpload[3] ? data[0].criteria6FileUpload[3].criteria6FileName:"");
          setValue6321f2(data[0].criteria6FileUpload[4] ? data[0].criteria6FileUpload[4].criteria6FileName:"");
          setValue6331f1(data[0].criteria6FileUpload[5] ? data[0].criteria6FileUpload[5].criteria6FileName:"");
          setValue6331f2(data[0].criteria6FileUpload[6] ? data[0].criteria6FileUpload[6].criteria6FileName:"");
          setValue6331f3(data[0].criteria6FileUpload[7] ? data[0].criteria6FileUpload[7].criteria6FileName:"");
          setValue6331f4(data[0].criteria6FileUpload[8] ? data[0].criteria6FileUpload[8].criteria6FileName:"");
          setValue6341f1(data[0].criteria6FileUpload[9] ? data[0].criteria6FileUpload[9].criteria6FileName:"");
          setValue6341f2(data[0].criteria6FileUpload[10] ? data[0].criteria6FileUpload[10].criteria6FileName:"");
          setValue6341f3(data[0].criteria6FileUpload[11] ? data[0].criteria6FileUpload[11].criteria6FileName:"");
          setValue6341f4(data[0].criteria6FileUpload[12] ? data[0].criteria6FileUpload[12].criteria6FileName:"");
        })
        .catch((error) => {
   ...
   const inputDataList = {
    ...
    yearTable6321: [
      {criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType },
      uniqueKey1: 201, input6321y: value6321t1, input6321v: value6321t6 },
      {criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType },
       uniqueKey1: 202,input6321y: value6321t2, input6321v: value6321t7 },
       {criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType },
       uniqueKey1: 203, input6321y: value6321t3, input6321v: value6321t8 },
       {criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType },
       uniqueKey1: 204, input6321y: value6321t4, input6321v: value6321t9 },
       {criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType },
       uniqueKey1: 205, input6321y: value6321t5, input6321v: value6321t10 },
    ],
    yearTable63212: [
      {criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType },
       uniqueKey1: 201, input63212y: value6321t11, input63212v: value6321t16 },
       {criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType },
       uniqueKey1: 202, input63212y: value6321t12, input63212v: value6321t17 },
       {criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType },
       uniqueKey1: 203, input63212y: value6321t13, input63212v: value6321t18 },
       {criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType },
       uniqueKey1: 204, input63212y: value6321t14, input63212v: value6321t19 },
       {criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType },
       uniqueKey1: 205, input63212y: value6321t15, input63212v: value6321t20 },
    ],
    yearTable6331: [
      {criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType },
       uniqueKey1: 201, input6331y: value6331t1, input6331v: value6331t6 },
       {criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType },
       uniqueKey1: 202, input6331y: value6331t2, input6331v: value6331t7 },
       {criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType },
       uniqueKey1: 203, input6331y: value6331t3, input6331v: value6331t8 },
       {criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType },
       uniqueKey1: 204, input6331y: value6331t4, input6331v: value6331t9 },
       {criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType },
       uniqueKey1: 205, input6331y: value6331t5, input6331v: value6331t10 },
    ],
    yearTable6341: [
      {criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType },
       uniqueKey1: 201, input6341y: value6341t1, input6341v: value6341t6 },
       {criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType },
       uniqueKey1: 202, input6341y: value6341t2, input6341v: value6341t7 },
       {criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType },
       uniqueKey1: 203, input6341y: value6341t3, input6341v: value6341t8 },
       {criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType },
       uniqueKey1: 204, input6341y: value6341t4, input6341v: value6341t9 },
       {criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType },
       uniqueKey1: 205, input6341y: value6341t5, input6341v: value6341t10 },
    ],
    yearTable63412: [
      {criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType },
       uniqueKey1: 201, input63412y: value6341t11, input63412v: value6341t16 },
       {criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType },
       uniqueKey1: 202, input63412y: value6341t12, input63412v: value6341t17 },
       {criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType },
       uniqueKey1: 203, input63412y: value6341t13, input63412v: value6341t18 },
       {criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType },
       uniqueKey1: 204, input63412y: value6341t14, input63412v: value6341t19 },
       {criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType },
       uniqueKey1: 205, input63412y: value6341t15, input63412v: value6341t20 },
    ],
  };
    ...
    <div className="c63-inputFields-mainContainer">
      ...
      <div className="c63x-eachInputField-container">
        <div className="c63x-weightage-container">
          <h1 className="c63x-weightage-heading-style">Weightage: 4</h1>
        </div>
        <form>
          ...
          <table className="c63x-Ql-table-style">
            ...
            <tr>
              ...
              <td className="c63x-Ql-tableBorders-style">
              {/* <a href={downloadFile(value631f1)} target="_blank">view</a> */}
              ...
              {pathValue631f1 === "" ? null : (
                <div className="c63-fileButtons-container">
                  <button
                    className="c63-viewFileButton-style"
                    style={{ height: "37px", width: "70px" }}
                  >
                    <a target="_openfile" href={filePreviewSrc631f1}>
                      {" "}
                      View File
                    </a>
                  </button>
                  <button
                    className="c63-removeFileButton-style"
                    onClick={(e) => {
                      setPathValue631f1("");
            ...
            <tr>
              ...
              <td className="c63x-Ql-tableBorders-style"></td>
              <td className="c63x-Ql-tableBorders-style">
              {/* <a href={downloadFile(value631f2)} target="_blank">view</a> */}
              <Button variant="contained" component="label">
                File Upload
                <input
                  className="input-text"
              ...
              {pathValue631f2 === "" ? null : (
                <div className="c63-fileButtons-container">
                  <button
                    ...
                    style={{ height: "37px", width: "70px" }}
                  >
                    <a target="_openfile" href={filePreviewSrc631f2}>
                      {" "}
                      View File
                    </a>
                  </button>
            ...
            <tr>
              ...
              <td className="c63x-Ql-tableBorders-style">
              {/* <a href={downloadFile(value631f3)} target="_blank">view</a> */}
              <Button variant="contained" component="label">
                File Upload
                <input
                  className="input-text"
              ...
              {pathValue631f3 === "" ? null : (
                <div className="c63-fileButtons-container">
                  <button
                    ...
                    style={{ height: "37px", width: "70px" }}
                  >
                    <a target="_openfile" href={filePreviewSrc631f3}>
                      {" "}
                      View File
                    </a>
                  </button>
          ...
          <div className="c63x-container">
            <div className="c63x-heading_Help-container">
              ...
              <HelpButton
                ...
                title='Write description in a maximum of 500 words'
                ><h1>(Total number of teachers provided with financial support to attend conferences,workshops and towards membership fee of professional bodies)/((2.1) Total number of full time teachers) * 100</h1></HelpButton>
            </div>
...
bodies year-wise during the last five years
            ...
            <table className="c63x-table-style">
              ...
              <tr>
                ...
                <td></td>
                <td>
                {/* <a href={downloadFile(value6321f1)} target="_blank">view</a> */}
                <Button variant="contained" component="label">
                File Upload
                <input
                  className="input-text"
              ...
              {pathValue6321f1 === "" ? null : (
                <div className="c63-fileButtons-container">
                  <button
                    ...
                    style={{ height: "37px", width: "70px" }}
                  >
                    <a target="_openfile" href={filePreviewSrc6321f1}>
                      {" "}
                      View File
                    </a>
                  </button>
              ...
              <tr>
                ...
                <td></td>
                <td>
                {/* <a href={downloadFile(value6321f2)} target="_blank">view</a> */}
                <Button variant="contained" component="label">
                File Upload
                <input
                  className="input-text"
        ...
        <form>
          <div className="c63x-container">
            <div className="c63x-heading_Help-container">
              <h1 className="c63x-heading-style">
                ...
                Percentage of teachers undergoing online/ face-to-face Faculty Development Programmes (FDP)/ Management Development Programs (MDP) during the last five years (Professional Development Programmes, Orientation/Induction Programmes, Refresher Course, Short Term Course )
              </h1>
              <button
              ...
              <HelpButton
                ...
                title='formula'
                ><h1>(Total number of teaching staff attending such Programmes )/((2.1)Total number of full time teachers) * 100</h1></HelpButton>
            </div>
            <div className="c63x-response-container">
              <button
                onClick={(e) => {
          ...
          <div className="c63xx-container">
            <h1 className="c63xx-Heading-style">
              ...
              Total number of teachers who have undergone online/ face-to-
             face Faculty Development Programmes (FDP)/ Management

Development Programs (MDP) during the last five years
(Professional Development Programmes, Orientation / Induction
Programmes, Refresher Course, Short Term Course )year-wise during
the last five years
            </h1>
            ...
            <table className="c63x-table-style">
              ...
              <tr>
                ...
                <td></td>
                <td>
                {/* <a href={downloadFile(value6331f1)} target="_blank">view</a> */}
                <Button variant="contained" component="label">
                File Upload
                <input
                  className="input-text"
              ...
              {pathValue6331f1 === "" ? null : (
                <div className="c63-fileButtons-container">
                  <button
                    ...
                    style={{ height: "37px", width: "70px" }}
                  >
                    <a target="_openfile" href={filePreviewSrc6331f1}>
                      {" "}
                      View File
                    </a>
                  </button>
              ...
              <tr>
                ...
                <td></td>
                <td>
                {/* <a href={downloadFile(value6331f2)} target="_blank">view</a> */}
                <Button variant="contained" component="label">
                File Upload
                <input
                  className="input-text"
              ...
              {pathValue6331f2 === "" ? null : (
                <div className="c63-fileButtons-container">
                  <button
                    ...
                    style={{ height: "37px", width: "70px" }}
                  >
                    <a target="_openfile" href={filePreviewSrc6331f2}>
                      {" "}
                      View File
                    </a>
                  </button>
              ...
              <tr>
                ...
                <td></td>
                <td>
                {/* <a href={downloadFile(value6331f3)} target="_blank">view</a> */}
                <Button variant="contained" component="label">
                File Upload
                <input
                  className="input-text"
              ...
              <tr>
                ...
                <td>
                <a href={downloadFile("UN6.3.3.xlsx")} target="_blank">View Template</a>
                </td>
                <td>
                {/* <a href={downloadFile(value6331f4)} target="_blank">view</a> */}
                <Button variant="contained" component="label">
                File Upload
                <input
                  className="input-text"
              ...
              {pathValue6331f4 === "" ? null : (
                <div className="c63-fileButtons-container">
                  <button
                    ...
                    style={{ height: "37px", width: "70px" }}
                  >
                    <a target="_openfile" href={filePreviewSrc6331f4}>
                      {" "}
                      View File
                    </a>
                  </button>
        ...
        <form>
          ...
          <div className="c63xx-container">
            <h1 className="c63xx-Heading-style">
              ...
              Total number of teachers undergoing online/face-to-face Faculty Development Programmes (FDP) during the last five years 
             (professional Development Programmes, Orientation/Induction Programmes, Refresher course, short term course ) year-wise
            ...
            <table className="c63x-table-style">
              ...
              <tr>
                ...
                <td></td>
                <td>
                <a href={downloadFile(value6341f1)} target="_blank">view</a>
                </td>
                <td className="c63x-Qt-tableBorders-style">pdf</td>
              </tr>
              <tr>
                ...
                <td></td>
                <td>
                <a href={downloadFile(value6341f2)} target="_blank">view</a>
                </td>
                <td className="c63x-Qt-tableBorders-style">pdf</td>
              </tr>
              <tr>
                ...
                <td></td>
                <td>
                <a href={downloadFile(value6341f3)} target="_blank">view</a>
                </td>
                <td className="c63x-Qt-tableBorders-style">pdf</td>
              </tr>
              <tr>
                ...
                <td>
                <a href={downloadFile(value6341f4)} target="_blank">view</a>
                </td>
                <td className="c63x-Qt-tableBorders-style">pdf</td>
              </tr>
            </table>
      ...
      <div className="c63x-button-container">
        <button onClick={onClickingSave} className="c63x-button-style">
         Modify
        </button>
      </div>
    </div>
