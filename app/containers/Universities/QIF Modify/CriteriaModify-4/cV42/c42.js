    ...
    () => fetch(resources.APPLICATION_URL+'criteria4getallfiles?collegeId='+collegeId+'&financialYear='+fYear+'&typeofInstitution='+instituteType).then(
      (response) => response
        ...
        .then((data) => {
          ...
          setValue4231t6(data[0].yearTable4231[0] ? data[0].yearTable4231[0].input4231y : "");
          setValue4231t7(data[0].yearTable4231[1] ? data[0].yearTable4231[1].input4231y : "");
          setValue4231t8(data[0].yearTable4231[2] ? data[0].yearTable4231[2].input4231y : "");
          setValue4231t9(data[0].yearTable4231[3] ? data[0].yearTable4231[3].input4231y : "");
          setValue4231t10(data[0].yearTable4231[4] ? data[0].yearTable4231[4].input4231y : "");
        ...
        <form>
          ...
          {/* <table className="c42x-Ql-table-style">
            ...
            <tr>
              ...
              <td className="c42x-Ql-tableBorders-style">
              <a href={downloadFile(value421f1)} target="_blank">view</a>
              </td>
            ...
            <tr>
              ...
              <td></td>
              <td>
              <a href={downloadFile(value421f2)} target="_blank">view</a>
              </td>
        ...
        <form>
          <div className="c42x-container">
            <div className="c42x-heading_Help-container">
              <div>
                ...
                <div className="c42x-radio-container" style={{width:"210%"}}>
          ...
          <table className="c42x-table-style">
            ...
            <tr>
              ...
              <td></td>
              <td>
              <a href={downloadFile(value422f1)} target="_blank">view</a>
              </td>
              <td className="c42x-Qt-tableBorders-style">pdf</td>
            </tr>
            <tr>
              ...
              <td>
              <a href={downloadFile(value422f2)} target="_blank">view</a>
              </td>
              <td className="c42x-Qt-tableBorders-style">pdf</td>
            </tr>
          </table>
          ...
          <div className="c42xx-container">
            ...
            <table className="c42x-table-style">
              ...
              <tr>
                ...
                <td></td>
                <td>
                {/* <a href={downloadFile(value4231f1)} target="_blank">view</a> */}
              ...
              {pathValue4231f1 === "" ? null : (
                <div className="c21-fileButtons-container">
                  ...
                  >
                    <a target="_openfile" href={filePreviewSrc423f1}>
                      {" "}
                      View File
                    </a>
                  </button>
              ...
              <tr>
                ...
                <td></td>
                <td>
                {/* <a href={downloadFile(value4231f2)} target="_blank">view</a> */}
                <Button variant="contained" component="label">
                File Upload
                <input
                  className="input-text"
              ...
              <tr>
                ...
                <td>
                <a href={downloadFile("un4.2.2.xlsx")} target="_blank">View Template</a>
                </td>
                <td>
                {/* <a href={downloadFile(value4231f3)} target="_blank">view</a> */}
                <Button variant="contained" component="label">
                File Upload
                <input
                  className="input-text"
      ...
      {/* <div className="c42x-eachInputField-container">
        ...
        <form>
          <div className="c42x-container">
            <div className="c42x-heading_Help-container">
              <h1 className="c42x-heading-style">
                ...
                foot falls and login data for online access)(data provided only for the latest
          ...
          <div className="c42xx-container">
            ...
            <h1 className="c42xx-Heading-style">
              <span className="c42xx-span-style">4.2.4.2: 
