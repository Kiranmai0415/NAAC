      ...
      (response) => response
        ...
        .then((data) => {
         ...
         // setValue5111t20(data[0].yearTable51112[4] ? data[0].yearTable51112[4].input51112v: "");
          ...
          // setValue5121t6(data[0].yearTable5121[0] ? data[0].yearTable5121[0].input5121y: "");
          // setValue5121t7(data[0].yearTable5121[1] ? data[0].yearTable5121[1].input5121y: "");
          // setValue5121t8(data[0].yearTable5121[2] ? data[0].yearTable5121[2].input5121y: "");
          // setValue5121t9(data[0].yearTable5121[3] ? data[0].yearTable5121[3].input5121y: "");
          // setValue5121t10(data[0].yearTable5121[4] ? data[0].yearTable5121[4].input5121y: "");
          ...
          // setValue5121t16(data[0].yearTable51212[0] ? data[0].yearTable51212[0].input51212y: "");
          // setValue5121t17(data[0].yearTable51212[1] ? data[0].yearTable51212[1].input51212y: "");
          // setValue5121t18(data[0].yearTable51212[2] ? data[0].yearTable51212[2].input51212y: "");
          // setValue5121t19(data[0].yearTable51212[3] ? data[0].yearTable51212[3].input51212y: "");
          // setValue5121t20(data[0].yearTable51212[4] ? data[0].yearTable51212[4].input51212y: "");
    ...
    <div className="c51-inputFields-mainContainer">
      ...
      <div className="c51x-eachInputField-container">
        <div className="c51x-weightage-container">
          <h1 className="c51x-weightage-heading-style">Weightage: 15</h1>
        </div>
        <form>
...
<button
              ...
              <HelpButton
                ...
                title='formula'
                >(Total number of students benefited by scholarships and freeships by institution,government and non-government agencies) / ( 1.1 Total number of students on rolls) * 100</HelpButton>
            </div>
        ...
        years 
            ...
            <table className="c51x-table-style">
              ...
              <tr>
                ...
                <td></td>
                <td>
                {/* <a href={downloadFile(value5111f1)} target="_blank">view</a> */}
              ...
              {pathValue5111f1 === "" ? null : (
                <div className="c51-fileButtons-container">
                  <button
                    className="c51-viewFileButton-style"
                    style={{ height: "37px", width: "70px" }}
                  >
                    <a target="_openfile" href={filePreviewSrc511f1}>
                      {" "}
                      View File
                    </a>
                  </button>
                  <button
                    className="c51-removeFileButton-style"
                    onClick={(e) => {
                      setPathValue5111f1("");
              ...
              <tr>
                ...
                <td></td>
                <td>
                {/* <a href={downloadFile(value5111f2)} target="_blank">view</a> */}
                <Button variant="contained" component="label">
                File Upload
                <input
                  className="input-text"
              ...
              {pathValue5111f2 === "" ? null : (
                <div className="c51-fileButtons-container">
                  <button
                    ...
                    style={{ height: "37px", width: "70px" }}
                  >
                    <a target="_openfile" href={filePreviewSrc511f2}>
                      {" "}
                      View File
                    </a>
                  </button>
              ...
              <tr>
                <td> Average percentage of students benefited by scholarships and
                  ...
                  years</td>
                <td>
                <a href={downloadFile("un5.1.1.xlsx")} target="_blank">View Template</a>
                </td>
                <td>
                {/* <a href={downloadFile(value5111f3)} target="_blank">view</a> */}
                <Button variant="contained" component="label">
                File Upload
                <input
                  className="input-text"
              ...
              {pathValue5111f3 === "" ? null : (
                <div className="c51-fileButtons-container">
                  <button
                    ...
                    style={{ height: "37px", width: "70px" }}
                  >
                    <a target="_openfile" href={filePreviewSrc511f3}>
                      {" "}
                      View File
                    </a>
                  </button>
                  <button
                    ...
                    onClick={(e) => {
                      setPathValue5111f3("");
                      document.getElementById("5111f3").value = "";
                    }}
                    style={{ height: "37px", width: "70px" }}
                  >
                    Reset
          ...
          <div className="c51xx-container">
            ...
            <table className="c51x-table-style">
              ...
              <tr>
                ...
                <td></td>
                <td>
                {/* <a href={downloadFile(value5121f1)} target="_blank">view</a> */}
                <Button variant="contained" component="label">
                File Upload
                <input
                  className="input-text"
              ...
              {pathValue5121f1 === "" ? null : (
                <div className="c51-fileButtons-container">
                  ...
                  <button
                    ...
                    onClick={(e) => {
                      setPathValue5121f1("");
                      document.getElementById("5121f1").value = "";
                    }}
                    style={{ height: "37px", width: "70px" }}
                  >
                    Reset
              ...
              <tr>
                ...
                <td>
                <a href={downloadFile("un5.1.3.xlsx")} target="_blank">View Template</a>
                </td>
                <td>
                {/* <a href={downloadFile(value5121f2)} target="_blank">view</a> */}
                <Button variant="contained" component="label">
                File Upload
                <input
                  className="input-text"
        ...
        <form>
          ...
          <table className="c51x-table-style">
            ...
            <tr>
              ...
              <td></td>
              <td>
              {/* <a href={downloadFile(value513f1)} target="_blank">view</a> */}
              <Button variant="contained" component="label">
                File Upload
                <input
                  className="input-text"
            ...
            <tr>
              ...
              <td></td>
              <td>
              {/* <a href={downloadFile(value513f2)} target="_blank">view</a> */}
              <Button variant="contained" component="label">
                File Upload
                <input
                  className="input-text"
            ...
            <tr>
              ...
              <td>
              <a href={downloadFile("un5.1.4.xlsx")} target="_blank">View Template</a>
              </td>
              <td>
              {/* <a href={downloadFile(value513f3)} target="_blank">view</a> */}
              <Button variant="contained" component="label">
                File Upload
                <input
                  className="input-text"
        ...
        <form>
          ...
          <table className="c51x-table-style">
            ...
            <tr>
              ...
              <td></td>
              <td>
              {/* <a href={downloadFile(value514f1)} target="_blank">view</a> */}
              <Button variant="contained" component="label">
                File Upload
                <input
                  className="input-text"
            ...
            <tr>
              ...
              <td></td>
              <td>
              {/* <a href={downloadFile(value514f2)} target="_blank">view</a> */}
              <Button variant="contained" component="label">
                File Upload
                <input
                  className="input-text"
              ...
              {pathValue514f2 === "" ? null : (
                <div className="c51-fileButtons-container">
                  <button
                    ...
                    style={{ height: "37px", width: "70px" }}
                  >
                    <a target="_openfile" href={filePreviewSrc514f2}>
                      {" "}
                      View File
                    </a>
                  </button>
            ...
            <tr>
              ...
              <td></td>
              <td>
              {/* <a href={downloadFile(value514f3)} target="_blank">view</a> */}
              <Button variant="contained" component="label">
                File Upload
                <input
                  className="input-text"
              ...
              {pathValue514f3 === "" ? null : (
                <div className="c51-fileButtons-container">
                  <button
                    ...
                    style={{ height: "37px", width: "70px" }}
                  >
                    <a target="_openfile" href={filePreviewSrc514f3}>
                      {" "}
                      View File
                    </a>
                  </button>
