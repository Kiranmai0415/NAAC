          ...
          <div className="c26xx-container">
            <table className="c26x-table-style">
              ...
              <tr>
                ...
                <td></td>
                <td>
                {/* <a href={downloadFile(value261f1)} target="_blank">view</a> */}
              ...
              {pathValue261f1 === "" ? null : (
                <div className="c26-fileButtons-container">
                  <button
                    className="c26-viewFileButton-style"
                    style={{ height: "37px", width: "70px" }}
                  >
                    <a target="_openfile" href={filePreviewSrc261f1}>
                      {" "}
                      View File
                    </a>
                  </button>
                  <button
                    className="c26-removeFileButton-style"
                    onClick={(e) => {
                      setPathValue261f1("");
              ...
              <tr>
                ...
                <td></td>
                <td>
                {/* <a href={downloadFile(value261f2)} target="_blank">view</a> */}
                <Button variant="contained" component="label">
                File Upload
                <input
                  className="input-text"
              ...
              {pathValue261f2 === "" ? null : (
                <div className="c26-fileButtons-container">
                  <button
                    ...
                    style={{ height: "37px", width: "70px" }}
                  >
                    <a target="_openfile" href={filePreviewSrc261f2}>
                      {" "}
                      View File
                    </a>
                  </button>
              ...
              <tr>
                ...
                <td></td>
                <td>
                {/* <a href={downloadFile(value261f3)} target="_blank">view</a> */}
                <Button variant="contained" component="label">
                File Upload
                <input
                  className="input-text"
              ...
              {pathValue261f3 === "" ? null : (
                <div className="c26-fileButtons-container">
                  <button
                    ...
                    style={{ height: "37px", width: "70px" }}
                  >
                    <a target="_openfile" href={filePreviewSrc261f3}>
                      {" "}
                      View File
                    </a>
                  </button>
          ...
          <div className="c26xx-container">
            <table className="c26x-table-style">
              ...
              <tr>
                ...
                <td></td>
                <td>
                {/* <a href={downloadFile(value262f1)} target="_blank">view</a> */}
                <Button variant="contained" component="label">
                File Upload
                <input
                  className="input-text"
              ...
              {pathValue262f1 === "" ? null : (
                <div className="c26-fileButtons-container">
                  <button
                    ...
                    style={{ height: "37px", width: "70px" }}
                  >
                    <a target="_openfile" href={filePreviewSrc262f1}>
                      {" "}
                      View File
                    </a>
                  </button>
              ...
              <tr>
                ...
                <td></td>
                <td>
                {/* <a href={downloadFile(value262f2)} target="_blank">view</a> */}
                <Button variant="contained" component="label">
                File Upload
                <input
                  className="input-text"
          ...
          <div className="c26xx-container">
            ...
            <table className="c26x-table-style">
              ...
              <tr>
                ...
                <td><a href="http://localhost:8080/api/v1/download/criteria2.6.3.xlsx">View Template</a></td>
                <td>
                <a href={downloadFile(value2632f1)} target="_blank">view</a>
                </td>
                <td className="c26x-Qt-tableBorders-style">pdf</td>
              </tr>
              <tr>
                ...
                <td></td>
                <td>
                <a href={downloadFile(value2632f2)} target="_blank">view</a>
                </td>
                <td className="c26x-Qt-tableBorders-style">pdf</td>
              </tr>
              <tr>
                ...
                <td></td>
                <td>
                <a href={downloadFile(value2632f3)} target="_blank">view</a>
                </td>
                <td className="c26x-Qt-tableBorders-style">pdf</td>
              </tr>
            </table>
