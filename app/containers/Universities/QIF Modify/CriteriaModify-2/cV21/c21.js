  ...
  useEffect(
    () => fetch(resources.APPLICATION_URL+'criteria2getallfiles?collegeId='+collegeId+'&financialYear='+fYear+'&typeofInstitution='+instituteType).then(
      (response) => response
        .json()
        .then((data) => {
          setValue2112t11(data[0].criteria21Qn[0] ? data[0].criteria21Qn[0].input2112t11 : "");
          setValue2111t2(data[0].criteria21Qn[0] ? data[0].criteria21Qn[0].input2111t2 : "");
          ...
          setValue2111t2(data[0].yearTable2111[1] ? data[0].yearTable2111[1].input2111v : "");
          ...
          setValue2121t2(data[0].yearTable2121[1] ? data[0].yearTable2121[1].input2121v : "");
        ...
        <form>
          ...
          <table className="c21x-table-style">
            ...
            <tr>
              ...
              <td></td>
              <td>
                {/* <a href={downloadFile(value2112f1)} target="_blank">view</a> */}
              ...
              {pathValue2112f1 === "" ? null : (
                <div className="c21-fileButtons-container">
                  ...
                  >
                    <a target="_openfile" href={filePreviewSrc211f1}>
                      {" "}
                      View File
                    </a>
                  </button>
                  <button
                    className="c21-removeFileButton-style"
                    onClick={(e) => {
                      setPathValue2112f1("");
            ...
            <tr>
              ...
              <td> <a href="http://localhost:8080/api/v1/download/criteria2.1.1.xlsx">View Template</a></td>
              <td>
                {/* <a href={downloadFile(value2112f2)} target="_blank">view</a> */}
                <Button variant="contained" component="label">
                File Upload
                <input
                  className="input-text"
              ...
              {pathValue2112f2 === "" ? null : (
                <div className="c21-fileButtons-container">
                  <button
                    ...
                    style={{ height: "37px", width: "70px" }}
                  >
                    <a target="_openfile" href={filePreviewSrc211f2}>
                      {" "}
                      View File
                    </a>
                  </button>
        ...
        <form>
          ...
          <div className="c21xx-container">
            <h1 className="c21xx-Heading-style">
             ...
             Number of actual students admitted against the reserved categories year-wise during the last five years           
              </h1>
              <h1 className="c21xx-Heading-style">
            ...
            <table className="c21x-table-style">
              ...
              <tr>
                ...
                <td></td>
                <td>
                  {/* <a href={downloadFile(value2121f1)} target="_blank">view</a> */}
                     <Button variant="contained" component="label">
                File Upload
                <input
                  className="input-text"
              ...
              <tr>
                ...
                <td><a href={downloadFile("un2.1.2.xlsx")} target="_blank">View Template</a></td>
                <td>
                  {/* <a href={downloadFile(value2121f2)} target="_blank">view</a> */}
                  <Button variant="contained" component="label">
                File Upload
                <input
                  className="input-text"
              ...
              {pathValue2121f2 === "" ? null : (
                <div className="c21-fileButtons-container">
                  <button
                    ...
                    style={{ height: "37px", width: "70px" }}
                  >
                    <a target="_openfile" href={filePreviewSrc212f1}>
                      {" "}
                      View File
                    </a>
                  </button>
