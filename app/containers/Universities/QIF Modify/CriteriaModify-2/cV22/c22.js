    ...
    () => fetch(resources.APPLICATION_URL+'criteria2getallfiles?collegeId='+collegeId+'&financialYear='+fYear+'&typeofInstitution='+instituteType).then(
      (response) => response
        ...
        .then((data) => {
          ...
          setValue222t2(data[0].criteria22Qn[0] ? data[0].criteria22Qn[0].input2221t2 : "");
          ...
          setValue221f2(data[0].criteria2FileUpload[1] ? data[0].criteria2FileUpload[1].criteria2FileName : "");
          setValue222f1(data[0].criteria2FileUpload[2] ? data[0].criteria2FileUpload[2].criteria2FileName : "");
        })
        .catch((error) => {
        ...
        <form>
          ...
          <table className="c22x-Ql-table-style">
            ...
            <tr>
              ...
              <td className="c22x-Ql-tableBorders-style">
              {/* <a href={downloadFile(value221f1)} target="_blank">view</a> */}
              ...
              {pathValue221f1 === "" ? null : (
                <div className="c22-fileButtons-container">
                  <button
                    className="c22-viewFileButton-style"
                    style={{ height: "37px", width: "70px" }}
                  >
                    <a target="_openfile" href={filePreviewSrc221f1}>
                      {" "}
                      View File
                    </a>
                  </button>
                  <button
                    className="c22-removeFileButton-style"
                    onClick={(e) => {
                      setPathValue221f1("");
            ...
            <tr>
              ...
              <td className="c22x-Ql-tableBorders-style"></td>
              <td className="c22x-Ql-tableBorders-style">
              {/* <a href={downloadFile(value221f2)} target="_blank">view</a> */}
              <Button variant="contained" component="label">
                File Upload
                <input
                  className="input-text"
              ...
              {pathValue221f2 === "" ? null : (
                <div className="c22-fileButtons-container">
                  <button
                    ...
                    style={{ height: "37px", width: "70px" }}
                  >
                    <a target="_openfile" href={filePreviewSrc221f2}>
                      {" "}
                      View File
                    </a>
                  </button>
          ...
          <div className="c22xx-container">
            ...
            <table className="c22x-table-style">
              ...
              <tr>
                ...
                <td></td>
                <td>
                {/* <a href={downloadFile(value222f1)} target="_blank">view</a> */}
                <Button variant="contained" component="label">
                File Upload
                <input
                  className="input-text"
              ...
              {pathValue222f1 === "" ? null : (
                <div className="c22-fileButtons-container">
                  <button
                    ...
                    style={{ height: "37px", width: "70px" }}
                  >
                    <a target="_openfile" href={filePreviewSrc222f1}>
                      {" "}
                      View File
                    </a>
                  </button>
