...
function Criteria35() {
 ...
 const [pathValue3511f5, setPathValue3511f5] = useState();
 const [filePreviewSrc351f5, setFilePreviewSrc351f5] = useState();
    ...
    () => fetch(resources.APPLICATION_URL+'criteria3getallfiles?collegeId='+collegeId+'&financialYear='+fYear+'&typeofInstitution='+instituteType).then(
      (response) => response
        ...
        .then((data) => {
          ...
          setValue3511f2(data[0].criteria3FileUpload[1] ? data[0].yearTable3521[1].criteria3FileName : "");
          setValue3511f3(data[0].criteria3FileUpload[2] ? data[0].yearTable3521[2].criteria3FileName : "");
          setValue3511f4(data[0].criteria3FileUpload[3] ? data[0].yearTable3521[3].criteria3FileName : "");
          setValue3521f1(data[0].criteria3FileUpload[4] ? data[0].yearTable3521[4].criteria3FileName : "");
          setValue3521f2(data[0].criteria3FileUpload[5] ? data[0].yearTable3521[5].criteria3FileName : "");
          setValue3521f3(data[0].criteria3FileUpload[6] ? data[0].yearTable3521[6].criteria3FileName : "");
          setValue3521f4(data[0].criteria3FileUpload[7] ? data[0].yearTable3521[7].criteria3FileName : "");
        })
        .catch((error) => {
                ...
                <td>
                  ...
                  >
                    <input
                      ...
                      // {
                        // (e) =>
                        //  setValue3231t10(e.target.value)}
                      // id="3231-t10"
                      // className="c32x-input-style"
                      // type="text"
                      // value={value3231t10}
          ...
          <div className="c35xx-container">
            <table className="c35x-table-style">
              ...
              {pathValue3511f1 === "" ? null : (
                <div className="c35-fileButtons-container">
                  <button
                    className="c35-viewFileButton-style"
                    style={{ height: "37px", width: "70px" }}
                  >
                    <a target="_openfile" href={filePreviewSrc351f1}>
                      {" "}
                      View File
                    </a>
                  </button>
                  <button
                    className="c35-removeFileButton-style"
                    onClick={(e) => {
                      setPathValue3511f1("");
              ...
              {pathValue3511f2 === "" ? null : (
                <div className="c35-fileButtons-container">
                  <button
                    ...
                    style={{ height: "37px", width: "70px" }}
                  >
                    <a target="_openfile" href={filePreviewSrc351f2}>
                      {" "}
                      View File
                    </a>
                  </button>
              ...
              {pathValue3511f3 === "" ? null : (
                <div className="c35-fileButtons-container">
                  <button
                    ...
                    style={{ height: "37px", width: "70px" }}
                  >
                    <a target="_openfile" href={filePreviewSrc351f3}>
                      {" "}
                      View File
                    </a>
                  </button>
              ...
              {pathValue3511f4 === "" ? null : (
                <div className="c35-fileButtons-container">
                  <button
                    ...
                    style={{ height: "37px", width: "70px" }}
                  >
                    <a target="_openfile" href={filePreviewSrc351f4}>
                      {" "}
                      View File
                    </a>
                  </button>
              ...
              <tr>
                ...
                id="3511-f5"
                  ...
                  style={{ display: "none" }}
                  onChange={(e) => {
                    setValue3511f5(e.target.files[0]);
                    setPathValue3511f5(e.target.value);
                    showFilePreview(e);
                  }}
                />
              </Button>
              {pathValue3511f5}
              {pathValue3511f5 === "" ? null : (
                <div className="c35-fileButtons-container">
                  <button
                    className="c35-viewFileButton-style"
                    style={{ height: "37px", width: "70px" }}
                  >
                    <a target="_openfile" href={filePreviewSrc351f5}>
                      {" "}
                      View File
                    </a>
                  </button>
                  <button
                    ...
                    onClick={(e) => {
                      setPathValue3511f5("");
                      document.getElementById("3511-f5").value = "";
                    }}
                    style={{ height: "37px", width: "70px" }}
                  >
                    Reset
...
year-wise during the last five years (INR in lakhs)
            ...
            <table className="c35x-table-style">
              ...
              <tr>
                ...
                <td>
                  <a href="http://localhost:8080/api/v1/download/criteria3.5.2.xlsx">
                    View Template
                  </a>
                </td>
                <td>
