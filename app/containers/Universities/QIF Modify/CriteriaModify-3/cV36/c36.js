...
const financialYear="2021-2022";
    ...
    () => fetch(resources.APPLICATION_URL+'criteria3getallfiles?collegeId='+collegeId+'&financialYear='+fYear+'&typeofInstitution='+instituteType).then(
      (response) => response
        ...
        .then((data) => {
          ...
          setValue3621t3(data[0].yearTable3621[2] ? data[0].yearTable3621[2].input3621y : "");
          ...
          setValue3631t2(data[0].yearTable3631[1] ? data[0].yearTable3631[1].input3631y : "");
          setValue3631t3(data[0].yearTable3631[2] ? data[0].yearTable3631[2].input3631y : "");
          setValue3631t4(data[0].yearTable3631[3] ? data[0].yearTable3631[3].input3631y : "");
          setValue3631t5(data[0].yearTable3631[4] ? data[0].yearTable3631[4].input3631y : "");
          setValue3631t6(data[0].yearTable3631[0] ? data[0].yearTable3631[0].input3631v : "");
          setValue3631t7(data[0].yearTable3631[1] ? data[0].yearTable3631[1].input3631v  : "");
          setValue3631t8(data[0].yearTable3631[2] ? data[0].yearTable3631[2].input3631v : "");
          setValue3631t9(data[0].yearTable3631[3] ? data[0].yearTable3631[3].input3631v : "");
          setValue3631t10(data[0].yearTable3631[4] ? data[0].yearTable3631[4].input3631v : "");

          setValue3641t1(data[0].yearTable3641[0] ? data[0].yearTable3641[0].input3641y : "");
          setValue3641t2(data[0].yearTable3641[1] ? data[0].yearTable3641[1].input3641y : "");
          setValue3641t3(data[0].yearTable3641[2] ? data[0].yearTable3641[2].input3641y : "");
          setValue3641t4(data[0].yearTable3641[3] ? data[0].yearTable3641[3].input3641y : "");
          setValue3641t5(data[0].yearTable3641[4] ? data[0].yearTable3641[4].input3641y : "");
          setValue3641t6(data[0].yearTable3641[0] ? data[0].yearTable3641[0].input3641v : "");
          setValue3641t7(data[0].yearTable3641[1] ? data[0].yearTable3641[1].input3641v : "");
          setValue3641t8(data[0].yearTable3641[2] ? data[0].yearTable3641[2].input3641v : "");
          setValue3641t9(data[0].yearTable3641[3] ? data[0].yearTable3641[3].input3641v : "");
          setValue3641t10(data[0].yearTable3641[4] ? data[0].yearTable3641[4].input3641v : "");
          ...
          setValue3631f2(data[0].criteria3FileUpload[1] ? data[0].criteria3FileUpload[1].criteria3FileName : "");
          setValue3631f3(data[0].criteria3FileUpload[2] ? data[0].criteria3FileUpload[2].criteria3FileName : "");
          setValue3641f1(data[0].criteria3FileUpload[3] ? data[0].criteria3FileUpload[3].criteria3FileName : "");
          setValue3641f2(data[0].criteria3FileUpload[4] ? data[0].criteria3FileUpload[4].criteria3FileName : "");
          setValue3641f3(data[0].criteria3FileUpload[5] ? data[0].criteria3FileUpload[5].criteria3FileName : "");
        })
        .catch((error) => {
  ...
  criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType },
    ...
    yearTable3621: [
      {criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType },
      uniqueKey1: 201,input3621y: value3621t1, input3621v: value3621t6 },
      {criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType },
        uniqueKey1: 202, input3621y: value3621t2, input3621v: value3621t7 },
        {criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType },
        uniqueKey1: 203, input3621y: value3621t3, input3621v: value3621t8 },
        {criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType },
        uniqueKey1: 204, input3621y: value3621t4, input3621v: value3621t9 },
        {criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType },
        uniqueKey1: 205, input3621y: value3621t5, input3621v: value3621t10 },
    ],

    yearTable3631: [
      {criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType },
        uniqueKey1: 201,input3631y: value3631t1, input3631v: value3631t6 },
        {criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType },
        uniqueKey1: 202,input3631y: value3631t2, input3631v: value3631t7 },
        {criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType },
        uniqueKey1: 203, input3631y: value3631t3, input3631v: value3631t8 },
        {criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType },
        uniqueKey1: 204, input3631y: value3631t4, input3631v: value3631t9 },
        {criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType },
        uniqueKey1: 205,input3631y: value3631t5, input3631v: value3631t10 },
    ],

    yearTable3641: [
      {criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType },
        uniqueKey1: 201,input3641y: value3641t1, input3641v: value3641t6 },
        {criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType },
        uniqueKey1: 202,input3641y: value3641t2, input3641v: value3641t7 },
        {criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType },
        uniqueKey1: 203, input3641y: value3641t3, input3641v: value3641t8 },
        {criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType },
        uniqueKey1: 204, input3641y: value3641t4, input3641v: value3641t9 },
        {criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType },
        uniqueKey1: 205, input3641y: value3641t5, input3641v: value3641t10 },
    ],

    yearTable36412: [
      {criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType },
        uniqueKey1: 201, input36412y: value3641t11, input36412v: value3641t16 },
        {criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType },
        uniqueKey1: 202, input36412y: value3641t12, input36412v: value3641t17 },
        {criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType },
        uniqueKey1: 203, input36412y: value3641t13, input36412v: value3641t18 },
        {criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType },
        uniqueKey1: 204, input36412y: value3641t14, input36412v: value3641t19 },
        {criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType },
        uniqueKey1: 205, input36412y: value3641t15, input36412v: value3641t20 },
    ],
  };
          ...
          <table className="c36x-Ql-table-style">
            ...
            <tr>
              ...
              {pathValue361f1 === "" ? null : (
                <div className="c36-fileButtons-container">
                  <button
                    className="c36-viewFileButton-style"
                    style={{ height: "37px", width: "70px" }}
                  >
                    <a target="_openfile" href={filePreviewSrc361f1}>
                      {" "}
                      View File
                    </a>
                  </button>
                  <button
                    className="c36-removeFileButton-style"
                    onClick={(e) => {
                      setPathValue361f1("");
              ...
              {pathValue361f2 === "" ? null : (
                <div className="c36-fileButtons-container">
                  <button
                    ...
                    style={{ height: "37px", width: "70px" }}
                  >
                    <a target="_openfile" href={filePreviewSrc361f2}>
                      {" "}
                      View File
                    </a>
                  </button>
        ...
        <form>
          <div className="c36x-container">
            <div className="c36x-heading_Help-container">
              ...
              <h1 className="c36x-heading-style">
                <span className="c36x-span-style">3.6.2: </span>
                Number of extension and outreach programs conducted by the institution through organized forums like NSS/NCC during the last five years.              </h1>
                <button
...
<div>
            <table className="c36x-table-style">
              ...
              {pathValue3621f1 === "" ? null : (
                <div className="c36-fileButtons-container">
                  <button
                    ...
                    style={{ height: "37px", width: "70px" }}
                  >
                    <a target="_openfile" href={filePreviewSrc362f1}>
                      {" "}
                      View File
                    </a>
                  </button>
              ...
              <tr>
                ...
                <td>
                <a href={downloadFile("un3.6.2.xlsx")} target="_blank">View Template</a>
                </td>
                <td>
                  {/* <input
                    onChange={(e) => {
              ...
              {pathValue3621f2 === "" ? null : (
                <div className="c36-fileButtons-container">
                  <button
                    ...
                    style={{ height: "37px", width: "70px" }}
                  >
                    <a target="_openfile" href={filePreviewSrc362f2}>
                      {" "}
                      View File
                    </a>
                  </button>
              ...
              {pathValue3621f3 === "" ? null : (
                <div className="c36-fileButtons-container">
                  <button
                    ...
                    style={{ height: "37px", width: "70px" }}
                  >
                    <a target="_openfile" href={filePreviewSrc362f3}>
                      {" "}
                      View File
                    </a>
                  </button>
          ...
          <div className="c36xx-container">
            ...
            <table className="c36x-table-style">
              ...
              <tr>
                ...
                <td>
                  <a href="http://localhost:8080/api/v1/download/criteria3.6.3.xlsx">View Template</a>
                </td>
                <td>
                  <input
                    onChange={(e) => {
          ...
          <div className="c36xx-container">
            ...
            <table className="c36x-table-style">
              ...
              <tr>
                ...
                <td>
                  <a href="http://localhost:8080/api/v1/download/criteria3.6.4.xlsx">View Template</a>
                </td>
                <td>
                  <input
                    onChange={(e) => {
