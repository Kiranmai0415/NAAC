    ...
    (response) => response
      ...
      .then((data) => {
        console.log(JSON.stringify(data));
          ...
          setValue3321f3(data[0].criteria3FileUpload[2] ? data[0].criteria3FileUpload[2].criteria3FileName : "");
          ...
          setValue3331f3(data[0].criteria3FileUpload[5] ? data[0].criteria3FileUpload[5].criteria3FileName : "");
          setValue331f1(data[0].criteria3FileUpload[6] ? data[0].criteria3FileUpload[6].criteria3FileName : "");
          setValue331f2(data[0].criteria3FileUpload[7] ? data[0].criteria3FileUpload[7].criteria3FileName : "");
        })
        .catch((error) => {
          ...
          <table className="c33x-Ql-table-style">
            ...
            <tr>
              ...
              {pathValue331f1 === "" ? null : (
                <div className="c33-fileButtons-container">
                  <button
                    className="c33-viewFileButton-style"
                    style={{ height: "37px", width: "70px" }}
                  >
                    <a target="_openfile" href={filePreviewSrc331f1}>
                      {" "}
                      View File
                    </a>
                  </button>
                  <button
                    className="c33-removeFileButton-style"
                    onClick={(e) => {
                      setPathValue331f1("");
              ...
              {pathValue331f2 === "" ? null : (
                <div className="c33-fileButtons-container">
                  <button
                    ...
                    style={{ height: "37px", width: "70px" }}
                  >
                    <a target="_openfile" href={filePreviewSrc331f2}>
                      {" "}
                      View File
                    </a>
                  </button>
              ...
              {pathValue3321f2 === "" ? null : (
                <div className="c33-fileButtons-container">
                  <button
                    ...
                    style={{ height: "37px", width: "70px" }}
                  >
                    <a target="_openfile" href={filePreviewSrc332f2}>
                      {" "}
                      View File
                    </a>
                  </button>
              ...
              {pathValue3331f1 === "" ? null : (
                <div className="c33-fileButtons-container">
                  ...
                  <button
                    ...
                    onClick={(e) => {
                      setPathValue3331f1("");
                      document.getElementById("3331-f1").value = "";
                    }}
                    style={{ height: "37px", width: "70px" }}
                  >
                    Reset
              ...
              {pathValue3331f2 === "" ? null : (
                <div className="c33-fileButtons-container">
                  <button
                    ...
                    style={{ height: "37px", width: "70px" }}
                  >
                    <a target="_openfile" href={filePreviewSrc333f2}>
                      {" "}
                      View File
                    </a>
                  </button>
                  <button
                    ...
                    onClick={(e) => {
                      setPathValue3331f2("");
                      document.getElementById("3331-f2").value = "";
                    }}
                    style={{ height: "37px", width: "70px" }}
                  >
                    Reset
              ...
              {pathValue3331f3 === "" ? null : (
                <div className="c33-fileButtons-container">
                  ...
                  <button
                    ...
                    onClick={(e) => {
                      setPathValue3331f3("");
                      document.getElementById("3331-f3").value = "";
                    }}
                    style={{ height: "37px", width: "70px" }}
                  >
                    Reset
