...
function Criteria37() {
 ...
 //help buttom
  ...
  const [pathValue3721f1, setPathValueValue3721f1] = useState('');
  const [value3721f2, setValue3721f2] = useState('');
  const [pathValue3721f2, setPathValueValue3721f2] = useState('');
  const [value3721f3, setValue3721f3] = useState('');
  const [pathValue3721f3, setPathValueValue3721f3] = useState('');
  const [pathValue3711f4, setPathValueValue3721f4] = useState('');
    ...
    () => fetch(resources.APPLICATION_URL+'criteria3getallfiles?collegeId='+collegeId+'&financialYear='+fYear+'&typeofInstitution='+instituteType).then(
      (response) => response
        ...
        .then((data) => {
          ...
          setValue3711f1(data[0].criteria3FileUpload[0] ? data[0].criteria3FileUpload[0].criteria3FileName : "");
          setValue3711f2(data[0].criteria3FileUpload[1] ? data[0].criteria3FileUpload[1].criteria3FileName : "");
          setValue3711f3(data[0].criteria3FileUpload[2] ? data[0].criteria3FileUpload[2].criteria3FileName : "");
          setValue3721f1(data[0].criteria3FileUpload[3] ? data[0].criteria3FileUpload[3].criteria3FileName : "");
          setValue3721f2(data[0].criteria3FileUpload[4] ? data[0].criteria3FileUpload[4].criteria3FileName : "");
          setValue3721f3(data[0].criteria3FileUpload[5] ? data[0].criteria3FileUpload[5].criteria3FileName : "");
 ...
 const inputDataList = {
  ...
  criteria37Qn: [
    ...
    yearTable3711: [
      {criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType },
      uniqueKey1: 201, input3711y: value3711t1, input3711v: value3711t6 },
      {criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType },
      uniqueKey1: 202, input3711y: value3711t2, input3711v: value3711t7 },
      {criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType },
       uniqueKey1: 203, input3711y: value3711t3, input3711v: value3711t8 },
       {criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType },
       uniqueKey1: 204, input3711y: value3711t4, input3711v: value3711t9 },
       {criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType },
       uniqueKey1: 205, input3711y: value3711t5, input3711v: value3711t10 },
    ],

    yearTable3721: [
      {criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType },
       uniqueKey1: 201,input3721y: value3721t1, input3721v: value3721t6 },
       {criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType },
       uniqueKey1: 202,input3721y: value3721t2, input3721v: value3721t7 },
       {criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType },
       uniqueKey1: 203,input3721y: value3721t3, input3721v: value3721t8 },
       {criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType },
       uniqueKey1: 204,input3721y: value3721t4, input3721v: value3721t9 },
       {criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType },
       uniqueKey1: 205,input3721y: value3721t5, input3721v: value3721t10 },
    ],
};
          ...
          <div className="c37xx-container">
            ...
            <table className="c37x-table-style">
              ...
              <tr>
                ...
                <td><a href={downloadFile("un3.7.1.xlsx")} target="_blank">view Template</a></td>
                <td>
                {/* <a href={downloadFile(value3711f1)} target="_blank">view</a> */}
              ...
              {pathValue3711f1 === "" ? null : (
                <div className="c37-fileButtons-container">
                  <button
                    className="c37-viewFileButton-style"
                    style={{ height: "37px", width: "70px" }}
                  >
                    <a target="_openfile" href={filePreviewSrc371f1}>
                      {" "}
                      View File
                    </a>
                  </button>
                  <button
                    className="c37-removeFileButton-style"
                    onClick={(e) => {
                      setPathValue3711f1("");
              ...
              <tr>
                <td>List and Copies of documents indicating the functiona MoUs/linkage/collaboration activity-wise and year-wise</td>
                <td></td>
                <td>
                {/* <a href={downloadFile(value3711f2)} target="_blank">view</a> */}
                <Button variant="contained" component="label">
                File Upload
                <input
                  className="input-text"
              ...
              {pathValue3711f2 === "" ? null : (
                <div className="c37-fileButtons-container">
                  <button
                    ...
                    style={{ height: "37px", width: "70px" }}
                  >
                    <a target="_openfile" href={filePreviewSrc371f2}>
                      {" "}
                      View File
                    </a>
                  </button>
              ...
              <tr>
                ...
                <td>
                {/* <a href={downloadFile(value3711f3)} target="_blank">view</a> */}
                <Button variant="contained" component="label">
                File Upload
                <input
                  className="input-text"
              ...
              {pathValue3711f3 === "" ? null : (
                <div className="c37-fileButtons-container">
                  <button
                    ...
                    style={{ height: "37px", width: "70px" }}
                  >
                    <a target="_openfile" href={filePreviewSrc371f3}>
                      {" "}
                      View File
                    </a>
                  </button>
              ...
              <tr>
                ...
                id="3711-f4"
                  ...
                  style={{ display: "none" }}
                  onChange={(e) => {
                    setValue3711f4(e.target.files[0]);
                    setPathValue3711f4(e.target.value);
                    showFilePreview(e);
                  }}
                />
              </Button>
              {pathValue3711f4}
              {pathValue3711f4 === "" ? null : (
                <div className="c37-fileButtons-container">
                  <button
                    className="c37-viewFileButton-style"
                    style={{ height: "37px", width: "70px" }}
                  >
                    <a target="_openfile" href={filePreviewSrc371f4}>
                      {" "}
                      View File
                    </a>
                  </button>
                  <button
                    ...
                    onClick={(e) => {
                      setPathValue3711f4("");
                      document.getElementById("3711-f4").value = "";
                    }}
                    style={{ height: "37px", width: "70px" }}
                  >
                    Reset
          ...
          <div className="c37xx-container">
            ...
            <table className="c37x-table-style">
              ...
              <tr>
                ...
                <td></td>
                <td>
                {/* <a href={downloadFile(value3721f1)} target="_blank">view</a> */}
                <Button variant="contained" component="label">
                File Upload
                <input
                  className="input-text"
              ...
              {pathValue3721f1 === "" ? null : (
                <div className="c37-fileButtons-container">
                  <button
                    ...
                    style={{ height: "37px", width: "70px" }}
                  >
                    <a target="_openfile" href={filePreviewSrc372f1}>
                      {" "}
                      View File
                    </a>
                  </button>
              ...
              <tr>
                ...
                <td></td>
                <td>
                {/* <a href={downloadFile(value3721f2)} target="_blank">view</a> */}
                <Button variant="contained" component="label">
                File Upload
                <input
                  className="input-text"
              ...
              {pathValue3721f2 === "" ? null : (
                <div className="c37-fileButtons-container">
                  <button
                    ...
                    style={{ height: "37px", width: "70px" }}
                  >
                    <a target="_openfile" href={filePreviewSrc372f2}>
                      {" "}
                      View File
                    </a>
                  </button>
              ...
              <tr>
                ...
                <td>
                <a href={downloadFile("3.7.1.xlsx")} target="_blank">
                    View Template
                  </a>
                </td>
                <td>
                {/* <a href={downloadFile(value3721f3)} target="_blank">view</a> */}
                <Button variant="contained" component="label">
                File Upload
                <input
                  className="input-text"
              ...
              {pathValue3721f3 === "" ? null : (
                <div className="c37-fileButtons-container">
                  <button
                    ...
                    style={{ height: "37px", width: "70px" }}
                  >
                    <a target="_openfile" href={filePreviewSrc372f3}>
                      {" "}
                      View File
                    </a>
                  </button>
