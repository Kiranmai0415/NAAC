    ...
    () => fetch(resources.APPLICATION_URL+'criteria7getallfiles?collegeId='+collegeId+'&financialYear='+fYear+'&typeofInstitution='+instituteType).then(
      (response) => response
        ...
        .then((data) => {
          ...
          setValue731f2(data[0].criteria7FileUpload[1] ? data[0].criteria7FileUpload[1].criteria7FileName:"");
        })
        .catch((error) => {
        ...
        <form>
          ...
          <table className="c73x-Ql-table-style">
            ...
            <tr>
              ...
              <td className="c73x-Ql-tableBorders-style">
                {/* <a href={downloadFile(value731f1)} target="_blank">view</a> */}
            ...
            <tr>
              ...
              <td className="c73x-Ql-tableBorders-style">
                {/* <a href={downloadFile(value731f2)} target="_blank">view</a> */}
                <Button variant="contained" component="label">
                File Upload
                <input
                  className="input-text"
