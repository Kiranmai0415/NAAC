    ...
    () => fetch(resources.APPLICATION_URL+'criteria7getallfiles?collegeId='+collegeId+'&financialYear='+fYear+'&typeofInstitution='+instituteType).then(
      (response) => response
        ...
        .then((data) => {
          ...
          setValue721f1(data[0].criteria7FileUpload[0] ? data[0].criteria72Ql[0].criteria7FileName:"");
          setValue721f2(data[0].criteria7FileUpload[0] ? data[0].criteria72Ql[0].criteria7FileName:"");
        })
        .catch((error) => {
        ...
        <form>
          <div className="c72x-Ql-label-textarea-container">
            <div className="c72x-heading_Help-container">
              <h1 className="c72x-heading-style">
                ...
                per the NAAC format provided in the Manual.
              </h1>
              <button
          ...
          <table className="c72x-Ql-table-style">
            ...
            <tr>
              ...
              <td className="c72x-Ql-tableBorders-style">
                {/* <a href={downloadFile(value721f1)} target="_blank">view</a> */}
            ...
            <tr>
              ...
              <td className="c72x-Ql-tableBorders-style">
                {/* <a href={downloadFile(value721f2)} target="_blank">view</a> */}
                <Button variant="contained" component="label">
                File Upload
                <input
                  className="input-text"
