    ...
    () => fetch(resources.APPLICATION_URL+'criteria7getallfiles?collegeId='+collegeId+'&financialYear='+fYear+'&typeofInstitution='+instituteType).then(
      (response) => response
        ...
        .then((data) => {
          ...
          setPathValue711f1(data[0].criteria7FileUpload[0] ? data[0].criteria7FileUpload[0].criteria7FileName:"");
          setPathValue711f2(data[0].criteria7FileUpload[1] ? data[0].criteria7FileUpload[1].criteria7FileName:"");
          setPathValue712f1(data[0].criteria7FileUpload[2] ? data[0].criteria7FileUpload[2].criteria7FileName:"");
          setPathValue712f2(data[0].criteria7FileUpload[3] ? data[0].criteria7FileUpload[3].criteria7FileName:"");
          setPathValue713f1(data[0].criteria7FileUpload[4] ? data[0].criteria7FileUpload[4].criteria7FileName:"");
          setPathValue713f2(data[0].criteria7FileUpload[5] ? data[0].criteria7FileUpload[5].criteria7FileName:"");
          setPathValue713f3(data[0].criteria7FileUpload[6] ? data[0].criteria7FileUpload[6].criteria7FileName:"");
          setPathValue714f1(data[0].criteria7FileUpload[7] ? data[0].criteria7FileUpload[7].criteria7FileName:"");
          setPathValue714f2(data[0].criteria7FileUpload[8] ? data[0].criteria7FileUpload[8].criteria7FileName:"");
          setPathValue715f1(data[0].criteria7FileUpload[9] ? data[0].criteria7FileUpload[9].criteria7FileName:"");
          setPathValue715f2(data[0].criteria7FileUpload[10] ? data[0].criteria7FileUpload[10].criteria7FileName:"");
          setPathValue715f3(data[0].criteria7FileUpload[11] ? data[0].criteria7FileUpload[11].criteria7FileName:"");
          setPathValue716f1(data[0].criteria7FileUpload[12] ? data[0].criteria7FileUpload[12].criteria7FileName:"");
          setPathValue716f2(data[0].criteria7FileUpload[13] ? data[0].criteria7FileUpload[13].criteria7FileName:"");
          setPathValue716f3(data[0].criteria7FileUpload[14] ? data[0].criteria7FileUpload[14].criteria7FileName:"");
          setPathValue716f4(data[0].criteria7FileUpload[15] ? data[0].criteria7FileUpload[15].criteria7FileName:"");
          setPathValue717f1(data[0].criteria7FileUpload[16] ? data[0].criteria7FileUpload[16].criteria7FileName:"");
          setPathValue717f2(data[0].criteria7FileUpload[17] ? data[0].criteria7FileUpload[17].criteria7FileName:"");
          setPathValue717f3(data[0].criteria7FileUpload[18] ? data[0].criteria7FileUpload[18].criteria7FileName:"");
          setPathValue717f4(data[0].criteria7FileUpload[19] ? data[0].criteria7FileUpload[19].criteria7FileName:"");
          setPathValue718f1(data[0].criteria7FileUpload[20] ? data[0].criteria7FileUpload[20].criteria7FileName:"");
          setPathValue718f2(data[0].criteria7FileUpload[21] ? data[0].criteria7FileUpload[21].criteria7FileName:"");
          setPathValue719f1(data[0].criteria7FileUpload[22] ? data[0].criteria7FileUpload[22].criteria7FileName:"");
          setPathValue719f2(data[0].criteria7FileUpload[23] ? data[0].criteria7FileUpload[23].criteria7FileName:"");
          setPathValue7110f1(data[0].criteria7FileUpload[24] ? data[0].criteria7FileUpload[24].criteria7FileName:"");
          setPathValue7110f2(data[0].criteria7FileUpload[25] ? data[0].criteria7FileUpload[25].criteria7FileName:"");
          setPathValue7110f3(data[0].criteria7FileUpload[26] ? data[0].criteria7FileUpload[26].criteria7FileName:"");
          setPathValue7111f1(data[0].criteria7FileUpload[27] ? data[0].criteria7FileUpload[27].criteria7FileName:"");
          setPathValue7111f2(data[0].criteria7FileUpload[28] ? data[0].criteria7FileUpload[28].criteria7FileName:"");
          setPathValue7111f3(data[0].criteria7FileUpload[29] ? data[0].criteria7FileUpload[29].criteria7FileName:"");
        })
        .catch((error) => {
