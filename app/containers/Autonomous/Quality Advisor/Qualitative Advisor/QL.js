...
function QL() {
  ...
  const criteriaQl2Grade = parseFloat(criteriaQl2Weightage / qlcriteria2).toFixed(2);
  const criteriaQl22Value = (qlweightage221 * metricGradeScale(dataValueGrade221));
  const criteriaQl23Value = (qlweightage231 * metricGradeScale(dataValueGrade231) + qlweightage232 * metricGradeScale(dataValueGrade232) + qlweightage234 * metricGradeScale(dataValueGrade234));
  const criteriaQl25Value = (qlweightage253 * metricGradeScale(dataValueGrade253));
  const criteriaQl26Value = (qlweightage261 * metricGradeScale(dataValueGrade261) + qlweightage262 * metricGradeScale(dataValueGrade262));

  const criteriaQl3Weightage = qlcriteria3Value();
  const criteriaQl3Grade = parseFloat(criteriaQl3Weightage / qlcriteria3).toFixed(2);
  const criteriaQl31Value = (qlweightage311 * metricGradeScale(dataValueGrade311));
  const criteriaQl33Value = (qlweightage331 * metricGradeScale(dataValueGrade331));
  const criteriaQl36Value = (qlweightage361 * metricGradeScale(dataValueGrade361));

  const criteriaQl4Weightage = qlcriteria4Value();
  const criteriaQl4Grade = parseFloat(criteriaQl4Weightage / qlcriteria4).toFixed(2);
  const criteriaQl41Value = (qlweightage411 * metricGradeScale(dataValueGrade411) + qlweightage412 * metricGradeScale(dataValueGrade412));
  ...
  const criteriaQl44Value = (qlweightage442 * metricGradeScale(dataValueGrade442));

  const criteriaQl5Weightage = qlcriteria5Value();
  const criteriaQl5Grade = parseFloat(criteriaQl5Weightage / qlcriteria5).toFixed(2);
  const criteriaQl53Value = (qlweightage532 * metricGradeScale(dataValueGrade532));
  ...
  const criteriaQl61Value = (qlweightage611 * metricGradeScale(dataValueGrade611) + qlweightage612 * metricGradeScale(dataValueGrade612));
  const criteriaQl62Value = (qlweightage621 * metricGradeScale(dataValueGrade621) + qlweightage622 * metricGradeScale(dataValueGrade622));
  const criteriaQl63Value = (qlweightage631 * metricGradeScale(dataValueGrade631));
  const criteriaQl64Value = (qlweightage641 * metricGradeScale(dataValueGrade641) + qlweightage643 * metricGradeScale(dataValueGrade643));
  const criteriaQl65Value = (qlweightage651 * metricGradeScale(dataValueGrade651) + qlweightage652 * metricGradeScale(dataValueGrade652));

  const criteriaQl7Weightage = qlcriteria7Value();
  const criteriaQl7Grade = parseFloat(criteriaQl7Weightage / qlcriteria7).toFixed(2);
  const criteriaQl71Value = (qlweightage711 * metricGradeScale(dataValueGrade711) + qlweightage713 * metricGradeScale(dataValueGrade713) + qlweightage718 * metricGradeScale(dataValueGrade718) + qlweightage719 * metricGradeScale(dataValueGrade719) + qlweightage7111 * metricGradeScale(dataValueGrade7111));
      ...
      <div className="eachTable-container">
        ...
        <tr style={{ textAlign: "center",  }}>
          ...
          <tr>
            ...
            <td>2.2.1</td>
            <td>QL</td>
            <td>The institution assesses the learning levels of the students and organises special Programmes for advanced learners and slow learners</td>
            <td>{qlweightage221}</td>
            <td>{qlkiWeightage22}</td>
            <td rowspan="7">{qlcriteria2}</td>
            <td>
              <input
                rows="10"
                type="text"
            ...
            <td>
              <select
                ...
                onChange={(e) => { setDataValueGrade221(e.target.value); }}
              >
                {grades.map(eachGrade => (
                  <option
                    id={eachGrade.grade}
            ...
            <td>
              <p>{parseFloat(criteriaQl22Value / qlkiWeightage22).toFixed(2)}</p>
            </td>
            <td rowSpan="7">
          ...
          <tr>
            ...
            <td>
              <select
                ...
                onChange={(e) => { setDataValueGrade232(e.target.value); }}
              >
                {grades.map(eachGrade => (
                  <option
                    id={eachGrade.grade}
          ...
          <tr>
            ...
            <td>
              <select
                ...
                onChange={(e) => { setDataValueGrade234(e.target.value); }}
              >
                {grades.map(eachGrade => (
                  <option
                    id={eachGrade.grade}
          ...
          <tr>
            ...
            <td>
              <select
                ...
                onChange={(e) => { setDataValueGrade253(e.target.value); }}
              >
                {grades.map(eachGrade => (
                  <option
                    id={eachGrade.grade}
          ...
          <tr>
            ...
            <td>
              <select
                ...
                onChange={(e) => { setDataValueGrade262(e.target.value); }}
              >
                {grades.map(eachGrade => (
                  <option
                    id={eachGrade.grade}
          ...
          <tr>
            ...
            <td>
              <select
                ...
                onChange={(e) => { setDataValueGrade311(e.target.value); }}
              >
                {grades.map(eachGrade => (
                  <option
                    id={eachGrade.grade}
            ...
            <td>
              <p>{parseFloat(criteriaQl31Value / qlkiWeightage31).toFixed(2)}</p>
            </td>
            <td rowSpan="3">
          ...
          <tr>
            ...
            <td>3.3.1</td>
            <td>QL</td>
            <td>Institution has created an eco system for innovations, creation and transfer of knowledge supported by dedicated centers for research, entrepreneurship, community orientation, Incubation etc.</td>
            ...
            <td>
              <select
                ...
                onChange={(e) => { setDataValueGrade331(e.target.value); }}
              >
                {grades.map(eachGrade => (
                  <option
                    id={eachGrade.grade}
            ...
            <td>
              <p>{parseFloat(criteriaQl33Value / qlkiWeightage33).toFixed(2)}</p>
            </td>
          </tr>
          <tr>
            <td>12.</td>
            ...
            <td>
              <select
                ...
                onChange={(e) => { setDataValueGrade361(e.target.value); }}
              >
                {grades.map(eachGrade => (
                  <option
                    id={eachGrade.grade}
            ...
            <td>
              <p>{parseFloat(criteriaQl36Value / qlkiWeightage36).toFixed(2)}</p>
            </td>
          </tr>
          <tr>
            <td>13.</td>
          ...
          <tr>
            ...
            <td>
              <select
                ...
                onChange={(e) => { setDataValueGrade412(e.target.value); }}
              >
                {grades.map(eachGrade => (
                  <option
                    id={eachGrade.grade}
          ...
          <tr>
            ...
            <td>
              <select
                ...
                onChange={(e) => { setDataValueGrade442(e.target.value); }}
              >
                {grades.map(eachGrade => (
                  <option
                    id={eachGrade.grade}
            ...
            <td>
              <p>{parseFloat(criteriaQl44Value / qlkiWeightage44).toFixed(2)}</p>
            </td>
          </tr>
          <tr>
            <td>18.</td>
            ...
            <td>
              <select
                ...
                onChange={(e) => { setDataValueGrade532(e.target.value); }}
              >
                {grades.map(eachGrade => (
                  <option
                    id={eachGrade.grade}
            ...
            <td>
              <p>{parseFloat(criteriaQl53Value / qlkiWeightage53).toFixed(2)}</p>
            </td>
            <td rowSpan="2">
          ...
          <tr>
            ...
            <td>
              <select
                ...
                onChange={(e) => { setDataValueGrade612(e.target.value); }}
              >
                {grades.map(eachGrade => (
                  <option
                    id={eachGrade.grade}
          ...
          <tr>
            ...
            <td>
              <select
                ...
                onChange={(e) => { setDataValueGrade622(e.target.value); }}
              >
                {grades.map(eachGrade => (
                  <option
                    id={eachGrade.grade}
          ...
          <tr>
            ...
            <td>6.3.1</td>
            <td>QL</td>
            <td>The institution has effective welfare measures for teaching and non-teaching staff and avenues for career development/ progression</td>
          ...
          <tr>
            ...
            <td>
              <select
                ...
                onChange={(e) => { setDataValueGrade643(e.target.value); }}
              >
                {grades.map(eachGrade => (
                  <option
                    id={eachGrade.grade}
          ...
          <tr>
            ...
            <td>
              <select
                ...
                onChange={(e) => { setDataValueGrade652(e.target.value); }}
              >
                {grades.map(eachGrade => (
                  <option
                    id={eachGrade.grade}
          ...
          <tr>
            ...
            <td>
              <select
                ...
                onChange={(e) => { setDataValueGrade713(e.target.value); }}
              >
                {grades.map(eachGrade => (
                  <option
                    id={eachGrade.grade}
          ...
          <tr>
            ...
            <td>
              <select
                ...
                onChange={(e) => { setDataValueGrade718(e.target.value); }}
              >
                {grades.map(eachGrade => (
                  <option
                    id={eachGrade.grade}
          ...
          <tr>
            ...
            <td>
              <select
                ...
                onChange={(e) => { setDataValueGrade719(e.target.value); }}
              >
                {grades.map(eachGrade => (
                  <option
                    id={eachGrade.grade}
          ...
          <tr>
            ...
            <td>
              <select
                ...
                onChange={(e) => { setDataValueGrade7111(e.target.value); }}
              >
                {grades.map(eachGrade => (
                  <option
                    id={eachGrade.grade}
