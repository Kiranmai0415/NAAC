...
export default function EvaluationReportAuthorize() {
  ...
  useEffect(() => fetch(
    'http://localhost:8080/api/v1/getallevaluativedata?collegeId='+collegeId+'&financialYear='
        + fYear
    ...
    .then((data) => {
      ...
      setautonomousName(data[0].nameofTheAutonomousCollege);
      setDepartmentName(data[0].nameofTheDepartment);
      setDist(data[0].dist);
      setState(data[0].state);
      setnumOfDepartments(data[0].totalNumberofDepartmentsIntheInstitution);
      setDepartment1(data[0].evaluativereportofthedepartment11[0].english);
      setZoology1(data[0].evaluativereportofthedepartment11[0].zoology);
      setBioTech1(
        data[0].evaluativereportofthedepartment11[0].bioTechnology
      );
      setDepartment2(data[0].evaluativereportofthedepartment11[1].english);
      setZoology2(data[0].evaluativereportofthedepartment11[1].zoology);
      setBioTech2(
        data[0].evaluativereportofthedepartment11[1].bioTechnology
      );
      setDepartment3(data[0].evaluativereportofthedepartment11[2].english);
      setZoology3(data[0].evaluativereportofthedepartment11[2].zoology);
      setBioTech3(
        data[0].evaluativereportofthedepartment11[2].bioTechnology
      );
      setDepartment4(data[0].evaluativereportofthedepartment11[3].english);
      setZoology4(data[0].evaluativereportofthedepartment11[3].zoology);
      setBioTech4(
        data[0].evaluativereportofthedepartment11[3].bioTechnology
      );
      setDepartment5(data[0].evaluativereportofthedepartment11[4].english);
      setZoology5(data[0].evaluativereportofthedepartment11[4].zoology);
      setBioTech5(
        data[0].evaluativereportofthedepartment11[4].bioTechnology
      );
      setDepartment61(data[0].evaluativereportofthedepartment11[5].english);
      setZoology61(data[0].evaluativereportofthedepartment11[5].zoology);
      setBioTech61(
        data[0].evaluativereportofthedepartment11[5].bioTechnology
      );
      setDepartment62(data[0].evaluativereportofthedepartment11[6].english);
      setZoology62(data[0].evaluativereportofthedepartment11[6].zoology);
      setBioTech62(
        data[0].evaluativereportofthedepartment11[6].bioTechnology
      );
      setDepartment63(data[0].evaluativereportofthedepartment11[7].english);
      setZoology63(data[0].evaluativereportofthedepartment11[7].zoology);
      setBioTech63(
        data[0].evaluativereportofthedepartment11[7].bioTechnology
      );
      setDepartment7(data[0].evaluativereportofthedepartment11[8].english);
      setZoology7(data[0].evaluativereportofthedepartment11[8].zoology);
      setBioTech7(
        data[0].evaluativereportofthedepartment11[8].bioTechnology
      );
      setDepartment8(data[0].evaluativereportofthedepartment11[9].english);
      setZoology8(data[0].evaluativereportofthedepartment11[9].zoology);
      setBioTech8(
      ...
      setZoology91(data[0].evaluativereportofthedepartment11[10].zoology);
      setBioTech91(
      ...
      setZoology92(data[0].evaluativereportofthedepartment11[11].zoology);
      setBioTech92(
      ...
      setZoology93(data[0].evaluativereportofthedepartment11[12].zoology);
      setBioTech93(
      ...
      setZoology94(data[0].evaluativereportofthedepartment11[13].zoology);
      setBioTech94(
      ...
      setZoology95(data[0].evaluativereportofthedepartment11[14].zoology);
      setBioTech95(
      ...
      setZoology96(data[0].evaluativereportofthedepartment11[15].zoology);
      setBioTech96(
      ...
      setZoology10(data[0].evaluativereportofthedepartment11[16].zoology);
      setBioTech10(
      ...
      setZoology11(data[0].evaluativereportofthedepartment11[17].zoology);
      setBioTech11(
      ...
      setZoology121(data[0].evaluativereportofthedepartment11[18].zoology);
      setBioTech121(
      ...
      setBioTech122(data[0].evaluativereportofthedepartment11[19].zoology);
      setBioTech122(
      ...
      setZoology123(data[0].evaluativereportofthedepartment11[20].zoology);
      setBioTech123(
      ...
      setZoology124(data[0].evaluativereportofthedepartment11[21].zoology);
      setBioTech124(
      ...
      setZoology13(data[0].evaluativereportofthedepartment11[22].zoology);
      setBioTech13(
      ...
      setZoology141(data[0].evaluativereportofthedepartment11[23].zoology);
      setBioTech141(
      ...
      setZoology142(data[0].evaluativereportofthedepartment11[24].zoology);
      setBioTech142(
      ...
      setZoology143(data[0].evaluativereportofthedepartment11[25].zoology);
      setBioTech143(
      ...
      setZoology15(data[0].evaluativereportofthedepartment11[26].zoology);
      setBioTech15(
  ...
  const authorize = {
    ...
    assignedBy: email,
    principalStatus: "A",
    programmerId:"EvaluationReportView"
  };
