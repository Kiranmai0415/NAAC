    ...
    () => fetch(resources.APPLICATION_URL+'criteria5getallfiles?collegeId='+collegeId+'&financialYear='+fYear+'&typeofInstitution='+instituteType).then(
      (response) => response
        ...
        .then((data) => {
          ...
          setValue541f1(data[0].criteria1FileUpload[0] ? data[0].criteria1FileUpload[0].criteria1FileName : "");
          setValue541f2(data[0].criteria1FileUpload[1] ? data[0].criteria1FileUpload[1].criteria1FileName : "");
          setValue542f1(data[0].criteria1FileUpload[2] ? data[0].criteria1FileUpload[2].criteria1FileName : "");
        })
        .catch((error) => {
          ...
          <div className="c54x-container">
            <div className="c54x-heading_Help-container">
              <h1 className="c54x-heading-style">
                ...
                <br/>
                <br/>
                <span className="c54x-label-style">5.4.1.1 </span>
                Amount of alumni contribution during the last five years 
                (INR in lakhs) to the institution through registered Alumni 
                association:
            ...
            <table className="c54x-table-style">
              ...
              <tr>
                ...
                <td>
                  ...
                  <a href={downloadFile(value541f1)} target="_blank">View File</a>
              ...
              <td>
                ...
                {pathValue542f1 === '' ? null : (
                  <div className="c54-fileButtons-container">
                    ...
                    <button className="c11-removeFileButton-style" 
                      onClick={(e)=>{setPathValue542f1("");
                      document.getElementById("542-f1").value="" }} >
                       Reset                     
                     </button>
                  </div>
                )}
                <a href={downloadFile(value542f1)} target="_blank">View File</a>
                {/* <div className="c11-fileButtons-container">
                  <button className="c11-viewFileButton-style">
              ...
              {pathValue542f1 === "" ? null : (
                <div className="c21-fileButtons-container">
                  <button
                    ...
                    style={{ height: "37px", width: "70px" }}
                  >
                    <a target="_openfile" href={filePreviewSrc542f1}>
                      {" "}
                      View File
                    </a>
                  </button>
