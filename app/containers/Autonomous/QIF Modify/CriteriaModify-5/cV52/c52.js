    ...
    () => fetch(resources.APPLICATION_URL+'criteria5getallfiles?collegeId='+collegeId+'&financialYear='+fYear+'&typeofInstitution='+instituteType).then(
      (response) => response
        ...
        .then((data) => {
          ...
          setValue5221t1(data[0].criteria52Qn[0] ? data[0].criteria52Qn[0].input5221t1 : "");
          setValue5221t2(data[0].criteria52Qn[0] ? data[0].criteria52Qn[0].input5221t2 : "");
         ...
         setValue5221t6(data[0].universityYearTable5221[0] ? data[0].universityYearTable5221[0].input5221v : "");
         setValue5221t7(data[0].universityYearTable5221[1] ? data[0].universityYearTable5221[1].input5221v : "");
         setValue5221t8(data[0].universityYearTable5221[2] ? data[0].universityYearTable5221[2].input5221v : "");
         setValue5221t9(data[0].universityYearTable5221[3] ? data[0].universityYearTable5221[3].input5221v : "");
         setValue5221t10(data[0].universityYearTable5221[4] ? data[0].universityYearTable5221[4].input5221v : "");
          ...
          setValue5221t16(data[0].universityYearTable52212[0] ? data[0].universityYearTable52212[0].input52212v : "");
          setValue5221t17(data[0].universityYearTable52212[1] ? data[0].universityYearTable52212[1].input52212v : "");
          setValue5221t18(data[0].universityYearTable52212[2] ? data[0].universityYearTable52212[2].input52212v : "");
          setValue5221t11(data[0].universityYearTable52212[3] ? data[0].universityYearTable52212[3].input52212v : "");
          setValue5221t11(data[0].universityYearTable52212[4] ? data[0].universityYearTable52212[4].input52212v : "");
          ...
          setValue5232t1(data[0].yearTable5232[0] ? data[0].yearTable5232[0].input5232y : "");
          setValue5232t2(data[0].yearTable5232[1] ? data[0].yearTable5232[1].input5232y : "");
          setValue5232t3(data[0].yearTable5232[2] ? data[0].yearTable5232[2].input5232y : "");
          setValue5232t4(data[0].yearTable5232[3] ? data[0].yearTable5232[3].input5232y : "");
          setValue5232t5(data[0].yearTable5232[4] ? data[0].yearTable5232[4].input5232y : "");
          setValue5232t6(data[0].yearTable5232[0] ? data[0].yearTable5232[0].input5232v : "");
          setValue5232t7(data[0].yearTable5232[1] ? data[0].yearTable5232[1].input5232v : "");
          setValue5232t8(data[0].yearTable5232[2] ? data[0].yearTable5232[2].input5232v : "");
          setValue5232t9(data[0].yearTable5232[3] ? data[0].yearTable5232[3].input5232v : "");
          setValue5232t10(data[0].yearTable5232[4] ? data[0].yearTable5232[4].input5232v : "");

          setValue5211f1(data[0].criteria5FileUpload[0] ? data[0].criteria5FileUpload[0].criteria5FileName : "");
          setValue5211f1(data[0].criteria5FileUpload[1] ? data[0].criteria5FileUpload[1].criteria5FileName : "");
          setValue5211f2(data[0].criteria5FileUpload[2] ? data[0].criteria5FileUpload[2].criteria5FileName : "");
          setValue5211f3(data[0].criteria5FileUpload[3] ? data[0].criteria5FileUpload[3].criteria5FileName : "");
          setValue5221f1(data[0].criteria5FileUpload[4] ? data[0].criteria5FileUpload[4].criteria5FileName : "");
          setValue5221f2(data[0].criteria5FileUpload[5] ? data[0].criteria5FileUpload[5].criteria5FileName : "");
          setValue5221f3(data[0].criteria5FileUpload[6] ? data[0].criteria5FileUpload[6].criteria5FileName : "");
          setValue5232f1(data[0].criteria5FileUpload[7] ? data[0].criteria5FileUpload[7].criteria5FileName : "");
          setValue5232f2(data[0].criteria5FileUpload[8] ? data[0].criteria5FileUpload[8].criteria5FileName : "");
          setValue5232f3(data[0].criteria5FileUpload[9] ? data[0].criteria5FileUpload[9].criteria5FileName : "");
        })
        .catch((error) => {
            ...
            <table className="c52x-table-style">
              ...
              {pathValue5211f1 === "" ? null : (
                <div className="c52-fileButtons-container">
                  ...
                  >
                    <a target="_openfile" href={filePreviewSrc5211f1}>
                      {" "}
                      View File
                    </a>
                  </button>
              ...
              {pathValue5211f2 === "" ? null : (
                <div className="c52-fileButtons-container">
                  <button
                    ...
                    style={{ height: "37px", width: "70px" }}
                  >
                    <a target="_openfile" href={filePreviewSrc5211f2}>
                      {" "}
                      View File
                    </a>
                  </button>
              ...
              <tr>
                ...
                <td>
                <a href={downloadFile("au5.2.2.xlsx")} target="_blank">View Template</a>
                </td>
                <td>
                  {/* <input
                    onChange={(e) => {
              ...
              {pathValue5211f3 === "" ? null : (
                <div className="c52-fileButtons-container">
                  <button
                    ...
                    style={{ height: "37px", width: "70px" }}
                  >
                    <a target="_openfile" href={filePreviewSrc5211f3}>
                      {" "}
                      View File
                    </a>
                  </button>
          ...
          <div className="c52xx-container">
            ...
            <table className="c52x-table-style">
              ...
              {pathValue5221f1 === "" ? null : (
                <div className="c52-fileButtons-container">
                  <button
                    ...
                    style={{ height: "37px", width: "70px" }}
                  >
                    <a target="_openfile" href={filePreviewSrc5221f1}>
                      {" "}
                      View File
                    </a>
                  </button>
              ...
              <tr>
                ...
                <td>
                  {/* <input
                    onChange={(e) => { setValue5221f2(e.target.files[0]); setPathValue5221f2(e.target.value); }}
                    id="5221-f2"
                    type="file"
                    className="c52-fileButton-style"
                  />
              ...
              {pathValue5221f2 === "" ? null : (
                <div className="c52-fileButtons-container">
                  <button
                    ...
                    style={{ height: "37px", width: "70px" }}
                  >
                    <a target="_openfile" href={filePreviewSrc5221f2}>
                      {" "}
                      View File
                    </a>
                  </button>
              ...
              <tr>
                <td>Details of student progression to higher education(Data Template)</td>
                <td>
                <a href={downloadFile("au5.2.1.xlsx")} target="_blank">View Template</a>
                </td>
                <td>
                  {/* <input
                    onChange={(e) => { setValue5221f3(e.target.files[0]); setPathValue5221f3(e.target.value); }}
                    id="5221-f3"
                    type="file"
                    className="c52-fileButton-style"
                  />
              ...
              {pathValue5221f3 === "" ? null : (
                <div className="c52-fileButtons-container">
                  <button
                    ...
                    style={{ height: "37px", width: "70px" }}
                  >
                    <a target="_openfile" href={filePreviewSrc5221f3}>
                      {" "}
                      View File
                    </a>
                  </button>
            ...
            <table className="c52x-Qt-table-style">
              ...
              <tr>
                ...
                <td>
                  ...
                  >
                    <input
                      onChange={(e) => { setValue5232t6(e.target.value); onClickingViewResponse523(); }}
                      id="5232-t6"
                      className="c52x-input-style"
                      type="text"
                      value={value5232t6}
                ...
                <td>
                  ...
                  >
                    <input
                      onChange={(e) => { setValue5232t7(e.target.value); onClickingViewResponse523(); }}
                      id="5232-t7"
                      className="c52x-input-style"
                      type="text"
                      value={value5232t7}
                ...
                <td>
                  ...
                  >
                    <input
                      onChange={(e) => { setValue5232t8(e.target.value); onClickingViewResponse523(); }}
                      id="5232-t8"
                      className="c52x-input-style"
                      type="text"
                      value={value5232t8}
                ...
                <td>
                  ...
                  >
                    <input
                      onChange={(e) => { setValue5232t9(e.target.value); onClickingViewResponse523(); }}
                      id="5232-t9"
                      className="c52x-input-style"
                      type="text"
                      value={value5232t9}
                ...
                <td>
                  ...
                  >
                    <input
                      onChange={(e) => { setValue5232t10(e.target.value); onClickingViewResponse523(); }}
                      id="5232-t10"
                      className="c52x-input-style"
                      type="text"
                      value={value5232t10}
            ...
            <table className="c52x-table-style">
              ...
              <tr>
                ...
                <td>
                  ...
                  <a href={downloadFile(value5232f1)} target="_blank">View File</a>
                  {/* <div className="c11-fileButtons-container">
                  <button className="c11-viewFileButton-style">
              ...
              <tr>
                ...
                <td>
                  ...
                  {pathValue5232f2 === '' ? null : (
                   ...
                   <a href={downloadFile(value5232f2)} target="_blank">View File</a>
                  {/* <div className="c11-fileButtons-container">
                  <button className="c11-viewFileButton-style">
              ...
              <tr>
                ...
                <td>
                  <a href="http://localhost:8080/api/v1/download/criteria5.2.3.xlsx">View Template</a>
                </td>
                <td>
                  <input
                    onChange={(e) => {
                  ...
                  <a href={downloadFile(value5232f3)} target="_blank">View File</a>
                  {/* <div className="c11-fileButtons-container">
                  <button className="c11-viewFileButton-style">
