...
function Criteria63() {
    ...
    () => fetch(resources.APPLICATION_URL+'criteria6getallfiles?collegeId='+collegeId+'&financialYear='+fYear+'&typeofInstitution='+instituteType).then(
      (response) => response
        ...
        .then((data) => {
          ...
          setValue631f4(data[0].criteria6FileUpload[3] ? data[0].criteria6FileUpload[3].criteria6FileName : "");
          setValue6321f1(data[0].criteria6FileUpload[4] ? data[0].criteria6FileUpload[4].criteria6FileName : "");
          setValue6321f2(data[0].criteria6FileUpload[5] ? data[0].criteria6FileUpload[5].criteria6FileName : "");
          setValue6331f1(data[0].criteria6FileUpload[6] ? data[0].criteria6FileUpload[6].criteria6FileName : "");
          setValue6331f2(data[0].criteria6FileUpload[7] ? data[0].criteria6FileUpload[7].criteria6FileName : "");
          setValue6331f3(data[0].criteria6FileUpload[8] ? data[0].criteria6FileUpload[8].criteria6FileName : "");
          setValue6331f3(data[0].criteria6FileUpload[9] ? data[0].criteria6FileUpload[9].criteria6FileName : "");
          setValue6341f4(data[0].criteria6FileUpload[10] ? data[0].criteria6FileUpload[10].criteria6FileName : "");
          setValue6341f2(data[0].criteria6FileUpload[11] ? data[0].criteria6FileUpload[11].criteria6FileName : "");
          setValue6341f3(data[0].criteria6FileUpload[12] ? data[0].criteria6FileUpload[12].criteria6FileName : "");
          setValue6341f4(data[0].criteria6FileUpload[13] ? data[0].criteria6FileUpload[13].criteria6FileName : "");
        })
        .catch((error) => {
 ...
 const inputDataList = {
  ...
  yearTable6321: [
    {
      criteriaId: {collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType},
       uniqueKey1: 1, input6321y: value6321t1, input6321v: value6321t6
    },
    {
      criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType },
       uniqueKey1: 2, input6321y: value6321t2, input6321v: value6321t7
    },
    {
      criteriaId: {collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType },
       uniqueKey1: 3, input6321y: value6321t3, input6321v: value6321t8
    },
    {
      criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType },
       uniqueKey1: 4, input6321y: value6321t4, input6321v: value6321t9
    },
    {
      criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType},
       uniqueKey1: 5, input6321y: value6321t5, input6321v: value6321t10
    },
  ],
  yearTable63212: [
    {
      criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType},
       uniqueKey1: 1, input63212y: value6321t11, input63212v: value6321t16
    },
    {
      criteriaId: {collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType },
       uniqueKey1: 2, input63212y: value6321t12, input63212v: value6321t17
    },
    {
      criteriaId: {collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType },
       uniqueKey1: 3, input63212y: value6321t13, input63212v: value6321t18
    },
    {
      criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType },
       uniqueKey1: 4, input63212y: value6321t14, input63212v: value6321t19
    },
    {
      criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType },
       uniqueKey1: 5, input63212y: value6321t15, input63212v: value6321t20
    },
  ],
  yearTable6331: [
    {
      criteriaId: {collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType},
       uniqueKey1: 1, input6331y: value6331t1, input6331v: value6331t6
    },
    {
      criteriaId: {collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType},
       uniqueKey1: 2, input6331y: value6331t2, input6331v: value6331t7
    },
    {
      criteriaId: {collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType },
       uniqueKey1: 3, input6331y: value6331t3, input6331v: value6331t8
    },
    {
      criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType },
       uniqueKey1: 4, input6331y: value6331t4, input6331v: value6331t9
    },
    {
      criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType },
       uniqueKey1: 5, input6331y: value6331t5, input6331v: value6331t10
    },
  ],
  yearTable6341: [
    {
      criteriaId: {collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType},
       uniqueKey1: 1, input6341y: value6341t1, input6341v: value6341t6
    },
    {
      criteriaId: {collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType },
       uniqueKey1: 2, input6341y: value6341t2, input6341v: value6341t7
    },
    {
      criteriaId: {collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType },
       uniqueKey1: 3, input6341y: value6341t3, input6341v: value6341t8
    },
    {
      criteriaId: {collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType},
       uniqueKey1: 4, input6341y: value6341t4, input6341v: value6341t9
    },
    {
      criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType },
       uniqueKey1: 5, input6341y: value6341t5, input6341v: value6341t10
    },
  ],
  yearTable63412: [
    {
      criteriaId: {collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType },
       uniqueKey1: 1, input63412y: value6341t11, input63412v: value6341t16
    },
    {
      criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType },
       uniqueKey1: 2, input63412y: value6341t12, input63412v: value6341t17
    },
    {
      criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType },
       uniqueKey1: 3, input63412y: value6341t13, input63412v: value6341t18
    },
    {
      criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType },
       uniqueKey1: 4, input63412y: value6341t14, input63412v: value6341t19
    },
    {
      criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType},
       uniqueKey1: 5, input63412y: value6341t15, input63412v: value6341t20
    },
  ],
};
        ...
        <form>
          ...
          <table className="c63x-Ql-table-style">
            ...
            <tr>
              ...
              <td className="c63x-Ql-tableBorders-style">
              <a href={downloadFile("au6.3.2.xlsx")} target="_blank">View Template</a>
              </td>
              <td className="c63x-Ql-tableBorders-style">
                {/* <input
                  onChange={(e) => {
                ...
                <td>
                  ...
                  {pathValue6321f1 === '' ? null : (
                    <div className="c63-fileButtons-container">
                      ...
                      <button className="c63-removeFileButton-style" 
              ...
              {pathValue6321f1 === "" ? null : (
                <div className="c63-fileButtons-container">
                  <button
                    ...
                    style={{ height: "37px", width: "70px" }}
                  >
                    <a target="_openfile" href={filePreviewSrc632f1}>
                      {" "}
                      View File
                    </a>
                  </button>
              ...
              {pathValue6331f1 === "" ? null : (
                <div className="c63-fileButtons-container">
                  <button
                    ...
                    style={{ height: "37px", width: "70px" }}
                  >
                    <a target="_openfile" href={filePreviewSrc633f1}>
                      {" "}
                      View File
                    </a>
                  </button>
              ...
              {pathValue6331f2 === "" ? null : (
                <div className="c63-fileButtons-container">
                  <button
                    ...
                    style={{ height: "37px", width: "70px" }}
                  >
                    <a target="_openfile" href={filePreviewSrc633f2}>
                      {" "}
                      View File
                    </a>
                  </button>
              ...
              {pathValue6331f3 === "" ? null : (
                <div className="c63-fileButtons-container">
                  <button
                    ...
                    style={{ height: "37px", width: "70px" }}
                  >
                    <a target="_openfile" href={filePreviewSrc6331f3}>
                      {" "}
                      View File
                    </a>
                  </button>
