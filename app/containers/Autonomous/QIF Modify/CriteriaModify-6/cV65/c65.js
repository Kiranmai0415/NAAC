...
console.log("object -->" + JSON.stringify(AuthService.getCurrentUser()));
  ...
  useEffect(
    () => fetch(resources.APPLICATION_URL+'criteria6getallfiles?collegeId=1&financialYear='+financialYear+'&typeofInstitution=autonomous').then(
      (response) => response
        .json()
        .then((data) => {
          ...
          setValue651f1(data[0].criteria6FileUpload[0] ? data[0].criteria6FileUpload[0].criteria6FileName : "");
          setValue651f2(data[0].criteria6FileUpload[1] ? data[0].criteria6FileUpload[0].criteria6FileName : "");
          setValue652f1(data[0].criteria6FileUpload[2] ? data[0].criteria6FileUpload[0].criteria6FileName : "");
          setValue652f2(data[0].criteria6FileUpload[3] ? data[0].criteria6FileUpload[0].criteria6FileName : "");
          setValue653f1(data[0].criteria6FileUpload[4] ? data[0].criteria6FileUpload[0].criteria6FileName : "");
          setValue653f2(data[0].criteria6FileUpload[5] ? data[0].criteria6FileUpload[0].criteria6FileName : "");
          setValue653f3(data[0].criteria6FileUpload[6] ? data[0].criteria6FileUpload[0].criteria6FileName : "");
          setValue653f4(data[0].criteria6FileUpload[7] ? data[0].criteria6FileUpload[0].criteria6FileName : "");
        })
        .catch((error) => {
 ...
 const inputDataList = {
  criteriaId: {    collegeId:collegeId,
    financialYear: fYear,
  ...
  return (
    <div className="c65-inputFields-mainContainer">
          ...
          <table className="c65x-Ql-table-style">
            ...
            <tr>
              ...
              <td className="c65x-Ql-tableBorders-style">
                ...
                <a href={downloadFile(value651f1)} target="_blank">View File</a>
              ...
              {pathValue651f1 === "" ? null : (
                <div className="c65-fileButtons-container">
                  <button
                    className="c65-viewFileButton-style"
                    style={{ height: "37px", width: "70px" }}
                  >
                    <a target="_openfile" href={filePreviewSrc651f1}>
                      {" "}
                      View File
                    </a>
                  </button>
                  <button
                    className="c65-removeFileButton-style"
                    onClick={(e) => {
                      setPathValue651f1("");
                      document.getElementById("651-f1").value = "";
                    }}
            ...
            <tr>
              ...
              <td className="c65x-Ql-tableBorders-style">
                ...
                <a href={downloadFile(value651f2)} target="_blank">View File</a>
                {/* <div className="c11-fileButtons-container">
                  <button className="c11-viewFileButton-style">
              ...
              {pathValue651f2 === "" ? null : (
                <div className="c65-fileButtons-container">
                  <button
                    ...
                    style={{ height: "37px", width: "70px" }}
                  >
                    <a target="_openfile" href={filePreviewSrc651f2}>
                      {" "}
                      View File
                    </a>
                  </button>
          ...
          <table className="c65x-Ql-table-style">
            ...
            <tr>
              ...
              <td className="c65x-Ql-tableBorders-style">
                ...
                <a href={downloadFile(value652f1)} target="_blank">View File</a>
                {/* <div className="c11-fileButtons-container">
                  <button className="c11-viewFileButton-style">
              ...
              {pathValue652f1 === "" ? null : (
                <div className="c65-fileButtons-container">
                  <button
                    ...
                    style={{ height: "37px", width: "70px" }}
                  >
                    <a target="_openfile" href={filePreviewSrc652f1}>
                      {" "}
                      View File
                    </a>
                  </button>
              ...
              {pathValue652f2 === "" ? null : (
                <div className="c65-fileButtons-container">
                  <button
                    ...
                    style={{ height: "37px", width: "70px" }}
                  >
                    <a target="_openfile" href={filePreviewSrc652f2}>
                      {" "}
                      View File
                    </a>
                  </button>
                ...
                <div className="c65x-radio-container">
                  <div className="c65x-radio-subContainer" style={{width:"45%"}}>
                    <div className="c65x-eachRadio-container">
                      <input name="653options" id="653-t1" type="radio" 
                       onChange={(e) => {
                    ...
                    <div className="c65x-eachRadio-container">
                      <input name="653options" id="653-t2" type="radio"
                        onChange={(e) => {
                          setValue653t2(e.target.value);
                        }}
                  ...
                  <div className="c65x-radio-subContainer">
                    <div className="c65x-eachRadio-container">
                      <input name="653options" id="653-t4" type="radio"
                       onChange={(e) => {
                        setValue653t4(e.target.value);
                      }}
                    ...
                    <div className="c65x-eachRadio-container">
                      <input name="653options" id="653-t5" type="radio"
                       onChange={(e) => {
                        setValue653t5(e.target.value);
                      }}
          ...
          <table className="c65x-table-style">
              ...
              {pathValue653f1 === "" ? null : (
                <div className="c65-fileButtons-container">
                  <button
                    ...
                    style={{ height: "37px", width: "70px" }}
                  >
                    <a target="_openfile" href={filePreviewSrc653f1}>
                      {" "}
                      View File
                    </a>
                  </button>
            ...
            <tr>
              ...
              <td>
                ...
                <a href={downloadFile(value653f2)} target="_blank">View File</a>
                {/* <div className="c11-fileButtons-container">
                  <button className="c11-viewFileButton-style">
              ...
              {pathValue653f2 === "" ? null : (
                <div className="c65-fileButtons-container">
                  <button
                    ...
                    style={{ height: "37px", width: "70px" }}
                  >
                    <a target="_openfile" href={filePreviewSrc653f2}>
                      {" "}
                      View File
                    </a>
                  </button>
            ...
            <tr>
              ...
              <td>
                ...
                <a href={downloadFile(value653f3)} target="_blank">View File</a>
                {/* <div className="c11-fileButtons-container">
                  <button className="c11-viewFileButton-style">
              ...
              {pathValue653f3 === "" ? null : (
                <div className="c65-fileButtons-container">
                  <button
                    ...
                    style={{ height: "37px", width: "70px" }}
                  >
                    <a target="_openfile" href={filePreviewSrc653f3}>
                      {" "}
                      View File
                    </a>
                  </button>
              ...
              <td>
                ...
                {pathValue653f4 === '' ? null : (
                  <div className="c65-fileButtons-container">
                    ...
                    <button className="c65-removeFileButton-style" 
                ...
                <a href={downloadFile(value653f4)} target="_blank">View File</a>
                {/* <div className="c11-fileButtons-container">
                  <button className="c11-viewFileButton-style">
              ...
              {pathValue653f4 === "" ? null : (
                <div className="c65-fileButtons-container">
                  <button
                    ...
                    style={{ height: "37px", width: "70px" }}
                  >
                    <a target="_openfile" href={filePreviewSrc653f4}>
                      {" "}
                      View File
                    </a>
                  </button>
      ...
      <div className="c65x-button-container">
        <button onClick={onClickingSave} className="c65x-button-style">
          Save
        </button>
      </div>
    </div>
