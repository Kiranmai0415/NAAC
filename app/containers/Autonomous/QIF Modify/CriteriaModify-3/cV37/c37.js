...
function Criteria37() {
 ...
 //help buttom
  ...
  const [gradeScaleClickStatus371, setGradeScaleClickStatus371] = useState(false);
  const [gradePointsClickStatus371, setGradePointsClickStatus371] = useState(false);

  const [gradeScale372, setGradeScale372] = useState('');
  const [gradePoints372, setGradePoints372] = useState();
  const [gradeScaleClickStatus372, setGradeScaleClickStatus372] = useState(false);
  const [gradePointsClickStatus372, setGradePointsClickStatus372] = useState(false);
 ...
 const inputDataList = {
  ...
  yearTable3711: [
    {
      criteriaId: {collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType},
       uniqueKey1: 1, input3711y: value3711t1, input3711v: value3711t6
    },
    {
      criteriaId: {collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType },
       uniqueKey1: 2, input3711y: value3711t2, input3711v: value3711t7
    },
    {
      criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType },
       uniqueKey1: 3, input3711y: value3711t3, input3711v: value3711t8
    },
    {
      criteriaId: {collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType},
       uniqueKey1: 4, input3711y: value3711t4, input3711v: value3711t9
    },
    {
      criteriaId: {collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType },
       uniqueKey1: 5, input3711y: value3711t5, input3711v: value3711t10
    },
  ],
  ...
  yearTable3721: [
    {
      criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType },
       uniqueKey1: 1, input3721y: value3721t1, input3721v: value3721t6
    },
    {
      criteriaId: {collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType},
       uniqueKey1: 2, input3721y: value3721t2, input3721v: value3721t7
    },
    {
      criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType},
       uniqueKey1: 3, input3721y: value3721t3, input3721v: value3721t8
    },
    {
      criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType },
       uniqueKey1: 4, input3721y: value3721t4, input3721v: value3721t9
    },
    {
      criteriaId: {collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType },
       uniqueKey1: 5, input3721y: value3721t5, input3721v: value3721t10
    },
  ],
};
            ...
            <table className="c37x-table-style">
              ...
              {pathValue3711f1 === "" ? null : (
                <div className="c21-fileButtons-container">
                  ...
                  >
                    <a target="_openfile" href={filePreviewSrc37111f1}>
                      {" "}
                      View File
                    </a>
                  </button>
              ...
              {pathValue3711f2 === "" ? null : (
                <div className="c21-fileButtons-container">
                  <button
                    ...
                    style={{ height: "37px", width: "70px" }}
                  >
                    <a target="_openfile" href={filePreviewSrc3711f2}>
                      {" "}
                      View File
                    </a>
                  </button>
              ...
              <tr>
                ...
                <td><a href={downloadFile("au3.7.1.xlsx")} target="_blank">
                  View Template</a>
                </td>
                <td>
                  {/* <input
              ...
              {pathValue3711f3 === "" ? null : (
                <div className="c21-fileButtons-container">
                  <button
                    ...
                    style={{ height: "37px", width: "70px" }}
                  >
                    <a target="_openfile" href={filePreviewSrc3711f3}>
                      {" "}
                      View File
                    </a>
                  </button>
          ...
          <div className="c37xx-container">
            ...
            <table className="c37x-table-style">
              ...
              <tr>
                ...
                <td>
                  <a href="http://localhost:8080/api/v1/download/criteria3.7.2.xlsx">View Template</a>
                </td>
                <td>
                  <input
                    onChange={(e) => {
