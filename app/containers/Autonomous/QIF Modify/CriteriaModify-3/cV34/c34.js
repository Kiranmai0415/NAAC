          ...
          <div className="c34x-container">
            <div className="c34x-heading_Help-container">
              ...
              <HelpButton
                ...
                title='formula'
              ><h1>Total number of books and chapters in edited volumes published during the last five years / Number of full time teachers (without repet count)during the last five years</h1></HelpButton>
            </div>
            <div className="c34x-response-container">
              <button
                onClick={(e) => {
          ...
          <div className="c34x-container">
            <div className="c34x-heading_Help-container">
              ...
              <HelpButton
                ...
                title='formula'
              ><h1>(h ? Index (Scopus)+ h ? index (Web of Science) during the last five years) /2</h1></HelpButton>
              <div className="c34x-response-container">
                <button
                  onClick={(e) => {
                    e.preventDefault();
