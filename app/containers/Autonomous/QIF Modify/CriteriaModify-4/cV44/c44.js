...
const financialYear="2021-2022";
  useEffect(
    () =>
      fetch(
        resources.APPLICATION_URL+"criteria4getallfiles?collegeId=" +
          collegeId +
          "&financialYear=" +
          fYear +
          "&typeofInstitution=" +
        ...
        response
          ...
          .then((data) => {
            ...
            setValue442t1(
              data[0].criteria44Ql[0] ? data[0].criteria44Ql[0].input442t1 : ""
            );

            setValue4411t1(
              data[0].yearTable4411[0]
                ? data[0].yearTable4411[0].input4411y
                : ""
            );
            setValue4411t2(
              data[0].yearTable4411[1]
                ? data[0].yearTable4411[1].input4411y
                : ""
            );
            setValue4411t3(
              data[0].yearTable4411[2]
                ? data[0].yearTable4411[2].input4411y
                : ""
            );
            setValue4411t4(
              data[0].yearTable4411[3]
                ? data[0].yearTable4411[3].input4411y
                : ""
            );
            setValue4411t5(
              data[0].yearTable4411[4]
                ? data[0].yearTable4411[4].input4411y
                : ""
            );
            setValue4411t6(
              data[0].yearTable4411[0]
                ? data[0].yearTable4411[0].input4411v
                : ""
            );
            setValue4411t7(
              data[0].yearTable4411[1]
                ? data[0].yearTable4411[1].input4411v
                : ""
            );
            setValue4411t8(
              data[0].yearTable4411[2]
            ...
            setValue4411t9(
              data[0].yearTable4411[3]
                ? data[0].yearTable4411[3].input4411v
                : ""
            );
            setValue4411t10(
              data[0].yearTable4411[4]
                ? data[0].yearTable4411[4].input4411v
                : ""
            );

            setValue4411t11(
              data[0].yearTable44112[0]
                ? data[0].yearTable44112[0].input44112y
                : ""
            );
            setValue4411t12(
              data[0].yearTable44112[1]
                ? data[0].yearTable44112[1].input44112y
                : ""
            );
            setValue4411t13(
              data[0].yearTable44112[2]
                ? data[0].yearTable44112[2].input44112y
                : ""
            );
            setValue4411t14(
              data[0].yearTable44112[3]
                ? data[0].yearTable44112[3].input44112y
                : ""
            );
            setValue4411t15(
              data[0].yearTable44112[4]
                ? data[0].yearTable44112[4].input44112y
                : ""
            );
            setValue4411t16(
              data[0].yearTable44112[0]
                ? data[0].yearTable44112[0].input44112v
                : ""
            );
            setValue4411t17(
              data[0].yearTable44112[1]
                ? data[0].yearTable44112[1].input44112v
                : ""
            );
            setValue4411t18(
              data[0].yearTable44112[2]
                ? data[0].yearTable44112[2].input44112v
                : ""
            );
            setValue4411t19(
              data[0].yearTable44112[3]
                ? data[0].yearTable44112[3].input44112v
                : ""
            );
            setValue4411t20(
              data[0].yearTable44112[4]
                ? data[0].yearTable44112[4].input44112v
                : ""
            );
            ...
            setValue4411f3(data[0].criteria4FileUpload[2] ? data[0].criteria4FileUpload[2].criteria4FileName: "");
            setValue442f1(data[0].criteria4FileUpload[3] ? data[0].criteria4FileUpload[3].criteria4FileName : "");
            setValue442f2(data[0].criteria4FileUpload[4] ? data[0].criteria4FileUpload[4].criteria4FileName : "");
          })
          .catch((error) => {
  ...
  return (
    <div className="c44-inputFields-mainContainer">
            ...
            <table className="c44x-table-style">
              ...
              <tr>
                ...
                <td>
                  ...
                  <a href={downloadFile(value4411f1)} target="_blank">View File</a>
              ...
              <tr>
                ...
                <td>
                  ...
                  <a href={downloadFile(value4411f2)} target="_blank">View File</a>
                  {/* <div className="c11-fileButtons-container">
                  <button className="c11-viewFileButton-style">
              ...
              <tr>
                ...
                <td>
                  ...
                  <a href={downloadFile(value4411f3)} target="_blank">View File</a>
                  {/* <div className="c11-fileButtons-container">
                  <button className="c11-viewFileButton-style">
              ...
              <td className="c44x-Ql-tableBorders-style">
                ...
                {pathValue442f1 === '' ? null : (
                  <div className="c44-fileButtons-container">
                    ...
                    <button className="c11-removeFileButton-style" 
                      onClick={(e)=>{setPathValue442f1("");
                      document.getElementById("442-f1").value="" }} >
                       Reset                     
                     </button>
                  </div>
                )} 
                <a href={downloadFile(value442f1)} target="_blank">View File</a>
                {/* <div className="c11-fileButtons-container">
                  <button className="c11-viewFileButton-style">
      ...
      <div className="c44x-button-container">
        <button onClick={onClickingModify} className="c44x-button-style">
          Save
        </button>
      </div>
    </div>
