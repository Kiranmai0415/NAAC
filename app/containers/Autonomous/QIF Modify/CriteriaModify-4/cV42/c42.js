...
useEffect(
  () => fetch(resources.APPLICATION_URL+'criteria4getallfiles?collegeId='+collegeId+'&financialYear='+fYear+'&typeofInstitution='+instituteType).then(
    (response) => response
      ...
      .then((data) => {
        ...
        setValue4231t1(data[0].yearTable4231[0] ? data[0].yearTable4231[0].input4231y : "");
        setValue4231t2(data[0].yearTable4231[1] ? data[0].yearTable4231[1].input4231y : "");
        setValue4231t3(data[0].yearTable4231[2] ? data[0].yearTable4231[2].input4231y : "");
        setValue4231t4(data[0].yearTable4231[3] ? data[0].yearTable4231[3].input4231y : "");
        setValue4231t5(data[0].yearTable4231[4] ? data[0].yearTable4231[4].input4231y : "");
        setValue4231t6(data[0].yearTable4231[0] ? data[0].yearTable4231[0].input4231v : "");
        setValue4231t7(data[0].yearTable4231[1] ? data[0].yearTable4231[1].input4231v : "");
        setValue4231t8(data[0].yearTable4231[2] ? data[0].yearTable4231[2].input4231v : "");
        setValue4231t9(data[0].yearTable4231[3] ? data[0].yearTable4231[3].input4231v : "");
        setValue4231t10(data[0].yearTable4231[4] ? data[0].yearTable4231[4].input4231v : "");
 ...
 const inputDataList = {
  ...
  yearTable4231: [
    {
      criteriaId: {collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType },
       uniqueKey1: 1, input4231y: value4231t1, input4231v: value4231t6
    },
    {
      criteriaId: {collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType  },
       uniqueKey1: 2, input4231y: value4231t2, input4231v: value4231t7
    },
    {
      criteriaId: {collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType },
       uniqueKey1: 3, input4231y: value4231t3, input4231v: value4231t8
    },
    {
      criteriaId: {collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType },
       uniqueKey1: 4, input4231y: value4231t4, input4231v: value4231t9
    },
    {
      criteriaId: {collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType },
       uniqueKey1: 5, input4231y: value4231t5, input4231v: value4231t10
    },
  ],
};
    ...
    <div className="c42-inputFields-mainContainer">
            ...
            <div className="c42x-heading_Help-container">
              <div>
                ...
                <div className="c42x-radio-container" style={{width:"200%"}}>
                  <div className="c42x-radio-subContainer" style={{width:"45%"}}>
          ...
          <table className="c42x-table-style">
            ...
            <tr>
              ...
              <td>
                ...
                <a href={downloadFile(value422f1)} target="_blank">View File</a>
                <div className="c11-fileButtons-container">
                  <button className="c11-viewFileButton-style">
            ...
            <tr>
              ...
              <td> <a href="http://localhost:8080/api/v1/download/criteria4.2.2&4.2.3.xlsx">View Template</a></td>
              <td>
                <input
                  onChange={(e) => {
                ...
                <a href={downloadFile(value422f2)} target="_blank">View File</a>
                <div className="c11-fileButtons-container">
                  <button className="c11-viewFileButton-style">
          ...
          <div className="c42xx-container">
            ...
            <table className="c42x-table-style">
                ...
                <td>
                  ...
                  {pathValue4231f1 === '' ? null : (
                    <div className="c42-fileButtons-container">
                      ...
                      <button className="c11-removeFileButton-style" 
                      onClick={(e)=>{setPathValue4231f1("");
                      document.getElementById("4231-f1").value="" }} >
                       Reset                     
                     </button>
                    </div>
                  )}
                   <a href={downloadFile(value4231f1)} target="_blank">View File</a>
                  {/* <div className="c11-fileButtons-container">
                  <button className="c11-viewFileButton-style">
                ...
                <td>
                  ...
                  {pathValue4231f2 === '' ? null : (
                    <div className="c42-fileButtons-container">
                      ...
                      <button className="c11-removeFileButton-style" 
                      onClick={(e)=>{setPathValue4231f2("");
                      document.getElementById("4231-f2").value="" }} >
                       Reset                     
                     </button>
                    </div>
                  )}
                   <a href={downloadFile(value4231f2)} target="_blank">View File</a>
                  {/* <div className="c11-fileButtons-container">
                  <button className="c11-viewFileButton-style">
              ...
              <tr>
               ...
               <a href={downloadFile("au4.2.2.xlsx")} target="_blank"> View Template</a>
                </td>
                <td>
                  {/* <input
                    onChange={(e) => {
                  ...
                  {pathValue4231f3 === '' ? null : (
                    <div className="c42-fileButtons-container">
                      ...
                      <button className="c11-removeFileButton-style" 
                      onClick={(e)=>{setPathValue4231f3("");
                      document.getElementById("4221-f3").value="" }} >
                       Reset                     
                     </button>
                    </div>
                  )}
                  <a href={downloadFile(value4231f3)} target="_blank">View File</a>
                  {/* <div className="c11-fileButtons-container">
                  <button className="c11-viewFileButton-style">
              ...
              {pathValue4231f3 === "" ? null : (
                <div className="c21-fileButtons-container">
                  ...
                  <button
                    ...
                    onClick={(e) => {
                      setPathValue4231f3("");
                      document.getElementById("4231-f3").value = "";
                    }}
                    style={{ height: "37px", width: "70px" }}
                  >
                    Reset
      ...
      {/* <div className="c42x-eachInputField-container">
        ...
        <form>
          ...
          <div className="c42xx-container">
            <h1 className="c42xx-Heading-style">
              <span className="c42xx-span-style">4.2.4.1: 
                ...
                <td>
                  ...
                  {pathValue4241f1 === '' ? null : (
                    <div className="c42-fileButtons-container">
                      ...
                      <button className="c11-removeFileButton-style" 
                      onClick={(e)=>{setPathValue4241f1("");
                      document.getElementById("4241-f1").value="" }} >
                       Reset                     
                     </button>
                    </div>
                  )}
                  <a href={downloadFile(value4241f1)} target="_blank">View File</a>
                  <div className="c11-fileButtons-container">
                  <button className="c11-viewFileButton-style">
                ...
                <td>
                  ...
                  {pathValue4241f2 === '' ? null : (
                    <div className="c42-fileButtons-container">
                      ...
                      <button className="c11-removeFileButton-style" 
                      onClick={(e)=>{setPathValue4241f2("");
                      document.getElementById("4241-f2").value="" }} >
                       Reset                     
                     </button>
                    </div>
                  )}
                  <a href={downloadFile(value4241f2)} target="_blank">View File</a>
                  <div className="c11-fileButtons-container">
                  <button className="c11-viewFileButton-style">
      ...
      <div className="c42x-button-container">
        <button onClick={onClickingSave} className="c42x-button-style">
          Save
        </button>
      </div>
    </div>
