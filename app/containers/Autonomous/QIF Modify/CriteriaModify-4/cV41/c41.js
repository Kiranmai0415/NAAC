    ...
    () => fetch(resources.APPLICATION_URL+'criteria4getallfiles?collegeId='+collegeId+'&financialYear='+fYear+'&typeofInstitution='+instituteType).then(
      (response) => response
        ...
        .then((data) => {
          ...
          setValue4131t1(data[0].criteria41Qn[0] ? data[0].criteria41Qn[0].input4131t1 : "");
          setValue4131t2(data[0].criteria41Qn[0] ? data[0].criteria41Qn[0].input4131t2 : "");
  ...
  function onClickingViewResponse414() {
   ...
   const inputDataList = {
    ...
    yearTable4141: [
      {
        criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType },
         uniqueKey1: 1, input4141y: value4141t1, input4141v: value4141t6
      },
      {
        criteriaId: {collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType },
         uniqueKey1: 2, input4141y: value4141t2, input4141v: value4141t7
      },
      {
        criteriaId: {collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType },
         uniqueKey1: 3, input4141y: value4141t3, input4141v: value4141t8
      },
      {
        criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType},
         uniqueKey1: 4, input4141y: value4141t4, input4141v: value4141t9
      },
      {
        criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType},
         uniqueKey1: 5, input4141y: value4141t5, input4141v: value4141t10
      },
    ],
    // yearTable41412: [
    //   {
    //     criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType },
    //      uniqueKey1: 1, input41412y: value4141t11, input41412v: value4141t16
    //   },
    //   {
    //     criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType },
    //      uniqueKey1: 2, input41412y: value4141t12, input41412v: value4141t17
    //   },
    //   {
    //     criteriaId: {collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType},
    //      uniqueKey1: 3, input41412y: value4141t13, input41412v: value4141t18
    //   },
    //   {
    //     criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType },
    //      uniqueKey1: 4, input41412y: value4141t14, input41412v: value4141t19
    //   },
    //   {
    //     criteriaId: {collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType},
    //      uniqueKey1: 5, input41412y: value4141t15, input41412v: value4141t20
    //   },
    // ],
  };
          ...
          <table className="c41x-Ql-table-style">
            ...
            <tr>
              ...
              <td className="c41x-Ql-tableBorders-style">
                ...
                <a href={downloadFile(value412f1)} target="_blank">View File</a>
                <div className="c11-fileButtons-container">
                  <button className="c11-viewFileButton-style">
            ...
            <tr>
              ...
              <td>
                ...
                {pathValue412f2 === '' ? null : (
                 ...
                 <a href={downloadFile(value412f2)} target="_blank">View File</a>
                <div className="c11-fileButtons-container">
                  <button className="c11-viewFileButton-style">
            ...
            <tr>
              ...
              <td>
                ...
                <a href={downloadFile(value412f3)} target="_blank">View File</a>
                <div className="c11-fileButtons-container">
                  <button className="c11-viewFileButton-style">
          ...
          <div className="c41xx-container">
            <div className="c41xx-label-textInput-container">
              <h1 className="c41xx-Heading-style">
                <span className="c41xx-span-style">4.1.3.1: 
                ...
                <span className="c41xx-span-style">4.1.3.2: 
                Number of classrooms and seminar halls in the Institution
                <input
            ...
            <table className="c41x-table-style">
              ...
              <tr>
                ...
                <td> <a href="http://localhost:8080/api/v1/download/criteria4.3.1.xlsx">View Template</a></td>
                <td>
                  <input
                    onChange={(e) => {
                  ...
                  <a href={downloadFile(value4131f1)} target="_blank">View File</a>
                  <div className="c11-fileButtons-container">
                  <button className="c11-viewFileButton-style">
            ...
            <table className="c41x-table-style">
              ...
              <tr>
                ...
                <td>
                  ...
                  <a href={downloadFile(value4141f1)} target="_blank">View File</a>
                   {/* <div className="c11-fileButtons-container">
                  <button className="c11-viewFileButton-style">
              ...
              <tr>
                ...
                <td>
                  ...
                  <a href={downloadFile(value4141f2)} target="_blank">View File</a>
                  {/* <div className="c11-fileButtons-container">
                  <button className="c11-viewFileButton-style">
              ...
              <tr>
                ...
                <td>
               <a href={downloadFile("au4.1.2..xlsx")} target="_blank">View Template</a></td>
                <td>
                  {/* <input
                    onChange={(e) => {
                  ...
                  <a href={downloadFile(value4141f3)} target="_blank">View File</a>
                  {/* <div className="c11-fileButtons-container">
                  <button className="c11-viewFileButton-style">
