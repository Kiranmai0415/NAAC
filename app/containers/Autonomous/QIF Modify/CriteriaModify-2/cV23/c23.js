    ...
    () => fetch(resources.APPLICATION_URL+'criteria2getallfiles?collegeId='+collegeId+'&financialYear='+fYear+'&typeofInstitution='+instituteType).then(
      (response) => response
        ...
        .then((data) => {
          ...
          setValue234t1(data[0].criteria23Ql[0] ? data[0].criteria23Ql[0].input234t1 : "");
          setResponseValue231(data[0].criteria23Ql[0] ? data[0].criteria23Ql[0].response231 : "");
          setResponseValue232(data[0].criteria23Ql[0] ? data[0].criteria23Ql[0].response234 : "");
          setResponseValue234(data[0].criteria23Ql[0] ? data[0].criteria23Ql[0].response231 : "");
          ...
          setResponseValue233(data[0].criteria23Qn[0] ? data[0].criteria23Qn[0].response233 : "");
          ...
          <table className="c23x-Ql-table-style">
            ...
            <tr>
              ...
              <td className="c23x-Ql-tableBorders-style">
                ...
                <a href={downloadFile(value231f1)} target="_blank">View File</a>
            ...
            <tr>
              ...
              <td className="c23x-Ql-tableBorders-style">
                ...
                <a href={downloadFile(value231f2)} target="_blank">View File</a>
                {/* <div className="c11-fileButtons-container">
                  <button className="c11-viewFileButton-style">
          ...
          <table className="c23x-Ql-table-style">
            ...
            <tr>
              ...
              <td className="c23x-Ql-tableBorders-style">
                ...
                {pathValue232f1 === '' ? null : (
                 ...
                 <a href={downloadFile(value232f1)} target="_blank">View File</a>
                {/* <div className="c11-fileButtons-container">
                  <button className="c11-viewFileButton-style">
            ...
            <tr>
              ...
              <td className="c23x-Ql-tableBorders-style">
                ...
                <a href={downloadFile(value232f2)} target="_blank">View File</a>
                {/* <div className="c11-fileButtons-container">
                  <button className="c11-viewFileButton-style">
...
plans by the institution
            ...
            <table className="c23x-table-style">
              ...
              <tr>
                ...
                <td>
                  ...
                  <a href={downloadFile(value2331f1)} target="_blank">View File</a>
                  {/* <div className="c11-fileButtons-container">
                  <button className="c11-viewFileButton-style">
              ...
              <tr>
                ...
                <td>
                  ...
                  <a href={downloadFile(value2331f2)} target="_blank">View File</a>
                  {/* <div className="c11-fileButtons-container">
                  <button className="c11-viewFileButton-style">
              ...
              <tr>
                ...
                <td>
                  ...
                  <a href={downloadFile(value2331f3)} target="_blank">View File</a>
                  {/* <div className="c11-fileButtons-container">
                  <button className="c11-viewFileButton-style">
          ...
          <table className="c23x-Ql-table-style">
            ...
            <tr>
              ...
              <td className="c23x-Ql-tableBorders-style">
                ...
                <a href={downloadFile(value234f1)} target="_blank">View File</a> */}
                {/* <div className="c11-fileButtons-container">
                  <button className="c11-viewFileButton-style">
      ...
      <div className="c23x-button-container">
        <button onClick={onClickingModify} className="c23x-button-style">
          Modify
        </button>
      </div>
    </div>
