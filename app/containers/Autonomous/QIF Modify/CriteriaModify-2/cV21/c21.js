 ...
 console.log("current year==" + fYear);
  ...
  const inputDataList = {
    ...
    yearTable21212: [
      {
        criteriaId: {collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType},
         uniqueKey1: 1, input21212y: value2121t11, input21212v: value2121t16
      },
      {
        criteriaId: {collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType },
         uniqueKey1: 2, input21212y: value2121t12, input21212v: value2121t17
      },
      {
        criteriaId: {collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType},
         uniqueKey1: 3, input21212y: value2121t13, input21212v: value2121t18
      },
      {
        criteriaId: {collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType },
         uniqueKey1: 4, input21212y: value2121t14, input21212v: value2121t19
      },
      {
        criteriaId: {collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType },
         uniqueKey1: 5, input21212y: value2121t15, input21212v: value2121t20
      },
    ]
  };
    ...
    () => fetch("http://localhost:8080/api/v1/criteria2getallfiles").then(
      (response) => response
        ...
        .then((data) => {
          ...
          setValue2112f2(data[0].criteria2FileUpload[1] ? data[0].criteria2FileUpload[1].criteria2FileName : "");
          setValue2121f1(data[0].criteria2FileUpload[2] ? data[0].criteria2FileUpload[2].criteria2FileName : "");
          setValue2121f2(data[0].criteria2FileUpload[3] ? data[0].criteria2FileUpload[3].criteria2FileName : "");
        })
        .catch((error) => {
          console.error("Error:", error);
        })
        ...
        <form>
          <div className="c21x-container">
            <div className="c21x-heading_Help-container">
              ...
              <HelpButton
                ...
                title='formula'
                > <h1 >(Total number of seats filled yearwise)/(Total number of sanctioned seats yearwise) * 100</h1></HelpButton>
            </div>
          ...
          <div className="c21xx-container">
            <h1 className="c21xx-Heading-style">
              <span className="c21xx-span-style">2.1.1.1: </span>: Number of
              seats filled year wise during last five years (Only first year
...
during the last five years
              ...
              <HelpButton
                ...
                title='formula'
                ><h1>(Total number of students admitted against the reserved categories)/(Total number of seats earmarked for reserved category as per GOI or State Government Rule )</h1></HelpButton>
            </div>
            <div className="c21x-response-container">
              <button
                onClick={(e) => {
...
categories year wise during the last five years
    ...
    GoI/State Govt. rule year wise during the last five years
      ...
      <div className="c21x-button-container">
        <button onClick={onClickingModify} className="c21x-button-style">
          Modify
        </button>
      </div>
    </div>
