      ...
      fetch(
        ...
        response
          ...
          .then((data) => {
            ...
            setValue131t1(
              data[0].criteria13Ql[0] ? data[0].criteria13Ql[0].input131t1 : ""
            );
            // setResponseValue131(data[0].criteria13Ql[0].response131);

            setValue134t1(
              data[0].criteria13Qn[0] ? data[0].criteria13Qn[0].input134t1 : ""
            );
            setValue1341t1(
              data[0].criteria13Qn[0] ? data[0].criteria13Qn[0].input1341t1 : ""
            );

            setResponseValue132(
              data[0].criteria13Qn[0] ? data[0].criteria13Qn[0].response132 : ""
            );
            setResponseValue133(
              data[0].criteria13Qn[0] ? data[0].criteria13Qn[0].response133 : ""
            );
            setResponseValue134(
              data[0].criteria13Qn[0] ? data[0].criteria13Qn[0].response134 : ""
            );

            setValue1321t1(
              data[0].yearTable1321[0]
                ? data[0].yearTable1321[0].input1321y
                : ""
            );
            setValue1321t6(
              data[0].yearTable1321[0]
                ? data[0].yearTable1321[0].input1321v
                : ""
            );

            setValue1321t2(
              data[0].yearTable1321[1]
                ? data[0].yearTable1321[1].input1321y
                : ""
            );
            setValue1321t7(
              data[0].yearTable1321[1]
                ? data[0].yearTable1321[1].input1321v
                : ""
            );

            setValue1321t3(
              data[0].yearTable1321[2]
                ? data[0].yearTable1321[2].input1321y
                : ""
            );
            setValue1321t8(
              data[0].yearTable1321[2]
                ? data[0].yearTable1321[2].input1321v
                : ""
            );

            setValue1321t4(
              data[0].yearTable1321[3]
                ? data[0].yearTable1321[3].input1321y
                : ""
            );
            setValue1321t9(
              data[0].yearTable1321[3]
                ? data[0].yearTable1321[3].input1321v
                : ""
            );

            setValue1321t5(
              data[0].yearTable1321[4]
                ? data[0].yearTable1321[4].input1321y
                : ""
            );
            setValue1321t10(
              data[0].yearTable1321[4]
                ? data[0].yearTable1321[4].input1321v
                : ""
            );

            setValue1331t1(
              data[0].yearTable1331[0]
                ? data[0].yearTable1331[0].input1331y
                : ""
            );
            setValue1331t6(
              data[0].yearTable1331[0]
                ? data[0].yearTable1331[0].input1331v
                : ""
            );

            setValue1331t2(
              data[0].yearTable1331[1]
                ? data[0].yearTable1331[1].input1331y
                : ""
            );
            setValue1331t7(
              data[0].yearTable1331[1]
                ? data[0].yearTable1331[1].input1331v
                : ""
            );

            setValue1331t3(
              data[0].yearTable1331[2]
                ? data[0].yearTable1331[2].input1331y
                : ""
            );
            setValue1331t8(
              data[0].yearTable1331[2]
                ? data[0].yearTable1331[2].input1331v
                : ""
            );

            setValue1331t4(
              data[0].yearTable1331[3]
                ? data[0].yearTable1331[3].input1331y
                : ""
            );
            setValue1331t9(
              data[0].yearTable1331[3]
                ? data[0].yearTable1331[3].input1331v
                : ""
            );

            setValue1331t5(
              data[0].yearTable1331[4]
                ? data[0].yearTable1331[4].input1331y
                : ""
            );
            setValue1331t10(
              data[0].yearTable1331[4]
                ? data[0].yearTable1331[4].input1331v
                : ""
            );

            setValue1331t11(
              data[0].yearTable13312[0]
                ? data[0].yearTable13312[0].input13312y
                : ""
            );
            setValue1331t16(
              data[0].yearTable13312[0]
                ? data[0].yearTable13312[0].input13312v
                : ""
            );

            setValue1331t12(
              data[0].yearTable13312[1]
                ? data[0].yearTable13312[1].input13312y
                : ""
            );
            setValue1331t17(
              data[0].yearTable13312[1]
                ? data[0].yearTable13312[1].input13312v
                : ""
            );

            setValue1331t13(
              data[0].yearTable13312[2]
                ? data[0].yearTable13312[2].input13312y
                : ""
            );
            setValue1331t18(
              data[0].yearTable13312[2]
                ? data[0].yearTable13312[2].input13312v
                : ""
            );

            setValue1331t14(
              data[0].yearTable13312[3]
                ? data[0].yearTable13312[3].input13312y
                : ""
            );
            setValue1331t19(
              data[0].yearTable13312[3]
                ? data[0].yearTable13312[3].input13312v
                : ""
            );

            setValue1331t15(
              data[0].yearTable13312[4]
                ? data[0].yearTable13312[4].input13312y
                : ""
            );
            setValue1331t20(
              data[0].yearTable13312[4]
                ? data[0].yearTable13312[4].input13312v
                : ""
            );
...
during the last five years many new value-added courses are added within the last five
              years
            </h1>
...
programs </td>
                <td>
                <a href={downloadFile("au1.3.2.xlsx")} target="_blank"> View Template
                  </a>
                </td>
                <td>
                  {/* <input
                  ...
                  <a href={downloadFile(value1321f3)} target="_blank">View File</a>
                  {/* <div className="c11-fileButtons-container">
                  <button className="c11-viewFileButton-style">
...
research projects / internships during the last five years
              ...
              <HelpButton
                ...
                title='formula'
                ><h1>(Number of Programs that have components of field projects research projects / internships during the last five years)/( Number of programmes offered during the last five years) * 100</h1></HelpButton>
            </div>
            <div className="c13x-response-container">
              <button
                onClick={(e) => {
            ...
            <table className="c13x-table-style">
              ...
              <tr>
                ...
                <td>
                  ...
                  <a href={downloadFile(value1331f1)} target="_blank">View File</a>
                  {/* <div className="c11-fileButtons-container">
                  <button className="c11-viewFileButton-style">
...
research projects / internships as approved by BOS</td>
                ...
                <td>
                  ...
                  <a href={downloadFile(value1331f2)} target="_blank">View File</a>
                  {/* <div className="c11-fileButtons-container">
                  <button className="c11-viewFileButton-style">
...
institutions
                ...
                </td>*/}  <Button variant="contained" component="label">
                File Upload
                <input
                  className="input-text"
...
by the students</td>
      ...
      <div className="c13x-button-container">
        <button onClick={onClickingModify} className="c13x-button-style">
          Modify
        </button>
      </div>
    </div>
