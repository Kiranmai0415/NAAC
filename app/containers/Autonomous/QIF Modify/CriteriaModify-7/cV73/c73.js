  ...
  return (
    <div className="c73-inputFields-mainContainer">
          ...
          <table className="c73x-Ql-table-style">
            ...
            <tr>
              ...
              <td className="c73x-Ql-tableBorders-style">
                ...
                {pathValue731f1 === '' ? null : (
                  <div className="c73-fileButtons-container">
                    ...
                    <button className="c73-removeFileButton-style" 
                ...
                <a href={downloadFile(value731f1)} target="_blank">View File</a> */}
              ...
              {pathValue731f1 === "" ? null : (
                <div className="c73-fileButtons-container">
                  <button
                    className="c73-viewFileButton-style"
                    style={{ height: "37px", width: "70px" }}
                  >
                    <a target="_openfile" href={filePreviewSrc731f1}>
                      {" "}
                      View File
                    </a>
                  </button>
                  <button
                    className="c73-removeFileButton-style"
                    onClick={(e) => {
                      setPathValue731f1("");
                      document.getElementById("731-f1").value = "";
                    }}
            ...
            <tr>
              ...
              <td className="c73x-Ql-tableBorders-style">
                ...
                <a href={downloadFile(value731f2)} target="_blank">View File</a> */}
                   <Button variant="contained" component="label">
                File Upload
                <input
                  className="input-text"
              ...
              {pathValue731f2 === "" ? null : (
                <div className="c73-fileButtons-container">
                  <button
                    ...
                    style={{ height: "37px", width: "70px" }}
                  >
                    <a target="_openfile" href={filePreviewSrc731f2}>
                      {" "}
                      View File
                    </a>
                  </button>
      ...
      <div className="c73x-button-container">
        <button onClick={onClickingSave} className="c73x-button-style">
          Save
        </button>
      </div>
    </div>
