...
console.log("current year==" + fYear);
  ...
  // useEffect(
  //   () => fetch('http://localhost:8080/api/v1/criteria7getallfiles').then(
  //     (response) => response
  //       .json()
  //       .then((data) => {
  //         setValue721t1(data[0].criteria7FieldInfoQl[1].input721t1);

  //         setValue721f1(data[0].criteria7FileUpload[0].criteria7FileName);
  //         setValue721f2(data[0].criteria7FileUpload[0].criteria7FileName);
  //       })
  //       .catch((error) => {
  //         console.error('Error:', error);
  //       })
  ...
  return (
    <div className="c72-inputFields-mainContainer">
        ...
        <form>
          ...
          Institution as per NAAC format provided in the Manual
              ...
              <button
                ...
                className="c72x-helpButton-style"
              >
                Help
              </button>
              <HelpButton
          ...
          <table className="c72x-Ql-table-style">
            ...
            <tr>
              ...
              <td className="c72x-Ql-tableBorders-style">
                ...
                {pathValue721f1 === '' ? null : (
                  <div className="c72-fileButtons-container">
                    ...
                    <button className="c72-removeFileButton-style" 
                ...
                <a href={downloadFile(value721f1)} target="_blank">View File</a> */}
                 {/* <div className="c72-fileButtons-container">
                  <button className="c72-viewFileButton-style">
              ...
              {pathValue721f1 === "" ? null : (
                <div className="c72-fileButtons-container">
                  <button
                    className="c72-viewFileButton-style"
                    style={{ height: "37px", width: "70px" }}
                  >
                    <a target="_openfile" href={filePreviewSrc721f1}>
                      {" "}
                      View File
                    </a>
                  </button>
                  <button
                    className="c72-removeFileButton-style"
                    onClick={(e) => {
                      setPathValue721f1("");
                      document.getElementById("721-f1").value = "";
                    }}
              ...
              {pathValue721f2 === "" ? null : (
                <div className="c72-fileButtons-container">
                  <button
                    ...
                    style={{ height: "37px", width: "70px" }}
                  >
                    <a target="_openfile" href={filePreviewSrc721f2}>
                      {" "}
                      View File
                    </a>
                  </button>
      ...
      <div className="c72x-button-container">
        <button onClick={onClickingSave} className="c72x-button-style">
          Save
        </button>
      </div>
    </div>
