...
function Criteria71() {
 ...
 //help buttom
  ...
  const [value712t2, setValue712t2] = useState();
  const [value712t3, setValue712t3] = useState();
  const [value712t4, setValue712t4] = useState();
  const [value712t5, setValue712t5] = useState();
  ...
  const [responseButtonStatus7110, setResponseButtonStatus7110] = useState(false);
  ...
  useEffect(
    () => fetch(resources.APPLICATION_URL+'criteria7getallfiles?collegeId='+collegeId+'&financialYear='+fYear+'&typeofInstitution='+instituteType).then(
      (response) => response
        .json()
        .then((data) => {
          ...
          setValue712f2(data[0].criteria7FileUpload[3] ? data[0].criteria7FileUpload[3].criteria7FileName : "");
          setValue713f1(data[0].criteria7FileUpload[4] ? data[0].criteria7FileUpload[4].criteria7FileName : "");
          setValue713f2(data[0].criteria7FileUpload[5] ? data[0].criteria7FileUpload[5].criteria7FileName : "");
          setValue713f3(data[0].criteria7FileUpload[6] ? data[0].criteria7FileUpload[6].criteria7FileName : "");
          setValue714f1(data[0].criteria7FileUpload[7] ? data[0].criteria7FileUpload[7].criteria7FileName : "");
          setValue714f2(data[0].criteria7FileUpload[8] ? data[0].criteria7FileUpload[8].criteria7FileName : "");
          setValue715f1(data[0].criteria7FileUpload[9] ? data[0].criteria7FileUpload[9].criteria7FileName : "");
          setValue715f2(data[0].criteria7FileUpload[10] ? data[0].criteria7FileUpload[10].criteria7FileName : "");
          setValue715f3(data[0].criteria7FileUpload[11] ? data[0].criteria7FileUpload[11].criteria7FileName : "");
          setValue716f1(data[0].criteria7FileUpload[12] ? data[0].criteria7FileUpload[12].criteria7FileName : "");
          setValue716f2(data[0].criteria7FileUpload[13] ? data[0].criteria7FileUpload[13].criteria7FileName : "");
          setValue716f3(data[0].criteria7FileUpload[14] ? data[0].criteria7FileUpload[14].criteria7FileName : "");
          setValue716f4(data[0].criteria7FileUpload[15] ? data[0].criteria7FileUpload[15].criteria7FileName : "");
          setValue717f1(data[0].criteria7FileUpload[16] ? data[0].criteria7FileUpload[16].criteria7FileName : "");
          setValue717f2(data[0].criteria7FileUpload[17] ? data[0].criteria7FileUpload[17].criteria7FileName : "");
          setValue717f3(data[0].criteria7FileUpload[18] ? data[0].criteria7FileUpload[18].criteria7FileName : "");
          setValue717f4(data[0].criteria7FileUpload[19] ? data[0].criteria7FileUpload[19].criteria7FileName : "");
          setValue718f1(data[0].criteria7FileUpload[20] ? data[0].criteria7FileUpload[20].criteria7FileName : "");
          setValue718f2(data[0].criteria7FileUpload[21] ? data[0].criteria7FileUpload[21].criteria7FileName : "");
          setValue719f1(data[0].criteria7FileUpload[22] ? data[0].criteria7FileUpload[22].criteria7FileName : "");
          setValue719f2(data[0].criteria7FileUpload[23] ? data[0].criteria7FileUpload[23].criteria7FileName : "");
          setValue7110f1(data[0].criteria7FileUpload[24] ? data[0].criteria7FileUpload[24].criteria7FileName : "");
          setValue7110f2(data[0].criteria7FileUpload[25] ? data[0].criteria7FileUpload[25].criteria7FileName : "");
          setValue7110f3(data[0].criteria7FileUpload[26] ? data[0].criteria7FileUpload[26].criteria7FileName : "");
          setValue7111f1(data[0].criteria7FileUpload[27] ? data[0].criteria7FileUpload[27].criteria7FileName : "");
          setValue7111f2(data[0].criteria7FileUpload[28] ? data[0].criteria7FileUpload[28].criteria7FileName : "");
          setValue7111f3(data[0].criteria7FileUpload[29] ? data[0].criteria7FileUpload[29].criteria7FileName : "");
        })
        .catch((error) => {
  ...
  function onClickingSave() {
    ...
    form71Data.append('criteria7Fieldinfo', jsonBlob(inputDataList));
    if (setPathValue715f1 !== '') {
      form71Data.append('uploadfile7', value715f1, 'f715f1-' + value715f1.name);
    }
    form71Data.append('criteria7Fieldinfo', jsonBlob(inputDataList));
    if (setPathValue715f2 !== '') {
      form71Data.append('uploadfile7', value715f2, 'f715f2-' + value715f2.name);
    }
    form71Data.append('criteria7Fieldinfo', jsonBlob(inputDataList));
    if (setPathValue715f3 !== '') {
      form71Data.append('uploadfile7', value715f3, 'f715f3-' + value715f3.name);
    }
    form71Data.append('criteria7Fieldinfo', jsonBlob(inputDataList));
    if (setPathValue716f1 !== '') {
      form71Data.append('uploadfile7', value716f1, 'f716f1-' + value716f1.name);
    }
    form71Data.append('criteria7Fieldinfo', jsonBlob(inputDataList));
    if (setPathValue716f2 !== '') {
      form71Data.append('uploadfile7', value716f2, 'f716f2-' + value716f2.name);
    }
    form71Data.append('criteria7Fieldinfo', jsonBlob(inputDataList));
    if (setPathValue716f3 !== '') {
      form71Data.append('uploadfile7', value716f3, 'f716f3-' + value716f3.name);
    }
    form71Data.append('criteria7Fieldinfo', jsonBlob(inputDataList));
    if (setPathValue716f4 !== '') {
      form71Data.append('uploadfile7', value716f4, 'f716f4-' + value716f4.name);
    }
    form71Data.append('criteria7Fieldinfo', jsonBlob(inputDataList));
    if (setPathValue717f1 !== '') {
      form71Data.append('uploadfile7', value717f1, 'f717f1-' + value717f1.name);
    }
    form71Data.append('criteria7Fieldinfo', jsonBlob(inputDataList));
    if (setPathValue717f2 !== '') {
      form71Data.append('uploadfile7', value717f2, 'f717f2-' + value717f2.name);
    }
    form71Data.append('criteria7Fieldinfo', jsonBlob(inputDataList));
    if (setPathValue717f3 !== '') {
      form71Data.append('uploadfile7', value717f3, 'f717f3-' + value717f3.name);
    }
    form71Data.append('criteria7Fieldinfo', jsonBlob(inputDataList));
    if (setPathValue717f4 !== '') {
      form71Data.append('uploadfile7', value717f4, 'f717f4-' + value717f4.name);
    }
    form71Data.append('criteria7Fieldinfo', jsonBlob(inputDataList));
    if (setPathValue718f1 !== '') {
      form71Data.append('uploadfile7', value718f1, 'f718f1-' + value718f1.name);
    }
    form71Data.append('criteria7Fieldinfo', jsonBlob(inputDataList));
    if (setPathValue718f2 !== '') {
      form71Data.append('uploadfile7', value718f2, 'f718f2-' + value718f2.name);
    }
    form71Data.append('criteria7Fieldinfo', jsonBlob(inputDataList));
    if (setPathValue719f1 !== '') {
      form71Data.append('uploadfile7', value719f1, 'f719f1-' + value719f1.name);
    }
    form71Data.append('criteria7Fieldinfo', jsonBlob(inputDataList));
    if (setPathValue719f2 !== '') {
      form71Data.append('uploadfile7', value719f2, 'f719f2-' + value719f2.name);
    }
    form71Data.append('criteria7Fieldinfo', jsonBlob(inputDataList));
    if (setPathValue7110f1 !== '') {
      form71Data.append(
        'uploadfile7',
        value7110f1,
        'f7110f1-' + value7110f1.name
      );
    }
    form71Data.append('criteria7Fieldinfo', jsonBlob(inputDataList));
    if (setPathValue7110f2 !== '') {
      form71Data.append(
        'uploadfile7',
        value7110f2,
        'f7110f2-' + value7110f2.name
      );
    }
    form71Data.append('criteria7Fieldinfo', jsonBlob(inputDataList));
    if (setPathValue7110f3 !== '') {
      form71Data.append(
        'uploadfile7',
        value7110f3,
        'f7110f3-' + value7110f3.name
      );
    }
    form71Data.append('criteria7Fieldinfo', jsonBlob(inputDataList));
    if (setPathValue7111f1 !== '') {
      form71Data.append(
        'uploadfile7',
        value7111f1,
        'f7111f1-' + value7111f1.name
      );
    }
    form71Data.append('criteria7Fieldinfo', jsonBlob(inputDataList));
    if (setPathValue7111f2 !== '') {
      form71Data.append(
        'uploadfile7',
        value7111f2,
        'f7111f2-' + value7111f2.name
      );
    }
    form71Data.append('criteria7Fieldinfo', jsonBlob(inputDataList));
    if (setPathValue7111f3 !== '') {
      form71Data.append(
        'uploadfile7',
        value7111f3,
        'f7111f3-' + value7111f3.name
      );
    }
...
function downloadFile(fileName) {
  ...
  return (
    <div className="c71-inputFields-mainContainer">
          ...
          <table className="c71x-Ql-table-style">
            ...
            <tr>
              ...
              <td className="c71x-Ql-tableBorders-style">
                ...
                {pathValue711f1 === '' ? null : (
                  <div className="c71-fileButtons-container">
                    ...
                    <button className="c71-removeFileButton-style" 
                      onClick={(e)=>{setPathValue711f1("");
              ...
              {pathValue711f1 === "" ? null : (
                <div className="c71-fileButtons-container">
                  <button
                    className="c71-viewFileButton-style"
                    style={{ height: "37px", width: "70px" }}
                  >
                    <a target="_openfile" href={filePreviewSrc711f1}>
                      {" "}
                      View File
                    </a>
                  </button>
                  <button
                    className="c71-removeFileButton-style"
                    onClick={(e) => {
                      setPathValue711f1("");
                      document.getElementById("711-f1").value = "";
                    }}
              ...
              {pathValue711f2 === "" ? null : (
                <div className="c71-fileButtons-container">
                  <button
                    ...
                    style={{ height: "37px", width: "70px" }}
                  >
                    <a target="_openfile" href={filePreviewSrc711f2}>
                      {" "}
                      View File
                    </a>
                  </button>
            ...
            <div className="c71x-heading_Help-container">
              <div>
                ...
                <div className="c71x-radio-container" style={{width:"105%"}}>
                  <div className="c71x-radio-subContainer" style={{width:"45%"}}>
                    ...
                    <div className="c71x-eachRadio-container">
                      <input
                        ...
                        onChange={(e) => setValue712t2(e.target.value)}
                      />
                    ...
                    <div className="c71x-eachRadio-container">
                      <input
                        ...
                        onChange={(e) => setValue712t3(e.target.value)}
                      />
                  ...
                  <div className="c71x-radio-subContainer">
                    <div className="c71x-eachRadio-container">
                      <input
                        ...
                        onChange={(e) => setValue712t4(e.target.value)}
                      />
                    ...
                    <div className="c71x-eachRadio-container">
                      <input
                        ...
                        onChange={(e) => setValue712t5(e.target.value)}
                      />
              ...
              {pathValue712f1 === "" ? null : (
                <div className="c71-fileButtons-container">
                  <button
                    ...
                    style={{ height: "37px", width: "70px" }}
                  >
                    <a target="_openfile" href={filePreviewSrc712f1}>
                      {" "}
                      View File
                    </a>
                  </button>
              ...
              {pathValue712f2 === "" ? null : (
                <div className="c71-fileButtons-container">
                  <button
                    ...
                    style={{ height: "37px", width: "70px" }}
                  >
                    <a target="_openfile" href={filePreviewSrc712f2}>
                      {" "}
                      View File
                    </a>
                  </button>
        ...
        <form>
          <div className="c71x-Ql-label-textarea-container">
            <div className="c71x-heading_Help-container">
              ...
              following types of degradable and non-degradable waste (within 500 words) 
              </h1>
              <button
              ...
              {pathValue713f1 === "" ? null : (
                <div className="c71-fileButtons-container">
                  <button
                    ...
                    style={{ height: "37px", width: "70px" }}
                  >
                    <a target="_openfile" href={filePreviewSrc713f1}>
                      {" "}
                      View File
                    </a>
                  </button>
              ...
              {pathValue713f2 === "" ? null : (
                <div className="c71-fileButtons-container">
                  <button
                    ...
                    style={{ height: "37px", width: "70px" }}
                  >
                    <a target="_openfile" href={filePreviewSrc713f2}>
                      {" "}
                      View File
                    </a>
                  </button>
              ...
              {pathValue713f3 === "" ? null : (
                <div className="c71-fileButtons-container">
                  <button
                    ...
                    style={{ height: "37px", width: "70px" }}
                  >
                    <a target="_openfile" href={filePreviewSrc713f3}>
                      {" "}
                      View File
                    </a>
                  </button>
                  ...
                  <div className="c71x-radio-subContainer" style={{width:"45%"}}>
                    ...
                    <div className="c71x-eachRadio-container">
                      <input
                        ...
                        type="radio"
                        value="Any three of the above"
                        onChange={(e) => setValue714t2(e.target.value)}
                      />
                    ...
                    <div className="c71x-eachRadio-container">
                      <input
                        ...
                        type="radio"
                        value="Any two of the above"
                        onChange={(e) => setValue714t3(e.target.value)}
                      />
                  ...
                  <div className="c71x-radio-subContainer">
                    <div className="c71x-eachRadio-container">
                      <input
                        ...
                        type="radio"
                        value="Any one of the above"
                        onChange={(e) => setValue714t4(e.target.value)}
                      />
                    ...
                    <div className="c71x-eachRadio-container">
                      <input
                        ...
                        type="radio"
                        value="None of the above"
                        onChange={(e) => setValue714t5(e.target.value)}
                      />
              ...
              {pathValue714f1 === "" ? null : (
                <div className="c71-fileButtons-container">
                  <button
                    ...
                    style={{ height: "37px", width: "70px" }}
                  >
                    <a target="_openfile" href={filePreviewSrc714f1}>
                      {" "}
                      View File
                    </a>
                  </button>
              ...
              {pathValue714f2 === "" ? null : (
                <div className="c71-fileButtons-container">
                  <button
                    ...
                    style={{ height: "37px", width: "70px" }}
                  >
                    <a target="_openfile" href={filePreviewSrc714f2}>
                      {" "}
                      View File
                    </a>
                  </button>
                  ...
                  <div className="c71x-radio-subContainer" style={{width:"45%"}}>
                    ...
                    <div className="c71x-eachRadio-container">
                      <input
                        ...
                        type="radio"
                        value="Any three of the above"
                        onChange={(e) => setValue715t2(e.target.value)}
                      />
                    ...
                    <div className="c71x-eachRadio-container">
                      <input
                        ...
                        type="radio"
                        value="Any two of the above"
                        onChange={(e) => setValue715t3(e.target.value)}
                      />
                  ...
                  <div className="c71x-radio-subContainer">
                    <div className="c71x-eachRadio-container">
                      <input
                        ...
                        type="radio"
                        value="Any one of the above"
                        onChange={(e) => setValue715t4(e.target.value)}
                      />
                    ...
                    <div className="c71x-eachRadio-container">
                      <input
                        ...
                        type="radio"
                        value="None of the above"
                        onChange={(e) => setValue715t5(e.target.value)}
                      />
              ...
              <td>
                ...
                {pathValue715f1 === '' ? null : (
                  <div className="c71-fileButtons-container">
                    ...
                    <button className="c11-removeFileButton-style" 
                      onClick={(e)=>{setPathValue715f1("");
                      document.getElementById("715-f1").value="" }} >
                       Reset                     
                     </button>
                  </div>
                )}
                <a href={downloadFile(value715f1)} target="_blank">View File</a>
                {/* <div className="c11-fileButtons-container">
                  <button className="c11-viewFileButton-style">
              ...
              {pathValue715f1 === "" ? null : (
                <div className="c71-fileButtons-container">
                  <button
                    ...
                    style={{ height: "37px", width: "70px" }}
                  >
                    <a target="_openfile" href={filePreviewSrc715f1}>
                      {" "}
                      View File
                    </a>
                  </button>
              ...
              <td>
                ...
                {pathValue715f2 === '' ? null : (
                  <div className="c71-fileButtons-container">
                    ...
                    <button className="c11-removeFileButton-style" 
                      onClick={(e)=>{setPathValue715f2("");
                      document.getElementById("715-f2").value="" }} >
                       Reset                     
                     </button>
                  </div>
                )}
                 <a href={downloadFile(value715f2)} target="_blank">View File</a>
                 {/* <div className="c11-fileButtons-container">
                  <button className="c11-viewFileButton-style">
              ...
              {pathValue715f2 === "" ? null : (
                <div className="c71-fileButtons-container">
                  <button
                    ...
                    style={{ height: "37px", width: "70px" }}
                  >
                    <a target="_openfile" href={filePreviewSrc715f2}>
                      {" "}
                      View File
                    </a>
                  </button>
              ...
              <td>
                ...
                {pathValue715f3 === '' ? null : (
                  <div className="c71-fileButtons-container">
                    ...
                    <button className="c11-removeFileButton-style" 
                      onClick={(e)=>{setPathValue715f3("");
                      document.getElementById("715-f3").value="" }} >
                       Reset                     
                     </button>
                  </div>
                )}
                <a href={downloadFile(value715f3)} target="_blank">View File</a>
                 {/* <div className="c11-fileButtons-container">
                  <button className="c11-viewFileButton-style">
              ...
              {pathValue715f3 === "" ? null : (
                <div className="c71-fileButtons-container">
                  <button
                    ...
                    style={{ height: "37px", width: "70px" }}
                  >
                    <a target="_openfile" href={filePreviewSrc715f3}>
                      {" "}
                      View File
                    </a>
                  </button>
                  ...
                  <div className="c71x-radio-subContainer" style={{width:"45%"}}>
                    ...
                    <div className="c71x-eachRadio-container">
                      <input
                        ...
                        type="radio"
                        value="Any three of the above"
                        onChange={(e) => setValue716t2(e.target.value)}
                      />
                    ...
                    <div className="c71x-eachRadio-container">
                      <input
                        ...
                        type="radio"
                        value="Any two of the above"
                        onChange={(e) => setValue716t3(e.target.value)}
                      />
                  ...
                  <div className="c71x-radio-subContainer">
                    <div className="c71x-eachRadio-container">
                      <input
                        ...
                        type="radio"
                        value="Any one of the above"
                        onChange={(e) => setValue716t4(e.target.value)}
                      />
                    ...
                    <div className="c71x-eachRadio-container">
                      <input
                        ...
                        type="radio"
                        value="None of the above"
                        onChange={(e) => setValue716t5(e.target.value)}
                      />
              ...
              <td>
                ...
                {pathValue716f1 === '' ? null : (
                  <div className="c71-fileButtons-container">
                    ...
                    <button className="c11-removeFileButton-style" 
                      onClick={(e)=>{setPathValue716f1("");
                      document.getElementById("716-f1").value="" }} >
                       Reset                     
                     </button>
                  </div>
                )}
                <a href={downloadFile(value716f1)} target="_blank">View File</a>
                 {/* <div className="c11-fileButtons-container">
                  <button className="c11-viewFileButton-style">
              ...
              {pathValue716f1 === "" ? null : (
                <div className="c71-fileButtons-container">
                  <button
                    ...
                    style={{ height: "37px", width: "70px" }}
                  >
                    <a target="_openfile" href={filePreviewSrc716f1}>
                      {" "}
                      View File
                    </a>
                  </button>
              ...
              <td>
                ...
                {pathValue716f2 === '' ? null : (
                  <div className="c71-fileButtons-container">
                    ...
                    <button className="c11-removeFileButton-style" 
                      onClick={(e)=>{setPathValue716f2("");
                      document.getElementById("716-f2").value="" }} >
                       Reset                     
                     </button>
                  </div>
                )}
                 <a href={downloadFile(value716f2)} target="_blank">View File</a>
                 {/* <div className="c11-fileButtons-container">
                  <button className="c11-viewFileButton-style">
              ...
              {pathValue716f2 === "" ? null : (
                <div className="c71-fileButtons-container">
                  <button
                    ...
                    style={{ height: "37px", width: "70px" }}
                  >
                    <a target="_openfile" href={filePreviewSrc716f2}>
                      {" "}
                      View File
                    </a>
                  </button>
              ...
              <td>
                ...
                {pathValue716f3 === '' ? null : (
                  <div className="c71-fileButtons-container">
                    ...
                    <button className="c11-removeFileButton-style" 
                      onClick={(e)=>{setPathValue716f3("");
                      document.getElementById("716-f3").value="" }} >
                       Reset                     
                     </button>
                  </div>
                )}
                <a href={downloadFile(value716f3)} target="_blank">View File</a>
                 {/* <div className="c11-fileButtons-container">
                  <button className="c11-viewFileButton-style">
              ...
              {pathValue716f3 === "" ? null : (
                <div className="c71-fileButtons-container">
                  <button
                    ...
                    style={{ height: "37px", width: "70px" }}
                  >
                    <a target="_openfile" href={filePreviewSrc716f3}>
                      {" "}
                      View File
                    </a>
                  </button>
              ...
              <td>
                ...
                {pathValue716f4 === '' ? null : (
                  <div className="c71-fileButtons-container">
                    ...
                    <button className="c11-removeFileButton-style" 
                      onClick={(e)=>{setPathValue716f4("");
                      document.getElementById("716-f4").value="" }} >
                       Reset                     
                     </button>
                  </div>
                )}
                <a href={downloadFile(value716f4)} target="_blank">View File</a>
                 {/* <div className="c11-fileButtons-container">
                  <button className="c11-viewFileButton-style">
              ...
              {pathValue716f4 === "" ? null : (
                <div className="c71-fileButtons-container">
                  <button
                    ...
                    style={{ height: "37px", width: "70px" }}
                  >
                    <a target="_openfile" href={filePreviewSrc716f4}>
                      {" "}
                      View File
                    </a>
                  </button>
                  ...
                  <div className="c71x-radio-subContainer" style={{width:"45%"}}>
                    ...
                    <div className="c71x-eachRadio-container">
                      <input
                        ...
                        type="radio"
                        value="Any three of the above"
                        onChange={(e) => setValue717t2(e.target.value)}
                      />
                    ...
                    <div className="c71x-eachRadio-container">
                      <input
                        ...
                        type="radio"
                        value="Any two of the above"
                        onChange={(e) => setValue717t3(e.target.value)}
                      />
                  ...
                  <div className="c71x-radio-subContainer">
                    <div className="c71x-eachRadio-container">
                      <input
                        ...
                        type="radio"
                        value="Any one of the above"
                        onChange={(e) => setValue717t4(e.target.value)}
                      />
                    ...
                    <div className="c71x-eachRadio-container">
                      <input
                        ...
                        type="radio"
                        value="None of the above"
                        onChange={(e) => setValue717t5(e.target.value)}
                      />
              ...
              <td>
                ...
                {pathValue717f1 === '' ? null : (
                  <div className="c71-fileButtons-container">
                    ...
                    <button className="c11-removeFileButton-style" 
                      onClick={(e)=>{setPathValue717f1("");
                      document.getElementById("717-f1").value="" }} >
                       Reset                     
                     </button>
                  </div>
                )}
                 <a href={downloadFile(value717f1)} target="_blank">View File</a>
                 {/* <div className="c11-fileButtons-container">
                  <button className="c11-viewFileButton-style">
              ...
              {pathValue717f1 === "" ? null : (
                <div className="c71-fileButtons-container">
                  <button
                    ...
                    style={{ height: "37px", width: "70px" }}
                  >
                    <a target="_openfile" href={filePreviewSrc717f1}>
                      {" "}
                      View File
                    </a>
                  </button>
              ...
              <td>
                ...
                {pathValue717f2 === '' ? null : (
                  <div className="c71-fileButtons-container">
                    ...
                    <button className="c11-removeFileButton-style" 
                      onClick={(e)=>{setPathValue717f2("");
                      document.getElementById("717-f2").value="" }} >
                       Reset                     
                     </button>
                  </div>
                )}
                <a href={downloadFile(value717f2)} target="_blank">View File</a>
                {/* <div className="c11-fileButtons-container">
                  <button className="c11-viewFileButton-style">
              ...
              {pathValue717f2 === "" ? null : (
                <div className="c71-fileButtons-container">
                  <button
                    ...
                    style={{ height: "37px", width: "70px" }}
                  >
                    <a target="_openfile" href={filePreviewSrc717f2}>
                      {" "}
                      View File
                    </a>
                  </button>
              ...
              <td>
                ...
                {pathValue717f3 === '' ? null : (
                  <div className="c71-fileButtons-container">
                    ...
                    <button className="c11-removeFileButton-style" 
                      onClick={(e)=>{setPathValue717f3("");
                      document.getElementById("717-f3").value="" }} >
                       Reset                     
                     </button>
                  </div>
                )}
                <a href={downloadFile(value717f3)} target="_blank">View File</a>
                {/* <div className="c11-fileButtons-container">
                  <button className="c11-viewFileButton-style">
              ...
              {pathValue717f3 === "" ? null : (
                <div className="c71-fileButtons-container">
                  <button
                    ...
                    style={{ height: "37px", width: "70px" }}
                  >
                    <a target="_openfile" href={filePreviewSrc717f3}>
                      {" "}
                      View File
                    </a>
                  </button>
              ...
              <td>
                ...
                {pathValue717f4 === '' ? null : (
                  <div className="c71-fileButtons-container">
                    ...
                    <button className="c11-removeFileButton-style" 
                      onClick={(e)=>{setPathValue717f4("");
                      document.getElementById("717-f4").value="" }} >
                       Reset                     
                     </button>
                  </div>
                )}
                <a href={downloadFile(value717f4)} target="_blank">View File</a>
                {/* <div className="c11-fileButtons-container">
                  <button className="c11-viewFileButton-style">
              ...
              {pathValue717f4 === "" ? null : (
                <div className="c71-fileButtons-container">
                  <button
                    ...
                    style={{ height: "37px", width: "70px" }}
                  >
                    <a target="_openfile" href={filePreviewSrc717f4}>
                      {" "}
                      View File
                    </a>
                  </button>
              ...
              <td className="c71x-Ql-tableBorders-style">
                ...
                {pathValue718f1 === '' ? null : (
                  <div className="c71-fileButtons-container">
                    ...
                    <button className="c11-removeFileButton-style" 
                      onClick={(e)=>{setPathValue718f1("");
                      document.getElementById("718-f1").value="" }} >
                       Reset                     
                     </button>
                  </div>
                )}
                <a href={downloadFile(value718f1)} target="_blank">View File</a>
                {/* <div className="c11-fileButtons-container">
                  <button className="c11-viewFileButton-style">
              ...
              {pathValue718f1 === "" ? null : (
                <div className="c71-fileButtons-container">
                  <button
                    ...
                    style={{ height: "37px", width: "70px" }}
                  >
                    <a target="_openfile" href={filePreviewSrc718f1}>
                      {" "}
                      View File
                    </a>
                  </button>
              ...
              <td className="c71x-Ql-tableBorders-style">
                ...
                {pathValue718f2 === '' ? null : (
                  <div className="c71-fileButtons-container">
                    ...
                    <button className="c11-removeFileButton-style" 
                      onClick={(e)=>{setPathValue718f2("");
                      document.getElementById("718-f2").value="" }} >
                       Reset                     
                     </button>
                  </div>
                )}
                <a href={downloadFile(value718f2)} target="_blank">View File</a>
                {/* <div className="c11-fileButtons-container">
                  <button className="c11-viewFileButton-style">
              ...
              {pathValue718f2 === "" ? null : (
                <div className="c71-fileButtons-container">
                  <button
                    ...
                    style={{ height: "37px", width: "70px" }}
                  >
                    <a target="_openfile" href={filePreviewSrc718f2}>
                      {" "}
                      View File
                    </a>
                  </button>
              ...
              <td className="c71x-Ql-tableBorders-style">
                ...
                {pathValue719f1 === '' ? null : (
                  <div className="c71-fileButtons-container">
                    ...
                    <button className="c11-removeFileButton-style" 
                      onClick={(e)=>{setPathValue719f1("");
                      document.getElementById("719-f1").value="" }} >
                       Reset                     
                     </button>
                  </div>
                )}
                <a href={downloadFile(value719f1)} target="_blank">View File</a>
                {/* <div className="c11-fileButtons-container">
                  <button className="c11-viewFileButton-style">
              ...
              {pathValue719f1 === "" ? null : (
                <div className="c71-fileButtons-container">
                  <button
                    ...
                    style={{ height: "37px", width: "70px" }}
                  >
                    <a target="_openfile" href={filePreviewSrc719f1}>
                      {" "}
                      View File
                    </a>
                  </button>
              ...
              <td className="c71x-Ql-tableBorders-style">
                ...
                {pathValue719f2 === '' ? null : (
                  <div className="c71-fileButtons-container">
                    ...
                    <button className="c11-removeFileButton-style" 
                      onClick={(e)=>{setPathValue719f2("");
                      document.getElementById("719-f2").value="" }} >
                       Reset                     
                     </button>
                  </div>
                )}
                 <a href={downloadFile(value719f2)} target="_blank">View File</a>
                {/* <div className="c11-fileButtons-container">
                  <button className="c11-viewFileButton-style">
              ...
              {pathValue719f2 === "" ? null : (
                <div className="c71-fileButtons-container">
                  <button
                    ...
                    style={{ height: "37px", width: "70px" }}
                  >
                    <a target="_openfile" href={filePreviewSrc719f2}>
                      {" "}
                      View File
                    </a>
                  </button>
                  ...
                  <div className="c71x-radio-subContainer" style={{width:"45%"}}>
                    ...
                    <div className="c71x-eachRadio-container">
                      <input
                        ...
                        type="radio"
                        value="Any three of the above"
                        onChange={(e) => setValue7110t2(e.target.value)}
                      />
                    ...
                    <div className="c71x-eachRadio-container">
                      <input
                        ...
                        type="radio"
                        value="Any two of the above"
                        onChange={(e) => setValue7110t3(e.target.value)}
                      />
                  ...
                  <div className="c71x-radio-subContainer">
                    <div className="c71x-eachRadio-container">
                      <input
                        ...
                        type="radio"
                        value="Any one of the above"
                        onChange={(e) => setValue7110t4(e.target.value)}
                      />
                    ...
                    <div className="c71x-eachRadio-container">
                      <input
                        ...
                        type="radio"
                        value="None of the above"
                        onChange={(e) => setValue7110t5(e.target.value)}
                      />
              ...
              <td>
                ...
                {pathValue7110f1 === '' ? null : (
                  <div className="c71-fileButtons-container">
                    ...
                    <button className="c11-removeFileButton-style" 
                      onClick={(e)=>{setPathValue7110f1("");
                      document.getElementById("7110-f1").value="" }} >
                       Reset                     
                     </button>
                  </div>
                )}
                <a href={downloadFile(value7110f1)} target="_blank">View File</a>
                {/* <div className="c11-fileButtons-container">
                  <button className="c11-viewFileButton-style">
              ...
              {pathValue7110f1 === "" ? null : (
                <div className="c71-fileButtons-container">
                  <button
                    ...
                    style={{ height: "37px", width: "70px" }}
                  >
                    <a target="_openfile" href={filePreviewSrc7110f1}>
                      {" "}
                      View File
                    </a>
                  </button>
              ...
              <td>
                ...
                {pathValue7110f2 === '' ? null : (
                  <div className="c71-fileButtons-container">
                    ...
                    <button className="c11-removeFileButton-style" 
                      onClick={(e)=>{setPathValue7110f2("");
                      document.getElementById("7110-f2").value="" }} >
                       Reset                     
                     </button>
                  </div>
                )}
                 <a href={downloadFile(value7110f2)} target="_blank">View File</a>
                {/* <div className="c11-fileButtons-container">
                  <button className="c11-viewFileButton-style">
              ...
              {pathValue7110f2 === "" ? null : (
                <div className="c71-fileButtons-container">
                  <button
                    ...
                    style={{ height: "37px", width: "70px" }}
                  >
                    <a target="_openfile" href={filePreviewSrc7110f2}>
                      {" "}
                      View File
                    </a>
                  </button>
              ...
              <td>
                ...
                {pathValue7110f3 === '' ? null : (
                  <div className="c71-fileButtons-container">
                    ...
                    <button className="c11-removeFileButton-style" 
                      onClick={(e)=>{setPathValue7110f3("");
                      document.getElementById("7110-f3").value="" }} >
                       Reset                     
                     </button>
                  </div>
                )}
                 <a href={downloadFile(value7110f3)} target="_blank">View File</a>
                {/* <div className="c11-fileButtons-container">
                  <button className="c11-viewFileButton-style">
              ...
              {pathValue7110f3 === "" ? null : (
                <div className="c71-fileButtons-container">
                  <button
                    ...
                    style={{ height: "37px", width: "70px" }}
                  >
                    <a target="_openfile" href={filePreviewSrc7110f3}>
                      {" "}
                      View File
                    </a>
                  </button>
              ...
              <td className="c71x-Ql-tableBorders-style">
                ...
                {pathValue7111f1 === '' ? null : (
                  <div className="c71-fileButtons-container">
                    ...
                    <button className="c11-removeFileButton-style" 
                      onClick={(e)=>{setPathValue7111f1("");
                      document.getElementById("7111-f1").value="" }} >
                       Reset                     
                     </button>
                  </div>
                )}
                <a href={downloadFile(value7111f1)} target="_blank">View File</a>
                {/* <div className="c11-fileButtons-container">
                  <button className="c11-viewFileButton-style">
              ...
              <td className="c71x-Ql-tableBorders-style">
                ...
                {pathValue7111f2 === '' ? null : (
                  <div className="c71-fileButtons-container">
                    ...
                    <button className="c11-removeFileButton-style" 
                      onClick={(e)=>{setPathValue7111f2("");
                      document.getElementById("7111-f2").value="" }} >
                       Reset                     
                     </button>
                  </div>
                )}
                <a href={downloadFile(value7111f2)} target="_blank">View File</a>
                {/* <div className="c11-fileButtons-container">
                  <button className="c11-viewFileButton-style">
              ...
              <td className="c71x-Ql-tableBorders-style">
                ...
                {pathValue7111f3 === '' ? null : (
                  <div className="c71-fileButtons-container">
                    ...
                    <button className="c11-removeFileButton-style" 
                      onClick={(e)=>{setPathValue7111f3("");
                      document.getElementById("7111-f3").value="" }} >
                       Reset                     
                     </button>
                  </div>
                )}
                <a href={downloadFile(value7111f3)} target="_blank">View File</a>
                {/* <div className="c11-fileButtons-container">
                  <button className="c11-viewFileButton-style">
      ...
      <div className="c71x-button-container">
        <button onClick={onClickingSave} className="c71x-button-style">
          Save
        </button>
      </div>
    </div>
