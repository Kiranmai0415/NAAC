...
function AcademicInfo() {
  ...
  useEffect(
    () =>
      fetch(
        'http://localhost:8080/api/v1/getallacademicdata?collegeId='+collegeId+'1&financialYear=' +
          fYear +
        ...
        response
          ...
          .then((data) => {
            ...
            setValueatt41(data[0].technicalStaff[3] ? data[0].technicalStaff[2].inputatt15 : "");
            setValueatt42(data[0].technicalStaff[3] ? data[0].technicalStaff[2].inputatt16 : "");
            setValueatt43(data[0].technicalStaff[3] ? data[0].technicalStaff[2].inputatt17 : "");
            setValueatt44(data[0].technicalStaff[3] ? data[0].technicalStaff[2].inputatt18 : "");
  ...
  function getAuthorizeAcademicinfo() {
    ...
    fetch(
      resources.APPLICATION_URL +
        'ssrdatasubmittoprincipal?collegeId='+collegeId+'&finacialYear='+fYear+'&typeofInstitution='+instituteType,
      authAPIMethod
    ).then((response) => {
