      ...
      fetch(
        ...
        response
          ...
          .then((data) => {
            ...
            setValue5311f2(data[0].criteria5FileUpload[0] ? data[0].criteria5FileUpload[0].criteria5FileName : "");
            setValue5311f3(data[0].criteria5FileUpload[0] ? data[0].criteria5FileUpload[0].criteria5FileName : "");
            setValue5321f1(data[0].criteria5FileUpload[0] ? data[0].criteria5FileUpload[0].criteria5FileName : "");
            setValue5321f2(data[0].criteria5FileUpload[0] ? data[0].criteria5FileUpload[0].criteria5FileName : "");
            setValue5331f1(data[0].criteria5FileUpload[0] ? data[0].criteria5FileUpload[0].criteria5FileName : "");
            setValue5331f2(data[0].criteria5FileUpload[0] ? data[0].criteria5FileUpload[0].criteria5FileName : "");
            setValue5331f3(data[0].criteria5FileUpload[0] ? data[0].criteria5FileUpload[0].criteria5FileName : "");
          })
          .catch((error) => {
            ...
            <div className="c53x-heading_Help-container">
              <h1 className="c53x-heading-style">
                ...
                Number of awards/medals for outstanding performance in 
                      ...
                      international events during the last five year
              </h1>
              <button
          ...
          <div className="c53xx-container">
            ...
            <table className="c53x-table-style">
              ...
              <tr>
                ...
                <td>
                <a href={downloadFile("au5.3.1.xlsx")} target="_blank">
                    View Template
                  </a>
                </td>
                <td>
            ...
            <table className="c53x-table-style">
              ...
              <tr>
                ...
                <td>
                  ...
                  <a href={downloadFile(value5331f1)} target="_blank">
                    View File
                  </a>
                  {/* <div className="c11-fileButtons-container">
                  <button className="c11-viewFileButton-style">
              ...
              <tr>
                ...
                <td>
                  ...
                  <a href={downloadFile(value5331f2)} target="_blank">
                    View File
                  </a>
                  {/* <div className="c11-fileButtons-container">
                  <button className="c11-viewFileButton-style">
              ...
              <tr>
                ...
                <td>
                <a href={downloadFile("au5.3.3.xlsx")} target="_blank">
                    View Template
                  </a>
                </td>
                <td>
