        ...
        response
         ...
         setValue5221t10(data[0].universityYearTable5221[4] ? data[0].universityYearTable5221[4].input5221v : "");
          ...
          setValue5232t10(data[0].yearTable5232[4] ? data[0].yearTable5232[4].input5232v : "");
            ...
            // setValue5211f1(data[0].criteria5FileUpload[0].criteria5FileName);
            // setValue5211f2(data[0].criteria5FileUpload[0].criteria5FileName);
            // setValue5211f3(data[0].criteria5FileUpload[0].criteria5FileName);
            // setValue5221f1(data[0].criteria5FileUpload[0].criteria5FileName);
            // setValue5221f2(data[0].criteria5FileUpload[0].criteria5FileName);
            // setValue5221f3(data[0].criteria5FileUpload[0].criteria5FileName);
            // setValue5232f1(data[0].criteria5FileUpload[0].criteria5FileName);
            // setValue5232f2(data[0].criteria5FileUpload[0].criteria5FileName);
            // setValue5232f3(data[0].criteria5FileUpload[0].criteria5FileName);
          })
          .catch((error) => {
    ...
    yearTable5232: [
      {
        ...
        uniqueKey1: 1,
        input5232y: value5232t1,
        input5232v: value5232t6,
      },
      {
        criteriaId: {
          collegeId: "1",
        ...
        uniqueKey1: 2,
        input5232y: value5232t2,
        input5232v: value5232t7,
      },
      {
        criteriaId: {
          collegeId: "1",
        ...
        uniqueKey1: 3,
        input5232y: value5232t3,
        input5232v: value5232t8,
      },
      {
        criteriaId: {
          collegeId: "1",
        ...
        uniqueKey1: 4,
        input5232y: value5232t4,
        input5232v: value5232t9,
      },
      {
        criteriaId: {
          collegeId: "1",
        ...
        uniqueKey1: 5,
        input5232y: value5232t5,
        input5232v: value5232t10,
      },
    ],
  };
          ...
          <div className="c52xx-container">
            <h1 className="c52xx-Heading-style">
              <span className="c52xx-span-style">
                5.2.2.1: Number of outgoing student progressing to higher
                education.
                {/* <input
                  readonly
