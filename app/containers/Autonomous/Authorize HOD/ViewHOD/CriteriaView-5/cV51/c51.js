      ...
      fetch(
        ...
        response
          ...
          // setValue5141t20(data[0].yearTable51412[4] ? data[0].yearTable51412[4].input51412v : "");
            ...
            // setValue5111f1(data[0].criteria5FileUpload[0].criteria5FileName);
            // setValue5111f2(data[0].criteria5FileUpload[0].criteria5FileName);
            // setValue5111f3(data[0].criteria5FileUpload[0].criteria5FileName);
            // setValue5111f4(data[0].criteria5FileUpload[0].criteria5FileName);
            // setValue5121f1(data[0].criteria5FileUpload[0].criteria5FileName);
            // setValue5121f2(data[0].criteria5FileUpload[0].criteria5FileName);
            // setValue5121f3(data[0].criteria5FileUpload[0].criteria5FileName);
            // setValue513f1(data[0].criteria5FileUpload[0].criteria5FileName);
            // setValue513f2(data[0].criteria5FileUpload[0].criteria5FileName);
            // setValue513f3(data[0].criteria5FileUpload[0].criteria5FileName);
            // setValue5141f1(data[0].criteria5FileUpload[0].criteria5FileName);
            // setValue5141f2(data[0].criteria5FileUpload[0].criteria5FileName);
            // setValue5141f3(data[0].criteria5FileUpload[0].criteria5FileName);
            // setValue5141f4(data[0].criteria5FileUpload[0].criteria5FileName);
            // setValue515f1(data[0].criteria5FileUpload[0].criteria5FileName);
            // setValue515f2(data[0].criteria5FileUpload[0].criteria5FileName);
            // setValue515f3(data[0].criteria5FileUpload[0].criteria5FileName);
          })
          .catch((error) => {
    ...
    yearTable5111: [
      {
        ...
        uniqueKey1: 1,
        input5111y: value5111t1,
        input5111v: value5111t6,
      },
      {
        criteriaId: {
          collegeId: "1",
        ...
        uniqueKey1: 2,
        input5111y: value5111t2,
        input5111v: value5111t7,
      },
      {
        criteriaId: {
          collegeId: "1",
        ...
        uniqueKey1: 3,
        input5111y: value5111t3,
        input5111v: value5111t8,
      },
      {
        criteriaId: {
          collegeId: "1",
        ...
        uniqueKey1: 4,
        input5111y: value5111t4,
        input5111v: value5111t9,
      },
      {
        criteriaId: {
          collegeId: "1",
        ...
        uniqueKey1: 5,
        input5111y: value5111t5,
        input5111v: value5111t10,
      },
    ],
    ...
    yearTable51212: [
      {
        ...
        uniqueKey1: 1,
        input51212y: value5121t11,
        input51212v: value5121t16,
      },
      {
        criteriaId: {
          collegeId: "1",
        ...
        uniqueKey1: 2,
        input51212y: value5121t12,
        input51212v: value5121t17,
      },
      {
        criteriaId: {
          collegeId: "1",
        ...
        uniqueKey1: 3,
        input51212y: value5121t13,
        input51212v: value5121t18,
      },
      {
        criteriaId: {
          collegeId: "1",
        ...
        uniqueKey1: 4,
        input51212y: value5121t14,
        input51212v: value5121t19,
      },
      {
        criteriaId: {
          collegeId: "1",
        ...
        uniqueKey1: 5,
        input51212y: value5121t15,
        input51212v: value5121t20,
      },
    ],
    yearTable5141: [
      {
        ...
        uniqueKey1: 1,
        input5141y: value5141t1,
        input5141v: value5141t6,
      },
      {
        criteriaId: {
          collegeId: "1",
        ...
        uniqueKey1: 2,
        input5141y: value5141t2,
        input5141v: value5141t7,
      },
      {
        criteriaId: {
          collegeId: "1",
        ...
        uniqueKey1: 3,
        input5141y: value5141t3,
        input5141v: value5141t8,
      },
      {
        criteriaId: {
          collegeId: "1",
        ...
        uniqueKey1: 4,
        input5141y: value5141t4,
        input5141v: value5141t9,
      },
      {
        criteriaId: {
          collegeId: "1",
        ...
        uniqueKey1: 5,
        input5141y: value5141t5,
        input5141v: value5141t10,
      },
    ],
    ...
    yearTable51412: [
      {
        ...
        uniqueKey1: 1,
        input51412y: value5141t11,
        input51412v: value5141t16,
      },
      {
        criteriaId: {
          collegeId: "1",
        ...
        uniqueKey1: 2,
        input51412y: value5141t12,
        input51412v: value5141t17,
      },
      {
        criteriaId: {
          collegeId: "1",
        ...
        uniqueKey1: 3,
        input51412y: value5141t13,
        input51412v: value5141t18,
      },
      {
        criteriaId: {
          collegeId: "1",
        ...
        uniqueKey1: 4,
        input51412y: value5141t14,
        input51412v: value5141t19,
      },
      {
        criteriaId: {
          collegeId: "1",
        ...
        uniqueKey1: 5,
        input51412y: value5141t15,
        input51412v: value5141t20,
      },
    ],
  };
           ...
           industries, individuals, philanthropists during the last five years        
            ...
            <table className="c51x-table-style">
              ...
              <tr>
                ...
                <td>
                <a href={downloadFile("au5.1.1.xlsx")} target="_blank">
                    View Template
                  </a>
                </td>
                <td>
        ...
        <form>
              ...
              <div>
                ...
                <div className="c51x-response-container">
                  ...
                  {responseButtonStatus513 ? (
                    <p className="c41x-responseResult-style">
                      {responseValue513}
                    </p>
                  ) : null}
                </div>
                <div className="c51x-radio-container">
                  <div
                    className="c51x-radio-subContainer"
                    style={{ width: "45%" }}
                  >
          ...
          <table className="c51x-table-style">
            ...
            <tr>
              ...
              <td>
              <a href={downloadFile("au5.1.3.xlsx")} target="_blank">
                  View Template
                </a>
              </td>
              <td>
            ...
            <table className="c51x-table-style">
              ...
              <tr>
                ...
                <td>
                  ...
                  <a href={downloadFile(value5141f1)} target="_blank">
                    View File
                  </a>
                  {/* <div className="c11-fileButtons-container">
                  <button className="c11-viewFileButton-style">
              ...
              <tr>
                ...
                <td>
                  ...
                  <a href={downloadFile(value5141f2)} target="_blank">
                    View File
                  </a>
                  {/* <div className="c11-fileButtons-container">
                  <button className="c11-viewFileButton-style">
        ...
        <form>
          <div className="c51x-container">
            <div className="c51x-heading_Help-container">
              <div>
                <h1 className="c51x-heading-style">
                  <span className="c51x-span-style">5.1.5: </span>
                  The institution adopts the following for redressal of student
                  grievances including sexual harassment and ragging cases
                </h1>
                <p className="c51x-para-style">
          ...
          <table className="c51x-table-style">
            ...
            <tr>
              ...
              <td>
                ...
                <a href={downloadFile(value515f1)} target="_blank">
                  View File
                </a>
                {/* <div className="c11-fileButtons-container">
                  <button className="c11-viewFileButton-style">
            ...
            <tr>
              ...
              <td>
                ...
                <a href={downloadFile(value515f2)} target="_blank">
                  View File
                </a>
                {/* <div className="c11-fileButtons-container">
                  <button className="c11-viewFileButton-style">
            ...
            <tr>
              ...
              <td>
                ...
                <a href={downloadFile(value515f3)} target="_blank">
                  View File
                </a>
                {/* <div className="c11-fileButtons-container">
                  <button className="c11-viewFileButton-style">
