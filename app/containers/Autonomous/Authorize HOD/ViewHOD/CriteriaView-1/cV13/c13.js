      ...
      fetch(
        ...
        response
          ...
          .then((data) => {
            ...
            setValue134t1(data[0].criteria13Qn[0] ? data[0].criteria13Qn[0].input134t1 : "");
            ...
            setValue1321t9(data[0].yearTable1321[3] ? data[0].yearTable1321[3].input1321v : "");
        ...
        <form>
          <div className="c13x-container">
            <div className="c13x-heading_Help-container">
              <h1 className="c13x-heading-style">
                ...
                Number of certificate/value added courses/Diploma Programmes offered by the institutions and online courses of MOOCs, SWAYAM/e-PG Pathshala/ NPTEL etc. where the students of the institution have enrolled and successfully completed during the last five years.
              </h1>
              <button
          ...
          <div className="c13xx-container">
            <h1 className="c13xx-Heading-style">
              ...
              Number of certificate/value added courses/Diploma Programmes offered by the institutions and online courses of MOOCs, SWAYAM/e-PG Pathshala/ NPTEL etc. where the students of the institution have enrolled and
            ...
            <table className="c13x-table-style">
              ...
              <tr>
                ...
                <td>
                <a href={downloadFile("au1.3.2.xlsx")} target="_blank">view template</a>
                </td>
                <td>
                  <input readonly
                    onChange={(e) => {
        ...
        <form>
          ...
          <div className="c13xx-container">
            <h1 className="c13xx-Heading-style">
              ...
              Number of students enrolled in value-added courses (beyond the
            ...
            <table className="c13x-table-style">
              ...
              <tr>
                <td>List of students enrolled(Data template)</td>
                <td>
                <a href={downloadFile("au1.3.3.xlsx")} target="_blank">view template</a>
                </td>
                <td>
                  <input readonly
                    onChange={(e) => {
          ...
          <div className="c13xx-container">
            <h1 className="c13xx-Heading-style">
              <span className="c13xx-span-style">
                1.3.4.1: Number of students undertaking field projects /
            ...
            <h1 className="c13xx-Heading-style">
              <span className="c13xx-span-style">
                1.3.4.1: Total number of students
                <input readonly
                  onChange={(e) => setValue1341t1(e.target.value)}
                  id="1341-t1"
                  style={{ marginLeft: "47.5%" }}
                  type="text"
                  value={value1341t1}
                />
              </span>
