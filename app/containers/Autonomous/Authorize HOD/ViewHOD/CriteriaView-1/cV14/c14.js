            ...
            <div className="c14x-heading_Help-container">
              <div>
                <h1 className="c14x-heading-style">
                  ...
                  semester wise / year wise) is obtained from
                </h1>
          ...
          <table className="c14x-Ql-table-style">
            ...
            <tr>
              ...
              <td className="c14x-Ql-tableBorders-style">
                ...
                <a href={downloadFile(value141f1)} target="_blank">
                  View File
                </a>
            ...
            <tr>
              <td className="c14x-Ql-tableBorders-style">
                ...
                minuted by the Governing Council,Syndicate, Board of Management
              </td>
              <td></td>
              <td className="c14x-Ql-tableBorders-style">
                <input
                ...
                <a href={downloadFile(value141f2)} target="_blank">
                  View File
                </a>
                {/* <div className="c11-fileButtons-container">
                  <button className="c11-viewFileButton-style">
            ...
            <tr>
              ...
              <td className="c14x-Ql-tableBorders-style">
                ...
                <a href={downloadFile(value141f3)} target="_blank">
                  View File
                </a>
                {/* <div className="c11-fileButtons-container">
                  <button className="c11-viewFileButton-style">
          ...
          <table className="c14x-Ql-table-style">
            ...
            <tr>
              ...
              <td className="c14x-Ql-tableBorders-style">
                ...
                <a href={downloadFile(value142f1)} target="_blank">
                  View File
                </a> */}
                {/* <div className="c11-fileButtons-container">
                  <button className="c11-viewFileButton-style">
            ...
            <tr>
              ...
              <td className="c14x-Ql-tableBorders-style">
                ...
                <a href={downloadFile(value142f2)} target="_blank">
                  View File
                </a> */}
                {/* <div className="c11-fileButtons-container">
                  <button className="c11-viewFileButton-style">
