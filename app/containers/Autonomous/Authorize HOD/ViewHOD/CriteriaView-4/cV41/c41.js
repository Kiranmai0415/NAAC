      ...
      fetch(
        ...
        response
          ...
          .then((data) => {
            ...
            setValue411t1(data[0].criteria41Ql[0].input411t1);
            setValue412t1(data[0].criteria41Ql[0].input412t1);

            setValue4131t1(data[0].criteria41Qn[0].input4131t1);
            setValue4131t2(data[0].criteria41Qn[0].input4131t2);

            setValue4141t1(data[0].yearTable4141[0].input4141y);
            setValue4141t2(data[0].yearTable4141[1].input4141y);
            setValue4141t3(data[0].yearTable4141[2].input4141y);
            setValue4141t4(data[0].yearTable4141[3].input4141y);
            setValue4141t5(data[0].yearTable4141[4].input4141y);
            setValue4141t6(data[0].yearTable4141[0].input4141v);
            setValue4141t7(data[0].yearTable4141[1].input4141v);
            setValue4141t8(data[0].yearTable4141[2].input4141v);
            setValue4141t9(data[0].yearTable4141[3].input4141v);
            setValue4141t10(data[0].yearTable4141[4].input4141v);

            setValue4141t11(data[0].yearTable41412[0].input41412y);
            setValue4141t12(data[0].yearTable41412[1].input41412y);
            setValue4141t13(data[0].yearTable41412[2].input41412y);
            setValue4141t14(data[0].yearTable41412[3].input41412y);
            setValue4141t15(data[0].yearTable41412[4].input41412y);
            setValue4141t16(data[0].yearTable41412[0].input41412v);
            setValue4141t17(data[0].yearTable41412[1].input41412v);
            setValue4141t18(data[0].yearTable41412[2].input41412v);
            setValue4141t19(data[0].yearTable41412[3].input41412v);
            setValue4141t20(data[0].yearTable41412[4].input41412v);

            setValue411f1(data[0].criteria4FileUpload[0].criteria4FileName);
            setValue411f2(data[0].criteria4FileUpload[0].criteria4FileName);
            setValue412f1(data[0].criteria4FileUpload[0].criteria4FileName);
            setValue412f2(data[0].criteria4FileUpload[0].criteria4FileName);
            setValue412f3(data[0].criteria4FileUpload[0].criteria4FileName);
            setValue4131f1(data[0].criteria4FileUpload[0].criteria4FileName);
            setValue4131f2(data[0].criteria4FileUpload[0].criteria4FileName);
            setValue4131f3(data[0].criteria4FileUpload[0].criteria4FileName);
            setValue4141f1(data[0].criteria4FileUpload[0].criteria4FileName);
            setValue4141f2(data[0].criteria4FileUpload[0].criteria4FileName);
            setValue4141f3(data[0].criteria4FileUpload[0].criteria4FileName);
          })
          .catch((error) => {
    ...
    criteria41Qn: [
      {
        ...
        uniqueKey1: 1,
        input4131t1: value4131t1,
        input4131t2: value4131t2,
          ...
          <div className="c41x-container">
            ...
            <div className="c41x-response-container">
              <button
                onClick={(e) => {
                  e.preventDefault();
                  setResponseButtonStatus413(!responseButtonStatus413);
                  onClickingViewResponse413();
                }}
                className="c41x-responseButton-style"
              >
                View Response
              </button>
              {responseButtonStatus413 ? (
                <p className="c41x-responseResult-style">{responseValue413}</p>
              ) : null}
            </div>
          </div>
          <div className="c41xx-container">
            <div className="c41xx-label-textInput-container">
              <h1 className="c41xx-Heading-style">
                <span className="c41xx-span-style">
                  4.1.3.1: Number of classrooms and seminar halls with ICT
                  facilities
                  <input
                    readonly
                    onChange={(e) => setValue4131t1(e.target.value)}
                    id="4131-t1"
                    style={{ width: "25%", marginLeft: "1.5%" }}
                    type="number"
                  />
                </span>
                <br /> <br />
                <span className="c41xx-span-style">
                  4.1.3.2: Number of classrooms and seminar halls in the
                  Institution
                  <input
                    readonly
                    onChange={(e) => setValue4131t2(e.target.value)}
                    id="4131-t2"
            ...
            <table className="c41x-table-style">
              ...
              <tr>
                ...
                <td>
                  {" "}
                  <a href="http://localhost:8080/api/v1/download/criteria4.3.1.xlsx">
                    View Template
                  </a>
                </td>
                <td>
                  ...
                  <a href={downloadFile(value4131f1)} target="_blank">
                    View File
                  </a>
                  <div className="c11-fileButtons-container">
                  <button className="c11-viewFileButton-style">
          ...
          <div className="c41x-container">
            <div className="c41x-heading_Help-container">
              ...
              <HelpButton
                ...
                title='formula'
                ><h1>(Total expenditure for infrastructure development andaugmentation excluding salary during the last five years)/(Total expenditure excluding salary during the last five years) * 100</h1></HelpButton>
            </div>
            <div className="c41x-response-container">
              <button
                onClick={(e) => {
          ...
          <div className="c41xx-container">
            ...
            <table className="c41x-table-style">
              ...
              <tr>
                ...
                <td>
                <a href={downloadFile("au4.1.2..xlsx")} target="_blank">
                    View Template
                  </a>
                </td>
                <td>
