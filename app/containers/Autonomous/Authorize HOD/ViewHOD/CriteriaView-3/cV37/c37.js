...
function Criteria37() {
 ...
 //help buttom
  ...
  const [gradeScale371, setGradeScale371] = useState("");
  const [gradePoints371, setGradePoints371] = useState();
  const [gradeScaleClickStatus371, setGradeScaleClickStatus371] =
    useState(false);
  const [gradePointsClickStatus371, setGradePointsClickStatus371] =
    useState(false);

  const [gradeScale372, setGradeScale372] = useState("");
  const [gradePoints372, setGradePoints372] = useState();
  const [gradeScaleClickStatus372, setGradeScaleClickStatus372] =
    useState(false);
  const [gradePointsClickStatus372, setGradePointsClickStatus372] =
    useState(false);
      ...
      fetch(
        ...
        response
          ...
          .then((data) => {
            ...
            setValue3711t1(data[0].yearTable3711[0].input3711y);
            setValue3711t2(data[0].yearTable3711[1].input3711y);
            setValue3711t3(data[0].yearTable3711[2].input3711y);
            setValue3711t4(data[0].yearTable3711[3].input3711y);
            setValue3711t5(data[0].yearTable3711[4].input3711y);
            setValue3711t6(data[0].yearTable3711[0].input3711v);
            setValue3711t7(data[0].yearTable3711[1].input3711v);
            setValue3711t8(data[0].yearTable3711[2].input3711v);
            setValue3711t9(data[0].yearTable3711[3].input3711v);
            setValue3711t10(data[0].yearTable3711[4].input3711v);

            setValue3721t1(data[0].yearTable3721[0].input3721y);
            setValue3721t2(data[0].yearTable3721[1].input3721y);
            setValue3721t3(data[0].yearTable3721[2].input3721y);
            setValue3721t4(data[0].yearTable3721[3].input3721y);
            setValue3721t5(data[0].yearTable3721[4].input3721y);
            setValue3721t6(data[0].yearTable3721[0].input3721v);
            setValue3721t7(data[0].yearTable3721[1].input3721v);
            setValue3721t8(data[0].yearTable3721[2].input3721v);
            setValue3721t9(data[0].yearTable3721[3].input3721v);
            setValue3721t10(data[0].yearTable3721[4].input3721v);

            // setValue3711f1(data[0].criteria3FileUpload[0].criteria3FileName);
            // setValue3711f2(data[0].criteria3FileUpload[0].criteria3FileName);
            // setValue3711f3(data[0].criteria3FileUpload[0].criteria3FileName);
            // setValue3721f1(data[0].criteria3FileUpload[0].criteria3FileName);
            // setValue3721f2(data[0].criteria3FileUpload[0].criteria3FileName);
            // setValue3721f3(data[0].criteria3FileUpload[0].criteria3FileName);
          })
          .catch((error) => {
                  ...
                  {pathValue3711f2 === "" ? null : (
                    <div className="c37-fileButtons-container">
                      ...
                      <button
                        ...
                        onClick={(e) => {
                          setPathValue3711f2("");
                          document.getElementById("37211-f2").value = "";
                        }}
                      >
                        Reset
                      </button>
