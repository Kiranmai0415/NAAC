...
useEffect(
  () => fetch("http://localhost:8080/api/v1/criteria3getallfiles").then(
    (response) => response
      .json()
      .then((data) => {
        setValue331t1(data[0].criteria3FieldInfoQl[2].input331t1);

        // setResponseValue111(data[0].criteria1FieldInfoQl[1].response111);
        // setResponseValue112(data[0].criteria1FieldInfoQn[2].response112);
        // setResponseValue113(data[0].criteria1FieldInfoQn[3].response113);

        setValue3321t1(data[0].yearTable3321[0].input3321y);
        setValue3321t2(data[0].yearTable3321[0].input3321y);
        setValue3321t3(data[0].yearTable3321[2].input3321y);
        setValue3321t4(data[0].yearTable3321[3].input3321y);
        setValue3321t5(data[0].yearTable3321[4].input3321y);
        setValue3321t6(data[0].yearTable3321[0].input3321v);
        setValue3321t7(data[0].yearTable3321[1].input3321v);
        setValue3321t8(data[0].yearTable3321[2].input3321v);
        setValue3321t9(data[0].yearTable3321[3].input3321v);
        setValue3321t10(data[0].yearTable3321[4].input3321v);

        setValue331f1(data[0].criteria3FileUpload[0].criteria3FileName);
        setValue331f2(data[0].criteria3FileUpload[1].criteria3FileName);
        setValue3321f1(data[0].criteria3FileUpload[2].criteria3FileName);
        setValue3321f2(data[0].criteria3FileUpload[3].criteria3FileName);
        setValue3321f3(data[0].criteria3FileUpload[4].criteria3FileName);
      })
      .catch((error) => {
        console.error("Error:", error);
      })
