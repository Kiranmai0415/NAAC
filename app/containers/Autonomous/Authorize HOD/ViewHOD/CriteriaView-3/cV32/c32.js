...
function Criteria32() {
 ...
 //help buttom
  ...
  const [gradeScaleClickStatus321, setGradeScaleClickStatus321] =
    useState(false);
  const [gradePointsClickStatus321, setGradePointsClickStatus321] =
    useState(false);

  const [gradeScale322, setGradeScale322] = useState("");
  const [gradePoints322, setGradePoints322] = useState();
  const [gradeScaleClickStatus322, setGradeScaleClickStatus322] =
    useState(false);
  const [gradePointsClickStatus322, setGradePointsClickStatus322] =
    useState(false);

  const [gradeScale323, setGradeScale323] = useState("");
  const [gradePoints323, setGradePoints323] = useState();
  const [gradeScaleClickStatus323, setGradeScaleClickStatus323] =
    useState(false);
  const [gradePointsClickStatus323, setGradePointsClickStatus323] =
    useState(false);

  const [gradeScale324, setGradeScale324] = useState("");
  const [gradePoints324, setGradePoints324] = useState();
  const [gradeScaleClickStatus324, setGradeScaleClickStatus324] =
    useState(false);
  const [gradePointsClickStatus324, setGradePointsClickStatus324] =
    useState(false);
  ...
  useEffect(
    () =>
      fetch(
        'http://localhost:8080/api/v1/criteria3getallfiles?collegeId='+collegeId+'&financialYear=' +
          fYear +
  ...
  const inputDataList = {
    ...
    yearTable3241: [
      ...
      typeofInstitution:instituteType,
        ...
        uniqueKey1: 1,
        input3241y: value3241t1,
        input3241v: value3241t6,
      },
      {
        criteriaId: {
          collegeId: collegeId,
      ...
      typeofInstitution:instituteType,
        ...
        uniqueKey1: 2,
        input3241y: value3241t2,
        input3241v: value3241t7,
      },
      {
        criteriaId: {
          collegeId: collegeId,
        ...
        uniqueKey1: 3,
        input3241y: value3241t3,
        input3241v: value3241t8,
      },
      {
        criteriaId: {
          collegeId: collegeId,
        ...
        uniqueKey1: 4,
        input3241y: value3241t4,
        input3241v: value3241t9,
      },
      {
        criteriaId: {
          collegeId: collegeId,
        ...
        uniqueKey1: 5,
        input3241y: value3241t5,
        input3241v: value3241t10,
      },
    ],
    yearTable32412: [
      {
        ...
        uniqueKey1: 1,
        input32412y: value3241t11,
        input32412v: value3241t16,
      },
      {
        criteriaId: {
          collegeId: collegeId,
      ...
      typeofInstitution:instituteType,
        ...
        uniqueKey1: 2,
        input32412y: value3241t12,
        input32412v: value3241t17,
      },
      {
        criteriaId: {
          collegeId: collegeId,
      ...
      typeofInstitution:instituteType,
        ...
        uniqueKey1: 3,
        input32412y: value3241t13,
        input32412v: value3241t18,
      },
      {
        criteriaId: {
          collegeId: collegeId,
        ...
        uniqueKey1: 4,
        input32412y: value3241t14,
        input32412v: value3241t19,
      },
      {
        criteriaId: {
          collegeId: collegeId,
        ...
        uniqueKey1: 5,
        input32412y: value3241t15,
        input32412v: value3241t20,
      },
    ],
  };
            ...
            <table className="c32x-Qt-table-style">
              ...
              <tr>
                ...
                <td className="c32x-Qt-tableBorders-style">
                  ...
                  <a href={downloadFile(value3211f1)} target="_blank">
                    View File
                  </a>
              ...
              <tr>
                ...
                <td>
                <a href={downloadFile("au3.2.1.xlsx")} target="_blank">
                    View Template
                  </a>
                </td>
                <td className="c32x-Qt-tableBorders-style">
                  ...
                  <a href={downloadFile(value3211f2)} target="_blank">
                    View File
                  </a>
                  {/* <div className="c11-fileButtons-container">
                  <button className="c11-viewFileButton-style">
            ...
            <table className="c32x-table-style">
              ...
              <tr>
                ...
                <td>
                  ...
                  <a href={downloadFile(value3221f1)} target="_blank">
                    View File
                  </a>
                  {/* <div className="c11-fileButtons-container">
                  <button className="c11-viewFileButton-style">
              ...
              <tr>
                ...
                <td>
                <a href={downloadFile("au3.2.2.xlsx")} target="_blank">
                    View Template
                  </a>
                </td>
                <td>
                  ...
                  <a href={downloadFile(value3221f2)} target="_blank">
                    View File
                  </a>
                  {/* <div className="c11-fileButtons-container">
                  <button className="c11-viewFileButton-style">
          ...
          <div className="c32x-container">
            <div className="c32x-heading_Help-container">
              ...
              <HelpButton
                ...
                title='formula'
                ><h1>(Number of teachers recognised as research guidesas in the latest completed academic year)/(Number of full time teachers during the latest completed academic year) * 100</h1></HelpButton>
            </div>
            <div className="c32x-response-container">
              <button
                onClick={(e) => {
...
latest completed academic year:
            ...
            <table className="c32x-table-style">
              ...
              <tr>
                ...
                <td>
                <a href={downloadFile("au3.2.3.xlsx")} target="_blank">
                    View Template
                  </a>
                </td>
                <td>
                  ...
                  <a href={downloadFile(value3231f1)} target="_blank">
                    View File
                  </a>
                  {/* <div className="c11-fileButtons-container">
                  <button className="c11-viewFileButton-style">
              ...
              <tr>
                ...
                <td>
                  ...
                  <a href={downloadFile(value3231f2)} target="_blank">
                    View File
                  </a>
                  {/* <div className="c11-fileButtons-container">
                  <button className="c11-viewFileButton-style">
              ...
              <tr>
                ...
                <td>
                  ...
                  <a href={downloadFile(value3231f3)} target="_blank">
                    View File
                  </a>
                </td>
                <td className="c32x-Qt-tableBorders-style">pdf</td>
            ...
            <table className="c32x-table-style">
              ...
              <tr>
                ...
                <td>
                  ...
                  <a href={downloadFile(value3241f1)} target="_blank">
                    View File
                  </a>
                  <div className="c11-fileButtons-container">
                  <button className="c11-viewFileButton-style">
              ...
              <tr>
                ...
                <td>
                  ...
                  <a href={downloadFile(value3241f2)} target="_blank">
                    View File
                  </a>
                  <div className="c11-fileButtons-container">
                  <button className="c11-viewFileButton-style">
              ...
              <tr>
                ...
                <td>
                  ...
                  <a href={downloadFile(value3241f3)} target="_blank">
                    View File
                  </a>
                  <div className="c11-fileButtons-container">
                  <button className="c11-viewFileButton-style">
              ...
              <tr>
                ...
                <td>
                  ...
                  <a href={downloadFile(value3241f4)} target="_blank">
                    View File
                  </a>
                  <div className="c11-fileButtons-container">
                  <button className="c11-viewFileButton-style">
