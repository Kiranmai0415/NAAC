...
function Criteria31() {
 ...
 //help buttom
  ...
  const [gradePointsClickStatus311, setGradePointsClickStatus311] =
    useState(false);

  const [gradeScale312, setGradeScale312] = useState("");
  const [gradePoints312, setGradePoints312] = useState();
  const [gradeScaleClickStatus312, setGradeScaleClickStatus312] =
    useState(false);
  const [gradePointsClickStatus312, setGradePointsClickStatus312] =
    useState(false);

  const [gradeScale313, setGradeScale313] = useState("");
  const [gradePoints313, setGradePoints313] = useState();
  const [gradeScaleClickStatus313, setGradeScaleClickStatus313] =
    useState(false);
  const [gradePointsClickStatus313, setGradePointsClickStatus313] =
    useState(false);

  const [KIweightedGrade31ClickStatus, setKIweightedGrade31ClickStatus] =
    useState("");
      ...
      fetch(
        ...
        response
          ...
          .then((data) => {
            ...
            setValue311t1(data[0].criteria31Ql[0].input311t1);
            setValue3131t11(data[0].criteria31Qn[0].input3131t11);
            ...
            setValue3131t1(data[0].yearTable3131[0].input3131y);
            setValue3131t2(data[0].yearTable3131[1].input3131y);
            setValue3131t3(data[0].yearTable3131[2].input3131y);
            setValue3131t4(data[0].yearTable3131[3].input3131y);
            setValue3131t5(data[0].yearTable3131[4].input3131y);
            setValue3131t6(data[0].yearTable3131[0].input3131v);
            setValue3131t7(data[0].yearTable3131[1].input3131v);
            setValue3131t8(data[0].yearTable3131[2].input3131v);
            setValue3131t9(data[0].yearTable3131[3].input3131v);
            setValue3131t10(data[0].yearTable3131[4].input3131v);
            setValue3121t1(data[0].yearTable3121[0].input3121y);
            setValue3121t2(data[0].yearTable3121[1].input3121y);
            setValue3121t3(data[0].yearTable3121[2].input3121y);
            setValue3121t4(data[0].yearTable3121[3].input3121y);
            setValue3121t5(data[0].yearTable3121[4].input3121y);
            setValue3121t6(data[0].yearTable3121[0].input3121v);
            setValue3121t7(data[0].yearTable3121[1].input3121v);
            setValue3121t8(data[0].yearTable3121[2].input3121v);
            setValue3121t9(data[0].yearTable3121[3].input3121v);
            setValue3121t10(data[0].yearTable3121[4].input3121v);
            setValue311f1(data[0].criteria3FileUpload[0].criteria3FileName);
            setValue311f2(data[0].criteria3FileUpload[1].criteria3FileName);
            setValue311f3(data[0].criteria3FileUpload[2].criteria3FileName);
            ...
            setValue3121f3(data[0].criteria3FileUpload[5].criteria3FileName);
            setValue3121f4(data[0].criteria3FileUpload[6].criteria3FileName);
            setValue3131f1(data[0].criteria3FileUpload[7].criteria3FileName);
            setValue3131f2(data[0].criteria3FileUpload[8].criteria3FileName);
            setValue3131f3(data[0].criteria3FileUpload[9].criteria3FileName);
          })
          .catch((error) => {
          ...
          <table className="c31x-Ql-table-style">
            ...
            <tr>
              ...
              <td className="c31x-Ql-tableBorders-style">
                ...
                <a href={downloadFile(value311f2)} target="_blank">
                  View File
                </a>
                {/* <div className="c11-fileButtons-container">
                  <button className="c11-viewFileButton-style">
            ...
            <tr>
              ...
              <td className="c31x-Ql-tableBorders-style">
                ...
                <a href={downloadFile(value311f3)} target="_blank">
                  View File
                </a>
                {/* <div className="c11-fileButtons-container">
                  <button className="c11-viewFileButton-style">
          ...
          <div className="c31xx-container">
            ...
            <table className="c31x-table-style">
              ...
              <tr>
                ...
                <td>
                <a href={downloadFile("au3.1.2.xlsx")} target="_blank">
                    View Template
                  </a>
                </td>
                <td>
