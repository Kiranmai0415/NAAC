...
function Criteria36() {
 ...
 //help buttom
  ...
  useEffect(
    () =>
      fetch(
        "http://localhost:8080/api/v1/criteria3getallfiles?collegeId=1&financialYear=" +
          financialYear +
        ...
        response
          ...
          .then((data) => {
            ...
            // setResponseValue111(data[0].criteria36Ql[1].response111);
            // setResponseValue112(data[0].criteria36Qn[2].response112);
            // setResponseValue113(data[0].criteria36Qn[3].response113);
            setValue361t1(data[0].criteria36Ql[0].input361t2);

            setValue3621t1(data[0].yearTable3621[0].input3621y);
            setValue3621t2(data[0].yearTable3621[1].input3621y);
            setValue3621t3(data[0].yearTable3621[2].input3621y);
            setValue3621t4(data[0].yearTable3621[3].input3621y);
            setValue3621t5(data[0].yearTable3621[4].input3621y);
            setValue3621t6(data[0].yearTable3621[0].input3621v);
            setValue3621t7(data[0].yearTable3621[1].input3621v);
            setValue3621t8(data[0].yearTable3621[2].input3621v);
            setValue3621t9(data[0].yearTable3621[3].input3621v);
            setValue3621t10(data[0].yearTable3621[4].input3621v);

            setValue3631t1(data[0].yearTable3631[0].input3631y);
            setValue3631t2(data[0].yearTable3631[1].input3631y);
            setValue3631t3(data[0].yearTable3631[2].input3631y);
            setValue3631t4(data[0].yearTable3631[3].input3631y);
            setValue3631t5(data[0].yearTable3631[4].input3631y);
            setValue3631t6(data[0].yearTable3631[0].input3631v);
            setValue3631t7(data[0].yearTable3631[1].input3631v);
            setValue3631t8(data[0].yearTable3631[2].input3631v);
            setValue3631t9(data[0].yearTable3631[3].input3631v);
            setValue3631t10(data[0].yearTable3631[4].input3631v);

            setValue3641t1(data[0].yearTable3641[0].input3641y);
            setValue3641t2(data[0].yearTable3641[1].input3641y);
            setValue3641t3(data[0].yearTable3641[2].input3641y);
            setValue3641t4(data[0].yearTable3641[3].input3641y);
            setValue3641t5(data[0].yearTable3641[4].input3641y);
            setValue3641t6(data[0].yearTable3641[0].input3641v);
            setValue3641t7(data[0].yearTable3641[1].input3641v);
            setValue3641t8(data[0].yearTable3641[2].input3641v);
            setValue3641t9(data[0].yearTable3641[3].input3641v);
            setValue3641t10(data[0].yearTable3641[4].input3641v);

            setValue3641t11(data[0].yearTable36412[0].input36412y);
            setValue3641t12(data[0].yearTable36412[1].input36412y);
            setValue3641t13(data[0].yearTable36412[2].input36412y);
            setValue3641t14(data[0].yearTable36412[3].input36412y);
            setValue3641t15(data[0].yearTable36412[4].input36412y);
            setValue3641t16(data[0].yearTable36412[0].input36412v);
            setValue3641t17(data[0].yearTable36412[1].input36412v);
            setValue3641t18(data[0].yearTable36412[2].input36412v);
            setValue3641t19(data[0].yearTable36412[3].input36412v);
            setValue3641t20(data[0].yearTable36412[4].input36412v);

            // setValue361f1(data[0].criteria3FileUpload[0].criteria3FileName);
            // setValue361f2(data[0].criteria3FileUpload[0].criteria3FileName);
            // setValue3621f1(data[0].criteria3FileUpload[0].criteria3FileName);
            // setValue3621f2(data[0].criteria3FileUpload[0].criteria3FileName);
            // setValue3621f3(data[0].criteria3FileUpload[0].criteria3FileName);
            // setValue3631f1(data[0].criteria3FileUpload[0].criteria3FileName);
            // setValue3631f2(data[0].criteria3FileUpload[0].criteria3FileName);
            // setValue3631f3(data[0].criteria3FileUpload[0].criteria3FileName);
            // setValue3641f1(data[0].criteria3FileUpload[0].criteria3FileName);
            // setValue3641f2(data[0].criteria3FileUpload[0].criteria3FileName);
            // setValue3641f3(data[0].criteria3FileUpload[0].criteria3FileName);
          })
          .catch((error) => {
  ...
  function onClickingViewResponse363() {
    if (
      ...
      setResponseValue363("Input should be an Integer");
    } else if (
      value3631t6 !== "" &&
      value3631t7 !== "" &&
      value3631t8 !== "" &&
  ...
  return (
    <div className="c36-inputFields-mainContainer">
          ...
          <table className="c36x-Ql-table-style">
            ...
            <tr>
              ...
              <td className="c36x-Ql-tableBorders-style">
                ...
                <a href={downloadFile(value361f1)} target="_blank">
                  View File
                </a>
            ...
            <tr>
              ...
              <td>
                ...
                <a href={downloadFile(value361f2)} target="_blank">
                  View File
                </a>
                {/* <div className="c11-fileButtons-container">
                  <button className="c11-viewFileButton-style">
            ...
            <table className="c36x-table-style">
              ...
              <tr>
                ...
                <td>
                  ...
                  <a href={downloadFile(value3621f1)} target="_blank">
                    View File
                  </a>
                  <div className="c11-fileButtons-container">
                  <button className="c11-viewFileButton-style">
              ...
              <tr>
                ...
                <td>
                  <a href="http://localhost:8080/api/v1/download/criteria3.6.2.xlsx">
                    View Template
                  </a>
                </td>
                <td>
                  ...
                  <a href={downloadFile(value3621f2)} target="_blank">
                    View File
                  </a>
                  <div className="c11-fileButtons-container">
                  <button className="c11-viewFileButton-style">
              ...
              <tr>
                ...
                <td>
                  ...
                  <a href={downloadFile(value3621f3)} target="_blank">
                    View File
                  </a>
                  <div className="c11-fileButtons-container">
                  <button className="c11-viewFileButton-style">
      ...
      <div className="c36x-eachInputField-container">
        <div className="c36x-weightage-container">
          <h1 className="c36x-weightage-heading-style">Weightage: 20</h1>
        </div>
        <form>
          <div className="c36x-container">
            <div className="c36x-heading_Help-container">
            ...
            <table className="c36x-table-style">
              ...
              <tr>
                ...
                <td>
                  ...
                  <a href={downloadFile(value3631f1)} target="_blank">
                    View File
                  </a>
                  {/* <div className="c11-fileButtons-container">
                  <button className="c11-viewFileButton-style">
              ...
              <tr>
                ...
                <td>
                  ...
                  <a href={downloadFile(value3631f2)} target="_blank">
                    View File
                  </a>
                  {/* <div className="c11-fileButtons-container">
                  <button className="c11-viewFileButton-style">
              ...
              <tr>
                ...
                <td>
                <a href={downloadFile("au3.6.2.xlsx")} target="_blank">
                    View Template
                  </a>
                </td>
                <td>
                  ...
                  <a href={downloadFile(value3631f3)} target="_blank">
                    View File
                  </a>
                  {/* <div className="c11-fileButtons-container">
                  <button className="c11-viewFileButton-style">
            ...
            <table className="c36x-table-style">
              ...
              <tr>
                ...
                <td>
                  ...
                  <a href={downloadFile(value3641f1)} target="_blank">
                    View File
                  </a>
                  <div className="c11-fileButtons-container">
                  <button className="c11-viewFileButton-style">
              ...
              <tr>
                ...
                <td>
                  ...
                  <a href={downloadFile(value3641f2)} target="_blank">
                    View File
                  </a>
                  <div className="c11-fileButtons-container">
                  <button className="c11-viewFileButton-style">
              ...
              <tr>
                ...
                <td>
                  <a href="http://localhost:8080/api/v1/download/criteria3.6.4.xlsx">
                    View Template
                  </a>
                </td>
                <td>
                  ...
                  <a href={downloadFile(value3641f3)} target="_blank">
                    View File
                  </a>
                  <div className="c11-fileButtons-container">
                  <button className="c11-viewFileButton-style">
