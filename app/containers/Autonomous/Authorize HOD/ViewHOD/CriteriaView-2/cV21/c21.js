...
function Criteria21() {
  ...
  useEffect(
    () =>
      fetch(
        'http://localhost:8080/api/v1/criteria2getallfiles?collegeId='+collegeId+'&financialYear=' +
          fYear +
        ...
        response
          ...
          .then((data) => {
            ...
            // setValue2112t11(data[0].criteria21Qn[0].input2112t11);
 
            setResponseValue211(data[0].criteria21Qn[0] ? data[0].criteria21Qn[0].response211 : "");
            setResponseValue212(data[0].criteria21Qn[0] ? data[0].criteria21Qn[0].response212 : "");

            setValue2111t1(data[0].yearTable2111[0] ? data[0].yearTable2111[0].input2111y : "");
            setValue2111t6(data[0].yearTable2111[0] ? data[0].yearTable2111[0].input2111v : "");
        
            setValue2111t2(data[0].yearTable2111[1] ? data[0].yearTable2111[1].input2111y : "");
            setValue2111t7(data[0].yearTable2111[1] ? data[0].yearTable2111[1].input2111v : "");

            setValue2111t3(data[0].yearTable2111[2] ? data[0].yearTable2111[2].input2111y : "");
            setValue2111t8(data[0].yearTable2111[2] ? data[0].yearTable2111[2].input2111v : "");

            setValue2111t4(data[0].yearTable2111[3] ? data[0].yearTable2111[3].input2111y : "");
            setValue2111t9(data[0].yearTable2111[3] ? data[0].yearTable2111[3].input2111v : "");

            setValue2111t5(data[0].yearTable2111[4] ? data[0].yearTable2111[4].input2111y : "");
            setValue2111t10(data[0].yearTable2111[4] ? data[0].yearTable2111[4].input2111v : "");

            setValue2112t1(data[0].yearTable2112[0] ? data[0].yearTable2112[0].input2112y : "");
            setValue2112t6(data[0].yearTable2112[0] ? data[0].yearTable2112[0].input2112v : "");

            setValue2112t2(data[0].yearTable2112[1] ? data[0].yearTable2112[1].input2112y : "");
            setValue2112t7(data[0].yearTable2112[1] ? data[0].yearTable2112[1].input2112v : "");

            setValue2112t3(data[0].yearTable2112[2] ? data[0].yearTable2112[2].input2112y : "");
            setValue2112t8(data[0].yearTable2112[2] ? data[0].yearTable2112[2].input2112v : "");

            setValue2112t4(data[0].yearTable2112[3] ? data[0].yearTable2112[3].input2112y : "");
            setValue2112t9(data[0].yearTable2112[3] ? data[0].yearTable2112[3].input2112v : "");

            setValue2112t5(data[0].yearTable2112[4] ? data[0].yearTable2112[4].input2112y : "");
            setValue2112t10(data[0].yearTable2112[4] ? data[0].yearTable2112[4].input2112v : "");

            setValue2121t1(data[0].yearTable2121[0] ? data[0].yearTable2121[0].input2121y : "");
            setValue2121t6(data[0].yearTable2121[0] ? data[0].yearTable2121[0].input2121v : "");

            setValue2121t2(data[0].yearTable2121[1] ? data[0].yearTable2121[1].input2121y : "");
            setValue2121t7(data[0].yearTable2121[1] ? data[0].yearTable2121[1].input2121v : "");

            setValue2121t3(data[0].yearTable2121[2] ? data[0].yearTable2121[2].input2121y : "");
            setValue2121t8(data[0].yearTable2121[2] ? data[0].yearTable2121[2].input2121v : "");

            setValue2121t4(data[0].yearTable2121[3] ? data[0].yearTable2121[3].input2121y : "");
            setValue2121t9(data[0].yearTable2121[3] ? data[0].yearTable2121[3].input2121v : "");

            setValue2121t5(data[0].yearTable2121[4] ? data[0].yearTable2121[4].input2121y : "");
            setValue2121t10(data[0].yearTable2121[4] ? data[0].yearTable2121[4].input2121v : "");

            setValue2121t11(data[0].yearTable21212[0] ? data[0].yearTable21212[0].input21212y : "");
            setValue2121t16(data[0].yearTable21212[0] ? data[0].yearTable21212[0].input21212v : "");

            setValue2121t12(data[0].yearTable21212[1] ? data[0].yearTable21212[1].input21212y : "");
            setValue2121t17(data[0].yearTable21212[1] ? data[0].yearTable21212[1].input21212v : "");

            setValue2121t13(data[0].yearTable21212[2] ? data[0].yearTable21212[2].input21212y : "");
            setValue2121t18(data[0].yearTable21212[2] ? data[0].yearTable21212[2].input21212v : "");

            setValue2121t14(data[0].yearTable21212[3] ? data[0].yearTable21212[3].input21212y : "");
            setValue2121t19(data[0].yearTable21212[3] ? data[0].yearTable21212[3].input21212v : "");

            setValue2121t15(data[0].yearTable21212[4] ? data[0].yearTable21212[4].input21212y : "");
            setValue2121t20(data[0].yearTable21212[4] ? data[0].yearTable21212[4].input21212v : "");

            // setValue2112f1(data[0].criteria2FileUpload[0].criteria2FileName);
            // setValue2112f2(data[0].criteria2FileUpload[1].criteria2FileName);
            // setValue2121f1(data[0].criteria2FileUpload[2].criteria2FileName);
            // setValue2121f2(data[0].criteria2FileUpload[3].criteria2FileName);
          })
          .catch((error) => {
        ...
        (response) =>
          response
            ...
            .then((data) => {
              ...
              setValue2111t1(data[0].yearTable2111[0].input2111y);
              setValue2111t2(data[0].yearTable2111[1].input2111y);
              setValue2111t3(data[0].yearTable2111[2].input2111y);
              setValue2111t4(data[0].yearTable2111[3].input2111y);
              setValue2111t5(data[0].yearTable2111[4].input2111y);
              setValue2111t6(data[0].yearTable2111[0].input2111v);
              setValue2111t7(data[0].yearTable2111[1].input2111v);
              setValue2111t8(data[0].yearTable2111[2].input2111v);
              setValue2111t9(data[0].yearTable2111[3].input2111v);
              setValue2111t10(data[0].yearTable2111[4].input2111v);

              setValue2112t1(data[0].yearTable2112[0].input2112y);
              setValue2112t2(data[0].yearTable2112[1].input2112y);
              setValue2112t3(data[0].yearTable2112[2].input2112y);
              setValue2112t4(data[0].yearTable2112[3].input2112y);
              setValue2112t5(data[0].yearTable2112[4].input2112y);
              setValue2112t6(data[0].yearTable2112[0].input2112v);
              setValue2112t7(data[0].yearTable2112[1].input2112v);
              setValue2112t8(data[0].yearTable2112[2].input2112v);
              setValue2112t9(data[0].yearTable2112[3].input2112v);
              setValue2112t10(data[0].yearTable2112[4].input2112v);

              setValue2121t1(data[0].yearTable2121[0].input2121y);
              setValue2121t2(data[0].yearTable2121[1].input2121y);
              setValue2121t3(data[0].yearTable2121[2].input2121y);
              setValue2121t4(data[0].yearTable2121[3].input2121y);
              setValue2121t5(data[0].yearTable2121[4].input2121y);
              setValue2121t6(data[0].yearTable2121[0].input2121v);
              setValue2121t7(data[0].yearTable2121[1].input2121v);
              setValue2121t8(data[0].yearTable2121[2].input2121v);
              setValue2121t9(data[0].yearTable2121[3].input2121v);
              setValue2121t10(data[0].yearTable2121[4].input2121v);

              setValue2121t11(data[0].yearTable21212[0].input21212y);
              setValue2121t12(data[0].yearTable21212[1].input21212y);
              setValue2121t13(data[0].yearTable21212[2].input21212y);
              setValue2121t14(data[0].yearTable21212[3].input21212y);
              setValue2121t15(data[0].yearTable21212[4].input21212y);
              setValue2121t16(data[0].yearTable21212[0].input21212v);
              setValue2121t17(data[0].yearTable21212[1].input21212v);
              setValue2121t18(data[0].yearTable21212[2].input21212v);
              setValue2121t19(data[0].yearTable21212[3].input21212v);
              setValue2121t20(data[0].yearTable21212[4].input21212v);
...
(Only first year admissions to be considered)
            ...
            <table className="c21x-table-style">
              ...
              <tr>
                ...
                <td>
                  {" "}
                  <a href={downloadFile("au2.1.1.xlsx")} target="_blank">
                    View Template
                  </a>
                </td>
                <td>
...
GoI/State Govt. rule year wise during the last five years
            ...
            <table className="c21x-table-style">
              ...
              <tr>
                ...
                <td>
                  <a href={downloadFile("au2.1.2.xlsx")} target="_blank">
                    View Template
                  </a>
                </td>
                <td>
