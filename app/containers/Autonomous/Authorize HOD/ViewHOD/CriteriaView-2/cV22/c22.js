...
function Criteria22() {
 ...
 //help buttom
  ...
  useEffect(
    () =>
      fetch(
        "http://localhost:8080/api/v1/criteria2getallfiles?collegeId=1&financialYear=" +
          financialYear +
        ...
        response
          ...
          .then((data) => {
            ...
            setPathValue221f1(data[0].criteria2FileUpload[0] ? data[0].criteria2FileUpload[0].criteria2FileName : "");
            setPathValue221f2(data[0].criteria2FileUpload[1] ? data[0].criteria2FileUpload[1].criteria2FileName : "");
          })
          .catch((error) => {
    ...
    <div className="c22-inputFields-mainContainer">
      ...
      <div className="c22x-eachInputField-container">
        <div className="c22x-weightage-container">
          <h1 className="c22x-weightage-heading-style">Weightage: 10</h1>
        </div>
        <form>
