    ...
    yearTable24112: [
      {
        ...
        uniqueKey1: 1,
        input24112y: value241t11,
        input24112v: value241t16,
      },
      {
        criteriaId: {
          collegeId:collegeId,
        ...
        uniqueKey1: 2,
        input24112y: value241t12,
        input24112v: value241t17,
      },
      {
        criteriaId: {
          collegeId:collegeId,
      ...
      typeofInstitution:instituteType,
        ...
        uniqueKey1: 3,
        input24112y: value241t13,
        input24112v: value241t18,
      },
      {
        criteriaId: {
          collegeId:collegeId,
      ...
      typeofInstitution:instituteType,
        ...
        uniqueKey1: 4,
        input24112y: value241t14,
        input24112v: value241t19,
      },
      {
        criteriaId: {
          collegeId:collegeId,
        ...
        uniqueKey1: 5,
        input24112y: value241t15,
        input24112v: value241t20,
      },
    ],
    yearTable2421: [
      {
...
last five years
              ...
              <HelpButton
                ...
                title='percentage'
                ><h1>(Total number of full time teachers during the last five years)/(Total number of sanctioned posts during the last five years) * 100</h1></HelpButton>
            </div>
          ...
          <div className="c24xx-container">
            <h1 className="c24x-heading-style">
              ...
              Number of sanctioned posts year wise during the last five 
years
            </h1>
            ...
            <table className="c24x-table-style">
              ...
              <tr>
                ...
                <td>
                <a href={downloadFile("au2.4.1.xlsx")} target="_blank"> view Template</a>
                </td>
                <td>
                  <input
                    readonly
          ...
          <div className="c24x-container">
            <div className="c24x-heading_Help-container">
              <h1 className="c24x-heading-style">
                ...
                Percentage of full time teachers with Ph.D./D.Sc. / D.Litt./ L.L.D
          ...
          <div className="c24xx-container">
            ...
            <table className="c24x-table-style">
              ...
              <tr>
                ...
                <td>
                <a href={downloadFile("au2.4.2.xlsx")} target="_blank"> view Template</a>
                </td>
                <td>
                  <input
                    readonly
      ...
      <div className="c24x-eachInputField-container">
        ...
        <form>
          <div className="c24x-container">
            <div className="c24x-heading_Help-container">
              ...
              <HelpButton
                ...
                title='formula'
              ><h1>(Sum of total teaching experience of full time teachers)/( Number of full time teachers during the latest completed academic year)</h1></HelpButton>
            </div>
            <div className="c24x-response-container">
              <button
                onClick={(e) => {
          ...
          <div className="c24xx-container">
            ...
            <h1 className="c24xx-Heading-style">
              <span className="c24xx-span-style">
                A: Sum of total experience of full time teachers
                <input
                  readonly
            ...
            <h1 className="c24xx-Heading-style">
              <span className="c24xx-span-style">
                B: Number of full time teachers
                <input
                  readonly
        ...
        <form>
          <div className="c24x-container">
            <div className="c24x-heading_Help-container">
              ...
              ><h1>(Sum of experience of full time teachers in the same institution)/(Number of full time teachers in the latest completed academic year)</h1></HelpButton>
            </div>
            </div>
            <div className="c24xx-container">
            <h1 className="c24xx-Heading-style">
