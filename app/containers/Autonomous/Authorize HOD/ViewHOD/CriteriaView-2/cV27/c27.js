          ...
          <div className="c27x-container">
            <div className="c27x-heading_Help-container">
              <h1 className="c27x-heading-style">
                ...
                Online student satisfaction survey regarding the teaching
                learning process. (Online survey will be conducted)
              </h1>
              <button
          ...
          <div className="c27xx-container">
            <table className="c27x-table-style">
              ...
              <tr>
                ...
                <td>
                <a href={downloadFile("au2.7.1.xlsx")} target="_blank">
                    View Template
                  </a>
                </td>
                <td>
