...
function Criteria63() {
 ...
 //help buttom
  ...
  useEffect(
    () =>
      fetch(
        "http://localhost:8080/api/v1/criteria6getallfiles?collegeId=1&financialYear=" +
          financialYear +
        ...
        response
          ...
          .then((data) => {
            ...
            setValue631t1(data[0].criteria63Ql[0].input631t1);

            setValue6321t1(data[0].yearTable6321[0].input6321y);
            setValue6321t2(data[0].yearTable6321[1].input6321y);
            setValue6321t3(data[0].yearTable6321[2].input6321y);
            setValue6321t4(data[0].yearTable6321[3].input6321y);
            setValue6321t5(data[0].yearTable6321[4].input6321y);
            setValue6321t6(data[0].yearTable6321[0].input6321v);
            setValue6321t7(data[0].yearTable6321[1].input6321v);
            setValue6321t8(data[0].yearTable6321[2].input6321v);
            setValue6321t9(data[0].yearTable6321[3].input6321v);
            setValue6321t10(data[0].yearTable6321[4].input6321v);

            setValue6321t11(data[0].yearTable63212[0].input63212y);
            setValue6321t12(data[0].yearTable63212[1].input63212y);
            setValue6321t13(data[0].yearTable63212[2].input63212y);
            setValue6321t14(data[0].yearTable63212[3].input63212y);
            setValue6321t15(data[0].yearTable63212[4].input63212y);
            setValue6321t16(data[0].yearTable63212[0].input63212v);
            setValue6321t17(data[0].yearTable63212[1].input63212v);
            setValue6321t18(data[0].yearTable63212[2].input63212v);
            setValue6321t19(data[0].yearTable63212[3].input63212v);
            setValue6321t20(data[0].yearTable63212[4].input63212v);

            setValue6331t1(data[0].yearTable6331[0].input6331y);
            setValue6331t2(data[0].yearTable6331[1].input6331y);
            setValue6331t3(data[0].yearTable6331[2].input6331y);
            setValue6331t4(data[0].yearTable6331[3].input6331y);
            setValue6331t5(data[0].yearTable6331[4].input6331y);
            setValue6331t6(data[0].yearTable6331[0].input6331v);
            setValue6331t7(data[0].yearTable6331[1].input6331v);
            setValue6331t8(data[0].yearTable6331[2].input6331v);
            setValue6331t9(data[0].yearTable6331[3].input6331v);
            setValue6331t10(data[0].yearTable6331[4].input6331v);

            setValue6341t1(data[0].yearTable6341[0].input6341y);
            setValue6341t2(data[0].yearTable6341[1].input6341y);
            setValue6341t3(data[0].yearTable6341[2].input6341y);
            setValue6341t4(data[0].yearTable6341[3].input6341y);
            setValue6341t5(data[0].yearTable6341[4].input6341y);
            setValue6341t6(data[0].yearTable6341[0].input6341v);
            setValue6341t7(data[0].yearTable6341[1].input6341v);
            setValue6341t8(data[0].yearTable6341[2].input6341v);
            setValue6341t9(data[0].yearTable6341[3].input6341v);
            setValue6341t10(data[0].yearTable6341[4].input6341v);

            setValue6341t11(data[0].yearTable63412[0].input63412y);
            setValue6341t12(data[0].yearTable63412[1].input63412y);
            setValue6341t13(data[0].yearTable63412[2].input63412y);
            setValue6341t14(data[0].yearTable63412[3].input63412y);
            setValue6341t15(data[0].yearTable63412[4].input63412y);
            setValue6341t16(data[0].yearTable63412[0].input63412v);
            setValue6341t17(data[0].yearTable63412[1].input63412v);
            setValue6341t18(data[0].yearTable63412[2].input63412v);
            setValue6341t19(data[0].yearTable63412[3].input63412v);
            setValue6341t20(data[0].yearTable63412[4].input63412v);

            // setValue631f1(data[0].criteria6FileUpload[0].criteria6FileName);
            // setValue631f2(data[0].criteria6FileUpload[0].criteria6FileName);
            // setValue631f3(data[0].criteria6FileUpload[0].criteria6FileName);
            // setValue631f4(data[0].criteria6FileUpload[0].criteria6FileName);
            // setValue6321f1(data[0].criteria6FileUpload[0].criteria6FileName);
            // setValue6321f2(data[0].criteria6FileUpload[0].criteria6FileName);
            // setValue6331f1(data[0].criteria6FileUpload[0].criteria6FileName);
            // setValue6331f2(data[0].criteria6FileUpload[0].criteria6FileName);
            // setValue6331f3(data[0].criteria6FileUpload[0].criteria6FileName);
            // setValue6331f3(data[0].criteria6FileUpload[0].criteria6FileName);
            // setValue6341f4(data[0].criteria6FileUpload[0].criteria6FileName);
            // setValue6341f2(data[0].criteria6FileUpload[0].criteria6FileName);
            // setValue6341f3(data[0].criteria6FileUpload[0].criteria6FileName);
            // setValue6341f4(data[0].criteria6FileUpload[0].criteria6FileName);
          })
          .catch((error) => {
          ...
          <table className="c63x-Ql-table-style">
            ...
            <tr>
              ...
              <td className="c63x-Ql-tableBorders-style">
                ...
                <a href={downloadFile(value631f1)} target="_blank">
                  View File
                </a>
            ...
            <tr>
              ...
              <td className="c63x-Ql-tableBorders-style">
                ...
                <a href={downloadFile(value631f2)} target="_blank">
                  View File
                </a>
                {/* <div className="c11-fileButtons-container">
                  <button className="c11-viewFileButton-style">
            ...
            <tr>
              ...
              <td className="c63x-Ql-tableBorders-style">
                ...
                <a href={downloadFile(value631f3)} target="_blank">
                  View File
                </a>
                {/* <div className="c11-fileButtons-container">
                  <button className="c11-viewFileButton-style">
            ...
            <table className="c63x-table-style">
              ...
              <tr>
                ...
                <td>
                  ...
                  <a href={downloadFile(value6321f1)} target="_blank">
                    View File
                  </a>
                  {/* <div className="c11-fileButtons-container">
                  <button className="c11-viewFileButton-style">
              ...
              <tr>
                ...
                <td>
                  ...
                  <a href={downloadFile(value6321f2)} target="_blank">
                    View File
                  </a>
                  {/* <div className="c11-fileButtons-container">
                  <button className="c11-viewFileButton-style">
        ...
        <form>
          ...
          <div className="c63xx-container">
            <h1 className="c63xx-Heading-style">
              ...
              Total number of professional Development/adiministrative trainning
              Programmes organised by the institution for teaching and non
              teaching staff year-wise during the last five years
            </h1>
            ...
            <table className="c63x-table-style">
              ...
              <tr>
                ...
                <td>
                  ...
                  <a href={downloadFile(value6331f1)} target="_blank">
                    View File
                  </a>
                  {/* <div className="c11-fileButtons-container">
                  <button className="c11-viewFileButton-style">
              ...
              <tr>
                ...
                <td>
                  ...
                  <a href={downloadFile(value6331f2)} target="_blank">
                    View File
                  </a>
                  {/* <div className="c11-fileButtons-container">
                  <button className="c11-viewFileButton-style">
              ...
              <tr>
                ...
                <td>
                  ...
                  <a href={downloadFile(value6331f3)} target="_blank">
                    View File
                  </a>
                  {/* <div className="c11-fileButtons-container">
                  <button className="c11-viewFileButton-style">
              ...
              <tr>
                ...
                <td>
                <a href={downloadFile("6.3.3.xlsx")} target="_blank">
                    View Template
                  </a>
                </td>
                <td>
                  ...
                  <a href={downloadFile(value6331f4)} target="_blank">
                    View File
                  </a>
                  {/* <div className="c11-fileButtons-container">
                  <button className="c11-viewFileButton-style">
        ...
        <form>
          <div className="c63x-container">
            <div className="c63x-heading_Help-container">
              <h1 className="c63x-heading-style">
                ...
                Faculty Development programmes during last five
                years(Professional Development Programmes, Orientation/Induction
          ...
          <div className="c63xx-container">
            <h1 className="c63xx-Heading-style">
              ...
              Total number of teachers attending professional development
              programmes,viz.,Orientation Programme, Refresher Course,Short Term
              Course,Faculty Development Programmes year wise during last five
              years
            </h1>
            ...
            <table className="c63x-table-style">
              ...
              <tr>
                ...
                <td>
                  ...
                  <a href={downloadFile(value6341f1)} target="_blank">
                    View File
                  </a>
                  {/* <div className="c11-fileButtons-container">
                  <button className="c11-viewFileButton-style">
              ...
              <tr>
                ...
                <td>
                  ...
                  <a href={downloadFile(value6341f2)} target="_blank">
                    View File
                  </a>
                  {/* <div className="c11-fileButtons-container">
                  <button className="c11-viewFileButton-style">
              ...
              <tr>
                ...
                <td>
                  ...
                  <a href={downloadFile(value6341f3)} target="_blank">
                    View File
                  </a>
                  {/* <div className="c11-fileButtons-container">
                  <button className="c11-viewFileButton-style">
              ...
              <tr>
                ...
                <td>
                  {/* <a href="http://localhost:8080/api/v1/download/criteria6.3.4.xlsx">
                    View Template
                  </a> */}
                </td>
                <td>
                  ...
                  <a href={downloadFile(value6341f4)} target="_blank">
                    View File
                  </a>
                  {/* <div className="c11-fileButtons-container">
                  <button className="c11-viewFileButton-style">
