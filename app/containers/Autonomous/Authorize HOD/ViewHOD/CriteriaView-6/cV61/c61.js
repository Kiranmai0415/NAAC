      ...
      fetch(
        ...
        response
          ...
          .then((data) => {
            ...
            setValue611t1(data[0].criteria61Ql[0].input611t1);
            setValue612t1(data[0].criteria61Ql[0].input612t1);

            // setValue611f1(data[0].criteria6FileUpload[0].criteria6FileName);
            // setValue611f2(data[0].criteria6FileUpload[0].criteria6FileName);
            // setValue612f1(data[0].criteria6FileUpload[0].criteria6FileName);
            // setValue612f2(data[0].criteria6FileUpload[0].criteria6FileName);
            // setValue612f3(data[0].criteria6FileUpload[0].criteria6FileName);
          })
          .catch((error) => {
