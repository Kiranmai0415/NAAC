      ...
      fetch(
        ...
        response
          ...
          .then((data) => {
            ...
            setValue621t1(data[0].criteria62Ql[0].input621t1);
            setValue622t1(data[0].criteria62Ql[0].input622t1);

            setValue623t1(data[0].criteria62Qn[0].input623t1);

            setValue621f1(data[0].criteria1FileUpload[0].criteria6FileName);
            setValue621f2(data[0].criteria1FileUpload[0].criteria6FileName);
            setValue621f3(data[0].criteria1FileUpload[0].criteria6FileName);
            setValue622f1(data[0].criteria1FileUpload[0].criteria6FileName);
            setValue622f2(data[0].criteria1FileUpload[0].criteria6FileName);
            setValue622f3(data[0].criteria1FileUpload[0].criteria6FileName);
            setValue623f1(data[0].criteria1FileUpload[0].criteria6FileName);
            setValue623f2(data[0].criteria1FileUpload[0].criteria6FileName);
            setValue623f3(data[0].criteria1FileUpload[0].criteria6FileName);
          })
          .catch((error) => {
    ...
    <div className="c62-inputFields-mainContainer">
      ...
      <div className="c62x-eachInputField-container">
        <div className="c62x-weightage-container">
          <h1 className="c62x-weightage-heading-style">Weightage: 6</h1>
        </div>
        <form>
            ...
            <tr>
              ...
              <td>
                <input
                  readonly
                  onChange={(e) => {
                    setValue623f1(e.target.value);
                    setPathValue623f1(e.target.value);
                  }}
                  id="623-f1"
                  type="file"
                  className="c62-fileButton-style"
