...
function IIQAAuthorize() {
  ...
  useEffect(
    () => fetch(resources.APPLICATION_URL + 'getallqiafiles?collegeId='+collegeId+'&financialYear='
      + fYear
      + '&typeofInstitution='+instituteType).then(
      (response) => response
        .json()
        .then((data) => {
  ...
  function getAuthorizeIIQA() {
    ...
    fetch(
      resources.APPLICATION_URL + 'qiadatasubmit?collegeId='+collegeId+'&financialYear='
      + fYear
      + '&typeofInstitution='+instituteType,
      authAPIMethod
    ).then((response) => {
