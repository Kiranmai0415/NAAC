...
function BasicInfo() {
      ...
      fetch(
        ...
        response
          ...
          .then((data) => {
            ...
            setValuebt1(
              data[0].basicProfile[0] ? data[0].basicProfile[0].inputbt1 : ""
            );
            setValuebt2(
              data[0].basicProfile[0] ? data[0].basicProfile[0].inputbt2 : ""
            );
            setValuebt3(
              data[0].basicProfile[0] ? data[0].basicProfile[0].inputbt3 : ""
            );
            setValuebt4(
              data[0].basicProfile[0] ? data[0].basicProfile[0].inputbt4 : ""
            );
            setValuebt5(
              data[0].basicProfile[0] ? data[0].basicProfile[0].inputbt5 : ""
            );
            setValuebt6(
              data[0].basicProfile[0] ? data[0].basicProfile[0].inputbt6 : ""
            );

            setValuebtc1(
              data[0].contactsforCommunication[0]
                ? data[0].contactsforCommunication[0].inputbtc1
                : ""
            );
            setValuebtc2(
              data[0].contactsforCommunication[0]
                ? data[0].contactsforCommunication[0].inputbtc2
                : ""
            );
            setValuebtc3(
              data[0].contactsforCommunication[0]
                ? data[0].contactsforCommunication[0].inputbtc3
                : ""
            );
            setValuebtc4(
              data[0].contactsforCommunication[0]
                ? data[0].contactsforCommunication[0].inputbtc4
                : ""
            );
            setValuebtc5(
              data[0].contactsforCommunication[0]
                ? data[0].contactsforCommunication[0].inputbtc5
                : ""
            );
            setValuebtc6(
              data[0].contactsforCommunication[0]
                ? data[0].contactsforCommunication[0].inputbtc6
                : ""
            );

            setValuebti1(
              data[0].natureofInstitution[0]
                ? data[0].natureofInstitution[0].inputbti1
                : ""
            );
            setValuebti2(
              data[0].natureofInstitution[0]
                ? data[0].natureofInstitution[0].inputbti2
                : ""
            );
            setValuebti3(
              data[0].natureofInstitution[0]
                ? data[0].natureofInstitution[0].inputbti3
                : ""
            );
            setValuebti4(
              data[0].natureofInstitution[0]
                ? data[0].natureofInstitution[0].inputbti4
                : ""
            );
            setValuebti5(
              data[0].natureofInstitution[0]
                ? data[0].natureofInstitution[0].inputbti5
                : ""
            );
            setValuebti6(
              data[0].natureofInstitution[0]
                ? data[0].natureofInstitution[0].inputbti6
                : ""
            );

            setValuebti11(
              data[0].institutionCollegeAffiliated[0]
                ? data[0].institutionCollegeAffiliated[0].inputbti11
                : ""
            );
            setValuebti12(
              data[0].institutionCollegeAffiliated[0]
                ? data[0].institutionCollegeAffiliated[0].inputbti12
                : ""
            );

            setValuebtr1(
              data[0].recognizedMinority[0]
                ? data[0].recognizedMinority[0].inputbtr1
                : ""
            );
            setValuebtr2(
              data[0].recognizedMinority[0]
                ? data[0].recognizedMinority[0].inputbtr2
                : ""
            );
            setValuebtr3(
              data[0].recognizedMinority[0]
                ? data[0].recognizedMinority[0].inputbtr3
                : ""
            );
            setValuebtr4(
              data[0].recognizedMinority[0]
                ? data[0].recognizedMinority[0].inputbtr4
                : ""
            );
            setValuebtr5(
              data[0].recognizedMinority[0]
                ? data[0].recognizedMinority[0].inputbtr5
                : ""
            );

            setValuebtr6(
              data[0].recognizationDetails[0]
                ? data[0].recognizationDetails[0].inputbtr6
                : ""
            );
            setValuebtr7(
              data[0].recognizationDetails[0]
                ? data[0].recognizationDetails[0].inputbtr7
                : ""
            );

            setValuebtpp11(
              data[0].programmesOffered[0]
                ? data[0].programmesOffered[0].inputpot1
                : ""
            );
            setValuebtpp12(
              data[0].programmesOffered[0]
                ? data[0].programmesOffered[0].inputpot2
                : ""
            );
            setValuebtpp13(
              data[0].programmesOffered[0]
                ? data[0].programmesOffered[0].inputpot3
                : ""
            );

            setValuebtpp21(
              data[0].programmesOffered[1]
                ? data[0].programmesOffered[1].inputpot1
                : ""
            );
            setValuebtpp22(
              data[0].programmesOffered[1]
                ? data[0].programmesOffered[1].inputpot2
                : ""
            );
            setValuebtpp23(
              data[0].programmesOffered[1]
                ? data[0].programmesOffered[1].inputpot3
                : ""
            );

            setValuebtpp31(
              data[0].programmesOffered[2]
                ? data[0].programmesOffered[2].inputpot1
                : ""
            );
            setValuebtpp32(
              data[0].programmesOffered[2]
                ? data[0].programmesOffered[2].inputpot2
                : ""
            );
            setValuebtpp33(
              data[0].programmesOffered[2]
                ? data[0].programmesOffered[2].inputpot3
                : ""
            );
            ...
            setValuebtpp51(
              data[0].proffessionalprogrammes[0]
                ? data[0].proffessionalprogrammes[0].inputpopt1
                : ""
            );
            setValuebtpp52(
              data[0].proffessionalprogrammes[0]
                ? data[0].proffessionalprogrammes[0].inputpopt2
                : ""
            );
            setValuebtpp53(
              data[0].proffessionalprogrammes[0]
                ? data[0].proffessionalprogrammes[0].inputpopt3
                : ""
            );

            setValuebtpp61(
              data[0].proffessionalprogrammes[1]
                ? data[0].proffessionalprogrammes[1].inputpopt1
                : ""
            );
            setValuebtpp62(
              data[0].proffessionalprogrammes[1]
                ? data[0].proffessionalprogrammes[1].inputpopt2
                : ""
            );
            setValuebtpp63(
              data[0].proffessionalprogrammes[1]
                ? data[0].proffessionalprogrammes[1].inputpopt3
                : ""
            );

            setValuebtpp71(
              data[0].proffessionalprogrammes[2]
                ? data[0].proffessionalprogrammes[2].inputpopt1
                : ""
            );
            setValuebtpp72(
              data[0].proffessionalprogrammes[2]
                ? data[0].proffessionalprogrammes[2].inputpopt2
                : ""
            );
            setValuebtpp73(
              data[0].proffessionalprogrammes[2]
                ? data[0].proffessionalprogrammes[2].inputpopt3
                : ""
            );

            setValuebtp11(
              data[0].programmeIntroduced[0]
                ? data[0].programmeIntroduced[0].inputbtp11
                : ""
            );
            setValuebtp12(
              data[0].programmeIntroduced[0]
                ? data[0].programmeIntroduced[0].inputbtp12
                : ""
            );
            setValuebtp13(
              data[0].programmeIntroduced[0]
                ? data[0].programmeIntroduced[0].inputbtp13
                : ""
            );
            setValuebtp14(
              data[0].programmeIntroduced[0]
                ? data[0].programmeIntroduced[0].inputbtp14
                : ""
            );
            setValuebtp15(
              data[0].programmeIntroduced[0]
                ? data[0].programmeIntroduced[0].inputbtp15
                : ""
            );

            setValuebtp21(
              data[0].programmeIntroduced[1]
                ? data[0].programmeIntroduced[1].inputbtp11
                : ""
            );
            setValuebtp22(
              data[0].programmeIntroduced[1]
                ? data[0].programmeIntroduced[1].inputbtp12
                : ""
            );
            setValuebtp23(
              data[0].programmeIntroduced[1]
                ? data[0].programmeIntroduced[1].inputbtp13
                : ""
            );
            setValuebtp24(
              data[0].programmeIntroduced[1]
                ? data[0].programmeIntroduced[1].inputbtp14
                : ""
            );
            setValuebtp25(
              data[0].programmeIntroduced[1]
                ? data[0].programmeIntroduced[1].inputbtp15
                : ""
            );

            setValuebtp31(
              data[0].programmeIntroduced[2]
                ? data[0].programmeIntroduced[2].inputbtp11
                : ""
            );
            setValuebtp32(
              data[0].programmeIntroduced[2]
                ? data[0].programmeIntroduced[2].inputbtp12
                : ""
            );
            setValuebtp33(
              data[0].programmeIntroduced[2]
                ? data[0].programmeIntroduced[2].inputbtp13
                : ""
            );
            setValuebtp34(
              data[0].programmeIntroduced[2]
                ? data[0].programmeIntroduced[2].inputbtp14
                : ""
            );
            setValuebtp35(
              data[0].programmeIntroduced[2]
                ? data[0].programmeIntroduced[2].inputbtp15
                : ""
            );

            setValuebtp41(
              data[0].programmeIntroduced[3]
                ? data[0].programmeIntroduced[3].inputbtp11
                : ""
            );
            setValuebtp42(
              data[0].programmeIntroduced[3]
                ? data[0].programmeIntroduced[3].inputbtp12
                : ""
            );
            setValuebtp43(
              data[0].programmeIntroduced[3]
                ? data[0].programmeIntroduced[3].inputbtp13
                : ""
            );
            setValuebtp44(
              data[0].programmeIntroduced[3]
                ? data[0].programmeIntroduced[3].inputbtp14
                : ""
            );
            setValuebtp45(
              data[0].programmeIntroduced[3]
                ? data[0].programmeIntroduced[3].inputbtp15
                : ""
            );

            setValuebtp51(
              data[0].programmeIntroduced[4]
                ? data[0].programmeIntroduced[4].inputbtp11
                : ""
            );
            setValuebtp52(
              data[0].programmeIntroduced[4]
                ? data[0].programmeIntroduced[4].inputbtp12
                : ""
            );
            setValuebtp53(
              data[0].programmeIntroduced[4]
                ? data[0].programmeIntroduced[4].inputbtp13
                : ""
            );
            setValuebtp54(
              data[0].programmeIntroduced[4]
                ? data[0].programmeIntroduced[4].inputbtp14
                : ""
            );
            setValuebtp55(
              data[0].programmeIntroduced[4]
                ? data[0].programmeIntroduced[4].inputbtp15
                : ""
            );
            ...
            //
            setValuebtd1(
              data[0].recognition[0] ? data[0].recognition[0].inputbtd11 : ""
            );
            setValuebtd11(
              data[0].recognition[0] ? data[0].recognition[0].inputbtd12 : ""
            );
            setValuebtd12(
              data[0].recognition[0] ? data[0].recognition[0].inputbtd13 : ""
            );
            setValuebtd13(
              data[0].recognition[0] ? data[0].recognition[0].inputbtd14 : ""
            );
            setValuebtd14(
              data[0].recognition[0] ? data[0].recognition[0].inputbtd15 : ""
            );

            //
            setValuebtip1(
              data[0].basicprofile2[0]
                ? data[0].basicprofile2[0].inputbtip1
                : ""
            );
            setValuebtip2(
              data[0].basicprofile2[0]
                ? data[0].basicprofile2[0].inputbtip2
                : ""
            );
            setValuebtip3(
              data[0].basicprofile2[0]
                ? data[0].basicprofile2[0].inputbtip3
                : ""
            );
            setValuebtip4(
              data[0].basicprofile2[0]
                ? data[0].basicprofile2[0].inputbtip4
                : ""
            );
            setValuebtip5(
              data[0].basicprofile2[0]
                ? data[0].basicprofile2[0].inputbtip5
                : ""
            );
            setValuebtip6(
              data[0].basicprofile2[0]
                ? data[0].basicprofile2[0].inputbtip6
                : ""
            );

            //
            setValuebtl11(
              data[0].campus[0] ? data[0].campus[0].inputbtl11 : ""
            );
            setValuebtl12(
              data[0].campus[0] ? data[0].campus[0].inputbtl12 : ""
            );
            setValuebtl13(
              data[0].campus[0] ? data[0].campus[0].inputbtl13 : ""
            );
            setValuebtl14(
              data[0].campus[0] ? data[0].campus[0].inputbtl14 : ""
            );
            setValuebtl15(
              data[0].campus[0] ? data[0].campus[0].inputbtl15 : ""
            );
          })
          .catch((error) => {
  ...
  const inputDataList = {
    ...
    basicProfile: [
      {
        ...
        // inputbti11: valuebti11,
        // inputbti12: valuebti12,
      },
    ],
    ...
    programmeIntroduced: [
      {
        ...
        uniqueKey1: 1,
        inputbtp11: valuebtp11,
        inputbtp12: valuebtp12,
        inputbtp13: valuebtp13,
        inputbtp14: valuebtp14,
        inputbtp15: valuebtp15,
      },

      {
        ...
        uniqueKey1: 2,
        inputbtp11: valuebtp21,
        inputbtp12: valuebtp22,
        inputbtp13: valuebtp23,
        inputbtp14: valuebtp24,
        inputbtp15: valuebtp25,
      },

      {
        ...
        uniqueKey1: 3,
        inputbtp11: valuebtp31,
        inputbtp12: valuebtp32,
        inputbtp13: valuebtp33,
        inputbtp14: valuebtp34,
        inputbtp15: valuebtp35,
      },

      {
        ...
        uniqueKey1: 4,
        inputbtp11: valuebtp41,
        inputbtp12: valuebtp42,
        inputbtp13: valuebtp43,
        inputbtp14: valuebtp44,
        inputbtp15: valuebtp45,
      },

      {
        ...
        uniqueKey1: 5,
        inputbtp11: valuebtp51,
        inputbtp12: valuebtp52,
        inputbtp13: valuebtp53,
        inputbtp14: valuebtp54,
        inputbtp15: valuebtp55,
      },
    ],
    ...
    programmesOffered: [
      {
        ...
        uniqueKey1: 1,
        inputpot1: valuebtpp11,
        inputpot2: valuebtpp12,
        inputpot3: valuebtpp13,
      },

      {
        ...
        uniqueKey1: 2,
        inputpot1: valuebtpp21,
        inputpot2: valuebtpp22,
        inputpot3: valuebtpp23,
      },

      {
        ...
        uniqueKey1: 3,
        inputpot1: valuebtpp31,
        inputpot2: valuebtpp32,
        inputpot3: valuebtpp33,
      },
    ],
    proffessionalprogrammes: [
      {
        criteriaId: {
          collegeId: collegeId,
          financialYear: fYear,
        ...
        uniqueKey1: 1,
        // // inputpost1,
        // inputpost2:valuebtpp41,
        // inputpost3:valuebtpp42,

        inputpopt1: valuebtpp51,
        inputpopt2: valuebtpp52,
        inputpopt3: valuebtpp53,
      },

      {
        ...
        uniqueKey1: 2,
        inputpopt1: valuebtpp61,
        inputpopt2: valuebtpp62,
        inputpopt3: valuebtpp63,
      },

      {
        ...
        uniqueKey1: 3,
        inputpopt1: valuebtpp71,
        inputpopt2: valuebtpp72,
        inputpopt3: valuebtpp73,
      },
    ],
    ...
    // inputbtpp21: valuebtpp21,
    // inputbtpp22: valuebtpp22,
    // inputbtpp23: valuebtpp23,
    // inputbtpp31: valuebtpp31,
    // inputbtpp32: valuebtpp32,
    // inputbtpp33: valuebtpp33,
    // inputbtpp41: valuebtpp41,
    // inputbtpp42: valuebtpp42,
    // inputbtpp51: valuebtpp51,
    // inputbtpp52: valuebtpp52,
    // inputbtpp53: valuebtpp53,
    // inputbtpp61: valuebtpp61,
    // inputbtpp62: valuebtpp62,
    // inputbtpp63: valuebtpp63,
    // inputbtpp71: valuebtpp71,
    // inputbtpp72: valuebtpp72,
    // inputbtpp73: valuebtpp73,
    ...
    recognition: [
      {
        ...
        uniqueKey1: 1,
        inputbtd11: valuebtd1,
        inputbtd12: valuebtd11,
        inputbtd13: valuebtd12,
        inputbtd14: valuebtd13,
        inputbtd15: valuebtd14,
      },
    ],
    basicprofile2: [
      {
        ...
        inputbtip2: valuebtip2,
        inputbtip3: valuebtip3,
        inputbtip4: valuebtip4,
        inputbtip5: valuebtip5,
        inputbtip6: valuebtip6,
      },
    ],
    campus: [
      {
  ...
  function onClickingSave(e) {
    ...
    if (pathValuebti13 !== "") {
      basicData.append("uploadSsrfile", valuebti13, "13-" + valuebti13.name);
    }
    // basicData.append('uploadSsrfile', valuebti13, '13-' + valuebti13);
