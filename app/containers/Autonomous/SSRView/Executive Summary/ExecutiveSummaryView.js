...
function ExecutiveSummaryView() {
  ...
  useEffect(
    () =>
      fetch(
        'http://localhost:8080/api/v1/getallexecutivedata?collegeId=' +
          collegeId +
          '&financialYear=' +
          fYear +
          '&typeofInstitution=' +
        ...
        response
          .json()
          .then((data) => {
            console.log("executive data is ==>",JSON.stringify(data));
            ...
            setPathValuees6(data[0].executiveFileUpload[0] ? data[0].executiveFileUpload[0].executiveFileName : "");
          })
          .catch((error) => {
    ...
    <div className="executive-main-container">
      <form>
        ...
        <div className="executive-eachTable-container">
          ...
          <label htmlFor="es6">File upload</label>
          <div
            className="executive-eachTable-container"
            style={{ margin: "10px" }}
          >
            <Stack direction="row" alignItems="center" spacing={4}>
            <a href={downloadFile(pathValuees6)} target="_blank"> View File </a>
