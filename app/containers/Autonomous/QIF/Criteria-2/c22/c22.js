          ...
          <div className="c22x-container">
            <div className="c22x-heading_Help-container">
              ...
              <button
                ...
                className="21x-helpButton-style"
              >
                Help
              </button>
              <HelpButton
                ...
                title='(Students (Latest completed academic year) : Teachers (Latest completed academic year))'
                ></HelpButton>
            </div>
