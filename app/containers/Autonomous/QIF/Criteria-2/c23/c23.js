            ...
            <div className="c23x-heading_Help-container">
              <h1 className="c23x-heading-style">
                ...
                Student centric methods, such as experiential learning, 
                  ...
                  tools including online resources for effective teaching and
              </h1>
              <button
          ...
          <div className="c23x-container">
            <div className="c23x-heading_Help-container">
              ...
              <HelpButton
                ...
                title='Write description in maximum of 500 words'
          ...
          <div className="c23xx-container">
            ...
            <h1 className="c23xx-Heading-style">
              ...
              <input
                ...
                id="2331-t2"
                style={{ width:"25%",marginLeft: '24.4%' }}
                type="number"
              />
            </h1>
        ...
        <form>
          <div className="c23x-Ql-label-textarea-container">
            <div className="c23x-heading_Help-container">
              ...
              <Help234
                isHelp234Clicked={help234Status}
                setIsHelp234Clicked={setHelp234Status}
              />
            </div>
