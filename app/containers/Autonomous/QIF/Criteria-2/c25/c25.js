        ...
        <form>
          <div className="c25x-container">
            <div className="c25x-heading_Help-container">
              ...
              <HelpButton
                ...
                title='Percentage'
                ><h1>(Total number of complaints or grievanves about evaluation )/(Total number of students appeared in the examinations) * 100</h1></HelpButton>
            </div>
            <div className="c25x-response-container">
              <button
                onClick={(e) => {
          ...
          <div className="c25xx-container">
            ...
            <h1 className="c25xx-Heading-style">
              ...
              Number of students appeared in the examination conducted by the institution year wise during the last five years            </h1>
            <table className="c25x-Qt-table-style">
              <tr>
                <th className="c25x-horizontalTable-heading-style">Year</th>
                <td>
