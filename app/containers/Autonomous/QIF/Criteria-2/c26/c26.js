          ...
          <div className="c26xx-container">
            ...
            <table className="c26x-table-style">
              ...
              <tr>
                ...
                <td> <a href={downloadFile("au2.6.2.xlsx")} target="_blank">View Template</a></td>
                <td>
                  <input
                    onChange={(e) => {
