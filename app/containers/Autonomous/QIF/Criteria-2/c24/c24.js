 ...
 //help buttom
  ...
  const inputDataList = {
    ...
    yearTable2411: [
      ...
      {
        criteriaId: {collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType},
         uniqueKey1: 3, input2411y: value241t3, input2411v: value241t8
      },
      {
        criteriaId: {collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType },
          ...
          <div className="c24x-container">
            <div className="c24x-heading_Help-container">
              ...
              <HelpButton
                ...
                title='Formula'
                ><h1>(Total number of full time teachers during the last five years
                  )/(Total number of sanctioned posts during the last five years) * 100</h1></HelpButton>
            </div>
...
<button
          ...
          <div className="c24xx-container">
            ...
            <h1 className="c24xx-Heading-style">
              ...
              id="2431-t1"
              style={{ width:"25%", marginLeft: '17.3%' }}
              type="number"
            />
             </span>
             </h1>
