          ...
          <table className="c61x-Ql-table-style">
            ...
            <tr>
              ...
              <td className="c61x-Ql-tableBorders-style">
                <input
                  onChange={(e) => {
                    setValue612f1(e.target.files[0]);
                    setPathValue612f1(e.target.value);
                    showFilePreview(e);
                ...
                {pathValue612f1 === '' ? null : (
                  <div className="c61-fileButtons-container">
                    ...
                    <button className="c11-removeFileButton-style" 
                      onClick={(e)=>{setPathValue612f1("");
                      document.getElementById("612-f1").value="" }} >
                      Reset
                     </button>
            ...
            <tr>
              ...
              <td className="c61x-Ql-tableBorders-style">
                <input
                  onChange={(e) => {
                    setValue612f2(e.target.files[0]);
                    setPathValue612f2(e.target.value);
                    showFilePreview(e);
                ...
                {pathValue612f2 === '' ? null : (
                  <div className="c61-fileButtons-container">
                    ...
                    <button className="c11-removeFileButton-style" 
                      onClick={(e)=>{setPathValue612f2("");
                      document.getElementById("612-f2").value="" }} >
                      Reset
                     </button>
            ...
            <tr>
              ...
              <td className="c61x-Ql-tableBorders-style">
                <input
                  onChange={(e) => {
                    setValue612f3(e.target.files[0]);
                    setPathValue612f3(e.target.value);
                    showFilePreview(e);
                ...
                {pathValue612f3 === '' ? null : (
                  <div className="c61-fileButtons-container">
                    ...
                    <button className="c11-removeFileButton-style" 
                      onClick={(e)=>{setPathValue612f3("");
                      document.getElementById("612-f3").value="" }} >
                      Reset
                     </button>
