              ...
              <div>
                ...
                <div className="c62x-radio-container" style={{width:"180%"}}>
                  <div className="c62x-radio-subContainer" style={{width:"45%"}}>
                    ...
                    <div className="c62x-eachRadio-container">
                      <input name="623options" id="623-t1" type="radio" onChange={(e) => { setValue623t1(e.target.value); }} value="Any three of the above"/>
                    ...
                    <div className="c62x-eachRadio-container">
                      <input name="623options" id="623-t1" type="radio" onChange={(e) => { setValue623t1(e.target.value); }} value="Any two of the above"/>
                  ...
                  <div className="c62x-radio-subContainer">
                    <div className="c62x-eachRadio-container">
                      <input name="623options" id="623-t1" type="radio" onChange={(e) => { setValue623t1(e.target.value); }} value="Any one of the above"/>
          ...
          <table className="c62x-table-style">
            ...
            <tr>
              ...
              <td>
                <input
                  onChange={(e) => {
                     setValue623f1(e.target.files[0]);
