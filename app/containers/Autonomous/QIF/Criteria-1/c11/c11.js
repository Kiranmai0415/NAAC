...
regional, national, and global developmental needs, which is
...
Outcomes(COs) of the Programmes offered by the institution
            ...
            <label htmlForm="111-t1" className="c11x-label-style">
              Response:
            </label>
            <textarea
          ...
          <div className="c11x-container">
            <div className="c11x-heading_Help-container">
              <h1 className="c11x-heading-style">
                ...
                The programmes offered by the institution focus on employability/
