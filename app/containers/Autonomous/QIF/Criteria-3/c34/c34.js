...
function Criteria34() {
 ...
 //help buttom
  ...
  const[gradeScaleClickStatus342,setGradeScaleClickStatus342] = useState("");
  const[gradePointsClickStatus342 ,setGradePointsClickStatus342 ] = useState("");
          ...
          <div className="c34xx-container">
            ...
            <table className="c34x-table-style">
              ...
              <tr>
                ...
                <td><a href={downloadFile("au3.4.2.xlsx")} target="_blank">view template</a></td>
                <td>
                  <input
                    onChange={(e) => {
          ...
          <div className="c34x-container">
            <div className="c34x-heading_Help-container">
              ...
              <HelpButton
                ...
                title='formula'
                ><h1>Total number of books and chapters in edited volumes published during the last five years / Number of full time teachers (without repeat count)during the last five year</h1></HelpButton>
            </div>
            <div className="c34x-response-container">
              <button
                onClick={(e) => {
          ...
          <div className="c34xx-container">
            ...
            <table className="c34x-table-style">
              ...
              <tr>
                ...
                <td>
                {/* <a href={downloadFile("au3.4.5.xlsx")} target="_blank">View Template</a> */}
                </td>
                <td>
                  <input
                    onChange={(e) => {
          ...
          <div className="c34x-container">
            <div className="c34x-heading_Help-container">
              ...
              <HelpButton
                ...
                title='formula'
                ><h1>(h ? Index (Scopus)+ h - index (Web of Science) during yhe last five years) / 2</h1></HelpButton>
            </div>
            <div className="c34x-response-container">
              <button
                onClick={(e) => {
          ...
          <div className="c34xx-container">
            ...
            <table className="c34x-table-style">
              ...
              <tr>
                ...
                <td>
                  {/* <a href="http://localhost:8080/api/v1/download/criteria3.4.6.xlsx">View Template</a> */}
                </td>
                <td>
                  <input
                    onChange={(e) => {
