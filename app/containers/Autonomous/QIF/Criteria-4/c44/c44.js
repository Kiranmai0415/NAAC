...
function Criteria44() {
 ...
 //help buttom
  ...
  function onClickingViewResponse441() {
    console.log("values responseValue442===>", typeof responseValue442)
    // if (
    //   value4411t6 === ''
    //       || value4411t7 === ''
    //       || value4411t8 === ''
    ...
    if (
      ...
      setResponseValue441(((((parseInt(value4411t6) / parseInt(value4411t16)) * 100)
           + ((parseInt(value4411t7) / parseInt(value4411t17)) * 100)
           + ((parseInt(value4411t8) /parseInt(value4411t18)) * 100)
          + ((parseInt(value4411t9) / parseInt(value4411t19)) * 100)
          + ((parseInt(value4411t10) / parseInt(value4411t20)) * 100)) / 5));
    }
    console.log("values responseValue442  after calculation==>", typeof parseInt(responseValue442))
  }
  ...
  const inputDataList = {
    ...
    yearTable4411: [
      {
        criteriaId: {collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType },
         uniqueKey1: 1, input4411y: value4411t1, input4411v: value4411t6
      },
      {
        criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType },
         uniqueKey1: 2, input4411y: value4411t2, input4411v: value4411t7
      },
      {
        criteriaId: {collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType },
         uniqueKey1: 3, input4411y: value4411t3, input4411v: value4411t8
      },
      {
        criteriaId: {collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType },
         uniqueKey1: 4, input4411y: value4411t4, input4411v: value4411t9
      },
      {
        criteriaId: {collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType },
         uniqueKey1: 5, input4411y: value4411t5, input4411v: value4411t10
      },
    ],
    yearTable44112: [
      {
        criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType },
         uniqueKey1: 1, input44112y: value4411t11, input44112v: value4411t16
      },
      {
        criteriaId: { collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType },
         uniqueKey1: 2, input44112y: value4411t12, input44112v: value4411t17
      },
      {
        criteriaId: {collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType },
         uniqueKey1: 3, input44112y: value4411t13, input44112v: value4411t18
      },
      {
        criteriaId: {collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType},
         uniqueKey1: 4, input44112y: value4411t14, input44112v: value4411t19
      },
      {
        criteriaId: {collegeId: collegeId, financialYear: fYear, typeofInstitution: instituteType },
         uniqueKey1: 5, input44112y: value4411t15, input44112v: value4411t20
      },
    ]
  };
          ...
          <div className="c44x-container">
            ...
            <div className="c44x-response-container">
              ...
              {responseButtonStatus441 ? (
                <p className="c44x-responseResult-style">{parseInt(responseValue441)}</p>
              ) : null}
            </div>
            {/* <div>{JSON.stringify(responseValue441)}</div> */}
          </div>
...
{/* 
            ...
            <table className="c44x-table-style">
              ...
              <tr>
                ...
                <td>
                <a href={downloadFile("au4.4.1.xlsx")} target="_blank">View Template</a>
                </td>
                <td>
                  <input
                    onChange={(e) => {
              ...
              <td>
                ...
                {pathValue442f2 === '' ? null : (
                  <div className="c44-fileButtons-container">
                    ...
                    <button className="c11-removeFileButton-style" 
                      onClick={(e)=>{setPathValue442f2("");
                      document.getElementById("441-f2").value="" }} >
                      Reset
                    </button>
