...
function ExecutiveSummary() {
  ...
  useEffect(
    () =>
      fetch("http://localhost:8080/api/v1/getallexecutivedata").then(
        (response) =>
          response
            .json()
            .then((data) => {
              setValuees1(data[0].inputes1);
              setValuees2(data[0].inputes2);
              setValuees3(data[0].inputes3);
              setValuees4(data[0].inputes4);
              setValuees5(data[0].inputes5);
              setValuees6(data[0].inputes6);
              setValuees7(data[0].inputes7);
              setValuees8(data[0].inputes8);
              setValuees9(data[0].inputes9);
              setValuees10(data[0].inputes10);
            })
            .catch((error) => {
