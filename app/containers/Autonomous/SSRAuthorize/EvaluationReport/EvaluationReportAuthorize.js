...
export default function EvaluationReportAuthorize() {
  ...
  const eamcetCode = AuthService.getCurrentUser().collegeId;
  console.log("eamcetCode==========>" + eamcetCode);
  const d = new Date();
    ...
    fetch(
      ...
      response
        ...
        .then((data) => {
          ...
          setZoology2(
            data[0].evaluativereportofthedepartment11[1]
              ? data[0].evaluativereportofthedepartment11[1].zoolog
              : ""
          );
          setBioTech2(
            data[0].evaluativereportofthedepartment11[1]
  ...
  function getAuthorizeEvaluation() {
    ...
    fetch(
      resources.APPLICATION_URL +
        "evaluativeRepotDataSubmittoPrincipal?collegeId=" +
        collegeId +
        "&finacialYear=" +
        fYear +
        "&typeofInstitution=" +
