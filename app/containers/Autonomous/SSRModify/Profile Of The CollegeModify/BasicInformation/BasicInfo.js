import { FormControl, FormControlLabel,RadioGroup,Radio, FormLabel, TextField } from "@material-ui/core";
...
function BasicInfo() {
  ...
  //  const financialYear="2021-2022";
   useEffect(
    () => fetch('http://localhost:8080/api/v1/getallacademicdata?collegeId='+collegeId+'&financialYear=' +
    fYear +
    ...
    <div className="main-container">
      ...
      <div className="eachTable-container">
        <form>
          ...
          <table>
            <tr>
              <th rowspan="2" align="center">Latest Year</th>
              <th colspan="2">
