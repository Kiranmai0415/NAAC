...
function IIQA() {
  ...
  const [iiqa23t5, setIiqa23t5] = useState();
  const [iiqa23t6, setIiqa23t6] = useState();
  const [iiqa23t7, setIiqa23t7] = useState();
  const [iiqa23t8, setIiqa23t8] = useState();
  ...
  const instituteType = AuthService.getCurrentUser().instituteType;
  ...
  useEffect(()=>{
    ...
    setIiqa23t8((Number(iiqa23t5)+Number(iiqa23t6)+Number(iiqa23t7))),
    setIiqa24t4((Number(iiqa24t1)+Number(iiqa24t2)+Number(iiqa24t3)))}
    ,[iiqa22t1,iiqa22t2,iiqa22t3,iiqa22t5,iiqa22t6,iiqa22t7,iiqa23t1,iiqa23t2,iiqa23t3,iiqa23t5,iiqa23t6,iiqa23t7,iiqa24t1,iiqa24t2,iiqa24t3]
    );
      ...
      <div className="eachTable-container">
        ...
        <table>
          ...
          <tr>
            <td>19</td>
            <td>
              If the institution is not autonomous to a university and is
                ...
                <tr>
                  ...
                  <td>
                    <input
                      type="number"
                      id="iiqa23t5"
                      onChange={(e) => setIiqa23t5(e.target.value)}
                    />
                  </td>
                  <td>
                    <input
                      type="number"
                      id="iiqa23t6"
                      onChange={(e) => setIiqa23t6(e.target.value)}
                    />
                  </td>
                  <td>
                    <input
                      type="number"
                      id="iiqa23t7"
                      onChange={(e) => setIiqa23t7(e.target.value)}
                    />
                  </td>
                  <td>
                    <input
