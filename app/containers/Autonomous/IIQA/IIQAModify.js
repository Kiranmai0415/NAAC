...
function IIQAModify() {
  ...
  useEffect(
    () =>
      fetch(
        "http://localhost:8080/api/v1/getallqiafiles?collegeId=" +
          collegeId +
          "&financialYear=" +
          fYear +
          "&typeofInstitution=" +
        ...
        response
          .json()
          .then((data) => {
            console.log("IIQA modify data==>"+JSON.stringify(data));
            // console.log("data[0].qiaIndicator1[0].inputiiqa22t1 =>" + data[0].qiaIndicator1[0]);
            setIiqaDate(data[0] ? data[0].inputIiqaDate : "");
            setIiqaAisheId(data[0] ? data[0].inputIiqaAisheId : "");
            setIiqaTrackId(data[0] ? data[0].inputIiqaTrackId : "");
            ...
            // }
            setIiqa22t1(
              data[0].qiaIndicator1[0]
                ? data[0].qiaIndicator1[0].inputiiqa22t1
                : ""
            );
            setIiqa22t2(
              data[0].qiaIndicator1[0]
                ? data[0].qiaIndicator1[0].inputiiqa22t2
                : ""
            );
            setIiqa22t3(
              data[0].qiaIndicator1[0]
                ? data[0].qiaIndicator1[0].inputiiqa22t3
                : ""
            );
            setIiqa22t4(
              data[0].qiaIndicator1[0]
                ? data[0].qiaIndicator1[0].inputiiqa22t4
                : ""
            );
            // console.log(data[0].qiaIndicator1[0].inputiiqa22t4);

            setIiqa22t5(
              data[0].qiaIndicator1[1]
                ? data[0].qiaIndicator1[1].inputiiqa22t1
                : ""
            );
            setIiqa22t6(
              data[0].qiaIndicator1[1]
                ? data[0].qiaIndicator1[1].inputiiqa22t2
                : ""
            );
            setIiqa22t7(
              data[0].qiaIndicator1[1]
                ? data[0].qiaIndicator1[1].inputiiqa22t3
                : ""
            );
            setIiqa22t8(
              data[0].qiaIndicator1[1]
                ? data[0].qiaIndicator1[1].inputiiqa22t4
                : ""
            );
            // qiaIndicator2
            setIiqa1t1(
              data[0].qiaIndicator2[0]
                ? data[0].qiaIndicator2[0].inputiiqa1t1
                : ""
            );
            setIiqa1t2(
              data[0].qiaIndicator2[0]
                ? data[0].qiaIndicator2[0].inputiiqa1t2
                : ""
            );
            setIiqa2t1(
              data[0].qiaIndicator2[0]
                ? data[0].qiaIndicator2[0].inputiiqa2t1
                : ""
            );
            setIiqa3t1(
              data[0].qiaIndicator2[0]
                ? data[0].qiaIndicator2[0].inputiiqa3t1
                : ""
            );
            setIiqa4t1(
              data[0].qiaIndicator2[0]
                ? data[0].qiaIndicator2[0].inputiiqa4t2
                : ""
            );
            setIiqa4t2(
              data[0].qiaIndicator2[0]
            ...
            setIiqa5t1(
              data[0].qiaIndicator2[0]
                ? data[0].qiaIndicator2[0].inputiiqa5t1
                : ""
            );
            setIiqa6t1(
              data[0].qiaIndicator2[0]
                ? data[0].qiaIndicator2[0].inputiiqa6t1
                : ""
            );
            setIiqa6t2(
              data[0].qiaIndicator2[0]
                ? data[0].qiaIndicator2[0].inputiiqa6t2
                : ""
            );
            setIiqa6t3(
              data[0].qiaIndicator2[0]
                ? data[0].qiaIndicator2[0].inputiiqa6t3
                : ""
            );
            setIiqa6t4(
              data[0].qiaIndicator2[0]
                ? data[0].qiaIndicator2[0].inputiiqa6t4
                : ""
            );
            setIiqa6t5(
              data[0].qiaIndicator2[0]
                ? data[0].qiaIndicator2[0].inputiiqa6t5
                : ""
            );
            setIiqa6t6(
              data[0].qiaIndicator2[0]
                ? data[0].qiaIndicator2[0].inputiiqa6t6
                : ""
            );
            setIiqa6t7(
              data[0].qiaIndicator2[0]
                ? data[0].qiaIndicator2[0].inputiiqa6t7
                : ""
            );
            setIiqa6t8(
              data[0].qiaIndicator2[0]
                ? data[0].qiaIndicator2[0].inputiiqa6t8
                : ""
            );
            setIiqa6t9(
              data[0].qiaIndicator2[0]
                ? data[0].qiaIndicator2[0].inputiiqa6t9
                : ""
            );
            setIiqa6t10(
              data[0].qiaIndicator2[0]
                ? data[0].qiaIndicator2[0].inputiiqa6t10
                : ""
            );
            setIiqa7t1(
              data[0].qiaIndicator2[0]
                ? data[0].qiaIndicator2[0].inputiiqa7t1
                : ""
            );
            setIiqa7t2(
              data[0].qiaIndicator2[0]
                ? data[0].qiaIndicator2[0].inputiiqa7t2
                : ""
            );
            setIiqa7t3(
              data[0].qiaIndicator2[0]
                ? data[0].qiaIndicator2[0].inputiiqa7t3
                : ""
            );
            setIiqa7t4(
              data[0].qiaIndicator2[0]
                ? data[0].qiaIndicator2[0].inputiiqa7t4
                : ""
            );
            setIiqa7t5(
              data[0].qiaIndicator2[0]
                ? data[0].qiaIndicator2[0].inputiiqa7t5
                : ""
            );
            setIiqa7t6(
              data[0].qiaIndicator2[0]
                ? data[0].qiaIndicator2[0].inputiiqa7t6
                : ""
            );
            setIiqa7t7(
              data[0].qiaIndicator2[0]
                ? data[0].qiaIndicator2[0].inputiiqa7t7
                : ""
            );
            setIiqa7t8(
              data[0].qiaIndicator2[0]
                ? data[0].qiaIndicator2[0].inputiiqa7t8
                : ""
            );
            setIiqa7t9(
              data[0].qiaIndicator2[0]
                ? data[0].qiaIndicator2[0].inputiiqa7t9
                : ""
            );
            setIiqa7t10(
              data[0].qiaIndicator2[0]
                ? data[0].qiaIndicator2[0].inputiiqa7t10
                : ""
            );
            setIiqa8t1(
              data[0].qiaIndicator2[0]
                ? data[0].qiaIndicator2[0].inputiiqa8t1
                : ""
            );
            setIiqa9t1(
              data[0].qiaIndicator2[0]
                ? data[0].qiaIndicator2[0].inputiiqa9t1
                : ""
            );
            setIiqa10t1(
              data[0].qiaIndicator2[0]
                ? data[0].qiaIndicator2[0].inputiiqa10t1
                : ""
            );
            setIiqa11t1(
              data[0].qiaIndicator2[0]
                ? data[0].qiaIndicator2[0].inputiiqa11t1
                : ""
            );
            setIiqa13t1(
              data[0].qiaIndicator2[0]
                ? data[0].qiaIndicator2[0].inputiiqa13t1
                : ""
            );
            setIiqa14t1(
              data[0].qiaIndicator2[0]
                ? data[0].qiaIndicator2[0].inputiiqa14t1
                : ""
            );
            setIiqa15t1(
              data[0].qiaIndicator2[0]
                ? data[0].qiaIndicator2[0].inputiiqa15t1
                : ""
            );
            setIiqa16t1(
              data[0].qiaIndicator2[0]
                ? data[0].qiaIndicator2[0].inputiiqa16t1
                : ""
            );
            setIiqa17t1(
              data[0].qiaIndicator2[0]
                ? data[0].qiaIndicator2[0].inputiiqa17t1
                : ""
            );
            setIiqa18t1(
              data[0].qiaIndicator2[0]
                ? data[0].qiaIndicator2[0].inputiiqa18t1
                : ""
            );
            setIiqa19t1(
              data[0].qiaIndicator2[0]
                ? data[0].qiaIndicator2[0].inputiiqa19t1
                : ""
            );
            setIiqa25t1(
              data[0].qiaIndicator2[0]
                ? data[0].qiaIndicator2[0].inputiiqa25t1
                : ""
            );
            setIiqa26t1(
              data[0].qiaIndicator2[0]
                ? data[0].qiaIndicator2[0].inputiiqa26t1
                : ""
            );
            setIiqa27t1(
              data[0].qiaIndicator2[0]
                ? data[0].qiaIndicator2[0].inputiiqa27t1
                : ""
            );
            setIiqa28t1(
              data[0].qiaIndicator2[0]
                ? data[0].qiaIndicator2[0].inputiiqa28t1
                : ""
            );
            setIiqa29t1(
              data[0].qiaIndicator2[0]
                ? data[0].qiaIndicator2[0].inputiiqa29t1
                : ""
            );
            setIiqa30t1(
              data[0].qiaIndicator2[0]
                ? data[0].qiaIndicator2[0].inputiiqa30t1
                : ""
            );
            setIiqa32t1(
              data[0].qiaIndicator2[0]
                ? data[0].qiaIndicator2[0].inputiiqa32t1
                : ""
            );

            // qiaIndicator3
            setIiqa12t1(
              data[0].qiaIndicator3[0]
                ? data[0].qiaIndicator3[0].inputiiqa12t1
                : ""
            );
            setIiqa12t2(
              data[0].qiaIndicator3[0]
                ? data[0].qiaIndicator3[0].inputiiqa12t2
                : ""
            );
            setIiqa12t3(
              data[0].qiaIndicator3[0]
                ? data[0].qiaIndicator3[0].inputiiqa12t3
                : ""
            );

            // qiaIndicator4
            setIiqa18t2(
              data[0].qiaIndicator4[0]
                ? data[0].qiaIndicator4[0].inputiiqa18t2
                : ""
            );
            setIiqa18t3(
              data[0].qiaIndicator4[0]
                ? data[0].qiaIndicator4[0].inputiiqa18t3
                : ""
            );

            // qiaIndicator5
            setIiqa20t1(
              data[0].qiaIndicator5[0]
                ? data[0].qiaIndicator5[0].inputiiqa20t1
                : ""
            );
            setIiqa20t2(
              data[0].qiaIndicator5[0]
                ? data[0].qiaIndicator5[0].inputiiqa20t2
                : ""
            );

            setIiqa20t3(
              data[0].qiaIndicator5[1]
                ? data[0].qiaIndicator5[1].inputiiqa20t1
                : ""
            );
            setIiqa20t4(
              data[0].qiaIndicator5[1]
                ? data[0].qiaIndicator5[1].inputiiqa20t2
                : ""
            );

            setIiqa20t5(
              data[0].qiaIndicator5[2]
                ? data[0].qiaIndicator5[2].inputiiqa20t1
                : ""
            );
            setIiqa20t6(
              data[0].qiaIndicator5[2]
                ? data[0].qiaIndicator5[2].inputiiqa20t2
                : ""
            );

            setIiqa20t7(
              data[0].qiaIndicator5[3]
                ? data[0].qiaIndicator5[3].inputiiqa20t1
                : ""
            );
            setIiqa20t8(
              data[0].qiaIndicator5[3]
                ? data[0].qiaIndicator5[3].inputiiqa20t2
                : ""
            );

            setIiqa20t9(
              data[0].qiaIndicator5[4]
                ? data[0].qiaIndicator5[4].inputiiqa20t1
                : ""
            );
            setIiqa20t10(
              data[0].qiaIndicator5[4]
                ? data[0].qiaIndicator5[4].inputiiqa20t2
                : ""
            );

            setIiqa20t11(
              data[0].qiaIndicator5[5]
                ? data[0].qiaIndicator5[5].inputiiqa20t1
                : ""
            );
            setIiqa20t12(
              data[0].qiaIndicator5[5]
                ? data[0].qiaIndicator5[5].inputiiqa20t2
                : ""
            );

            // qiaIndicator6
            setIiqa21t1(
              data[0].qiaIndicator6[0]
                ? data[0].qiaIndicator6[0].inputiiqa21t1
                : ""
            );
            setIiqa21t2(
              data[0].qiaIndicator6[0]
                ? data[0].qiaIndicator6[0].inputiiqa21t2
                : ""
            );
            setIiqa21t3(
              data[0].qiaIndicator6[0]
                ? data[0].qiaIndicator6[0].inputiiqa21t3
                : ""
            );
            setIiqa21t4(
              data[0].qiaIndicator6[0]
                ? data[0].qiaIndicator6[0].inputiiqa21t4
                : ""
            );
            setIiqa21t5(
              data[0].qiaIndicator6[0]
                ? data[0].qiaIndicator6[0].inputiiqa21t5
                : ""
            );

            setIiqa21t6(
              data[0].qiaIndicator6[1]
                ? data[0].qiaIndicator6[1].inputiiqa21t1
                : ""
            );
            setIiqa21t7(
              data[0].qiaIndicator6[1]
                ? data[0].qiaIndicator6[1].inputiiqa21t2
                : ""
            );
            setIiqa21t8(
              data[0].qiaIndicator6[1]
                ? data[0].qiaIndicator6[1].inputiiqa21t3
                : ""
            );
            setIiqa21t9(
              data[0].qiaIndicator6[1]
                ? data[0].qiaIndicator6[1].inputiiqa21t4
                : ""
            );
            setIiqa21t10(
              data[0].qiaIndicator6[1]
                ? data[0].qiaIndicator6[1].inputiiqa21t5
                : ""
            );

            setIiqa21t11(
              data[0].qiaIndicator6[2]
                ? data[0].qiaIndicator6[2].inputiiqa21t1
                : ""
            );
            setIiqa21t12(
              data[0].qiaIndicator6[2]
                ? data[0].qiaIndicator6[2].inputiiqa21t2
                : ""
            );
            setIiqa21t13(
              data[0].qiaIndicator6[2]
                ? data[0].qiaIndicator6[2].inputiiqa21t3
                : ""
            );
            setIiqa21t14(
              data[0].qiaIndicator6[2]
                ? data[0].qiaIndicator6[2].inputiiqa21t4
                : ""
            );
            setIiqa21t15(
              data[0].qiaIndicator6[2]
                ? data[0].qiaIndicator6[2].inputiiqa21t5
                : ""
            );

            setIiqa21t16(
              data[0].qiaIndicator6[3]
                ? data[0].qiaIndicator6[3].inputiiqa21t1
                : ""
            );
            setIiqa21t17(
              data[0].qiaIndicator6[3]
                ? data[0].qiaIndicator6[3].inputiiqa21t2
                : ""
            );
            setIiqa21t18(
              data[0].qiaIndicator6[3]
                ? data[0].qiaIndicator6[3].inputiiqa21t3
                : ""
            );
            setIiqa21t19(
              data[0].qiaIndicator6[3]
                ? data[0].qiaIndicator6[3].inputiiqa21t4
                : ""
            );
            setIiqa21t20(
              data[0].qiaIndicator6[3]
                ? data[0].qiaIndicator6[3].inputiiqa21t5
                : ""
            );

            setIiqa21t21(
              data[0].qiaIndicator6[4]
                ? data[0].qiaIndicator6[4].inputiiqa21t1
                : ""
            );
            setIiqa21t22(
              data[0].qiaIndicator6[4]
                ? data[0].qiaIndicator6[4].inputiiqa21t2
                : ""
            );
            setIiqa21t23(
              data[0].qiaIndicator6[4]
                ? data[0].qiaIndicator6[4].inputiiqa21t3
                : ""
            );
            setIiqa21t24(
              data[0].qiaIndicator6[4]
                ? data[0].qiaIndicator6[4].inputiiqa21t4
                : ""
            );
            setIiqa21t25(
              data[0].qiaIndicator6[4]
                ? data[0].qiaIndicator6[4].inputiiqa21t5
                : ""
            );

            setIiqa21t26(
              data[0].qiaIndicator6[5]
                ? data[0].qiaIndicator6[5].inputiiqa21t1
                : ""
            );
            setIiqa21t27(
              data[0].qiaIndicator6[5]
                ? data[0].qiaIndicator6[5].inputiiqa21t2
                : ""
            );
            setIiqa21t28(
              data[0].qiaIndicator6[5]
                ? data[0].qiaIndicator6[5].inputiiqa21t3
                : ""
            );
            setIiqa21t29(
              data[0].qiaIndicator6[5]
                ? data[0].qiaIndicator6[5].inputiiqa21t4
                : ""
            );
            setIiqa21t30(
              data[0].qiaIndicator6[5]
                ? data[0].qiaIndicator6[5].inputiiqa21t5
                : ""
            );

            setIiqa21t31(
              data[0].qiaIndicator6[6]
                ? data[0].qiaIndicator6[6].inputiiqa21t1
                : ""
            );
            setIiqa21t32(
              data[0].qiaIndicator6[6]
                ? data[0].qiaIndicator6[6].inputiiqa21t2
                : ""
            );
            setIiqa21t33(
              data[0].qiaIndicator6[6]
                ? data[0].qiaIndicator6[6].inputiiqa21t3
                : ""
            );
            setIiqa21t34(
              data[0].qiaIndicator6[6]
                ? data[0].qiaIndicator6[6].inputiiqa21t4
                : ""
            );
            setIiqa21t35(
              data[0].qiaIndicator6[6]
                ? data[0].qiaIndicator6[6].inputiiqa21t5
                : ""
            );

            setIiqa21t36(
              data[0].qiaIndicator6[7]
                ? data[0].qiaIndicator6[7].inputiiqa21t1
                : ""
            );
            setIiqa21t37(
              data[0].qiaIndicator6[7]
                ? data[0].qiaIndicator6[7].inputiiqa21t2
                : ""
            );
            setIiqa21t38(
              data[0].qiaIndicator6[7]
                ? data[0].qiaIndicator6[7].inputiiqa21t3
                : ""
            );
            setIiqa21t39(
              data[0].qiaIndicator6[7]
                ? data[0].qiaIndicator6[7].inputiiqa21t4
                : ""
            );
            setIiqa21t40(
              data[0].qiaIndicator6[7]
                ? data[0].qiaIndicator6[7].inputiiqa21t5
                : ""
            );

            setIiqa21t51(
              data[0].qiaIndicator6[8]
                ? data[0].qiaIndicator6[8].inputiiqa21t1
                : ""
            );
            setIiqa21t52(
              data[0].qiaIndicator6[8]
                ? data[0].qiaIndicator6[8].inputiiqa21t2
                : ""
            );
            setIiqa21t53(
              data[0].qiaIndicator6[8]
                ? data[0].qiaIndicator6[8].inputiiqa21t3
                : ""
            );
            setIiqa21t54(
              data[0].qiaIndicator6[8]
                ? data[0].qiaIndicator6[8].inputiiqa21t4
                : ""
            );
            setIiqa21t55(
              data[0].qiaIndicator6[8]
                ? data[0].qiaIndicator6[8].inputiiqa21t5
                : ""
            );

            setIiqa21t56(
              data[0].qiaIndicator6[9]
                ? data[0].qiaIndicator6[9].inputiiqa21t1
                : ""
            );
            setIiqa21t57(
              data[0].qiaIndicator6[9]
                ? data[0].qiaIndicator6[9].inputiiqa21t2
                : ""
            );
            setIiqa21t58(
              data[0].qiaIndicator6[9]
                ? data[0].qiaIndicator6[9].inputiiqa21t3
                : ""
            );
            setIiqa21t59(
              data[0].qiaIndicator6[9]
                ? data[0].qiaIndicator6[9].inputiiqa21t4
                : ""
            );
            setIiqa21t60(
              data[0].qiaIndicator6[9]
                ? data[0].qiaIndicator6[9].inputiiqa21t5
                : ""
            );

            setIiqa21t61(
              data[0].qiaIndicator6[10]
                ? data[0].qiaIndicator6[10].inputiiqa21t1
                : ""
            );
            setIiqa21t62(
              data[0].qiaIndicator6[10]
                ? data[0].qiaIndicator6[10].inputiiqa21t2
                : ""
            );
            setIiqa21t63(
              data[0].qiaIndicator6[10]
                ? data[0].qiaIndicator6[10].inputiiqa21t3
                : ""
            );
            setIiqa21t64(
              data[0].qiaIndicator6[10]
                ? data[0].qiaIndicator6[10].inputiiqa21t4
                : ""
            );
            setIiqa21t65(
              data[0].qiaIndicator6[10]
                ? data[0].qiaIndicator6[10].inputiiqa21t5
                : ""
            );

            setIiqa21t66(
              data[0].qiaIndicator6[11]
                ? data[0].qiaIndicator6[11].inputiiqa21t1
                : ""
            );
            setIiqa21t67(
              data[0].qiaIndicator6[11]
                ? data[0].qiaIndicator6[11].inputiiqa21t2
                : ""
            );
            setIiqa21t68(
              data[0].qiaIndicator6[11]
                ? data[0].qiaIndicator6[11].inputiiqa21t3
                : ""
            );
            setIiqa21t69(
              data[0].qiaIndicator6[11]
                ? data[0].qiaIndicator6[11].inputiiqa21t4
                : ""
            );
            setIiqa21t70(
              data[0].qiaIndicator6[11]
                ? data[0].qiaIndicator6[11].inputiiqa21t5
                : ""
            );

            // qiaIndicator7
            setIiqa26t2(
              data[0].qiaIndicator7[0]
                ? data[0].qiaIndicator7[0].inputiiqa26t2
                : ""
            );

            // qiaIndicator8
            setIiqa27t1(
              data[0].qiaIndicator8[0]
                ? data[0].qiaIndicator8[0].inputiiqa27t1
                : ""
            );

            // qiaIndicator9
            setIiqa23t1(
              data[0].qiaIndicator9[0]
                ? data[0].qiaIndicator9[0].inputiiqa23t1
                : ""
            );
            setIiqa23t2(
              data[0].qiaIndicator9[0]
                ? data[0].qiaIndicator9[0].inputiiqa23t2
                : ""
            );
            setIiqa23t3(
              data[0].qiaIndicator9[0]
                ? data[0].qiaIndicator9[0].inputiiqa23t3
                : ""
            );
            setIiqa23t4(
              data[0].qiaIndicator9[0]
                ? data[0].qiaIndicator9[0].inputiiqa23t4
                : ""
            );

            // qiaIndicator10
            setIiqa24t1(
              data[0].qiaIndicator10[0]
                ? data[0].qiaIndicator10[0].inputiiqa24t1
                : ""
            );
            setIiqa24t2(
              data[0].qiaIndicator10[0]
                ? data[0].qiaIndicator10[0].inputiiqa24t2
                : ""
            );
            setIiqa24t3(
              data[0].qiaIndicator10[0]
                ? data[0].qiaIndicator10[0].inputiiqa24t3
                : ""
            );
            setIiqa24t4(
              data[0].qiaIndicator10[0]
                ? data[0].qiaIndicator10[0].inputiiqa24t4
                : ""
            );

            // qiaIndicator12
            setIiqa1t3(
              data[0].qiaIndicator12[0]
                ? data[0].qiaIndicator12[0].inputiiqa1t3
                : ""
            );
            setIiqa1t4(
              data[0].qiaIndicator12[0]
                ? data[0].qiaIndicator12[0].inputiiqa1t4
                : ""
            );
            setIiqa1t5(
              data[0].qiaIndicator12[0]
                ? data[0].qiaIndicator12[0].inputiiqa1t5
                : ""
            );
            setIiqa1t6(
              data[0].qiaIndicator12[0]
                ? data[0].qiaIndicator12[0].inputiiqa1t6
                : ""
            );

            setPathValueiiqa31f1(data[0].qiaIndiactor_fileupload[0].qiaFileName);
  ...
  function onClickingModify(e) {
    ...
    fetch("http://localhost:8080/api/v1/qiafileupload", filesFetchMethod).then(
      (response) => {
        ...
        <table>
              ...
              <table>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <a href={downloadFile(pathValueiiqa26f1)} target="_blank"> <a target="_openfile" href={filePreviewSrc111f1}> View File</a></a> */}
              ...
              <table>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    />
                      {/* <div className="c11-fileButtons-container">
                      <a href={downloadFile(pathValueiiqa27f1)} target="_blank"> <a target="_openfile" href={filePreviewSrc111f1}> View File</a></a> */}
                  {/* <button className="c11-viewFileButton-style">
          ...
          <tr>
            ...
            <td>
              ...
              />
               {/* <div className="c11-fileButtons-container">
               <a href={downloadFile(pathValueiiqa28f1)} target="_blank"> <a target="_openfile" href={filePreviewSrc111f1}> View File</a></a>
                  {/* <button className="c11-viewFileButton-style"> */}
          ...
          <tr>
            ...
            <td>
              ...
              />
                {/* <div className="c11-fileButtons-container">
                <a href={downloadFile(pathValueiiqa29f1)} target="_blank"> <a target="_openfile" href={filePreviewSrc111f1}> View File</a></a>
                  {/* <button className="c11-viewFileButton-style"> */}
          ...
          <tr>
            ...
            <td>
              ...
              />
               {/* <div className="c11-fileButtons-container">
               <a href={downloadFile(pathValueiiqa30f1)} target="_blank"> <a target="_openfile" href={filePreviewSrc111f1}> View File</a></a> */}
                  {/* <button className="c11-viewFileButton-style">
