...
function Intern1() {
 ...
 const [valuei1t111, setValuesi1t111] = useState();
  ...
  useEffect(
    ()=> 
    fetch("http://localhost:8080/api/v1/getallinternshipfiles"
    ).then((response) => response.json()
    .then((data) => {
      console.log(JSON.stringify(data));
      setValuesi1t1(data[0].if1t1);
      setValuesi1t2(data[0].if1t2);
      setValuesi1t3(data[0].if1t3);
      setValuesi1t4(data[0].if1t4);
      setValuesi1t5(data[0].if1t5);
      setValuesi1t6(data[0].if1t6);
      setValuesi1t7(data[0].if1t7);
      setValuesi1t8(data[0].if1t8);
      setValuesi1t9(data[0].if1t9);
      setValuesi1t10(data[0].if1t10);
      setValuesi1t11(data[0].if1t11);
      setValuesi1t111(data[0].internshipfiles[0].internshipfiles);
    ...
    <div className="App">
      <div className="i1-main-conatiner">
        ...
        <div className="i1-button-container">
          ...
          <button className="i1-button-style" onClick={onClickingView}>
            View
          </button>
        </div>
      </div>
