...
export default function GeneralInformation() {
  ...
  const [pathValueep23Display, setPathValueep23Display] = useState("");

  const [valueep24, setValueep24] = useState();
  const [pathValueep24, setPathValueep24] = useState("");
  const [pathValueep24Display, setPathValueep24Display] = useState("");

  const [valueep25, setValueep25] = useState();
  const [pathValueep25, setPathValueep25] = useState("");
  const [pathValueep25Display, setPathValueep25Display] = useState("");
      ...
      fetch("http://localhost:8080/api/v1/getallprofiledata").then((response) =>
        response
          ...
          .then((data) => {
            ...
            setPathValueep22Display( data[0].profileFileUpload[0].profileFileName );

            setValueep23( data[0].profileFileUpload[1].profileFilePath );
            setPathValueep23Display( data[0].profileFileUpload[1].profileFileName );

            setValueep24( data[0].profileFileUpload[2].profileFilePath );
            setPathValueep24Display( data[0].profileFileUpload[2].profileFileName );

            setValueep25( data[0].profileFileUpload[3].profileFilePath );
            setPathValueep25Display( data[0].profileFileUpload[3].profileFileName );
 ...
 if(pathValueep24 != ""){
  ...
  if(pathValueep25 != ""){
    ...
    fetch("http://localhost:8080/api/v1/profileData", filesFetchMethod).then(
      (response) => {
              ...
              <td>
                <input
                  ...
                  onChange={(e) => {
                    ...
                    setPathValueep23(e.target.value);
                    showFilePreview(e);
                  }}
                />
                {pathValueep23Display === "" ? null : (
                  <div className="fileButtons-container">
                    <button className="viewFileButton-style">
                      <a target="_openfile" href={downloadFile(pathValueep23Display)}>{pathValueep23Display}
              ...
              <td>
                <input
                  ...
                  onChange={(e) => {
                    ...
                    setPathValueep24(e.target.value);
                    showFilePreview(e);
                  }}
                />
                {pathValueep24Display === "" ? null : (
                  <div className="fileButtons-container">
                    <button className="viewFileButton-style">
                      <a target="_openfile" href={downloadFile(pathValueep24Display)}>{pathValueep24Display}
              ...
              <td>
                <input
                  ...
                  onChange={(e) => {
                    ...
                    setPathValueep25(e.target.value);
                    showFilePreview(e);
                  }}
                />
                {pathValueep25Display === "" ? null : (
                  <div className="fileButtons-container">
                    <button className="viewFileButton-style">
                      <a target="_openfile" href={downloadFile(pathValueep25Display)}>{pathValueep25Display}
