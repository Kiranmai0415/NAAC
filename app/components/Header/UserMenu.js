...
function UserMenu(props) {
  ...
  const handleLogout = () => {
    AuthService.logout();
    console.log('loged In user is ==>' + AuthService.getCurrentUser());
    history.push('/login');
  ...
  return (
    <div>
      {/* commenting for timebeing the notifications */}
      {/* <IconButton
        aria-haspopup="true"
      ...
      <Button onClick={handleMenu('user-setting')}>
        ...
        />
        {AuthService.getCurrentUser().email}<br/>{date.toLocaleDateString() + " - " + date.toLocaleTimeString()}
      </Button>
      <Menu
        id="menu-appbar"
        anchorEl={anchorEl}
