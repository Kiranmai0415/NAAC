      ...
      <Toolbar disableGutters={!open}>
        ...
        <Hidden smDown>
          <div className={classes.headerProperties}>
            ...
            <div style={{ margin: '10px' }}><img src={Vignanslogo} alt="Vignans University" style={{ width: '250px', }} /></div> <Typography component="h2">Powered by <img src={Aspironlogo} alt="aspiron" style={{ width: '100px', }} />subsidiary of <img src={Adiverselogo} alt="adiverse tech" style={{ width: '100px', }} /></Typography>
