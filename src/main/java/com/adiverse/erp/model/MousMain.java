...
@Entity
@Table(name ="mous_main")
public class MousMain implements Serializable{
    ...
    public List<MousFileUpload> mousFileUpload;
	...
	public List<Mous> getMous() {
		return mous;
	}

	public void setMous(List<Mous> mous) {
		this.mous = mous;
	}

	public List<MousFileUpload> getMousFileUpload() {
		return mousFileUpload;
	}

	public void setMousFileUpload(List<MousFileUpload> mousFileUpload) {
		this.mousFileUpload = mousFileUpload;
	}
