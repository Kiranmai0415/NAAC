...
public class FeedbackForm_MB implements Serializable
{
	...
	@Override
	public int hashCode() {
		return Objects.hash(checkerdate, checkerid, feedback_id, ff1t1, ff1t2, ff1t3, ff1t4, ff1t5, ff1t6, workstatus);
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		FeedbackForm_MB other = (FeedbackForm_MB) obj;
		return Objects.equals(checkerdate, other.checkerdate) && Objects.equals(checkerid, other.checkerid)
				&& feedback_id == other.feedback_id && Objects.equals(ff1t1, other.ff1t1)
				...
				&& Objects.equals(ff1t6, other.ff1t6) && Objects.equals(workstatus, other.workstatus);
	}
