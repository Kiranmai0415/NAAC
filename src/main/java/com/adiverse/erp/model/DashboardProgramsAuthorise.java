...
@Component
@Entity
@Table(name = "dashboard_programs_authorise")
public class DashboardProgramsAuthorise implements Serializable{
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		DashboardProgramsAuthorise other = (DashboardProgramsAuthorise) obj;
