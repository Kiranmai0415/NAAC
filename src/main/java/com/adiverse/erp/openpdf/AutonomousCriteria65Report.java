...
//@Service
//public class AutonomousCriteria65Report {
//	
...
//			PdfPCell cell133criteria61 = new PdfPCell(new Paragraph("Any additional information"));
...
//					new Paragraph((criteria6file != null ? criteria6file.get(17).getCriteria6FilePath() : "")));
...
//			PdfPCell cell160 = new PdfPCell(new Paragraph(criteria6file != null ? criteria6file.get(1).getCriteria6FilePath() : ""));
//
