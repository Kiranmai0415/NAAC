...
//
//@Service
//public class UniversityCriteria5Report {
//	
...
//			PdfPCell cell00025 = new PdfPCell(new Paragraph("Link for additional information"));
...
//					new Paragraph(criteria5Record != null ? criterai5file.get(8).getCriteria5FilePath() : ""));
//			
//			PdfPCell cell000311 = new PdfPCell(new Paragraph("Link for additional information\r\n"
//					+ "harassment and ragging cases\r\n"
//					+ "\r\n\r\n\r\n"));
...
//							+ (criteria5Record != null ? criteria5Record.getCriteria5FieldInfoQn().get(0).getInput5212t1()
//									: ""),
//					font3));
//
...
//			PdfPCell cell53criteria5 = new PdfPCell(new Paragraph("Self attested list of students placed\r\n\r\n\r\n"));
//			PdfPCell cell54criteria5 = new PdfPCell(
//					new Paragraph(criteria5Record != null ? criterai5file.get(13).getCriteria5FilePath() : ""));
//			PdfPCell cell55criteria5 = new PdfPCell(new Paragraph("Institutional data in prescribed format \r\n\r\n\r\n"));
//			PdfPCell cell56criteria5 = new PdfPCell(
//					new Paragraph(criteria5Record != null ? criterai5file.get(14).getCriteria5FilePath() : ""));
//			PdfPCell cell57criteria5 = new PdfPCell(new Paragraph("Link for additional information\r\n\r\n\r\n"));
...
//					font3));
//			
//			PdfPCell cell01121 = new PdfPCell(new Paragraph(
...
//				table5221.addCell(criteria5Record.getUniversityYearTable5221().get(i).getInput5221y());
//
//			}
//			for (int i = 0; i < criteria5Record.getUniversityYearTable5221().size(); i++) {
//				table5221.addCell(criteria5Record.getUniversityYearTable5221().get(i).getInput5221v());
//
//			}
//
...
//			PdfPCell cell61criteria5 = new PdfPCell(new Paragraph("Institutional data in prescribed format\r\n\r\n\r\n"));
...
//			PdfPCell cell65criteria5 = new PdfPCell(new Paragraph("Link for additional information"));
...
//			PdfPCell cell73criteria5 = new PdfPCell(new Paragraph("Link for additional information\r\n\r\n\r\n"));
...
//							+ "\r\n\r\n" + "Response:"
//							+ (criteria5Record != null
//									? criteria5Record.getCriteria5FieldInfoQl().get(0).getResponse532()
//									: ""),
//					font3));
...
//			}
//			for (int i = 0; i < criteria5Record.getYearTable5331().size(); i++) {
//				table5331.addCell(criteria5Record.getYearTable5331().get(i).getInput5331v());
//
//			}
//
...
//			PdfPCell cell913criteria5 = new PdfPCell(new Paragraph("Any additional information\r\n\r\n\r\n"));
