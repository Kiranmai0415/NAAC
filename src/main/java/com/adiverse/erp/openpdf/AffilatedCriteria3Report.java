...
//
//@Service
//public class AffilatedCriteria3Report 
//{
//	
...
//			PdfPCell cell5criteria3 = new PdfPCell(new Paragraph("e-copies of the grant award letters for sponsoredresearch projects / endowments\r\n"
//					));
...
//							? criteria3_FieldInfoQnList.get(0).getResponse311()
//							: ""),
//					font2));
//			
//			PdfPCell cell31100criteria3 = new PdfPCell(new Paragraph(
//					 (criteria3_FieldInfoQnList != null
//							? criteria3_FieldInfoQnList.get(0).getInput3111t1()
//							: ""),
//					font2));
//
//
//			PdfPCell cell3110criteria3 = new PdfPCell(new Paragraph(
//					"3.1.1.1 Total Grants from Government and non-governmental agencies for research projects ,\r\n"
//					+ "endowments, Chairs in the institution during the last five years (INR in Lakhs)",font2));
//			
//
//			
//			
...
//			table13criteria31.addCell(cell31100criteria3);
//			table13criteria31.addCell(cell3110criteria3);
//			
//			
...
//			
//			//YEAR TABLE 3111
//			Table table3111criteria3 = new Table(criteria3FieldInfoList.get(0).getAffiliated_YearTable3111().size());
//
//			table3111criteria3.setPadding(10);
//			table3111criteria3.setWidth(100f);
//
//			for (int i = 0; i < criteria3FieldInfoList.get(0).getAffiliated_YearTable3111().size(); i++) {
//				table3111criteria3.addCell(criteria3FieldInfoList.get(0).getAffiliated_YearTable3111().get(i).getInput3111y());
//
//			}
//			for (int i = 0; i < criteria3FieldInfoList.get(0).getYearTable3121().size(); i++) {
//				table3111criteria3.addCell(criteria3FieldInfoList.get(0).getAffiliated_YearTable3111().get(i).getInput3111v());
//
//			}
//
...
//			PdfPCell cell23criteria3 = new PdfPCell(new Paragraph("Institutional data in prescribed format\r\n\r\n\r\n"));
...
//					"3.1.2.1 Number of teachers recognized as research guide\r\n\r\n"
//							+ "\r\n" + "Response:"
//							+ (criteria3_FieldInfoQnList != null
//									? criteria3_FieldInfoQnList.get(0).getResponse312()
//									: ""),
...
//					new Paragraph(criteria3_FieldInfoQnList != null ? criteria3file.get(4).getCriteria3FilePath() : ""));
//			PdfPCell cell35criteria3 = new PdfPCell(new Paragraph("List of research projects and funding details"));
...
//			
//			
//			PdfPCell cell37criteria3 = new PdfPCell(new Paragraph("Any additional information"));
//			PdfPCell cell38criteria3 = new PdfPCell(
//					new Paragraph(criteria3_FieldInfoQnList != null ? criteria3file.get(6).getCriteria3FilePath() : ""));
//			
//			PdfPCell cell39criteria3 = new PdfPCell(new Paragraph("Paste link to funding agency website"));
//			PdfPCell cell40criteria3 = new PdfPCell(
...
//			table3criteria3.addCell(cell37criteria3);
//			table3criteria3.addCell(cell38criteria3);
//			table3criteria3.addCell(cell39criteria3);
//			table3criteria3.addCell(cell40criteria3);
//			
...
//							+ "\r\n" + "Response:"
//							+ (criteria3_FieldInfoQn != null
//									? criteria3_FieldInfoQn.getCriteria3FieldInfoQn().get(0).()
//									: ""),
//					font2));*/
//			PdfPCell cell3131criteria3 = new PdfPCell(new Paragraph(
//					"3.1.3.1 Number of departments having Research projects funded by government and nong"
//							+ "\r\n\r\n",
//					font2));
...
//			PdfPCell cell47criteria3 = new PdfPCell(new Paragraph("Paste link for additional information\r\n\r\n"));
...
//									? criteria3_FieldInfoQlList.get(0).getResponse321()
//									: ""),
//					font2));
//			
//			PdfPCell cell3210criteria3 = new PdfPCell(new Paragraph(
//					 (criteria3_FieldInfoQlList != null
//									? criteria3_FieldInfoQlList.get(0).getInput321t1()
//									: "")));
//			
//			
...
//			table43criteria31.addCell(cell3210criteria3);
...
//			PdfPCell cell53criteria3 = new PdfPCell(new Paragraph("Report of the event"));
...
//					new Paragraph("List of workshops/seminars during last 5 years \r\n\r\n\r\n"));
...
//			
//			
//			PdfPCell cell57criteria3 = new PdfPCell(
//					new Paragraph("Any additional information \r\n\r\n\r\n"));
//			PdfPCell cell58criteria3 = new PdfPCell(new Paragraph(criteria3_FieldInfoQnList != null ? criteria3file.get(13).getCriteria3FilePath() :""));
//			
//			
//			
//			
...
//			table5criteria3.addCell(cell57criteria3);
//			table5criteria3.addCell(cell58criteria3);
//			
//			
//			PdfPCell cell322criteria3 = new PdfPCell(
//					new Paragraph("3.2.2 Number of workshops/seminars conducted on Research Methodology, Intellectual Property\r\n"
...
//			
//			
//			PdfPCell cell3220criteria3 = new PdfPCell(
//					new Paragraph((criteria3_FieldInfoQnList != null
//									? criteria3_FieldInfoQnList.get(0).getInput3221t11()
//									: ""),
//							font1criteria3));
//			
//			
...
//			table53criteria31.addCell(cell3220criteria3);
...
//			PdfPCell cell68criteria3 = new PdfPCell(new Paragraph(criteria3_FieldInfoQnList != null ? criteria3file.get(16).getCriteria3FilePath():""));
...
//			PdfPCell cell78criteria3 = new PdfPCell(new Paragraph(criteria3_FieldInfoQnList != null ? criteria3file.get(19).getCriteria3FilePath() : ""));
...
//			PdfPCell cell163criteria3 = new PdfPCell(new Paragraph("e-copies of related Document\r\n\r\n\r\n"));
...
//					"Details of Collaborative activities with institutions/industries for research, Faculty exchange, Student exchange/ internship\r\n\r\n\r\n"));
...
//					font2));
//			
//			PdfPCell cell3510criteria3 = new PdfPCell(new Paragraph(
//					(criteria3_FieldInfoQnList != null
//									? criteria3_FieldInfoQnList.get(0).getInput351t1()
//									: ""),
//					font2));
//			
//			
...
//					+ "internship year-wise during the last five year.\r\n"
//							+ "\r\n\r\n",
//					font2));
//
//			table161criteria31.addCell(cell351criteria3);
//			table161criteria31.addCell(cell3510criteria3);
...
//					new Paragraph("e-Copies of the MoUs with institution/\r\n"
...
//					new Paragraph("Details of functional MoUs with institutions of\r\n"
//							+ "national, international importance, other universities\r\n"
//							+ "etc during the last five years\rn\r\n\r\n"));
...
//					+ " 2019-20 2018-19 2017-18 2016-17 2015-1\r\n"
//							+ "\r\n\r\n",
//					font2));
...
//			PdfPCell cell186criteria3 = new PdfPCell(new Paragraph(criteria3_FieldInfoQnList != null ? criteria3file.get(45).getCriteria3FilePath() : ""));
