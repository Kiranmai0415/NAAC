...
//
//@Service
//public class UniversityCriteria65Report {
//	
//
...
//
//			Paragraph paragraph14criteria61 = new Paragraph(
...
//							+ "Response");
//			document.add(paragraph14criteria61);
//			
//			if(criteria6Fieldinfo.getCriteria6FieldInfoQl() !=null)
//			{
//							
//							
//				Paragraph paragraph14criteria62 = new Paragraph(criteria6Fieldinfo != null
//									? criteria6Fieldinfo.getCriteria6FieldInfoQl().get(0).getResponse651(): "");
//									
//					document.add(paragraph14criteria62);
//					
//			}
...
//			
//			
//			Paragraph paragraph14criteria63 = new Paragraph(
...
//					+ "Response:");
//			document.add(paragraph14criteria63);
//			
//			
//			if(criteria6Fieldinfo.getCriteria6FieldInfoQl() !=null)
//			{
//			Paragraph paragraph14criteria64 = new Paragraph(criteria6Fieldinfo != null
//									? criteria6Fieldinfo.getCriteria6FieldInfoQl().get(0).getResponse652()
//									: "");
...
//			PdfPCell cell143criteria6 = new PdfPCell(new Paragraph("Strategic Plan and deployment documents on the website\r\n"));
...
//			// create table 15
//			
//			Paragraph paragraph14criteria6411 = new Paragraph("6.5.3	Quality assurance initiatives of the institution include:\r\n" + "\r\n"
...
//							+ "Response:");
//			
//			document.add(paragraph14criteria6411);
//			
//			if(criteria6Fieldinfo.getCriteria6FieldInfoQn() !=null)
//			{
//			Paragraph paragraph14criteria65 = new Paragraph (criteria6Fieldinfo != null
//									? criteria6Fieldinfo.getCriteria6FieldInfoQn().get(0).getResponse653()
//									: "");
//			document.add(paragraph14criteria65);
//			
//		}
...
//			PdfPCell cell160 = new PdfPCell(new Paragraph(criteria6Record != null ? criteria6file.get(0).getCriteria6FilePath() : ""));
//			
//
