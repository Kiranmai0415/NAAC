...
//@Service
//public class AffiliatedCriteria25Report2 {
//	
//	
//
//	
...
//
//			Paragraph paragraph7criteria21 = new Paragraph(
//					"2.5.1  Mechanism of internal assessment is transparent and robust in terms of frequency and modE"
//							+ "\r\n" + "Response:");
//			document.add(paragraph7criteria21);
//			
//			if(criteria2Fieldinfo.getCriteria2FieldInfoQl() !=null)
//			{
//			Paragraph paragraph7criteria22 = new Paragraph( (criteria2Fieldinfo != null
//									? criteria2Fieldinfo.getCriteria2FieldInfoQl().get(0).getResponseValue251()
//									: ""));
...
//
//			PdfPCell cell74criteria2 = new PdfPCell(new Paragraph(criteria2Record != null ? criteria2file.get(0).getCriteria2FilePath() : ""));
