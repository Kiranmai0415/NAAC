...
//
//@Service
//public class AffiliatedCriteria71Report {
//
...
//				(criteria7Fieldinfo != null
//									? criteria7Fieldinfo.getCriteria7FieldInfoQl().get(0).getInput711t1()
//									: ""),
//					font3));
//			
//			
...
//			PdfPCell cell1113criteria7 = new PdfPCell(new Paragraph("Link for specific facilities provided for women interms of: a. Safety and security b. Counselling c.Common Rooms d. Day care center for youngchildren e. Any other relevant information\r\n\r\n\r\n"));
//			PdfPCell cell1114criteria7 = new PdfPCell(
//					new Paragraph((criteria7Record != null ? criteria7file.get(0).getCriteria7FilePath() : "")));
//			PdfPCell cell115criteria7 = new PdfPCell(new Paragraph("Link for annual gender sensitization action plan\r\n/r/n/r/n"));
...
//			PdfPCell cell1117criteria7 = new PdfPCell(new Paragraph((criteria7Record != null ? criteria7file.get(0).getCriteria7FilePath() : "")));
//			PdfPCell cell1190criteria7 = new PdfPCell(new Paragraph("Any other relevant information\r\n\r\n\r\n"));
//			PdfPCell cell1191criteria7 = new PdfPCell(new Paragraph((criteria7Record != null ? criteria7file.get(0).getCriteria7FilePath() : "")));
//
...
//					 (criteria7Fieldinfo != null
//									? criteria7Fieldinfo.getCriteria7FieldInfoQn().get(0).getInput712t1()
//									: ""),
//					font3));
//			
//
...
//
//			PdfPCell cell21criteria7 = new PdfPCell(new Paragraph("FileDiscription\r\n\r\n\r\n", font3));
//			PdfPCell cell22criteria7 = new PdfPCell(new Paragraph("Document\r\n\r\n\r\n", font3));
//			PdfPCell cell23criteria7 = new PdfPCell(new Paragraph("Reports on environment and energy audits submitted by the auditing agency\r\n\r\n\r\n"));
//			PdfPCell cell24criteria7 = new PdfPCell(new Paragraph((criteria7Record != null ? criteria7file.get(0).getCriteria7FilePath() : "")));
//			PdfPCell cell25criteria7 = new PdfPCell(new Paragraph("Certification by the auditing agency	\r\n\r\n\r\n"));
//			PdfPCell cell26criteria7 = new PdfPCell(new Paragraph((criteria7Record != null ? criteria7file.get(0).getCriteria7FilePath() : "")));
//			PdfPCell cell27criteria7 = new PdfPCell(new Paragraph("Certificates of the awards received	\r\n\r\n\r\n"));
//			PdfPCell cell28criteria7 = new PdfPCell(new Paragraph((criteria7Record != null ? criteria7file.get(0).getCriteria7FilePath() : "")));
//			
//			PdfPCell cell29criteria7 = new PdfPCell(new Paragraph("Any other relevant information	\r\n\r\n\r\n"));
//			PdfPCell cell30criteria7 = new PdfPCell(new Paragraph((criteria7Record != null ? criteria7file.get(0).getCriteria7FilePath() : "")));
//			
//			
//			
...
//					(criteria7Fieldinfo != null
//									? criteria7Fieldinfo.getCriteria7FieldInfoQn().get(0).getInput713t1()
//									: ""),
//					font3));
//			
//			
...
//
//			PdfPCell cell63criteria7 = new PdfPCell(new Paragraph("Supporting documents on the information provided (as reflected in the administrative and academic activities of the Institution)\r\n\r\n\r\n"));
...
//									? criteria7Record.getCriteria7FieldInfoQl().get(0).getResponse714()
//									: ""),
//							font3));
//
...
////			 */
////			PdfPCell cell670criteria7 = new PdfPCell(new Paragraph("File Description\r\n\r\n\r\n", font3));
////			PdfPCell cell680criteria7 = new PdfPCell(new Paragraph("Document\r\n\r\n\r\n", font3));
////			PdfPCell cell69criteria7 = new PdfPCell(
////					new Paragraph("Various policy documents / decisions circulated forimplementation \r\n\r\n\r\n" ));
...
////			PdfPCell cell75criteria7 = new PdfPCell(new Paragraph("Link for any other relevant information\r\n\r\n"));
////			PdfPCell cell76criteria7 = new PdfPCell(
////					new Paragraph((criteria7Record != null ? criteria7file.get(13).getCriteria7FilePath() : "")));
////
////			table6criteria7.addCell(cell670criteria7);
////			table6criteria7.addCell(cell680criteria7);
...
////			table6criteria7.addCell(cell75criteria7);
////			table6criteria7.addCell(cell76criteria7);
////			
////
...
////			PdfPCell cell750criteria7 = new PdfPCell(new Paragraph("File Description\r\n\r\n\r\n"));
////			PdfPCell cell760criteria7 = new PdfPCell(new Paragraph("Document\r\n\r\n\r\n"));
...
////					new Paragraph((criteria7Record != null ? criteria7file.get(0).getCriteria7FilePath() : "")));
////			PdfPCell cell81criteria7 = new PdfPCell(new Paragraph("Any other relevant information\r\n\r\n\r\n"));
////			PdfPCell cell82criteria7 = new PdfPCell(
////					new Paragraph((criteria7Record != null ? criteria7file.get(0).getCriteria7FilePath() : "")));
////			PdfPCell cell83criteria7 = new PdfPCell(new Paragraph("Link for any other relevant information\r\n\r\n\r\n"));
////			
////			table15criteria7.addCell(cell750criteria7);
////			table15criteria7.addCell(cell760criteria7);
...
////			PdfPCell cell89criteria7 = new PdfPCell(new Paragraph("Any other relevant information\r\n\r\n\r\n"));
...
////					new Paragraph("Link for any other relevant information\r\n\r\n\r\n"));
...
////					new Paragraph("Link for supporting documents on the information provided (as reflected in the administrative and academic activities of the Institution)\r\n"));
...
////			PdfPCell cell107criteria7 = new PdfPCell(new Paragraph(" Link for details of activities that inculcate values necessary to render students in to responsible citizensnecessary to render students in to responsible citizens\r\n\r\n"));
...
////					" Details of the monitoring committee composition and minutes of the committee meeting, number ofprogrammes organized, reports on the variousprograms etc., in support of the claims\r\n\r\n\r\n"));
...
////			table7111criteria7.setSpacingBefore(20);
////			table7111criteria7.setSpacingAfter(20);
////
...
////							+ "in Debates, Essay Writing, Group Discussions, Poster Presentation and Slogan Writing Competitions held during these celebrations.\r\n"
