...
//
//@Service
//public class AffilatedCriteria31Report2 
//{
//	
...
//
//			Paragraph paragraph21criteria3 = new Paragraph(
...
//							+ "Response:");
//			
//			document.add(paragraph21criteria3);
//			
//			Paragraph paragraph22criteria3 = new Paragraph(criteria3Fieldinfo != null
//							? criteria3Fieldinfo.getCriteria3FieldInfoQn().get(0).getResponse311()
//							: "");
//			document.add(paragraph22criteria3);
//					
//			
...
//
//
//			Paragraph paragraph211criteria3 = new Paragraph(
...
//			document.add(paragraph211criteria3);
//			
//
//			
//			
...
//			{
//			Table table3111criteria3 = new Table(criteria3Fieldinfo.getAffiliated_YearTable3111().size());
//
//			table3111criteria3.setPadding(10);
//			table3111criteria3.setWidth(100f);
//
//			for (int i = 0; i < criteria3Fieldinfo.getAffiliated_YearTable3111().size(); i++) {
//				table3111criteria3.addCell(criteria3Fieldinfo.getAffiliated_YearTable3111().get(i).getInput3111y());
//
//			}
//			for (int i = 0; i < criteria3Fieldinfo.getYearTable3121().size(); i++) {
//				table3111criteria3.addCell(criteria3Fieldinfo.getAffiliated_YearTable3111().get(i).getInput3111v());
//
//			}
//
...
//					new Paragraph("e-copies of the grant award letters for research projects sponsored by non-government\r\n"));
