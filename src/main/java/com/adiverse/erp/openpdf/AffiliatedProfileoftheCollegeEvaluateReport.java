...
@Service
public class AffiliatedProfileoftheCollegeEvaluateReport {
	...
	public String generateReport(Map<String, String> allParams) throws DocumentException, IOException {
		...
		try { 
			...
			if (CollectionUtils.isNotEmpty(profileList)) {
				...
				PdfPTable table60 = new PdfPTable(4);
				...
				PdfPCell cell010criteria7 = new PdfPCell(new Paragraph(ProfileRecord!=null?ProfileRecord.getEvaluativeFileupload().get(0).getEvaluative_filePath():""));//file
				PdfPCell cell011criteria7 = new PdfPCell(new Paragraph(new Paragraph(ProfileRecord!=null?ProfileRecord.getEvaluativeReport().get(1).getValuet1():"",font5)));
				PdfPCell cell012criteria7 = new PdfPCell(new Paragraph(ProfileRecord!=null?ProfileRecord.getEvaluativeFileupload().get(1).getEvaluative_filePath():""));
				PdfPCell cell013criteria7 = new PdfPCell(new Paragraph(new Paragraph(ProfileRecord!=null?ProfileRecord.getEvaluativeReport().get(2).getValuet1():"",font5)));
				PdfPCell cell09criteria17 = new PdfPCell(new Paragraph(ProfileRecord!=null?ProfileRecord.getEvaluativeFileupload().get(2).getEvaluative_filePath():""));
				PdfPCell cell010criteria17 = new PdfPCell(new Paragraph(new Paragraph(ProfileRecord!=null?ProfileRecord.getEvaluativeReport().get(3).getValuet1():"",font5)));
				PdfPCell cell011criteria17 = new PdfPCell(new Paragraph(ProfileRecord!=null?ProfileRecord.getEvaluativeFileupload().get(3).getEvaluative_filePath():""));
			
			

				
				cell09criteria7.setExtraParagraphSpace(10);
				cell09criteria7.setHorizontalAlignment(Element.ALIGN_CENTER);
				table60.addCell(cell09criteria7);
				

				cell010criteria7.setExtraParagraphSpace(10);
				cell010criteria7.setHorizontalAlignment(Element.ALIGN_CENTER);
				table60.addCell(cell010criteria7);
				
				cell011criteria7.setExtraParagraphSpace(10);
				cell011criteria7.setHorizontalAlignment(Element.ALIGN_CENTER);
				table60.addCell(cell011criteria7);
				
				
				cell012criteria7.setExtraParagraphSpace(10);
				cell012criteria7.setHorizontalAlignment(Element.ALIGN_CENTER);
				table60.addCell(cell012criteria7);
				
				cell013criteria7.setExtraParagraphSpace(10);
				cell013criteria7.setHorizontalAlignment(Element.ALIGN_CENTER);
				table60.addCell(cell013criteria7);
				
				
				cell09criteria17.setExtraParagraphSpace(10);
				cell09criteria17.setHorizontalAlignment(Element.ALIGN_CENTER);
				table60.addCell(cell09criteria17);
				
				cell010criteria17.setExtraParagraphSpace(10);
				cell010criteria17.setHorizontalAlignment(Element.ALIGN_CENTER);
				table60.addCell(cell010criteria17);
				
				
				cell011criteria17.setExtraParagraphSpace(10);
