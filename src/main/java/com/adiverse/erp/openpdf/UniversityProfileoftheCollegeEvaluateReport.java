...
@Service
public class UniversityProfileoftheCollegeEvaluateReport {
		...
		try { 
			...
			if (CollectionUtils.isNotEmpty(profileList)) {
				...
				if (root != null) {
					...
					reportPath = "UniversityProfileoftheCollegeEvaluateReport-" + strDate + ".pdf";
					file = root.resolve(reportPath);
				}
				System.out.println("reportPath is ==>" + file.toAbsolutePath().toString()); 
				
				Document document = new Document(PageSize.A4);
				// PdfWriter.getInstance(document, response.getOutputStream(,font5)); 
				...
				PdfPCell cell011criteria7 = new PdfPCell(new Paragraph(ProfileRecord!=null?ProfileRecord.getEvaluativeReport().get(0).getValuet2():"",font5)); 
				...
				PdfPCell cell013criteria7 = new PdfPCell(new Paragraph(ProfileRecord!=null?ProfileRecord.getEvaluativeReport().get(0).getValuet3():"",font5)); 
				...
				PdfPCell cell010criteria17 = new PdfPCell(new Paragraph(ProfileRecord!=null?ProfileRecord.getEvaluativeReport().get(0).getValuet4():"",font5)); 
