...
//
//@Service
//public class UniversityCriteria26Report2 {
//	
...
//
//			PdfPCell cell841criteria2 = new PdfPCell(new Paragraph(criteria2Record != null ? criteria2file.get(0).getCriteria2FilePath() : ""));
...
//					+ "\r\n" + "Response:");
////					+ (criteria2Fieldinfo != null ? criteria2Fieldinfo.getCriteria2FieldInfoQn().get(0).getResponse263()
////							: ""));
