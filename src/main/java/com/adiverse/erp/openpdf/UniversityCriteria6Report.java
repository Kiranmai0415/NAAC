...
//
//@Service
//public class UniversityCriteria6Report {
//	
//
...
//			PdfPCell cell3criteria6 = new PdfPCell(new Paragraph("Link for aditional information"));
...
//			PdfPCell cell35criteria6 = new PdfPCell(new Paragraph("Strategic Plan and deployment documents on the\r\n"
//					+ "website\r\n\r\n\r\n"));
...
//			PdfPCell cell55criteria6 = new PdfPCell(new Paragraph("ERP (Enterprise Resource Planning) Document\r\n\r\n\r\n"));
//			PdfPCell cell56criteria6 = new PdfPCell(
//					new Paragraph((criteria6Record != null ? criteria6file.get(4).getCriteria6FilePath() : "")));
//			PdfPCell cell57criteria6 = new PdfPCell(new Paragraph("Details of implementation of e-governance in areas\r\n"
...
//			PdfPCell cell73criteria6 = new PdfPCell(new Paragraph("Details of teachers provided with financial support\r\n"
...
//			PdfPCell cell83criteria6 = new PdfPCell(new Paragraph("Reports of Academic Staff College or similar\r\n"
//					+ "centers\r\n\r\n\r\n"));
//			PdfPCell cell84criteria6 = new PdfPCell(
//					new Paragraph((criteria6Record != null ? criteria6file.get(8).getCriteria6FilePath() : "")));
//			PdfPCell cell85criteria6 = new PdfPCell(new Paragraph("Details of professional development / administrative\r\n"
...
//			PdfPCell cell93criteria6 = new PdfPCell(new Paragraph("IQAC report summary\r\n\r\n\r\n"));
//			PdfPCell cell94criteria6 = new PdfPCell(
//					new Paragraph((criteria6Record != null ? criteria6file.get(11).getCriteria6FilePath() : "")));
//			PdfPCell cell95criteria6 = new PdfPCell(new Paragraph("Details of teachers attending professional\r\n"
...
//			PdfPCell cell103criteria6 = new PdfPCell(new Paragraph("Details of Funds / Grants received from government\r\n"
...
//			PdfPCell cell133criteria6 = new PdfPCell(new Paragraph("Upload e-copies of the accreditations and\r\n"
//					+ "certifications"));
//			PdfPCell cell134criteria6 = new PdfPCell(
//					new Paragraph((criteria6Record != null ? criteria6file.get(18).getCriteria6FilePath() : "")));
//			PdfPCell cell1331criteria6 = new PdfPCell(new Paragraph("Upload details of Quality assurance initiatives of the\r\n"
...
//			
//			PdfPCell cell1333criteria6 = new PdfPCell(new Paragraph("Paste web link of Annual reports of University"));
//			PdfPCell cell1344criteria6 = new PdfPCell(
//					new Paragraph((criteria6Record != null ? criteria6file.get(20).getCriteria6FilePath() : "")));
//			PdfPCell cell13315criteria6 = new PdfPCell(new Paragraph("Link for Additional Information"));
//			PdfPCell cell13416criteria6 = new PdfPCell(
...
//			table131criteria6.addCell(cell1333criteria6);
//			table131criteria6.addCell(cell1344criteria6);
//			table131criteria6.addCell(cell13315criteria6);
//			table131criteria6.addCell(cell13416criteria6);
//			
//			
...
//			PdfPCell cell143criteria6 = new PdfPCell(new Paragraph("Link for additional information\r\n\r\n\r\n"));
...
//					new Paragraph(criteria6Record != null ? criteria6file.get(24).getCriteria6FilePath() : ""));
//			PdfPCell cell157 = new PdfPCell(new Paragraph("Any additional information\r\n\r\n\r\n"));
//			PdfPCell cell158 = new PdfPCell(
//					new Paragraph(criteria6Record != null ? criteria6file.get(25).getCriteria6FilePath() : ""));
