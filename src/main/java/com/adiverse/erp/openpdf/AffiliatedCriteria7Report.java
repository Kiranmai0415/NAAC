...
//
//@Service
//public class AffiliatedCriteria7Report {
//
...
//				(criteria7Record != null
//									? criteria7Record.getCriteria7FieldInfoQl().get(0).getInput711t1()
//									: ""),
//					font3));
//			
//			
...
//					 (criteria7Record != null
//									? criteria7Record.getCriteria7FieldInfoQn().get(0).getInput712t1()
//									: ""),
//					font3));
//			
//
...
//							+ "Response:"
//							+ (criteria7Record != null
//									? criteria7Record.getCriteria7FieldInfoQn().get(0).getResponse713()
//									: ""),
//					font3));
//
//			PdfPCell cell7130criteria7 = new PdfPCell(new Paragraph(
//					(criteria7Record != null
//									? criteria7Record.getCriteria7FieldInfoQn().get(0).getInput713t1()
//									: ""),
//					font3));
//			
//			
...
//			PdfPCell cell55criteria7 = new PdfPCell(new Paragraph("Link for Relevant documents like\r\n"
...
//			PdfPCell cell57criteria7 = new PdfPCell(new Paragraph("Link for Geotagged photographs of the facilities\r\n\r\n\r\n"));
...
//			PdfPCell cell67criteria7 = new PdfPCell(new Paragraph("Link for any other relevant information\r\n\r\n\r\n"));
//			PdfPCell cell68criteria7 = new PdfPCell(
...
//			table3criteria7.addCell(cell67criteria7);
//			table3criteria7.addCell(cell68criteria7);
//			
//
...
//					 (criteria7Record != null
//									? criteria7Record.getCriteria7FieldInfoQl().get(0).getInput731t1()
//									: ""),
//					font3));
//			
//			
...
//			PdfPCell cell24criteria7 = new PdfPCell(new Paragraph("Link for appropriate web in the Institutional website\r\n\r\n\r\n"));
