...
@Service
	...
	public class AutonomousIiqaReport {
//		@Autowired
...
//				       		addLogo(document);
			...
			//creating table 4 cloums date of submission	
				...
				PdfPCell cell10 = new PdfPCell(new Paragraph(qiadata.getInputIiqaAisheId(),font));
				...
				PdfPCell cell13 = new PdfPCell(new Paragraph(qiadata.getInputIiqaTrackId(),font));
