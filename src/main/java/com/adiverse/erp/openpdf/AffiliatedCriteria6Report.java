...
//@Service
//public class AffiliatedCriteria6Report {
//	
//	
//
//	
...
//					 (criteria6Record != null
//									? criteria6Record.getCriteria6FieldInfoQl().get(0).getInput611t1()
//									: ""),
//					font3);
//			
//		
...
//			PdfPCell cell34criteria6 = new PdfPCell(new Paragraph(criteria6Record != null ? criteria6file.get(5).getCriteria6FilePath() :""));
//			PdfPCell cell35criteria6 = new PdfPCell(new Paragraph("strategic Plan and deployment documents on the website\r\n"
//					+ "\r\n\r\n\r\n"));
//			PdfPCell cell36criteria6 = new PdfPCell(new Paragraph(criteria6Record != null ? criteria6file.get(6).getCriteria6FilePath() :""));
//			PdfPCell cell37criteria6 = new PdfPCell(new Paragraph("Paste link for additional information"));
//			
//			
//			PdfPCell cell38criteria6 = new PdfPCell(new Paragraph(criteria6Record != null ? criteria6file.get(7).getCriteria6FilePath() :""));
//			
//			
...
//									? criteria6Record.getCriteria6FieldInfoQl().get(0).getInput621t1()
//									: ""),
//							font3));
//			
...
//			PdfPCell cell43criteria6 = new PdfPCell(new Paragraph("Upload any additional information\r\n\r\n\r\n"));
//			PdfPCell cell44criteria6 = new PdfPCell(
//					new Paragraph((criteria6Record != null ? criteria6file.get(8).getCriteria6FilePath() : "")));
//			PdfPCell cell45criteria6 = new PdfPCell(new Paragraph("Paste link for additional information\r\n\r\n\r\n"));
//			PdfPCell cell46criteria6 = new PdfPCell(new Paragraph(criteria6Record != null ? criteria6file.get(9).getCriteria6FilePath() :""));
//			PdfPCell cell47criteria6 = new PdfPCell(new Paragraph("Link to Organogram of the Institution webpage "));
//			PdfPCell cell48criteria6 = new PdfPCell(new Paragraph(criteria6Record != null ? criteria6file.get(10).getCriteria6FilePath() :""));
...
//							+ "\r\n" + "\r\n" + "Response:"
//							+ (criteria6Record != null
//									? criteria6Record.getCriteria6FieldInfoQn().get(0).getResponse622()
//									: ""),
//					font3));
//			PdfPCell cell410 = new PdfPCell(new Paragraph(
//					(criteria6Record != null
//									? criteria6Record.getCriteria6FieldInfoQn().get(0).getInput622t1()
//									: ""),
//					font3));
//			
//			
...
//			PdfPCell cell60criteria6 = new PdfPCell(new Paragraph(criteria6Record != null ? criteria6file.get(14).getCriteria6FilePath() :""));
...
//			PdfPCell cell63criteria6 = new PdfPCell(new Paragraph(" Upload Any additional information\r\n\r\n\r\n"));
...
//			PdfPCell cell66criteria6 = new PdfPCell(new Paragraph(criteria6Record != null ? criteria6file.get(16).getCriteria6FilePath() : ""));
...
//					 (criteria6Record != null
//									? criteria6Record.getCriteria6FieldInfoQl().get(0).getInput631t1()
//									: ""),
//					font3));
//			
//			
...
//			PdfPCell cell76criteria6 = new PdfPCell(new Paragraph(criteria6Record != null ? criteria6file.get(18).getCriteria6FilePath() :""));
//			
//			
//			
...
//					 (criteria6Record != null
//									? criteria6Record.getCriteria6FieldInfoQn().get(0).getInput632t1()
//									: ""),
//					font3));
//			
//			
...
//					table6321criteria6.addCell(criteria6Record.getYearTable6331().get(i).getInput6331y());
//				}
//				for (int i = 0; i < criteria6Record.getYearTable6321().size(); i++) {
//					table6321criteria6.addCell(criteria6Record.getYearTable6331().get(i).getInput6331v());
//				}
//
...
//			PdfPCell cell85criteria6 = new PdfPCell(new Paragraph("Reports of the Human Resource DevelopmentCentres (UGC ASC or other relevant centres)\r\n"
//					+ "\r\n\r\n\r\n"));
//			PdfPCell cell86criteria6 = new PdfPCell(
//					new Paragraph((criteria6Record != null ? criteria6file.get(20).getCriteria6FilePath() : "")));
//			PdfPCell cell87criteria6 = new PdfPCell(new Paragraph("Details of professional development / administrativetraining Programmes organized by the Universityfor teaching and non teaching staff\r\n\r\n\r\n"));
//			PdfPCell cell88criteria6 = new PdfPCell(
//					new Paragraph((criteria6Record != null ? criteria6file.get(21).getCriteria6FilePath() : "")));
//			
...
//					 (criteria6Record != null
//									? criteria6Record.getCriteria6FieldInfoQn().get(0).getInput6333t1()
//									: ""),
//					font3)); 
//			
...
//					new Paragraph((criteria6Record != null ? criteria6file.get(22).getCriteria6FilePath() : "")));
...
//					new Paragraph((criteria6Record != null ? criteria6file.get(23).getCriteria6FilePath() : "")));
//			PdfPCell cell97criteria6 = new PdfPCell(new Paragraph("IQAC report summary\r\n\r\n\r\n"));
//			PdfPCell cell98criteria6 = new PdfPCell(new Paragraph(criteria6Record != null ? criteria6file.get(24).getCriteria6FilePath() :""));
...
//			PdfPCell cell100criteria6 = new PdfPCell(new Paragraph(criteria6Record != null ? criteria6file.get(25).getCriteria6FilePath() :""));
...
//					new Paragraph((criteria6Record != null ? criteria6file.get(33).getCriteria6FilePath() : "")));
...
//					new Paragraph((criteria6Record != null ? criteria6file.get(34).getCriteria6FilePath() : "")));
//			
...
//					new Paragraph(criteria6Record != null ? criteria6file.get(37).getCriteria6FilePath() : ""));
//			PdfPCell cell155 = new PdfPCell(new Paragraph("Upload details of Quality assurance initiatives of the\r\n"
//					+ "institution\r\n\r\n\r\n"));
//			PdfPCell cell156 = new PdfPCell(
//					new Paragraph(criteria6Record != null ? criteria6file.get(38).getCriteria6FilePath() : ""));
//			PdfPCell cell157 = new PdfPCell(new Paragraph("Upload any additional information\r\n\r\n\r\n"));
//			PdfPCell cell158 = new PdfPCell(
//					new Paragraph(criteria6Record != null ? criteria6file.get(39).getCriteria6FilePath() : ""));
