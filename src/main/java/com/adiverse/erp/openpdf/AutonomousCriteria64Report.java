...
//@Service
//public class AutonomousCriteria64Report {
//	
...
//
//			
//			Paragraph paragraph13criteria622= new Paragraph("6.4.1: The institutional Strategic/ Perspective plan is effectively deployed\r\n");
//			document.add(paragraph13criteria622);
//			
//			Paragraph paragraph13criteria623= new Paragraph(criteria6Fieldinfo != null
//					? criteria6Fieldinfo.getCriteria6FieldInfoQl().get(0).getResponse641()
//					: "");
//			document.add(paragraph13criteria623);
//			
...
//			PdfPCell cell103criteria6 = new PdfPCell(new Paragraph("Strategic Plan and deployment documents on the website"));
//			PdfPCell cell104criteria6 = new PdfPCell(
//					new Paragraph((criteria6file != null ? criteria6file.get(0).getCriteria6FilePath() : "")));
//			PdfPCell cell103criteria61 = new PdfPCell(new Paragraph("Paste link for additional Information"));
//			PdfPCell cell104criteria61 = new PdfPCell(
//					new Paragraph((criteria6file != null ? criteria6file.get(0).getCriteria6FilePath() : "")));
//			PdfPCell cell103criteria611 = new PdfPCell(new Paragraph("Paste link for additional Information"));
...
//			
//			
//			Paragraph paragraph13criteria624= new Paragraph("6.4.2: Funds / Grants received from non-government bodies, individuals, philanthropists during the last five years (not covered in Criterion III and V) (INR in Lakhs)"+"\r\n");
//			document.add(paragraph13criteria624);
//			Paragraph paragraph13criteria625= new Paragraph(criteria6Fieldinfo != null
//					? criteria6Fieldinfo.getCriteria6FieldInfoQn().get(0).getResponse642()
//					: "");
...
//	//create table 6421
//
//			if (criteria6Fieldinfo.getYearTable6421()!=null) {
//
//				Table table6421 = new Table(criteria6Fieldinfo.getYearTable6421().size(), 2);
//
//				table6421.setPadding(10);
//				table6421.setWidth(100f);
//
//				for (int i = 0; i < criteria6Fieldinfo.getYearTable6421().size(); i++) {
//					table6421.addCell(criteria6Fieldinfo.getYearTable6421().get(i).getInput6421y());
//				}
//				if( criteria6Fieldinfo.getYearTable6341() !=null)
//				{
//				for (int i = 0; i < criteria6Fieldinfo.getYearTable6341().size(); i++) {
//					table6421.addCell(criteria6Fieldinfo.getYearTable6421().get(i).getInput6421v());
//				}
//				}
//				else
//				{
...
//			PdfPCell cell120criteria6 = new PdfPCell(new Paragraph((criteria6Record != null ? criteria6file.get(0).getCriteria6FilePath() : "")));
...
//			
//			
//			Paragraph paragraph13criteria626= new Paragraph("6.4.3: Institutional strategies for mobilisation of funds and the optimal utilisation of resources"+"\r\n"+"Response:");
//			document.add(paragraph13criteria626);
//			Paragraph paragraph13criteria627= new Paragraph(criteria6Fieldinfo != null
//					? criteria6Fieldinfo.getCriteria6FieldInfoQl().get(0).getResponse643()
//					: "");
...
//			PdfPCell cell123criteria6 = new PdfPCell(new Paragraph("Strategic Plan and deployment documents on the website\r\n"));
//			PdfPCell cell124criteria6 = new PdfPCell(new Paragraph((criteria6file != null ? criteria6file.get(0).getCriteria6FilePath() : "")));
//			PdfPCell cell123criteria61 = new PdfPCell(new Paragraph("Paste link for additional Information\r\n"));
//			PdfPCell cell124criteria61 = new PdfPCell(new Paragraph((criteria6file != null ? criteria6file.get(0).getCriteria6FilePath() : "")));
//			PdfPCell cell123criteria611 = new PdfPCell(new Paragraph("Upload any additional information\r\n"));
//			PdfPCell cell124criteria611 = new PdfPCell(new Paragraph((criteria6file != null ? criteria6file.get(0).getCriteria6FilePath() : "")));
