...
//@Service
//public class AutonomousCriteria61Report {
//	
//	
//
//	
...
//					new Paragraph((criteria6file != null ? criteria6file.get(1).getCriteria6FilePath() : "")));
...
//			
//			
//			Paragraph paragraph1criteria621 = new Paragraph("6.1.2: The effective leadership is reflected in various institutional practices such as decentralization and participative management.\r\n");
//			document.add(paragraph1criteria621);
//
//			Paragraph paragraph30criteria6331= new Paragraph(
//					 (criteria6Fieldinfo != null
//									? criteria6Fieldinfo.getCriteria6FieldInfoQl().get(0).getResponse612()
//									: ""),
//					font3);
//
//document.add(paragraph30criteria6331);
//			
//
//
//
...
//PdfPTable table110criteria611=new PdfPTable(1);
//table110criteria6.setWidthPercentage(100);
//PdfPCell cell1criteria61 = new PdfPCell(new Paragraph("FileDiscription\r\n\r\n\r\n", font3));
//PdfPCell cell2criteria61 = new PdfPCell(new Paragraph("Document\r\n\r\n", font3));
//PdfPCell cell3criteria61 = new PdfPCell(new Paragraph("Upload Any aditional information"));
//PdfPCell cell4criteria61 = new PdfPCell(
//		new Paragraph((criteria6file != null ? criteria6file.get(0).getCriteria6FilePath() : "")));
//PdfPCell cell5criteria61 = new PdfPCell(new Paragraph("Paste link for Any aditional information"));
//PdfPCell cell6criteria61 = new PdfPCell(
//		new Paragraph((criteria6file != null ? criteria6file.get(1).getCriteria6FilePath() : "")));
//table1criteria611.addCell(cell1criteria61);
//table1criteria611.addCell(cell2criteria61);
//table1criteria611.addCell(cell5criteria61);
//table1criteria611.addCell(cell6criteria61);
//table1criteria611.addCell(cell3criteria61);
//table1criteria611.addCell(cell4criteria61);
//
//
//document.add(table1criteria611);
//
//
//			
//       document.close();
